...
function GetOciCommandsToLongParams_search() {
    $ociCommandsToLongParams = @{
        'search resource free-text-search' = 'from-json help limit matching-context-type page tenant-id text'
        'search resource structured-search' = 'from-json help limit matching-context-type page query-text tenant-id'
