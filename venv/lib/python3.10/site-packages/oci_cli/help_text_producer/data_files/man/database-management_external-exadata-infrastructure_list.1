...
.
.TH "DATABASE-MANAGEMENT_EXTERNAL-EXADATA-INFRASTRUCTURE_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
database-management_external-exadata-infrastructure_list \- 
.
...
.nf
.ft C
oci database\-management external\-exadata\-infrastructure list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/database\-management/external\-exadata\-infrastructure/list.html#cmdoption\-compartment\-id

    oci database\-management external\-exadata\-infrastructure list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
