...
.
.TH "IDENTITY-DOMAINS_SECURITY-QUESTIONS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_security-questions \- 
.
...
.nf
.ft C
oci identity\-domains security\-questions list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains security\-questions list
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains security\-questions search [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains security\-questions search \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains security\-questions search \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
