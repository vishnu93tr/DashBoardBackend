...
.
.TH "JMS_WORK-REQUEST_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
jms_work-request_list \- 
.
...
.SH DESCRIPTION
.sp
List the work requests in a compartment. The query parameter \fIcompartmentId\fP is required unless the query parameter \fIid\fP or \fIfleetId\fP is specified.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci jms work\-request list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
