...
.
.TH "OS-MANAGEMENT-HUB_SOFTWARE-SOURCE_CREATE-VERSIONED-CUSTOM-SWSRC" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
os-management-hub_software-source_create-versioned-custom-swsrc \- 
.
...
.INDENT 0.0
.TP
.B \-\-software\-source\-version [text]
.UNINDENT
.sp
The version to assign to this custom software source.
.INDENT 0.0
.TP
.B \-\-vendor\-software\-sources [complex type]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-is\-auto\-resolve\-dependencies [boolean]
.UNINDENT
.sp
Indicates whether the service should automatically resolve package dependencies when including specific packages in the software source.
.INDENT 0.0
.TP
.B \-\-is\-created\-from\-package\-list [boolean]
.UNINDENT
.sp
Indicates whether the service should create the software source from a list of packages provided by the user.
.INDENT 0.0
.TP
.B \-\-is\-latest\-content\-only [boolean]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-packages [complex type]
.UNINDENT
.sp
A property used for compatibility only. It doesn’t provide a complete list of packages. See \fI\%AddPackagesToSoftwareSourceDetails\fP <\fBhttps://docs.cloud.oracle.com/api/#/en/osmh/latest/datatypes/AddPackagesToSoftwareSourceDetails\fP> for providing the list of packages used to create the software source when isCreatedFromPackageList is set to true.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
.INDENT 0.0
.TP
.B \-\-software\-source\-sub\-type [text]
.UNINDENT
.sp
