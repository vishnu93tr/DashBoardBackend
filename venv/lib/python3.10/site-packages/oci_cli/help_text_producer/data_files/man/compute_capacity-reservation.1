...
.
.TH "COMPUTE_CAPACITY-RESERVATION" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
compute_capacity-reservation \- 
.
...
.SS Description
.sp
Moves a compute capacity reservation into a different compartment. For information about moving resources between compartments, see \fI\%Moving Resources to a Different Compartment\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Identity/Tasks/managingcompartments.htm#moveRes\fP>\&.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci compute capacity\-reservation change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the compartment to move the compute capacity reservation to.
...
.nf
.ft C
    export availability_domain=<substitute\-value\-of\-availability_domain> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/compute/capacity\-reservation/create.html#cmdoption\-availability\-domain
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/compute/capacity\-reservation/create.html#cmdoption\-compartment\-id

    capacity_reservation_id=$(oci compute capacity\-reservation create \-\-availability\-domain $availability_domain \-\-compartment\-id $compartment_id \-\-query data.id \-\-raw\-output)

    oci compute capacity\-reservation change\-compartment \-\-capacity\-reservation\-id $capacity_reservation_id \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.SS Description
.sp
Creates a new compute capacity reservation in the specified compartment and availability domain. Compute capacity reservations let you reserve instances in a compartment. When you launch an instance using this reservation, you are assured that you have enough space for your instance, and you won’t get out of capacity errors. For more information, see \fI\%Reserved Capacity\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Compute/Tasks/reserve-capacity.htm\fP>\&.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci compute capacity\-reservation create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the compartment containing the capacity reservation.
.SS Optional Parameters
.INDENT 0.0
.TP
...
.INDENT 0.0
.TP
.B \-\-instance\-reservation\-configs [complex type]
.UNINDENT
.sp
...
.sp
This option is a JSON list with items of type InstanceReservationConfigDetails.  For documentation on InstanceReservationConfigDetails please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/iaas/20160918/datatypes/InstanceReservationConfigDetails\fP\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
.INDENT 0.0
.TP
.B \-\-is\-default\-reservation [boolean]
.UNINDENT
.sp
Whether this capacity reservation is the default. For more information, see \fI\%Capacity Reservations\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Compute/Tasks/reserve-capacity.htm#default\fP>\&.
.INDENT 0.0
.TP
.B \-\-max\-wait\-seconds [integer]
.UNINDENT
...
.nf
.ft C
ACTIVE, CREATING, DELETED, DELETING, MOVING, UPDATING
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci compute capacity\-reservation create \-\-availability\-domain $availability_domain \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci compute capacity\-reservation delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci compute capacity\-reservation delete \-\-capacity\-reservation\-id $capacity_reservation_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci compute capacity\-reservation get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci compute capacity\-reservation get \-\-capacity\-reservation\-id $capacity_reservation_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci compute capacity\-reservation instance list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci compute capacity\-reservation instance list \-\-capacity\-reservation\-id $capacity_reservation_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci compute capacity\-reservation instance\-shape list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/compute/capacity\-reservation/instance\-shape/list.html#cmdoption\-compartment\-id

    oci compute capacity\-reservation instance\-shape list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci compute capacity\-reservation list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/compute/capacity\-reservation/list.html#cmdoption\-compartment\-id
...
.nf
.ft C
oci compute capacity\-reservation update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci compute capacity\-reservation update \-\-capacity\-reservation\-id $capacity_reservation_id
.ft P
.fi
.UNINDENT
.UNINDENT
