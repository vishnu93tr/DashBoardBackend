...
.
.TH "OPCTL_OPERATOR-CONTROL_CHANGE-COMPARTMENT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
opctl_operator-control_change-compartment \- 
.
...
.nf
.ft C
oci opctl operator\-control change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci opctl operator\-control change\-compartment \-\-operator\-control\-id $operator_control_id
.ft P
.fi
.UNINDENT
.UNINDENT
