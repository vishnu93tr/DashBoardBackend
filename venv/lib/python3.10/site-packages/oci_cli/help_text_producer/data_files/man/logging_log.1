...
.
.TH "LOGGING_LOG" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
logging_log \- 
.
...
.nf
.ft C
oci logging log change\-log\-group [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export display_name=<substitute\-value\-of\-display_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/logging/log/create.html#cmdoption\-display\-name
    export log_group_id=<substitute\-value\-of\-log_group_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/logging/log/create.html#cmdoption\-log\-group\-id
    export log_type=<substitute\-value\-of\-log_type> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/logging/log/create.html#cmdoption\-log\-type
    ...
    log_id=$(oci logging log create \-\-display\-name $display_name \-\-log\-group\-id $log_group_id \-\-log\-type $log_type \-\-query data.id \-\-raw\-output)

    oci logging log change\-log\-group \-\-log\-group\-id $log_group_id \-\-log\-id $log_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci logging log create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci logging log create \-\-display\-name $display_name \-\-log\-group\-id $log_group_id \-\-log\-type $log_type
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci logging log delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci logging log delete \-\-log\-group\-id $log_group_id \-\-log\-id $log_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
For list pagination. The value of the \fIopc\-next\-page\fP or \fIopc\-previous\-page\fP response header from the previous “List” call. For important details about how pagination works, see \fI\%List Pagination\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/API/Concepts/usingapi.htm#nine\fP>\&.
.INDENT 0.0
.TP
.B \-\-page\-size [integer]
.UNINDENT
...
.UNINDENT
.sp
The field to sort by (one column only). Default sort order is ascending exception of \fItimeCreated\fP and \fItimeLastModified\fP columns (descending).
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
...
.nf
.ft C
oci logging log update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci logging log update \-\-log\-group\-id $log_group_id \-\-log\-id $log_id
.ft P
.fi
.UNINDENT
.UNINDENT
