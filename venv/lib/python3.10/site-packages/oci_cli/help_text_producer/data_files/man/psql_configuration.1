...
.
.TH "PSQL_CONFIGURATION" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
psql_configuration \- 
.
...
.nf
.ft C
oci psql configuration change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the compartment into which the configuration will be moved.
.INDENT 0.0
.TP
...
.nf
.ft C
    oci psql configuration create \-\-generate\-param\-json\-input db\-configuration\-overrides > db\-configuration\-overrides.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci psql configuration create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the compartment that contains the configuration.
.INDENT 0.0
.TP
.B \-\-db\-configuration\-overrides [complex type]
.UNINDENT
.sp
...
.UNINDENT
.sp
The name of the shape for the configuration. Example: \fIVM.Standard.E4.Flex\fP
.SS Optional Parameters
.INDENT 0.0
.TP
...
.nf
.ft C
oci psql configuration delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci psql configuration get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci psql configuration update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
