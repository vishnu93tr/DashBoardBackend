...
.
.TH "DEVOPS_PULL-REQUEST_UNSUBSCRIBE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
devops_pull-request_unsubscribe \- 
.
...
.nf
.ft C
oci devops pull\-request unsubscribe [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export token=<substitute\-value\-of\-token> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/devops/pull\-request/unsubscribe.html#cmdoption\-token
    ...
    oci devops pull\-request unsubscribe \-\-file $file \-\-pull\-request\-id $pull_request_id \-\-token $token
.ft P
.fi
.UNINDENT
.UNINDENT
