...
.
.TH "OPSI_DATABASE-INSIGHTS_UPDATE-EXTERNAL-MYSQL-DATABASE-INSIGHT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
opsi_database-insights_update-external-mysql-database-insight \- 
.
...
.nf
.ft C
oci opsi database\-insights update\-external\-mysql\-database\-insight [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export database_insight_id=<substitute\-value\-of\-database_insight_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/opsi/database\-insights/update\-external\-mysql\-database\-insight.html#cmdoption\-database\-insight\-id

    oci opsi database\-insights update\-external\-mysql\-database\-insight \-\-database\-insight\-id $database_insight_id
.ft P
.fi
.UNINDENT
.UNINDENT
