...
.
.TH "IDENTITY-DOMAINS_MY-SMTP-CREDENTIAL" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_my-smtp-credential \- 
.
...
.nf
.ft C
oci identity\-domains my\-smtp\-credential create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains my\-smtp\-credential create \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export user_name=<substitute\-value\-of\-user_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/identity\-domains/my\-smtp\-credential/create.html#cmdoption\-user\-name

    oci identity\-domains my\-smtp\-credential create \-\-schemas file://schemas.json \-\-user\-name $user_name
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains my\-smtp\-credential delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    my_smtp_credential_id=$(oci identity\-domains my\-smtp\-credential create \-\-schemas file://schemas.json \-\-user\-name $user_name \-\-query data.id \-\-raw\-output)

    oci identity\-domains my\-smtp\-credential delete \-\-my\-smtp\-credential\-id $my_smtp_credential_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains my\-smtp\-credential get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains my\-smtp\-credential get \-\-my\-smtp\-credential\-id $my_smtp_credential_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains my\-smtp\-credential patch [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains my\-smtp\-credential patch \-\-generate\-param\-json\-input operations > operations.json
    oci identity\-domains my\-smtp\-credential patch \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains my\-smtp\-credential patch \-\-my\-smtp\-credential\-id $my_smtp_credential_id \-\-operations file://operations.json \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
