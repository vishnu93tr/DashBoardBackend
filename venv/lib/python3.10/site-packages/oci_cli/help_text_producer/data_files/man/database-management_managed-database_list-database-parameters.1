...
.
.TH "DATABASE-MANAGEMENT_MANAGED-DATABASE_LIST-DATABASE-PARAMETERS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
database-management_managed-database_list-database-parameters \- 
.
...
.INDENT 0.0
.TP
.B \-\-is\-allowed\-values\-included [boolean]
.UNINDENT
.sp
...
.UNINDENT
.sp
The source used to list database parameters. \fICURRENT\fP is used to get the database parameters that are currently in effect for the database instance. \fISPFILE\fP is used to list parameters from the server parameter file. Default is \fICURRENT\fP\&.
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
