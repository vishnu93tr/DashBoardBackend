...
.
.TH "IDENTITY-DOMAINS_MY-APPS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_my-apps \- 
.
...
.nf
.ft C
oci identity\-domains my\-apps list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains my\-apps list
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains my\-apps search [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains my\-apps search \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains my\-apps search \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
