...
.
.TH "OS-MANAGEMENT-HUB_SCHEDULED-JOB_UPDATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
os-management-hub_scheduled-job_update \- 
.
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the scheduled job.
...
.sp
This option is a JSON list with items of type ScheduledJobOperation.  For documentation on ScheduledJobOperation please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/scheduledjob/20220901/datatypes/ScheduledJobOperation\fP\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
.INDENT 0.0
.TP
.B \-\-recurring\-rule [text]
.UNINDENT
.sp
The frequency schedule for a recurring scheduled job.
.INDENT 0.0
.TP
.B \-\-retry\-intervals [complex type]
.UNINDENT
.sp
...
.UNINDENT
.sp
The time of the next execution of this scheduled job (in \fI\%RFC 3339\fP <\fBhttps://tools.ietf.org/rfc/rfc3339\fP> format).
.INDENT 0.0
.INDENT 3.5
