...
.
.TH "IDENTITY-DOMAINS_IDENTITY-PROVIDERS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_identity-providers \- 
.
...
.nf
.ft C
oci identity\-domains identity\-providers list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains identity\-providers list
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains identity\-providers search [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains identity\-providers search \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains identity\-providers search \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
