...
.
.TH "NETWORK_DRG-ROUTE-DISTRIBUTION_CREATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network_drg-route-distribution_create \- 
.
...
.SH DESCRIPTION
.sp
Creates a new route distribution for the specified DRG. Assign the route distribution as an import distribution to a DRG route table using the \fIUpdateDrgRouteTable\fP or \fICreateDrgRouteTable\fP operations. Assign the route distribution as an export distribution to a DRG attachment using the \fIUpdateDrgAttachment\fP or \fICreateDrgAttachment\fP operations.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci network drg\-route\-distribution create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the DRG the DRG route table belongs to.
...
.ft C
    ...
    export distribution_type=<substitute\-value\-of\-distribution_type> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/network/drg\-route\-distribution/create.html#cmdoption\-distribution\-type

    drg_id=$(oci network drg create \-\-compartment\-id $compartment_id \-\-query data.id \-\-raw\-output)

    oci network drg\-route\-distribution create \-\-distribution\-type $distribution_type \-\-drg\-id $drg_id
.ft P
.fi
.UNINDENT
.UNINDENT
