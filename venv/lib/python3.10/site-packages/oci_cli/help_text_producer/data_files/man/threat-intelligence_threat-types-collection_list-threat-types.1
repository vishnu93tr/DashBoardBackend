...
.
.TH "THREAT-INTELLIGENCE_THREAT-TYPES-COLLECTION_LIST-THREAT-TYPES" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
threat-intelligence_threat-types-collection_list-threat-types \- 
.
...
.nf
.ft C
oci threat\-intelligence threat\-types\-collection list\-threat\-types [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/threat\-intelligence/threat\-types\-collection/list\-threat\-types.html#cmdoption\-compartment\-id

    oci threat\-intelligence threat\-types\-collection list\-threat\-types \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
