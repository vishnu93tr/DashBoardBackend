...
.
.TH "RESOURCE-MANAGER_STACK_UPDATE-FROM-BITBUCKET-CLOUD" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
resource-manager_stack_update-from-bitbucket-cloud \- 
.
...
.nf
.ft C
oci resource\-manager stack update\-from\-bitbucket\-cloud [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export config_source_configuration_source_provider_id=<substitute\-value\-of\-config_source_configuration_source_provider_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/resource\-manager/stack/update\-from\-bitbucket\-cloud.html#cmdoption\-config\-source\-configuration\-source\-provider\-id
    ...
    oci resource\-manager stack update\-from\-bitbucket\-cloud \-\-config\-source\-configuration\-source\-provider\-id $config_source_configuration_source_provider_id \-\-stack\-id $stack_id
.ft P
.fi
.UNINDENT
.UNINDENT
