...
.
.TH "GENERATIVE-AI_MODEL" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
generative-ai_model \- 
.
...
.SH DESCRIPTION
.sp
You can create a custom model by using your dataset to fine\-tune an out\-of\-the\-box text generation base model. Have your dataset ready before you create a custom model. See \fI\%Training Data Requirements\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/generative-ai/training-data-requirements.htm\fP>\&.
.sp
...
.SS Description
.sp
Moves a custom model into a different compartment. For information about moving resources between compartments, see \fI\%Moving Resources to a Different Compartment\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Identity/Tasks/managingcompartments.htm#moveRes\fP>\&.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci generative\-ai model change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci generative\-ai model change\-compartment \-\-compartment\-id $compartment_id \-\-model\-id $model_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci generative\-ai model create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-fine\-tune\-details [complex type]
.UNINDENT
.sp
...
.ft C
    ...
    oci generative\-ai model create \-\-base\-model\-id $base_model_id \-\-compartment\-id $compartment_id \-\-fine\-tune\-details file://fine\-tune\-details.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci generative\-ai model delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci generative\-ai model delete \-\-model\-id $model_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci generative\-ai model get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci generative\-ai model get \-\-model\-id $model_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci generative\-ai model update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci generative\-ai model update \-\-model\-id $model_id
.ft P
.fi
.UNINDENT
.UNINDENT
