...
.
.TH "JMS_DEPLOYED-APPLICATION-USAGE_SUMMARIZE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
jms_deployed-application-usage_summarize \- 
.
...
.nf
.ft C
oci jms deployed\-application\-usage summarize [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The field to sort the deployed applications. Only one sort order can be provided. If no value is specified _timeLastSeen_ is default.
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
...
.nf
.ft C
applicationName, applicationType, approximateJavaServerInstanceCount, approximateLibraryCount, isClustered, javaServerInstanceCount, timeFirstSeen, timeLastSeen
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci jms deployed\-application\-usage summarize \-\-fleet\-id $fleet_id
.ft P
.fi
.UNINDENT
.UNINDENT
