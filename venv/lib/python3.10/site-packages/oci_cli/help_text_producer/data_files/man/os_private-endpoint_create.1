...
.
.TH "OS_PRIVATE-ENDPOINT_CREATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
os_private-endpoint_create \- 
.
...
.nf
.ft C
oci os private\-endpoint create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
A prefix to use for the private endpoint. The customer VCN’s DNS records are updated with this prefix. The prefix input from the customer will be the first sub\-domain in the endpointFqdn. Example: If the prefix chosen is “abc”, then the endpointFqdn will be ‘abc.private.objectstorage.<region>.oraclecloud.com’
.INDENT 0.0
.TP
.B \-\-subnet\-id [text]
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-additional\-prefixes [complex type]
.UNINDENT
.sp
...
.UNINDENT
.sp
A list of the OCIDs of the network security groups (NSGs) to add the private endpoint’s VNIC to. For more information about NSGs, see \fI\%NetworkSecurityGroup\fP <\fBhttps://docs.cloud.oracle.com/api/#/en/iaas/latest/NetworkSecurityGroup/\fP>\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
.nf
.ft C
    oci os private\-endpoint create \-\-generate\-param\-json\-input access\-targets > access\-targets.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/os/private\-endpoint/create.html#cmdoption\-compartment\-id
    export name=<substitute\-value\-of\-name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/os/private\-endpoint/create.html#cmdoption\-name
    export prefix=<substitute\-value\-of\-prefix> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/os/private\-endpoint/create.html#cmdoption\-prefix
    export subnet_id=<substitute\-value\-of\-subnet_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/os/private\-endpoint/create.html#cmdoption\-subnet\-id

    oci os private\-endpoint create \-\-access\-targets file://access\-targets.json \-\-compartment\-id $compartment_id \-\-name $name \-\-prefix $prefix \-\-subnet\-id $subnet_id
.ft P
.fi
.UNINDENT
.UNINDENT
