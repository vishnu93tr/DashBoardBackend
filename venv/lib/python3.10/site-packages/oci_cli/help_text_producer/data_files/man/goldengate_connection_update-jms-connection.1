...
.
.TH "GOLDENGATE_CONNECTION_UPDATE-JMS-CONNECTION" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
goldengate_connection_update-jms-connection \- 
.
...
.INDENT 0.0
.TP
.B \-\-jndi\-provider\-url [text]
.UNINDENT
.sp
The URL that Java Message Service will use to contact the JNDI provider. e.g.: ‘\fI\%tcp://myjms.host.domain:61616?jms.prefetchPolicy.all=1000\fP’
.INDENT 0.0
.TP
.B \-\-jndi\-security\-credentials [text]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-jndi\-security\-credentials\-secret\-id [text]
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the Secret where the security credentials are stored associated to the principal. Note: When provided, ‘jndiSecurityCredentials’ field must not be provided.
.INDENT 0.0
.TP
.B \-\-jndi\-security\-principal [text]
.UNINDENT
.sp
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the Secret where the KeyStore password is stored. Note: When provided, ‘keyStorePassword’ field must not be provided.
.INDENT 0.0
.TP
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the Secret where the password is stored, that Oracle GoldenGate uses to connect the associated Java Message Service. Note: When provided, ‘password’ field must not be provided.
.INDENT 0.0
.TP
.B \-\-private\-ip [text]
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the Secret where the password is stored for the cert inside of the Keystore. In case it differs from the KeyStore password, it should be provided. Note: When provided, ‘sslKeyPassword’ field must not be provided.
.INDENT 0.0
.TP
.B \-\-subnet\-id [text]
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the Secret where the TrustStore password is stored. Note: When provided, ‘trustStorePassword’ field must not be provided.
.INDENT 0.0
.TP
