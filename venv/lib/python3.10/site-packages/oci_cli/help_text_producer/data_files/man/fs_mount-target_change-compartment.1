...
.
.TH "FS_MOUNT-TARGET_CHANGE-COMPARTMENT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
fs_mount-target_change-compartment \- 
.
...
.nf
.ft C
oci fs mount\-target change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the compartment to move the mount target to.
.INDENT 0.0
.TP
.B \-\-mount\-target\-id [text]
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the mount target.
...
.ft C
    ...
    mount_target_id=$(oci fs mount\-target create \-\-availability\-domain $availability_domain \-\-compartment\-id $compartment_id \-\-subnet\-id $subnet_id \-\-query data.id \-\-raw\-output)

    oci fs mount\-target change\-compartment \-\-compartment\-id $compartment_id \-\-mount\-target\-id $mount_target_id
.ft P
.fi
.UNINDENT
.UNINDENT
