...
.
.TH "NETWORK-FIREWALL_NETWORK-FIREWALL-POLICY_CREATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network-firewall_network-firewall-policy_create \- 
.
...
.nf
.ft C
oci network\-firewall network\-firewall\-policy create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci network\-firewall network\-firewall\-policy create \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
