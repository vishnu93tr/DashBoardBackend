...
.
.TH "DB_VM-CLUSTER-NETWORK_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_vm-cluster-network_list \- 
.
...
.SH DESCRIPTION
.sp
Gets a list of the VM cluster networks in the specified compartment. Applies to Exadata \fI\%Cloud@Customer\fP <\fBCloud@Customer\fP> instances only.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci db vm\-cluster\-network list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci db vm\-cluster\-network list \-\-compartment\-id $compartment_id \-\-exadata\-infrastructure\-id $exadata_infrastructure_id
.ft P
.fi
.UNINDENT
.UNINDENT
