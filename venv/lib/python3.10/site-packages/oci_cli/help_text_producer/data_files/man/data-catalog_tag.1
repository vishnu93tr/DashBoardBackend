...
.
.TH "DATA-CATALOG_TAG" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-catalog_tag \- 
.
...
.SH DESCRIPTION
.sp
A free\-form label or keyword you create to be able to logically group data objects.
...
.nf
.ft C
oci data\-catalog tag list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci data\-catalog tag list \-\-catalog\-id $catalog_id
.ft P
.fi
.UNINDENT
.UNINDENT
