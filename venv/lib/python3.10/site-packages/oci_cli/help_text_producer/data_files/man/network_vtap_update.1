...
.
.TH "NETWORK_VTAP_UPDATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network_vtap_update \- 
.
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the VTAP.
...
.UNINDENT
.sp
The capture filter’s Oracle ID (\fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP>).
.INDENT 0.0
.TP
...
.INDENT 0.0
.TP
.B \-\-is\-vtap\-enabled [boolean]
.UNINDENT
.sp
Used to start or stop a \fIVtap\fP resource.
.INDENT 0.0
.IP \(bu 2
\fITRUE\fP directs the VTAP to start mirroring traffic. * \fIFALSE\fP (Default) directs the VTAP to stop mirroring traffic.
.UNINDENT
.INDENT 0.0
.TP
.B \-\-max\-packet\-size [integer]
.UNINDENT
.sp
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the source point where packets are captured.
.INDENT 0.0
.TP
.B \-\-source\-private\-endpoint\-ip [text]
.UNINDENT
.sp
The IP Address of the source private endpoint.
.INDENT 0.0
.TP
.B \-\-source\-private\-endpoint\-subnet\-id [text]
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the subnet that source private endpoint belongs to.
.INDENT 0.0
.TP
.B \-\-source\-type [text]
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the destination resource where mirrored packets are sent.
.INDENT 0.0
.TP
.B \-\-target\-ip [text]
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-vxlan\-network\-identifier [integer]
.UNINDENT
.sp
