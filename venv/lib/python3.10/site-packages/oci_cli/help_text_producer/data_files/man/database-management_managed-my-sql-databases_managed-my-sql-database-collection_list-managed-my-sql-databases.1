...
.
.TH "DATABASE-MANAGEMENT_MANAGED-MY-SQL-DATABASES_MANAGED-MY-SQL-DATABASE-COLLECTION_LIST-MANAGED-MY-SQL-DATABASES" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
database-management_managed-my-sql-databases_managed-my-sql-database-collection_list-managed-my-sql-databases \- 
.
...
.INDENT 0.0
.TP
.B \-\-filter\-by\-my\-sql\-database\-type\-param [text]
.UNINDENT
.sp
