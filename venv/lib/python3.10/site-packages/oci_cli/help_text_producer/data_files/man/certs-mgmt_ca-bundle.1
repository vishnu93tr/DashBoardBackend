...
.
.TH "CERTS-MGMT_CA-BUNDLE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
certs-mgmt_ca-bundle \- 
.
...
.SS Description
.sp
Moves a CA bundle to a different compartment in the same tenancy. For information about moving resources between compartments, see \fI\%Moving Resources to a Different Compartment\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Identity/Tasks/managingcompartments.htm#moveRes\fP>\&.
.sp
...
.nf
.ft C
oci certs\-mgmt ca\-bundle change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the compartment into which the CA bundle should move.
...
.nf
.ft C
    export ca_bundle_pem=<substitute\-value\-of\-ca_bundle_pem> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/certs\-mgmt/ca\-bundle/create.html#cmdoption\-ca\-bundle\-pem
    ...
    oci certs\-mgmt ca\-bundle change\-compartment \-\-ca\-bundle\-id $ca_bundle_id \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci certs\-mgmt ca\-bundle create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci certs\-mgmt ca\-bundle create \-\-ca\-bundle\-pem $ca_bundle_pem \-\-compartment\-id $compartment_id \-\-name $name
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci certs\-mgmt ca\-bundle delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci certs\-mgmt ca\-bundle get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci certs\-mgmt ca\-bundle get \-\-ca\-bundle\-id $ca_bundle_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.SS Description
.sp
Lists all CA bundles that match the query parameters. Optionally, you can use the parameter \fIFilterByCaBundleIdQueryParam\fP to limit the result set to a single item that matches the specified CA bundle.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
...
.nf
.ft C
oci certs\-mgmt ca\-bundle update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci certs\-mgmt ca\-bundle update \-\-ca\-bundle\-id $ca_bundle_id
.ft P
.fi
.UNINDENT
.UNINDENT
