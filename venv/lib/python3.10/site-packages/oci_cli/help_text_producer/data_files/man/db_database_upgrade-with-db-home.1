...
.
.TH "DB_DATABASE_UPGRADE-WITH-DB-HOME" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_database_upgrade-with-db-home \- 
.
...
.nf
.ft C
oci db database upgrade\-with\-db\-home [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export action=<substitute\-value\-of\-action> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/db/database/upgrade\-with\-db\-home.html#cmdoption\-action
    ...
    oci db database upgrade\-with\-db\-home \-\-action $action \-\-database\-id $database_id \-\-db\-home\-id $db_home_id
.ft P
.fi
.UNINDENT
.UNINDENT
