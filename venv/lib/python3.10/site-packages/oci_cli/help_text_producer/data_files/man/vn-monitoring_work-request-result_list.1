...
.
.TH "VN-MONITORING_WORK-REQUEST-RESULT_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
vn-monitoring_work-request-result_list \- 
.
...
.nf
.ft C
oci vn\-monitoring work\-request\-result list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export work_request_id=<substitute\-value\-of\-work_request_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/vn\-monitoring/work\-request\-result/list.html#cmdoption\-work\-request\-id

    oci vn\-monitoring work\-request\-result list \-\-work\-request\-id $work_request_id
.ft P
.fi
.UNINDENT
.UNINDENT
