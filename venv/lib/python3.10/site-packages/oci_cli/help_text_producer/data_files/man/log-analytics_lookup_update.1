...
.
.TH "LOG-ANALYTICS_LOOKUP_UPDATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
log-analytics_lookup_update \- 
.
...
The lookup fields.
.sp
This option is a JSON list with items of type LogAnalyticsLookupFields.  For documentation on LogAnalyticsLookupFields please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/loganalytics/20200601/datatypes/LogAnalyticsLookupFields\fP\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
.nf
.ft C
    export lookup_name=<substitute\-value\-of\-lookup_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/log\-analytics/lookup/update.html#cmdoption\-lookup\-name
    export namespace_name=<substitute\-value\-of\-namespace_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/log\-analytics/lookup/update.html#cmdoption\-namespace\-name
