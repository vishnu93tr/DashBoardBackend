...
.
.TH "JMS_FLEET_CHANGE-COMPARTMENT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
jms_fleet_change-compartment \- 
.
...
.nf
.ft C
oci jms fleet change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the compartment into which the Fleet should be moved.
.INDENT 0.0
.TP
.B \-\-fleet\-id [text]
.UNINDENT
...
.ft C
    ...
    oci jms fleet change\-compartment \-\-compartment\-id $compartment_id \-\-fleet\-id $fleet_id
.ft P
.fi
.UNINDENT
.UNINDENT
