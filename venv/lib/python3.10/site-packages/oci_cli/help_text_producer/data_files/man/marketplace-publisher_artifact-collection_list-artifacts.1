...
.
.TH "MARKETPLACE-PUBLISHER_ARTIFACT-COLLECTION_LIST-ARTIFACTS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
marketplace-publisher_artifact-collection_list-artifacts \- 
.
...
.nf
.ft C
oci marketplace\-publisher artifact\-collection list\-artifacts [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/marketplace\-publisher/artifact\-collection/list\-artifacts.html#cmdoption\-compartment\-id

    oci marketplace\-publisher artifact\-collection list\-artifacts \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
