...
.
.TH "OPSI_OPSI-CONFIGURATIONS_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
opsi_opsi-configurations_list \- 
.
...
.nf
.ft C
oci opsi opsi\-configurations list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/opsi/opsi\-configurations/list.html#cmdoption\-compartment\-id

    oci opsi opsi\-configurations list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
