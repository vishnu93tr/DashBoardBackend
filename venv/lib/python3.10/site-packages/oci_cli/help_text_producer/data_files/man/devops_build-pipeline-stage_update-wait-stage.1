...
.
.TH "DEVOPS_BUILD-PIPELINE-STAGE_UPDATE-WAIT-STAGE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
devops_build-pipeline-stage_update-wait-stage \- 
.
...
.nf
.ft C
oci devops build\-pipeline\-stage update\-wait\-stage [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export stage_id=<substitute\-value\-of\-stage_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/devops/build\-pipeline\-stage/update\-wait\-stage.html#cmdoption\-stage\-id

    oci devops build\-pipeline\-stage update\-wait\-stage \-\-stage\-id $stage_id
.ft P
.fi
.UNINDENT
.UNINDENT
