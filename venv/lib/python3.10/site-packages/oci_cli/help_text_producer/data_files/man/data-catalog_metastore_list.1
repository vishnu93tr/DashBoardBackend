...
.
.TH "DATA-CATALOG_METASTORE_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-catalog_metastore_list \- 
.
...
.nf
.ft C
oci data\-catalog metastore list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-catalog/metastore/list.html#cmdoption\-compartment\-id

    oci data\-catalog metastore list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
