...
.
.TH "OS-MANAGEMENT-HUB_LIFECYCLE-ENVIRONMENT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
os-management-hub_lifecycle-environment \- 
.
...
.SS Description
.sp
Moves a lifecycle environment into a different compartment within the same tenancy. For information about moving resources between compartments, see \fI\%Moving Resources to a Different Compartment\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Identity/Tasks/managingcompartments.htm#moveRes\fP>\&.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci os\-management\-hub lifecycle\-environment change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the lifecycle environment.
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the compartment to move the lifecycle environment to.
.INDENT 0.0
.TP
.B \-\-from\-json [text]
.UNINDENT
...
.nf
.ft C
    export lifecycle_env_id=<substitute\-value\-of\-lifecycle_env_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/os\-management\-hub/lifecycle\-environment/change\-compartment.html#cmdoption\-lifecycle\-env\-id

    oci os\-management\-hub lifecycle\-environment change\-compartment \-\-lifecycle\-env\-id $lifecycle_env_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the compartment that contains the lifecycle environment.
.INDENT 0.0
.TP
.B \-\-display\-name [text]
.UNINDENT
...
.nf
.ft C
oci os\-management\-hub lifecycle\-environment delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export lifecycle_env_id=<substitute\-value\-of\-lifecycle_env_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/os\-management\-hub/lifecycle\-environment/delete.html#cmdoption\-lifecycle\-env\-id

    oci os\-management\-hub lifecycle\-environment delete \-\-lifecycle\-env\-id $lifecycle_env_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci os\-management\-hub lifecycle\-environment get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export lifecycle_env_id=<substitute\-value\-of\-lifecycle_env_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/os\-management\-hub/lifecycle\-environment/get.html#cmdoption\-lifecycle\-env\-id

    oci os\-management\-hub lifecycle\-environment get \-\-lifecycle\-env\-id $lifecycle_env_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci os\-management\-hub lifecycle\-environment update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.sp
This option is a JSON list with items of type UpdateLifecycleStageDetails.  For documentation on UpdateLifecycleStageDetails please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/lifecycleenvironment/20220901/datatypes/UpdateLifecycleStageDetails\fP\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
.nf
.ft C
    export lifecycle_env_id=<substitute\-value\-of\-lifecycle_env_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/os\-management\-hub/lifecycle\-environment/update.html#cmdoption\-lifecycle\-env\-id

    oci os\-management\-hub lifecycle\-environment update \-\-lifecycle\-env\-id $lifecycle_env_id
.ft P
.fi
.UNINDENT
.UNINDENT
