...
.
.TH "ANNOUNCE_ANNOUNCEMENT-SUBSCRIPTION" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
announce_announcement-subscription \- 
.
...
.nf
.ft C
oci announce announcement\-subscription change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-announcement\-subscription\-id [text]
.UNINDENT
.sp
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the compartment into which you want to move the announcement subscription.
...
.ft C
    ...
    oci announce announcement\-subscription change\-compartment \-\-announcement\-subscription\-id $announcement_subscription_id \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the compartment where you want to create the announcement subscription.
.INDENT 0.0
.TP
.B \-\-display\-name [text]
.UNINDENT
...
.UNINDENT
.sp
The OCID of the Notifications service topic that is the target for publishing announcements that match the configured announcement subscription. The caller of the operation needs the ONS_TOPIC_PUBLISH permission for the targeted Notifications service topic. For more information about Notifications permissions, see \fI\%Details for Notifications\fP <\fBhttps://docs.cloud.oracle.com/Content/Identity/policyreference/notificationpolicyreference.htm\fP>\&.
.SS Optional Parameters
.INDENT 0.0
.TP
...
.sp
This option is a JSON dictionary of type dict(str, FilterGroupDetails).  For documentation on FilterGroupDetails please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/announcementsubscription/0.0.1/datatypes/FilterGroupDetails\fP\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
.nf
.ft C
oci announce announcement\-subscription delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci announce announcement\-subscription delete \-\-announcement\-subscription\-id $announcement_subscription_id
.ft P
.fi
.UNINDENT
.UNINDENT
.SS \fBdelete\-filter\-group\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.nf
.ft C
oci announce announcement\-subscription get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci announce announcement\-subscription get \-\-announcement\-subscription\-id $announcement_subscription_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci announce announcement\-subscription update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the Notifications service topic that is the target for publishing announcements that match the configured announcement subscription. The caller of the operation needs the ONS_TOPIC_PUBLISH permission for the targeted Notifications service topic. For more information about Notifications permissions, see \fI\%Details for Notifications\fP <\fBhttps://docs.cloud.oracle.com/Content/Identity/policyreference/notificationpolicyreference.htm\fP>\&.
.INDENT 0.0
.TP
.B \-\-preferred\-language [text]
.UNINDENT
...
.ft C
    ...
    oci announce announcement\-subscription update \-\-announcement\-subscription\-id $announcement_subscription_id
.ft P
.fi
.UNINDENT
.UNINDENT
.SS \fBupdate\-filter\-group\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.nf
.ft C
oci announce announcement\-subscription update\-filter\-group [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci announce announcement\-subscription update\-filter\-group \-\-generate\-param\-json\-input filters > filters.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export display_name=<substitute\-value\-of\-display_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/announce/announcement\-subscription/create.html#cmdoption\-display\-name
    export ons_topic_id=<substitute\-value\-of\-ons_topic_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/announce/announcement\-subscription/create.html#cmdoption\-ons\-topic\-id
    export filter_group_name=<substitute\-value\-of\-filter_group_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/announce/announcement\-subscription/update\-filter\-group.html#cmdoption\-filter\-group\-name

    announcement_subscription_id=$(oci announce announcement\-subscription create \-\-compartment\-id $compartment_id \-\-display\-name $display_name \-\-ons\-topic\-id $ons_topic_id \-\-query data.id \-\-raw\-output)

    oci announce announcement\-subscription update\-filter\-group \-\-announcement\-subscription\-id $announcement_subscription_id \-\-filter\-group\-name $filter_group_name \-\-filters file://filters.json
.ft P
.fi
.UNINDENT
.UNINDENT
