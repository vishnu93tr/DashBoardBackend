...
.
.TH "DATA-SAFE_PRIVATE-ENDPOINT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_private-endpoint \- 
.
...
.nf
.ft C
oci data\-safe private\-endpoint change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci data\-safe private\-endpoint change\-compartment \-\-private\-endpoint\-id $private_endpoint_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci data\-safe private\-endpoint create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci data\-safe private\-endpoint create \-\-compartment\-id $compartment_id \-\-display\-name $display_name \-\-subnet\-id $subnet_id \-\-vcn\-id $vcn_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci data\-safe private\-endpoint get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci data\-safe private\-endpoint get \-\-private\-endpoint\-id $private_endpoint_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci data\-safe private\-endpoint list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
ACTIVE, CREATING, DELETED, DELETING, FAILED, NA, UPDATING
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-safe/private\-endpoint/list.html#cmdoption\-compartment\-id

    oci data\-safe private\-endpoint list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci data\-safe private\-endpoint update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci data\-safe private\-endpoint update \-\-private\-endpoint\-id $private_endpoint_id
.ft P
.fi
.UNINDENT
.UNINDENT
