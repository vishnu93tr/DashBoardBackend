...
.
.TH "MARKETPLACE_ACCEPTED-AGREEMENT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
marketplace_accepted-agreement \- 
.
...
.UNINDENT
.sp
A signature generated for the listing package agreements that you can retrieve with \fI\%GetAgreement\fP <\fBhttps://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/marketplace/agreement/get.html\fP>\&.
...
.ft C
    ...
    accepted_agreement_id=$(oci marketplace accepted\-agreement create \-\-agreement\-id $agreement_id \-\-compartment\-id $compartment_id \-\-listing\-id $listing_id \-\-package\-version $package_version \-\-signature $signature \-\-query data.id \-\-raw\-output)
...
.nf
.ft C
oci marketplace accepted\-agreement get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci marketplace accepted\-agreement get \-\-accepted\-agreement\-id $accepted_agreement_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci marketplace accepted\-agreement list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The field to use to sort listed results. You can only specify one field to sort by. \fITIMEACCEPTED\fP displays results in descending order by default. You can change your preference by specifying a different sort order.
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/marketplace/accepted\-agreement/list.html#cmdoption\-compartment\-id
...
.nf
.ft C
oci marketplace accepted\-agreement update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci marketplace accepted\-agreement update \-\-accepted\-agreement\-id $accepted_agreement_id
.ft P
.fi
.UNINDENT
.UNINDENT
