...
.
.TH "SERVICE-CATALOG_PRIVATE-APPLICATION-PACKAGE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
service-catalog_private-application-package \- 
.
...
.nf
.ft C
oci service\-catalog private\-application\-package download\-config [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export file=<substitute\-value\-of\-file> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/service\-catalog/private\-application\-package/download\-config.html#cmdoption\-file
    export package_id=<substitute\-value\-of\-package_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/service\-catalog/private\-application\-package/download\-config.html#cmdoption\-package\-id

    oci service\-catalog private\-application\-package download\-config \-\-file $file \-\-package\-id $package_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci service\-catalog private\-application\-package get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export package_id=<substitute\-value\-of\-package_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/service\-catalog/private\-application\-package/get.html#cmdoption\-package\-id

    oci service\-catalog private\-application\-package get \-\-package\-id $package_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The field to use to sort listed results. You can only specify one field to sort by. \fITIMECREATED\fP displays results in descending order by default. You can change your preference by specifying a different sort order.
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
