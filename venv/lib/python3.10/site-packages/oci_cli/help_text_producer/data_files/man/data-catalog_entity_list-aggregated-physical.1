...
.
.TH "DATA-CATALOG_ENTITY_LIST-AGGREGATED-PHYSICAL" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-catalog_entity_list-aggregated-physical \- 
.
...
.nf
.ft C
oci data\-catalog entity list\-aggregated\-physical [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
createdById, dataAssetKey, description, displayName, externalKey, folderKey, folderName, harvestStatus, isLogical, isPartition, key, lastJobKey, lifecycleState, path, properties, timeCreated, timeExternal, timeStatusUpdated, timeUpdated, typeKey, updatedById, uri
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-is\-include\-properties [boolean]
.UNINDENT
.sp
...
.ft C
    ...
    export data_asset_key=<substitute\-value\-of\-data_asset_key> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-catalog/entity/list\-aggregated\-physical.html#cmdoption\-data\-asset\-key
    export entity_key=<substitute\-value\-of\-entity_key> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-catalog/entity/list\-aggregated\-physical.html#cmdoption\-entity\-key

    catalog_id=$(oci data\-catalog catalog create \-\-compartment\-id $compartment_id \-\-query data.id \-\-raw\-output)

    oci data\-catalog entity list\-aggregated\-physical \-\-catalog\-id $catalog_id \-\-data\-asset\-key $data_asset_key \-\-entity\-key $entity_key
.ft P
.fi
.UNINDENT
.UNINDENT
