...
.
.TH "DB_VM-CLUSTER-NETWORK_DELETE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_vm-cluster-network_delete \- 
.
...
.SH DESCRIPTION
.sp
Deletes the specified VM cluster network. Applies to Exadata \fI\%Cloud@Customer\fP <\fBCloud@Customer\fP> instances only. To delete a cloud VM cluster in an Exadata Cloud Service instance, use the \fI\%DeleteCloudVmCluster\fP <\fBhttps://docs.cloud.oracle.com/api/#/en/database/latest/CloudVmCluster/DeleteCloudVmCluster\fP> operation.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci db vm\-cluster\-network delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci db vm\-cluster\-network delete \-\-exadata\-infrastructure\-id $exadata_infrastructure_id \-\-vm\-cluster\-network\-id $vm_cluster_network_id
.ft P
.fi
.UNINDENT
.UNINDENT
