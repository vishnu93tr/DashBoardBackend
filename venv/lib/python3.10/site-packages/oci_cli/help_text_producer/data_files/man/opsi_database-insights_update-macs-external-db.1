...
.
.TH "OPSI_DATABASE-INSIGHTS_UPDATE-MACS-EXTERNAL-DB" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
opsi_database-insights_update-macs-external-db \- 
.
...
.SH DESCRIPTION
.sp
Update tags for a MACS Agent Managed External Database Insight resource in Operations Insights.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci opsi database\-insights update\-macs\-external\-db [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export database_insight_id=<substitute\-value\-of\-database_insight_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/opsi/database\-insights/update\-macs\-external\-db.html#cmdoption\-database\-insight\-id

    oci opsi database\-insights update\-macs\-external\-db \-\-database\-insight\-id $database_insight_id
.ft P
.fi
.UNINDENT
.UNINDENT
