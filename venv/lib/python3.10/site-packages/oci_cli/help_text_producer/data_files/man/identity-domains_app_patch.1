...
.
.TH "IDENTITY-DOMAINS_APP_PATCH" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_app_patch \- 
.
...
.nf
.ft C
oci identity\-domains app patch [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains app patch \-\-generate\-param\-json\-input operations > operations.json
    oci identity\-domains app patch \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains app patch \-\-app\-id $app_id \-\-operations file://operations.json \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
