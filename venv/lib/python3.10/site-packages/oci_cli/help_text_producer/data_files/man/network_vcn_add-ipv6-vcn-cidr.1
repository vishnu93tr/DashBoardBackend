...
.
.TH "NETWORK_VCN_ADD-IPV6-VCN-CIDR" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network_vcn_add-ipv6-vcn-cidr \- 
.
...
.nf
.ft C
oci network vcn add\-ipv6\-vcn\-cidr [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-byoipv6\-cidr\-detail [complex type]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-ipv6\-private\-cidr\-block [text]
.UNINDENT
.sp
This field is not required and should only be specified if a ULA or private IPv6 prefix is desired for VCN’s private IP address space. See\(gaIPv6 Addresses <\fI\%https://docs.cloud.oracle.com/iaas/Content/Network/Concepts/ipv6.htm\fP>\(ga__.
.sp
Example:
.INDENT 0.0
.INDENT 3.5
...
.nf
.ft C
2001:0db8:0123::/48\(ga or \(gafd00:1000:0:1::/64
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci network vcn add\-ipv6\-vcn\-cidr \-\-vcn\-id $vcn_id
.ft P
.fi
.UNINDENT
.UNINDENT
