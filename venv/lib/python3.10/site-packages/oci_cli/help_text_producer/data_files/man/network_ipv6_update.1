...
.
.TH "NETWORK_IPV6_UPDATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network_ipv6_update \- 
.
...
.SH DESCRIPTION
.sp
Updates the specified IPv6. You must specify the object’s \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP>\&. Use this operation if you want to:
.INDENT 0.0
.INDENT 3.5
.INDENT 0.0
.IP \(bu 2
...
.nf
.ft C
oci network ipv6 update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the IPv6.
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the VNIC to reassign the IPv6 to. The VNIC must be in the same subnet as the current VNIC.
.INDENT 0.0
.TP
...
.nf
.ft C
    ipv6_id=$(oci network ipv6 create \-\-query data.id \-\-raw\-output)

    oci network ipv6 update \-\-ipv6\-id $ipv6_id
.ft P
.fi
.UNINDENT
.UNINDENT
