...
.
.TH "IAM_DYNAMIC-GROUP" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
iam_dynamic-group \- 
.
...
.sp
This works like regular user/group membership. But in that case, the membership is a static relationship, whereas in a dynamic group, the membership of an instance certificate to a dynamic group is determined during runtime. For more information, see \fI\%Managing Dynamic Groups\fP <\fBhttps://docs.cloud.oracle.com/Content/Identity/dynamicgroups/managingdynamicgroups.htm\fP>\&.
.sp
...
.sp
You must also specify a \fIname\fP for the dynamic group, which must be unique across all dynamic groups in your tenancy, and cannot be changed. Note that this name has to be also unique across all groups in your tenancy. You can use this name or the OCID when writing policies that apply to the dynamic group. For more information about policies, see \fI\%How Policies Work\fP <\fBhttps://docs.cloud.oracle.com/Content/Identity/policieshow/how-policies-work.htm\fP>\&.
.sp
You must also specify a \fIdescription\fP for the dynamic group (although it can be an empty string). It does not have to be unique, and you can change it anytime with \fI\%UpdateDynamicGroup\fP <\fBhttps://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/iam/dynamic-group/update.html\fP>\&.
.sp
...
.UNINDENT
.sp
The matching rule to dynamically match an instance certificate to this dynamic group. For rule syntax, see \fI\%Managing Dynamic Groups\fP <\fBhttps://docs.cloud.oracle.com/Content/Identity/dynamicgroups/managingdynamicgroups.htm\fP>\&.
.INDENT 0.0
.TP
.B \-\-name [text]
.UNINDENT
...
.nf
.ft C
    export description=<substitute\-value\-of\-description> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/iam/dynamic\-group/create.html#cmdoption\-description
    export matching_rule=<substitute\-value\-of\-matching_rule> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/iam/dynamic\-group/create.html#cmdoption\-matching\-rule
    export name=<substitute\-value\-of\-name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/iam/dynamic\-group/create.html#cmdoption\-name

    oci iam dynamic\-group create \-\-description $description \-\-matching\-rule $matching_rule \-\-name $name
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci iam dynamic\-group delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    dynamic_group_id=$(oci iam dynamic\-group create \-\-description $description \-\-matching\-rule $matching_rule \-\-name $name \-\-query data.id \-\-raw\-output)

    oci iam dynamic\-group delete \-\-dynamic\-group\-id $dynamic_group_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci iam dynamic\-group get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci iam dynamic\-group get \-\-dynamic\-group\-id $dynamic_group_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci iam dynamic\-group list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci iam dynamic\-group update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci iam dynamic\-group update \-\-dynamic\-group\-id $dynamic_group_id
.ft P
.fi
.UNINDENT
.UNINDENT
