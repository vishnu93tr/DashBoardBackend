...
.
.TH "NETWORK_DRG-ATTACHMENT_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network_drg-attachment_list \- 
.
...
.SH DESCRIPTION
.sp
Lists the \fIDrgAttachment\fP resource for the specified compartment. You can filter the results by DRG, attached network, attachment type, DRG route table or VCN route table.
.sp
...
.nf
.ft C
oci network drg\-attachment list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the DRG route table assigned to the DRG attachment.
.INDENT 0.0
.TP
.B \-\-from\-json [text]
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the resource (virtual circuit, VCN, IPSec tunnel, or remote peering connection) attached to the DRG.
.INDENT 0.0
.TP
.B \-\-page [text]
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/network/drg\-attachment/list.html#cmdoption\-compartment\-id

    oci network drg\-attachment list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
