...
.
.TH "DATA-CATALOG_ENTITY_DELETE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-catalog_entity_delete \- 
.
...
.nf
.ft C
oci data\-catalog entity delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export data_asset_key=<substitute\-value\-of\-data_asset_key> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-catalog/entity/delete.html#cmdoption\-data\-asset\-key
    export entity_key=<substitute\-value\-of\-entity_key> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-catalog/entity/delete.html#cmdoption\-entity\-key

    catalog_id=$(oci data\-catalog catalog create \-\-compartment\-id $compartment_id \-\-query data.id \-\-raw\-output)

    oci data\-catalog entity delete \-\-catalog\-id $catalog_id \-\-data\-asset\-key $data_asset_key \-\-entity\-key $entity_key
.ft P
.fi
.UNINDENT
.UNINDENT
