...
.
.TH "ANOMALY-DETECTION_DATA-ASSET_CREATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
anomaly-detection_data-asset_create \- 
.
...
.nf
.ft C
oci anomaly\-detection data\-asset create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-data\-source\-details [complex type]
.UNINDENT
.sp
...
.ft C
    ...
    oci anomaly\-detection data\-asset create \-\-compartment\-id $compartment_id \-\-data\-source\-details file://data\-source\-details.json \-\-project\-id $project_id
.ft P
.fi
.UNINDENT
.UNINDENT
