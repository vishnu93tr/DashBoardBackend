...
.
.TH "IDENTITY-DOMAINS_CLOUD-GATE-MAPPING" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_cloud-gate-mapping \- 
.
...
.nf
.ft C
oci identity\-domains cloud\-gate\-mapping delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    cloud_gate_mapping_id=$(oci identity\-domains cloud\-gate\-mapping create \-\-cloud\-gate file://cloud\-gate.json \-\-gateway\-app file://gateway\-app.json \-\-policy\-name $policy_name \-\-resource\-prefix $resource_prefix \-\-schemas file://schemas.json \-\-server file://server.json \-\-query data.id \-\-raw\-output)

    oci identity\-domains cloud\-gate\-mapping delete \-\-cloud\-gate\-mapping\-id $cloud_gate_mapping_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains cloud\-gate\-mapping get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains cloud\-gate\-mapping get \-\-cloud\-gate\-mapping\-id $cloud_gate_mapping_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains cloud\-gate\-mapping patch [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains cloud\-gate\-mapping patch \-\-generate\-param\-json\-input operations > operations.json
    oci identity\-domains cloud\-gate\-mapping patch \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains cloud\-gate\-mapping patch \-\-cloud\-gate\-mapping\-id $cloud_gate_mapping_id \-\-operations file://operations.json \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains cloud\-gate\-mapping put [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains cloud\-gate\-mapping put \-\-generate\-param\-json\-input cloud\-gate > cloud\-gate.json
    oci identity\-domains cloud\-gate\-mapping put \-\-generate\-param\-json\-input gateway\-app > gateway\-app.json
    oci identity\-domains cloud\-gate\-mapping put \-\-generate\-param\-json\-input schemas > schemas.json
    oci identity\-domains cloud\-gate\-mapping put \-\-generate\-param\-json\-input server > server.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains cloud\-gate\-mapping put \-\-cloud\-gate file://cloud\-gate.json \-\-cloud\-gate\-mapping\-id $cloud_gate_mapping_id \-\-gateway\-app file://gateway\-app.json \-\-policy\-name $policy_name \-\-resource\-prefix $resource_prefix \-\-schemas file://schemas.json \-\-server file://server.json
.ft P
.fi
.UNINDENT
.UNINDENT
