...
.
.TH "GOLDENGATE_CONNECTION_UPDATE-POSTGRESQL-CONNECTION" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
goldengate_connection_update-postgresql-connection \- 
.
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the Secret that stores the private key of the PostgreSQL server. The supported file formats are .pem and .crt. Note: When provided, ‘sslKey’ field must not be provided.
.INDENT 0.0
.TP
.B \-\-ssl\-mode [text]
.UNINDENT
