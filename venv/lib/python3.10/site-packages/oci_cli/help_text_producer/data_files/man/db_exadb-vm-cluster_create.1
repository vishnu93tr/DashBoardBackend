...
.
.TH "DB_EXADB-VM-CLUSTER_CREATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_exadb-vm-cluster_create \- 
.
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the backup network subnet associated with the Exadata VM cluster on Exascale Infrastructure.
.INDENT 0.0
.TP
...
.INDENT 0.0
.TP
.B \-\-enabled\-e\-cpu\-count [integer]
.UNINDENT
.sp
The number of ECPUs to enable for an Exadata VM cluster on Exascale Infrastructure.
.INDENT 0.0
.TP
.B \-\-grid\-image\-id [text]
.UNINDENT
.sp
...
.sp
\fBNote:\fP The hostname must be unique within the subnet. If it is not unique, then the Exadata VM cluster on Exascale Infrastructure will fail to provision.
.INDENT 0.0
.TP
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the subnet associated with the Exadata VM cluster on Exascale Infrastructure.
.INDENT 0.0
.TP
.B \-\-total\-e\-cpu\-count [integer]
.UNINDENT
.sp
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the Exadata Database Storage Vault.
.INDENT 0.0
.TP
.B \-\-vm\-file\-system\-storage [complex type]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-data\-collection\-options [complex type]
.UNINDENT
.sp
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
...
.INDENT 0.0
.TP
.B \-\-private\-zone\-id [text]
.UNINDENT
.sp
The private zone ID in which you want DNS records to be created.
.INDENT 0.0
.TP
.B \-\-scan\-listener\-port\-tcp [integer]
.UNINDENT
.sp
The TCP Single Client Access Name (SCAN) port. The default port is 1521.
.INDENT 0.0
.TP
.B \-\-scan\-listener\-port\-tcps [integer]
.UNINDENT
.sp
...
.UNINDENT
.sp
The time zone to use for the Exadata VM cluster on Exascale Infrastructure. For details, see \fI\%Time Zones\fP <\fBhttps://docs.cloud.oracle.com/Content/Database/References/timezones.htm\fP>\&.
.INDENT 0.0
.TP
