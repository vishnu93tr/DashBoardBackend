...
.
.TH "JMS_FLEET_REQUEST-JAVA-MIGRATION-ANALYSES" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
jms_fleet_request-java-migration-analyses \- 
.
...
.nf
.ft C
oci jms fleet request\-java\-migration\-analyses [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci jms fleet request\-java\-migration\-analyses \-\-generate\-param\-json\-input targets > targets.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci jms fleet request\-java\-migration\-analyses \-\-fleet\-id $fleet_id \-\-targets file://targets.json
.ft P
.fi
.UNINDENT
.UNINDENT
