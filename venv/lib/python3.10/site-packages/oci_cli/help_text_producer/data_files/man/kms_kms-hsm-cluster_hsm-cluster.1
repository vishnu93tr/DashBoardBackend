...
.
.TH "KMS_KMS-HSM-CLUSTER_HSM-CLUSTER" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
kms_kms-hsm-cluster_hsm-cluster \- 
.
...
.UNINDENT
.SS \fBcancel\-hsm\-cluster\-deletion\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.nf
.ft C
oci kms kms\-hsm\-cluster hsm\-cluster cancel\-hsm\-cluster\-deletion [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci kms kms\-hsm\-cluster hsm\-cluster cancel\-hsm\-cluster\-deletion \-\-hsm\-cluster\-id $hsm_cluster_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci kms kms\-hsm\-cluster hsm\-cluster change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the compartment to move the hsm cluster to.
.INDENT 0.0
.TP
.B \-\-hsm\-cluster\-id [text]
.UNINDENT
...
.ft C
    ...
    oci kms kms\-hsm\-cluster hsm\-cluster change\-compartment \-\-compartment\-id $compartment_id \-\-hsm\-cluster\-id $hsm_cluster_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.UNINDENT
.SS \fBdownload\-certificate\-signing\-request\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.nf
.ft C
oci kms kms\-hsm\-cluster hsm\-cluster download\-certificate\-signing\-request [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci kms kms\-hsm\-cluster hsm\-cluster download\-certificate\-signing\-request \-\-hsm\-cluster\-id $hsm_cluster_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci kms kms\-hsm\-cluster hsm\-cluster get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci kms kms\-hsm\-cluster hsm\-cluster get \-\-hsm\-cluster\-id $hsm_cluster_id
.ft P
.fi
.UNINDENT
.UNINDENT
.SS \fBget\-pre\-co\-user\-credentials\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.nf
.ft C
oci kms kms\-hsm\-cluster hsm\-cluster get\-pre\-co\-user\-credentials [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci kms kms\-hsm\-cluster hsm\-cluster get\-pre\-co\-user\-credentials \-\-hsm\-cluster\-id $hsm_cluster_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/kms/kms\-hsm\-cluster/hsm\-cluster/list.html#cmdoption\-compartment\-id

    oci kms kms\-hsm\-cluster hsm\-cluster list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
.SS \fBschedule\-hsm\-cluster\-deletion\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.nf
.ft C
oci kms kms\-hsm\-cluster hsm\-cluster schedule\-hsm\-cluster\-deletion [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
An optional property indicating when to delete the HsmCluster resource, expressed in \fI\%RFC 3339\fP <\fBhttps://tools.ietf.org/html/rfc3339\fP> timestamp format. The specified time must be between 7 and 30 days from the time when the request is received. If this property is missing, it will be set to 30 days from the time of the request by default.
.INDENT 0.0
.INDENT 3.5
...
.ft C
    ...
    oci kms kms\-hsm\-cluster hsm\-cluster schedule\-hsm\-cluster\-deletion \-\-hsm\-cluster\-id $hsm_cluster_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.SS Description
.sp
Modifies properties of an HSM cluster resource, including \fIdisplayName\fP, \fIfreeformTags\fP and \fIdefinedTags\fP\&.
.sp
...
.nf
.ft C
oci kms kms\-hsm\-cluster hsm\-cluster update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
A user\-friendly name for the HSM resource. It does not have to be unique, and it is changeable. Avoid entering confidential information.
.INDENT 0.0
.TP
.B \-\-force
.UNINDENT
...
.ft C
    ...
    oci kms kms\-hsm\-cluster hsm\-cluster update \-\-hsm\-cluster\-id $hsm_cluster_id
.ft P
.fi
.UNINDENT
.UNINDENT
.SS \fBupload\-partition\-certificates\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
