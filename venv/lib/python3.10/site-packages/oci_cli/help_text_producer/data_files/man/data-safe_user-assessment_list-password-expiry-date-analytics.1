...
.
.TH "DATA-SAFE_USER-ASSESSMENT_LIST-PASSWORD-EXPIRY-DATE-ANALYTICS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_user-assessment_list-password-expiry-date-analytics \- 
.
...
.nf
.ft C
oci data\-safe user\-assessment list\-password\-expiry\-date\-analytics [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci data\-safe user\-assessment list\-password\-expiry\-date\-analytics \-\-user\-assessment\-id $user_assessment_id
.ft P
.fi
.UNINDENT
.UNINDENT
