...
.
.TH "IDENTITY-DOMAINS_SCHEMA" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_schema \- 
.
...
.nf
.ft C
oci identity\-domains schema get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export schema_id=<substitute\-value\-of\-schema_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/identity\-domains/schema/get.html#cmdoption\-schema\-id

    oci identity\-domains schema get \-\-schema\-id $schema_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains schema patch [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains schema patch \-\-generate\-param\-json\-input operations > operations.json
    oci identity\-domains schema patch \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export schema_id=<substitute\-value\-of\-schema_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/identity\-domains/schema/patch.html#cmdoption\-schema\-id

    oci identity\-domains schema patch \-\-operations file://operations.json \-\-schema\-id $schema_id \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-idcs\-mappable [boolean]
.UNINDENT
.sp
Specifies if the attributes in this schema can be used for mapping with external identity sources such as AD or LDAP
.sp
\fBSCIM++ Properties:\fP  \- caseExact: false  \- multiValued: false  \- mutability: readOnly  \- required: true  \- returned: default  \- type: boolean  \- uniqueness: none
.INDENT 0.0
.TP
.B \-\-schema\-id [text]
.UNINDENT
...
.sp
\fBSCIM++ Properties:\fP  \- idcsCompositeKey: []  \- multiValued: true  \- mutability: readWrite  \- required: false  \- returned: default  \- type: complex
.sp
This option is a JSON list with items of type SchemaAttributes.  For documentation on SchemaAttributes please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/identitydomains/v1/datatypes/SchemaAttributes\fP\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
.INDENT 0.0
.TP
.B \-\-idcs\-attribute\-cacheable [boolean]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-idcs\-maps\-to\-same\-target\-attribute\-name\-as [text]
.UNINDENT
.sp
Contains the canonical name of the other attribute sharing the same idcsTargetAttributeName
.sp
\fBAdded In:\fP 2209122038
.sp
\fBSCIM++ Properties:\fP  \- caseExact: false  \- idcsSearchable: false  \- multiValued: false  \- mutability: readWrite  \- required: false  \- returned: always  \- type: string  \- uniqueness: none
.INDENT 0.0
.TP
.B \-\-idcs\-override\-common\-attribute [boolean]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-idcs\-resource\-types [complex type]
.UNINDENT
.sp
