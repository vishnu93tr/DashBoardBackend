...
.
.TH "IDENTITY-DOMAINS_RESOURCE-TYPE-SCHEMA-ATTRIBUTES" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_resource-type-schema-attributes \- 
.
...
.nf
.ft C
oci identity\-domains resource\-type\-schema\-attributes list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains resource\-type\-schema\-attributes list
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains resource\-type\-schema\-attributes search [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains resource\-type\-schema\-attributes search \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains resource\-type\-schema\-attributes search \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
