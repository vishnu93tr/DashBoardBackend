...
.
.TH "DATABASE-MANAGEMENT_MANAGED-DATABASE_LIST-OPTIMIZER-STATISTICS-ADVISOR-EXECUTIONS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
database-management_managed-database_list-optimizer-statistics-advisor-executions \- 
.
...
.nf
.ft C
oci database\-management managed\-database list\-optimizer\-statistics\-advisor\-executions [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-end\-time\-less\-than\-or\-equal\-to [text]
.UNINDENT
.sp
...
.nf
.ft C
    export managed_database_id=<substitute\-value\-of\-managed_database_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/database\-management/managed\-database/list\-optimizer\-statistics\-advisor\-executions.html#cmdoption\-managed\-database\-id

    oci database\-management managed\-database list\-optimizer\-statistics\-advisor\-executions \-\-managed\-database\-id $managed_database_id
.ft P
.fi
.UNINDENT
.UNINDENT
