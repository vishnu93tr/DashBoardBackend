...
.
.TH "DB_VM-CLUSTER_CREATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_vm-cluster_create \- 
.
...
.SH DESCRIPTION
.sp
Creates an Exadata \fI\%Cloud@Customer\fP <\fBCloud@Customer\fP> VM cluster.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
...
.INDENT 0.0
.TP
.B \-\-is\-sparse\-diskgroup\-enabled [boolean]
.UNINDENT
.sp
...
.UNINDENT
.sp
The time zone to use for the VM cluster. For details, see \fI\%DB System Time Zones\fP <\fBhttps://docs.cloud.oracle.com/Content/Database/References/timezones.htm\fP>\&.
.INDENT 0.0
.TP
.B \-\-vm\-cluster\-type [text]
.UNINDENT
.sp
