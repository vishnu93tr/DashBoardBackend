...
.
.TH "OPSI_AWR-HUBS_SUMMARIZE-AWR-DATABASE-SNAPSHOT-RANGES" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
opsi_awr-hubs_summarize-awr-database-snapshot-ranges \- 
.
...
.nf
.ft C
oci opsi awr\-hubs summarize\-awr\-database\-snapshot\-ranges [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export awr_hub_id=<substitute\-value\-of\-awr_hub_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/opsi/awr\-hubs/summarize\-awr\-database\-snapshot\-ranges.html#cmdoption\-awr\-hub\-id

    oci opsi awr\-hubs summarize\-awr\-database\-snapshot\-ranges \-\-awr\-hub\-id $awr_hub_id
.ft P
.fi
.UNINDENT
.UNINDENT
