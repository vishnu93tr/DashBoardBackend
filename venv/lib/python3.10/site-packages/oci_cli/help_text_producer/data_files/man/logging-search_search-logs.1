...
.
.TH "LOGGING-SEARCH_SEARCH-LOGS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
logging-search_search-logs \- 
.
...
.sp
See \fI\%Using the API\fP <\fBhttps://docs.cloud.oracle.com/Content/Logging/Concepts/using_the_api_searchlogs.htm\fP> for SDK examples.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
...
.UNINDENT
.sp
Query corresponding to the search operation. This query is parsed and validated before execution and should follow the specification. For more information on the query language specification, see \fI\%Logging Query Language Specification\fP <\fBhttps://docs.cloud.oracle.com/Content/Logging/Reference/query_language_specification.htm\fP>\&.
.INDENT 0.0
.TP
.B \-\-time\-end [datetime]
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-is\-return\-field\-info [boolean]
.UNINDENT
.sp
...
.UNINDENT
.sp
For list pagination. The value of the opc\-next\-page response header from the previous “Search” call. For important details about how pagination works, see \fI\%List Pagination\fP <\fBhttps://docs.cloud.oracle.com/Content/API/Concepts/usingapi.htm#nine\fP>\&.
