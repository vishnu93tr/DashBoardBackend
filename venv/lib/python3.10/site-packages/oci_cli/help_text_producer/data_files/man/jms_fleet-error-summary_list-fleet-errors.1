...
.
.TH "JMS_FLEET-ERROR-SUMMARY_LIST-FLEET-ERRORS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
jms_fleet-error-summary_list-fleet-errors \- 
.
...
.nf
.ft C
oci jms fleet\-error\-summary list\-fleet\-errors [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The field to sort FleetError. Only one sort order may be provided. Default order is \fBdescending\fP\&. If no value is specified _timeLastSeen_ is default.
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
