...
.
.TH "DB_EXADATA-INFRASTRUCTURE_ADD-STORAGE-CAPACITY" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_exadata-infrastructure_add-storage-capacity \- 
.
...
.SH DESCRIPTION
.sp
Makes the storage capacity from additional storage servers available for VM Cluster consumption. Applies to Exadata \fI\%Cloud@Customer\fP <\fBCloud@Customer\fP> instances only.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
