...
.
.TH "COMPUTE_DEDICATED-VM-HOST-INSTANCE_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
compute_dedicated-vm-host-instance_list \- 
.
...
.nf
.ft C
oci compute dedicated\-vm\-host\-instance list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci compute dedicated\-vm\-host\-instance list \-\-compartment\-id $compartment_id \-\-dedicated\-vm\-host\-id $dedicated_vm_host_id
.ft P
.fi
.UNINDENT
.UNINDENT
