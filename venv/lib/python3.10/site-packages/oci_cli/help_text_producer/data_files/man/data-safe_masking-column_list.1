...
.
.TH "DATA-SAFE_MASKING-COLUMN_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_masking-column_list \- 
.
...
.nf
.ft C
oci data\-safe masking\-column list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-masking\-column\-lifecycle\-state [text]
.UNINDENT
.sp
...
.nf
.ft C
ACTIVE, CREATING, DELETING, FAILED, NEEDS_ATTENTION, UPDATING
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
dataType, objectName, schemaName, timeCreated
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-time\-updated\-greater\-than\-or\-equal\-to [datetime]
.UNINDENT
.sp
Search for resources that were updated after a specific date. Specifying this parameter corresponding \fItimeUpdatedGreaterThanOrEqualTo\fP parameter will retrieve all resources updated after the specified created date, in “YYYY\-MM\-ddThh:mmZ” format with a Z offset, as defined by RFC 3339.
.INDENT 0.0
.INDENT 3.5
The following datetime formats are supported:
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-time\-updated\-less\-than [datetime]
.UNINDENT
.sp
Search for resources that were updated before a specific date. Specifying this parameter corresponding \fItimeUpdatedLessThan\fP parameter will retrieve all resources updated before the specified created date, in “YYYY\-MM\-ddThh:mmZ” format with a Z offset, as defined by RFC 3339.
.INDENT 0.0
.INDENT 3.5
The following datetime formats are supported:
.UNINDENT
...
.ft C
    ...
    oci data\-safe masking\-column list \-\-masking\-policy\-id $masking_policy_id
.ft P
.fi
.UNINDENT
.UNINDENT
