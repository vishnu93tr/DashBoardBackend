...
.
.TH "OCE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
oce \- 
.
...
.nf
.ft C
oci oce oce\-instance change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the compartment into which the OceInstance should be moved.
.INDENT 0.0
.TP
.B \-\-oce\-instance\-id [text]
.UNINDENT
.sp
...
.ft C
    ...
    oce_instance_id=$(oci oce oce\-instance create \-\-admin\-email $admin_email \-\-compartment\-id $compartment_id \-\-idcs\-access\-token $idcs_access_token \-\-name $name \-\-object\-storage\-namespace $object_storage_namespace \-\-tenancy\-id $tenancy_id \-\-tenancy\-name $tenancy_name \-\-query data.id \-\-raw\-output)

    oci oce oce\-instance change\-compartment \-\-compartment\-id $compartment_id \-\-oce\-instance\-id $oce_instance_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-object\-storage\-namespace [text]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-add\-on\-features [complex type]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-identity\-stripe [complex type]
.UNINDENT
.sp
Details of the identity stripe used for OceInstance, including name of the Identity Cloud Service instance in my services to be used and value of the Identity Cloud Service tenancy. Example: \fI{“serviceName”: “secondstripe”; “tenancy”: “idcs\-8416ebdd0d674f84803f4193cce026e9”}\fP
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
.nf
.ft C
oci oce oce\-instance delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci oce oce\-instance delete \-\-oce\-instance\-id $oce_instance_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci oce oce\-instance get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci oce oce\-instance get \-\-oce\-instance\-id $oce_instance_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci oce oce\-instance list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/oce/oce\-instance/list.html#cmdoption\-compartment\-id

    oci oce oce\-instance list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci oce oce\-instance update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci oce oce\-instance update \-\-oce\-instance\-id $oce_instance_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci oce work\-request get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export work_request_id=<substitute\-value\-of\-work_request_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/oce/work\-request/get.html#cmdoption\-work\-request\-id

    oci oce work\-request get \-\-work\-request\-id $work_request_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci oce work\-request list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/oce/work\-request/list.html#cmdoption\-compartment\-id

    oci oce work\-request list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci oce work\-request\-error list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export work_request_id=<substitute\-value\-of\-work_request_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/oce/work\-request\-error/list.html#cmdoption\-work\-request\-id

    oci oce work\-request\-error list \-\-work\-request\-id $work_request_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci oce work\-request\-log\-entry list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export work_request_id=<substitute\-value\-of\-work_request_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/oce/work\-request\-log\-entry/list.html#cmdoption\-work\-request\-id

    oci oce work\-request\-log\-entry list \-\-work\-request\-id $work_request_id
.ft P
.fi
.UNINDENT
.UNINDENT
