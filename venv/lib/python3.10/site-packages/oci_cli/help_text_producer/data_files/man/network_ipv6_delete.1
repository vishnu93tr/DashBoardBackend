...
.
.TH "NETWORK_IPV6_DELETE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network_ipv6_delete \- 
.
...
.SH DESCRIPTION
.sp
Unassigns and deletes the specified IPv6. You must specify the object’s \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP>\&. The IPv6 address is returned to the subnet’s pool of available addresses.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci network ipv6 delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
