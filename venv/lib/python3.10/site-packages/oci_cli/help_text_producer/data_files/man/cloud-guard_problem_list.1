...
.
.TH "CLOUD-GUARD_PROBLEM_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
cloud-guard_problem_list \- 
.
...
.sp
The ListProblems operation returns only the problems in \fIcompartmentId\fP passed. The list does not include any subcompartments of the compartmentId passed.
.sp
...
.sp
The parameter \fIcompartmentIdInSubtree\fP applies when you perform ListProblems on the \fIcompartmentId\fP passed and when it is set to true, the entire hierarchy of compartments can be returned. To get a full list of all compartments and subcompartments in the tenancy (root compartment), set the parameter \fIcompartmentIdInSubtree\fP to true and \fIaccessLevel\fP to ACCESSIBLE.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
...
.nf
.ft C
DELETED, DISMISSED, OPEN, RESOLVED
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-problem\-category [text]
.UNINDENT
.sp
Setting this to \fISECURITY_ZONE\fP returns only security zone\-related violations.
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/cloud\-guard/problem/list.html#cmdoption\-compartment\-id
