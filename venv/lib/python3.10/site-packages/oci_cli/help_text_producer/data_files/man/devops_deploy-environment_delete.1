...
.
.TH "DEVOPS_DEPLOY-ENVIRONMENT_DELETE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
devops_deploy-environment_delete \- 
.
...
.nf
.ft C
oci devops deploy\-environment delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export environment_id=<substitute\-value\-of\-environment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/devops/deploy\-environment/delete.html#cmdoption\-environment\-id

    oci devops deploy\-environment delete \-\-environment\-id $environment_id
.ft P
.fi
.UNINDENT
.UNINDENT
