...
.
.TH "DATA-INTEGRATION_SCHEDULE_UPDATE-MONTHLY-RULE-FREQUENCY" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-integration_schedule_update-monthly-rule-frequency \- 
.
...
.nf
.ft C
oci data\-integration schedule update\-monthly\-rule\-frequency [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-frequency\-details\-time [complex type]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-is\-daylight\-adj\-enabled [boolean]
.UNINDENT
.sp
...
.nf
.ft C
FIFTH, FIRST, FOURTH, LAST, SECOND, THIRD
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export application_key=<substitute\-value\-of\-application_key> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/schedule/update\-monthly\-rule\-frequency.html#cmdoption\-application\-key
    export key=<substitute\-value\-of\-key> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/schedule/update\-monthly\-rule\-frequency.html#cmdoption\-key
    export object_version=<substitute\-value\-of\-object_version> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/schedule/update\-monthly\-rule\-frequency.html#cmdoption\-object\-version
    export schedule_key=<substitute\-value\-of\-schedule_key> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/schedule/update\-monthly\-rule\-frequency.html#cmdoption\-schedule\-key
    ...
    oci data\-integration schedule update\-monthly\-rule\-frequency \-\-application\-key $application_key \-\-key $key \-\-object\-version $object_version \-\-schedule\-key $schedule_key \-\-workspace\-id $workspace_id
.ft P
.fi
.UNINDENT
.UNINDENT
