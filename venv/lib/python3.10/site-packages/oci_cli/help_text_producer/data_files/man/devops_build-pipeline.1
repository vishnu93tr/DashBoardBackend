...
.
.TH "DEVOPS_BUILD-PIPELINE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
devops_build-pipeline \- 
.
...
.nf
.ft C
oci devops build\-pipeline create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-build\-pipeline\-parameters [complex type]
.UNINDENT
.sp
...
.ft C
    ...
    oci devops build\-pipeline create \-\-project\-id $project_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci devops build\-pipeline delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci devops build\-pipeline delete \-\-build\-pipeline\-id $build_pipeline_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci devops build\-pipeline get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci devops build\-pipeline get \-\-build\-pipeline\-id $build_pipeline_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci devops build\-pipeline list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci devops build\-pipeline update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci devops build\-pipeline update \-\-build\-pipeline\-id $build_pipeline_id
.ft P
.fi
.UNINDENT
.UNINDENT
