...
.
.TH "IDENTITY-DOMAINS_APPS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_apps \- 
.
...
.nf
.ft C
oci identity\-domains apps list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains apps search [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains apps search \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains apps search \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
