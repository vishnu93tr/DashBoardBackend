...
.
.TH "KMS_KMS-HSM-CLUSTER_HSM-PARTITION" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
kms_kms-hsm-cluster_hsm-partition \- 
.
...
.nf
.ft C
oci kms kms\-hsm\-cluster hsm\-partition get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export hsm_partition_id=<substitute\-value\-of\-hsm_partition_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/kms/kms\-hsm\-cluster/hsm\-partition/get.html#cmdoption\-hsm\-partition\-id
    ...
    oci kms kms\-hsm\-cluster hsm\-partition get \-\-hsm\-cluster\-id $hsm_cluster_id \-\-hsm\-partition\-id $hsm_partition_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci kms kms\-hsm\-cluster hsm\-partition list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
ACTIVATING, ACTIVATION_REQUIRED, ACTIVE, DELETED, DELETING, INACTIVE, PENDING_DELETION, SCHEDULING_DELETION
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci kms kms\-hsm\-cluster hsm\-partition list \-\-hsm\-cluster\-id $hsm_cluster_id
.ft P
.fi
.UNINDENT
.UNINDENT
