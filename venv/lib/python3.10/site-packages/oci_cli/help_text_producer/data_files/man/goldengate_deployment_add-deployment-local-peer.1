...
.
.TH "GOLDENGATE_DEPLOYMENT_ADD-DEPLOYMENT-LOCAL-PEER" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
goldengate_deployment_add-deployment-local-peer \- 
.
...
.nf
.ft C
oci goldengate deployment add\-deployment\-local\-peer [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export deployment_id=<substitute\-value\-of\-deployment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/goldengate/deployment/add\-deployment\-local\-peer.html#cmdoption\-deployment\-id

    oci goldengate deployment add\-deployment\-local\-peer \-\-deployment\-id $deployment_id
.ft P
.fi
.UNINDENT
.UNINDENT
