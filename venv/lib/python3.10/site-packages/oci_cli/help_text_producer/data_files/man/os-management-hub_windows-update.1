...
.
.TH "OS-MANAGEMENT-HUB_WINDOWS-UPDATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
os-management-hub_windows-update \- 
.
...
.nf
.ft C
oci os\-management\-hub windows\-update get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export windows_update_id=<substitute\-value\-of\-windows_update_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/os\-management\-hub/windows\-update/get.html#cmdoption\-windows\-update\-id

    oci os\-management\-hub windows\-update get \-\-windows\-update\-id $windows_update_id
.ft P
.fi
.UNINDENT
.UNINDENT
.SS \fBlist\-windows\-updates\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.nf
.ft C
oci os\-management\-hub windows\-update list\-windows\-updates [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the compartment. This parameter is required and returns only resources contained within the specified compartment.
.SS Optional Parameters
.INDENT 0.0
.TP
.B \-\-all
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/os\-management\-hub/windows\-update/list\-windows\-updates.html#cmdoption\-compartment\-id

    oci os\-management\-hub windows\-update list\-windows\-updates \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
