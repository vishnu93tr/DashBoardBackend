...
.
.TH "RECOVERY_PROTECTED-DATABASE_FETCH-PROTECTED-DATABASE-CONFIGURATION" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
recovery_protected-database_fetch-protected-database-configuration \- 
.
...
.nf
.ft C
oci recovery protected\-database fetch\-protected\-database\-configuration [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
ALL, CABUNDLE, HOSTS, RCVCONF, TNSNAMES
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci recovery protected\-database fetch\-protected\-database\-configuration \-\-file $file \-\-protected\-database\-id $protected_database_id
.ft P
.fi
.UNINDENT
.UNINDENT
