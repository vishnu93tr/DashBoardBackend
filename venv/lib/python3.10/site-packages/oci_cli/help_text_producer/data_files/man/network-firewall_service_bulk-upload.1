...
.
.TH "NETWORK-FIREWALL_SERVICE_BULK-UPLOAD" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network-firewall_service_bulk-upload \- 
.
...
.nf
.ft C
oci network\-firewall service bulk\-upload [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-bulk\-upload\-services\-details [complex type]
.UNINDENT
.sp
Request Details to bulk import the services for the Network Firewall Policy resource.
.INDENT 0.0
.TP
...
.nf
.ft C
    oci network\-firewall service bulk\-upload \-\-generate\-param\-json\-input bulk\-upload\-services\-details > bulk\-upload\-services\-details.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci network\-firewall service bulk\-upload \-\-bulk\-upload\-services\-details file://bulk\-upload\-services\-details.json \-\-network\-firewall\-policy\-id $network_firewall_policy_id
.ft P
.fi
.UNINDENT
.UNINDENT
