...
.
.TH "DISASTER-RECOVERY_DR-PROTECTION-GROUP_UPDATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
disaster-recovery_dr-protection-group_update \- 
.
...
.SH DESCRIPTION
.sp
Update the DR protection group identified by \fIdrProtectionGroupId\fP\&.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
...
.sp
This option is a JSON list with items of type UpdateDrProtectionGroupMemberDetails.  For documentation on UpdateDrProtectionGroupMemberDetails please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/disasterrecovery/20220125/datatypes/UpdateDrProtectionGroupMemberDetails\fP\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
.ft C
    ...
    oci disaster\-recovery dr\-protection\-group update \-\-dr\-protection\-group\-id $dr_protection_group_id
.ft P
.fi
.UNINDENT
.UNINDENT
