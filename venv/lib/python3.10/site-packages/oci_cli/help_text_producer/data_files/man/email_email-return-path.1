...
.
.TH "EMAIL_EMAIL-RETURN-PATH" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
email_email-return-path \- 
.
...
.nf
.ft C
oci email email\-return\-path create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-parent\-resource\-id [text]
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the EmailDomain for this email return path.
...
.ft C
    ...
    oci email email\-return\-path create \-\-parent\-resource\-id $parent_resource_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci email email\-return\-path delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-email\-return\-path\-id [text]
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of this email return path.
.SS Optional Parameters
.INDENT 0.0
.TP
.B \-\-force
...
.ft C
    ...
    oci email email\-return\-path delete \-\-email\-return\-path\-id $email_return_path_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci email email\-return\-path get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci email email\-return\-path get \-\-email\-return\-path\-id $email_return_path_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci email email\-return\-path list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the Email Domain to which this Email Return Path belongs.
.INDENT 0.0
.TP
.B \-\-sort\-by [text]
.UNINDENT
...
.INDENT 0.0
.IP \(bu 2
\fBTIMECREATED:\fP Sorts by timeCreated. * \fBNAME:\fP Sorts by name. * \fBID:\fP Sorts by id.
.UNINDENT
.sp
Accepted values are:
.INDENT 0.0
...
.nf
.ft C
    oci email email\-return\-path list
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci email email\-return\-path update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci email email\-return\-path update \-\-email\-return\-path\-id $email_return_path_id
.ft P
.fi
.UNINDENT
.UNINDENT
