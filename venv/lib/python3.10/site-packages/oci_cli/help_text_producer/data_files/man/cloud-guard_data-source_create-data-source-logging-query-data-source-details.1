...
.
.TH "CLOUD-GUARD_DATA-SOURCE_CREATE-DATA-SOURCE-LOGGING-QUERY-DATA-SOURCE-DETAILS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
cloud-guard_data-source_create-data-source-logging-query-data-source-details \- 
.
...
.INDENT 0.0
.TP
.B \-\-data\-source\-details\-additional\-entities\-count [integer]
.UNINDENT
.sp
The additional entities count used for data source query
.INDENT 0.0
.TP
.B \-\-data\-source\-details\-interval\-in\-minutes [integer]
.UNINDENT
.sp
Interval in minutes that query is run periodically.
.INDENT 0.0
.TP
.B \-\-data\-source\-details\-logging\-query\-details [complex type]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-data\-source\-details\-logging\-query\-type [text]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-data\-source\-details\-operator [text]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-data\-source\-details\-query\-start\-time [complex type]
.UNINDENT
.sp
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
...
.INDENT 0.0
.TP
.B \-\-data\-source\-details\-regions [complex type]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-data\-source\-details\-threshold [integer]
.UNINDENT
.sp
