...
.
.TH "DEVOPS_DEPLOY-ENVIRONMENT_CREATE-OKE-CLUSTER-ENVIRONMENT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
devops_deploy-environment_create-oke-cluster-environment \- 
.
...
.nf
.ft C
oci devops deploy\-environment create\-oke\-cluster\-environment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export cluster_id=<substitute\-value\-of\-cluster_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/devops/deploy\-environment/create\-oke\-cluster\-environment.html#cmdoption\-cluster\-id
    ...
    oci devops deploy\-environment create\-oke\-cluster\-environment \-\-cluster\-id $cluster_id \-\-project\-id $project_id
.ft P
.fi
.UNINDENT
.UNINDENT
