...
.
.TH "RESOURCE-MANAGER_TEMPLATE_CHANGE-COMPARTMENT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
resource-manager_template_change-compartment \- 
.
...
.SH DESCRIPTION
.sp
Moves a template into a different compartment within the same tenancy. For information about moving resources between compartments, see \fI\%Moving Resources to a Different Compartment\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Identity/Tasks/managingcompartments.htm#moveRes\fP>\&.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci resource\-manager template change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the template.
...
.ft C
    ...
    oci resource\-manager template change\-compartment \-\-compartment\-id $compartment_id \-\-template\-id $template_id
.ft P
.fi
.UNINDENT
.UNINDENT
