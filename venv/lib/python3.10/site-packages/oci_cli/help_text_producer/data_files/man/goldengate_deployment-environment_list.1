...
.
.TH "GOLDENGATE_DEPLOYMENT-ENVIRONMENT_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
goldengate_deployment-environment_list \- 
.
...
.nf
.ft C
oci goldengate deployment\-environment list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/goldengate/deployment\-environment/list.html#cmdoption\-compartment\-id

    oci goldengate deployment\-environment list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
