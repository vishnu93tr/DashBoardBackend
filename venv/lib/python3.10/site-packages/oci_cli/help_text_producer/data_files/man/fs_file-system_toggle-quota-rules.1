...
.
.TH "FS_FILE-SYSTEM_TOGGLE-QUOTA-RULES" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
fs_file-system_toggle-quota-rules \- 
.
...
.SH DESCRIPTION
.sp
Enable or disable quota enforcement for the file system. If \fIareQuotaRulesEnabled\fP = \fItrue\fP, then the quota enforcement will be enabled. If \fIareQuotaRulesEnabled\fP = \fIfalse\fP, then the quota enforcement will be disabled.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci fs file\-system toggle\-quota\-rules [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export are_quota_rules_enabled=<substitute\-value\-of\-are_quota_rules_enabled> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/fs/file\-system/toggle\-quota\-rules.html#cmdoption\-are\-quota\-rules\-enabled
    ...
    oci fs file\-system toggle\-quota\-rules \-\-are\-quota\-rules\-enabled $are_quota_rules_enabled \-\-file\-system\-id $file_system_id
.ft P
.fi
.UNINDENT
.UNINDENT
