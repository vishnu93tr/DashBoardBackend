...
.
.TH "QUEUE_MESSAGES_PUT-MESSAGES" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
queue_messages_put-messages \- 
.
...
.SH DESCRIPTION
.sp
Puts messages into the queue. You must use the \fI\%messages endpoint\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/queue/messages.htm#messages__messages-endpoint\fP> to produce messages. The messages endpoint may be different for different queues. Use 
.nf
\(ga\(ga
.fi
...
.nf
.ft C
oci queue messages put\-messages [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci queue messages put\-messages \-\-messages file://messages.json \-\-queue\-id $queue_id
.ft P
.fi
.UNINDENT
.UNINDENT
