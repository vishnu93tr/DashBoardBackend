...
.
.TH "DATA-SAFE_LIBRARY-MASKING-FORMAT-SUMMARY_LIST-LIBRARY-MASKING-FORMATS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_library-masking-format-summary_list-library-masking-formats \- 
.
...
.nf
.ft C
oci data\-safe library\-masking\-format\-summary list\-library\-masking\-formats [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-library\-masking\-format\-source [text]
.UNINDENT
.sp
...
.nf
.ft C
displayName, lifecycleState, timeCreated, timeUpdated
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-safe/library\-masking\-format\-summary/list\-library\-masking\-formats.html#cmdoption\-compartment\-id

    oci data\-safe library\-masking\-format\-summary list\-library\-masking\-formats \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
