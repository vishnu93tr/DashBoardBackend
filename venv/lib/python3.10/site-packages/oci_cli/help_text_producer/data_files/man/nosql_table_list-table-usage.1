...
.
.TH "NOSQL_TABLE_LIST-TABLE-USAGE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
nosql_table_list-table-usage \- 
.
...
.nf
.ft C
oci nosql table list\-table\-usage [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export table_name_or_id=<substitute\-value\-of\-table_name_or_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/nosql/table/list\-table\-usage.html#cmdoption\-table\-name\-or\-id

    oci nosql table list\-table\-usage \-\-table\-name\-or\-id $table_name_or_id
.ft P
.fi
.UNINDENT
.UNINDENT
