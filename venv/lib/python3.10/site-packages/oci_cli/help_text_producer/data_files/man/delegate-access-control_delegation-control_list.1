...
.
.TH "DELEGATE-ACCESS-CONTROL_DELEGATION-CONTROL_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
delegate-access-control_delegation-control_list \- 
.
...
.nf
.ft C
oci delegate\-access\-control delegation\-control list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/delegate\-access\-control/delegation\-control/list.html#cmdoption\-compartment\-id

    oci delegate\-access\-control delegation\-control list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
