...
.
.TH "FUSION-APPS_REFRESH-ACTIVITY" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
fusion-apps_refresh-activity \- 
.
...
.SH DESCRIPTION
.sp
An environment refresh copies data from a source environment to a target environment, making a copy of the source environment onto the target environment. For more information, see \fI\%Refreshing an Environment\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/fusion-applications/refresh-environment.htm\fP>\&.
...
.nf
.ft C
oci fusion\-apps refresh\-activity delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export refresh_activity_id=<substitute\-value\-of\-refresh_activity_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/fusion\-apps/refresh\-activity/delete.html#cmdoption\-refresh\-activity\-id
    ...
    oci fusion\-apps refresh\-activity delete \-\-fusion\-environment\-id $fusion_environment_id \-\-refresh\-activity\-id $refresh_activity_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci fusion\-apps refresh\-activity list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
ACCEPTED, CANCELED, FAILED, IN_PROGRESS, NEEDS_ATTENTION, SUCCEEDED
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-time\-expected\-finish\-less\-than\-or\-equal\-to [datetime]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-time\-scheduled\-start\-greater\-than\-or\-equal\-to [datetime]
.UNINDENT
.sp
...
.ft C
    ...
    oci fusion\-apps refresh\-activity list \-\-fusion\-environment\-id $fusion_environment_id
.ft P
.fi
.UNINDENT
.UNINDENT
