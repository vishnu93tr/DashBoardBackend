...
.
.TH "DATA-SAFE_DATABASE-SECURITY-CONFIG_UPDATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_database-security-config_update \- 
.
...
.nf
.ft C
oci data\-safe database\-security\-config update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-sql\-firewall\-config [complex type]
.UNINDENT
.sp
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
...
.nf
.ft C
    export database_security_config_id=<substitute\-value\-of\-database_security_config_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-safe/database\-security\-config/update.html#cmdoption\-database\-security\-config\-id

    oci data\-safe database\-security\-config update \-\-database\-security\-config\-id $database_security_config_id
.ft P
.fi
.UNINDENT
.UNINDENT
