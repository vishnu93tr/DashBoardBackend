...
.
.TH "DISASTER-RECOVERY_DR-PROTECTION-GROUP_DISASSOCIATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
disaster-recovery_dr-protection-group_disassociate \- 
.
...
.SH DESCRIPTION
.sp
Delete the association between the DR protection group identified by \fIdrProtectionGroupId\fP\&. and its peer DR protection group.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci disaster\-recovery dr\-protection\-group disassociate [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export type=<substitute\-value\-of\-type> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/disaster\-recovery/dr\-protection\-group/disassociate.html#cmdoption\-type
    ...
    oci disaster\-recovery dr\-protection\-group disassociate \-\-dr\-protection\-group\-id $dr_protection_group_id \-\-type $type
.ft P
.fi
.UNINDENT
.UNINDENT
