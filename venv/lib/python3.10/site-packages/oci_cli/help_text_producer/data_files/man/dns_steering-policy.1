...
.
.TH "DNS_STEERING-POLICY" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
dns_steering-policy \- 
.
...
.nf
.ft C
oci dns steering\-policy change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the compartment into which the steering policy should be moved.
.INDENT 0.0
.TP
...
.ft C
    ...
    oci dns steering\-policy change\-compartment \-\-compartment\-id $compartment_id \-\-steering\-policy\-id $steering_policy_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.sp
A \fI204\fP response indicates that the delete has been successful. Deletion will fail if the policy is attached to any zones. To detach a policy from a zone, see \fIDeleteSteeringPolicyAttachment\fP\&.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
...
.ft C
    ...
    oci dns steering\-policy delete \-\-steering\-policy\-id $steering_policy_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci dns steering\-policy get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The field by which to sort steering policies. If unspecified, defaults to \fItimeCreated\fP\&.
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
