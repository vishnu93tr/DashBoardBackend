...
.
.TH "NETWORK_VNIC_UPDATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network_vnic_update \- 
.
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the VNIC.
...
.UNINDENT
.sp
The hostname for the VNIC’s primary private IP. Used for DNS. The value is the hostname portion of the primary private IP’s fully qualified domain name (FQDN) (for example, \fIbminstance1\fP in FQDN \fIbminstance1.subnet123.vcn1.oraclevcn.com\fP). Must be unique across all VNICs in the subnet and comply with \fI\%RFC 952\fP <\fBhttps://tools.ietf.org/html/rfc952\fP> and \fI\%RFC 1123\fP <\fBhttps://tools.ietf.org/html/rfc1123\fP>\&. The value appears in the \fI\%Vnic\fP <\fBhttps://docs.cloud.oracle.com/api/#/en/iaas/latest/Vnic/\fP> object and also the \fI\%PrivateIp\fP <\fBhttps://docs.cloud.oracle.com/api/#/en/iaas/latest/PrivateIp/\fP> object returned by \fI\%ListPrivateIps\fP <\fBhttps://docs.cloud.oracle.com/api/#/en/iaas/latest/PrivateIp/ListPrivateIps\fP> and \fI\%GetPrivateIp\fP <\fBhttps://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/network/private-ip/get.html\fP>\&.
.sp
...
.sp
If the VNIC belongs to a VLAN as part of the Oracle Cloud VMware Solution (instead of belonging to a subnet), the value of the \fInsgIds\fP attribute is ignored. Instead, the VNIC belongs to the NSGs that are associated with the VLAN itself. See \fI\%Vlan\fP <\fBhttps://docs.cloud.oracle.com/api/#/en/iaas/latest/Vlan\fP>\&.
.sp
For more information about NSGs, see \fI\%NetworkSecurityGroup\fP <\fBhttps://docs.cloud.oracle.com/api/#/en/iaas/latest/NetworkSecurityGroup/\fP>\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the route table the IP address or VNIC will use. For more information, see \fI\%Source Based Routing\fP <\fBhttps://docs.oracle.com/iaas/Content/Network/Tasks/managingroutetables.htm#Overview_of_Routing_for_Your_VCN__source_routing\fP>\&.
.INDENT 0.0
.TP
...
.UNINDENT
.sp
Whether the source/destination check is disabled on the VNIC. Defaults to \fIfalse\fP, which means the check is performed. For information about why you would skip the source/destination check, see \fI\%Using a Private IP as a Route Target\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Network/Tasks/managingroutetables.htm#privateip\fP>\&.
.sp
If the VNIC belongs to a VLAN as part of the Oracle Cloud VMware Solution (instead of belonging to a subnet), the value of the \fIskipSourceDestCheck\fP attribute is ignored. This is because the source/destination check is always disabled for VNICs in a VLAN. Example: \fItrue\fP
.INDENT 0.0
.TP
