...
.
.TH "APPMGMT-CONTROL_MONITORED-INSTANCE_ACTIVATE-PLUGIN" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
appmgmt-control_monitored-instance_activate-plugin \- 
.
...
.nf
.ft C
oci appmgmt\-control monitored\-instance activate\-plugin [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export monitored_instance_id=<substitute\-value\-of\-monitored_instance_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/appmgmt\-control/monitored\-instance/activate\-plugin.html#cmdoption\-monitored\-instance\-id

    oci appmgmt\-control monitored\-instance activate\-plugin \-\-monitored\-instance\-id $monitored_instance_id
.ft P
.fi
.UNINDENT
.UNINDENT
