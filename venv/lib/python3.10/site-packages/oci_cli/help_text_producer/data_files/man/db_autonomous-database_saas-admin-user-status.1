...
.
.TH "DB_AUTONOMOUS-DATABASE_SAAS-ADMIN-USER-STATUS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_autonomous-database_saas-admin-user-status \- 
.
...
.nf
.ft C
oci db autonomous\-database saas\-admin\-user\-status [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci db autonomous\-database saas\-admin\-user\-status \-\-autonomous\-database\-id $autonomous_database_id
.ft P
.fi
.UNINDENT
.UNINDENT
