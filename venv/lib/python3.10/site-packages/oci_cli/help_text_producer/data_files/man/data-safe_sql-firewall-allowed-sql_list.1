...
.
.TH "DATA-SAFE_SQL-FIREWALL-ALLOWED-SQL_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_sql-firewall-allowed-sql_list \- 
.
...
.sp
The ListSqlFirewallAllowedSqls operation returns only the SQL Firewall allowed SQL statements in the specified \fIcompartmentId\fP\&.
.sp
...
.nf
.ft C
oci data\-safe sql\-firewall\-allowed\-sql list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-safe/sql\-firewall\-allowed\-sql/list.html#cmdoption\-compartment\-id

    oci data\-safe sql\-firewall\-allowed\-sql list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
