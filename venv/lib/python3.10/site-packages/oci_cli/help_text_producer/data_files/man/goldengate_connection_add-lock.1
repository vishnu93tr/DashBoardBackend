...
.
.TH "GOLDENGATE_CONNECTION_ADD-LOCK" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
goldengate_connection_add-lock \- 
.
...
.nf
.ft C
oci goldengate connection add\-lock [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export connection_id=<substitute\-value\-of\-connection_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/goldengate/connection/add\-lock.html#cmdoption\-connection\-id
    export type=<substitute\-value\-of\-type> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/goldengate/connection/add\-lock.html#cmdoption\-type

    oci goldengate connection add\-lock \-\-connection\-id $connection_id \-\-type $type
.ft P
.fi
.UNINDENT
.UNINDENT
