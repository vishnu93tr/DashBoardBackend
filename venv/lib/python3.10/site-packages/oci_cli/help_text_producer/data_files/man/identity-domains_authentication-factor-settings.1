...
.
.TH "IDENTITY-DOMAINS_AUTHENTICATION-FACTOR-SETTINGS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_authentication-factor-settings \- 
.
...
.nf
.ft C
oci identity\-domains authentication\-factor\-settings list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains authentication\-factor\-settings list
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains authentication\-factor\-settings search [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains authentication\-factor\-settings search \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains authentication\-factor\-settings search \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
