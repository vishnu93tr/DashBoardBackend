...
.
.TH "NETWORK-FIREWALL_DECRYPTION-PROFILE_BULK-UPLOAD" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network-firewall_decryption-profile_bulk-upload \- 
.
...
.nf
.ft C
oci network\-firewall decryption\-profile bulk\-upload [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-bulk\-upload\-decryption\-profiles\-details [complex type]
.UNINDENT
.sp
Request Details to bulk import decryption profiles for the Network Firewall Policy resource.
.INDENT 0.0
.TP
...
.nf
.ft C
    oci network\-firewall decryption\-profile bulk\-upload \-\-generate\-param\-json\-input bulk\-upload\-decryption\-profiles\-details > bulk\-upload\-decryption\-profiles\-details.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci network\-firewall decryption\-profile bulk\-upload \-\-bulk\-upload\-decryption\-profiles\-details file://bulk\-upload\-decryption\-profiles\-details.json \-\-network\-firewall\-policy\-id $network_firewall_policy_id
.ft P
.fi
.UNINDENT
.UNINDENT
