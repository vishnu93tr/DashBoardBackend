...
.
.TH "DATA-INTEGRATION_TASK-RUN_UPDATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-integration_task-run_update \- 
.
...
.ft C
    ...
    export application_key=<substitute\-value\-of\-application_key> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/task\-run/update.html#cmdoption\-application\-key
    export task_run_key=<substitute\-value\-of\-task_run_key> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/task\-run/update.html#cmdoption\-task\-run\-key
    ...
    oci data\-integration task\-run update \-\-application\-key $application_key \-\-task\-run\-key $task_run_key \-\-workspace\-id $workspace_id
.ft P
.fi
.UNINDENT
.UNINDENT
