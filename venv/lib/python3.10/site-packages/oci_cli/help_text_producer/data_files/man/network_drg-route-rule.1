...
.
.TH "NETWORK_DRG-ROUTE-RULE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network_drg-route-rule \- 
.
...
.nf
.ft C
oci network drg\-route\-rule add [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the DRG route table.
...
.sp
This option is a JSON list with items of type AddDrgRouteRuleDetails.  For documentation on AddDrgRouteRuleDetails please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/iaas/20160918/datatypes/AddDrgRouteRuleDetails\fP\&.
...
.ft C
    ...
    oci network drg\-route\-rule add \-\-drg\-route\-table\-id $drg_route_table_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci network drg\-route\-rule list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci network drg\-route\-rule list \-\-drg\-route\-table\-id $drg_route_table_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci network drg\-route\-rule remove [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci network drg\-route\-rule remove \-\-drg\-route\-table\-id $drg_route_table_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.sp
This option is a JSON list with items of type UpdateDrgRouteRuleDetails.  For documentation on UpdateDrgRouteRuleDetails please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/iaas/20160918/datatypes/UpdateDrgRouteRuleDetails\fP\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
