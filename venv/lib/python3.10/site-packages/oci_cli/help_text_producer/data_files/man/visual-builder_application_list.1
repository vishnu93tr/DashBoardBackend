...
.
.TH "VISUAL-BUILDER_APPLICATION_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
visual-builder_application_list \- 
.
...
.nf
.ft C
oci visual\-builder application list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export id=<substitute\-value\-of\-id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/visual\-builder/application/list.html#cmdoption\-id

    oci visual\-builder application list \-\-id $id
.ft P
.fi
.UNINDENT
.UNINDENT
