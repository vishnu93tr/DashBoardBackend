...
.
.TH "DEVOPS_CONNECTION_CREATE-GITLAB-CONNECTION" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
devops_connection_create-gitlab-connection \- 
.
...
.nf
.ft C
oci devops connection create\-gitlab\-connection [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export personal_access_token=<substitute\-value\-of\-personal_access_token> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/devops/connection/create\-gitlab\-connection.html#cmdoption\-personal\-access\-token
    ...
    oci devops connection create\-gitlab\-connection \-\-personal\-access\-token $personal_access_token \-\-project\-id $project_id
.ft P
.fi
.UNINDENT
.UNINDENT
