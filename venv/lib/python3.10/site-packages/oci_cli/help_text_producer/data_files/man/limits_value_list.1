...
.
.TH "LIMITS_VALUE_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
limits_value_list \- 
.
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/limits/value/list.html#cmdoption\-compartment\-id
    export service_name=<substitute\-value\-of\-service_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/limits/value/list.html#cmdoption\-service\-name

    oci limits value list \-\-compartment\-id $compartment_id \-\-service\-name $service_name
.ft P
.fi
.UNINDENT
.UNINDENT
