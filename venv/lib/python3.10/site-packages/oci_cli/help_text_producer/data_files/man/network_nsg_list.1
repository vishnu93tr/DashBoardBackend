...
.
.TH "NETWORK_NSG_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network_nsg_list \- 
.
...
.SH DESCRIPTION
.sp
Lists either the network security groups in the specified compartment, or those associated with the specified VLAN. You must specify either a \fIvlanId\fP or a \fIcompartmentId\fP, but not both. If you specify a \fIvlanId\fP, all other parameters are ignored.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
