...
.
.TH "APM-CONFIG_CONFIG_CREATE-OPTIONS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
apm-config_config_create-options \- 
.
...
.nf
.ft C
oci apm\-config config create\-options [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export apm_domain_id=<substitute\-value\-of\-apm_domain_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/apm\-config/config/create\-options.html#cmdoption\-apm\-domain\-id

    oci apm\-config config create\-options \-\-apm\-domain\-id $apm_domain_id
.ft P
.fi
.UNINDENT
.UNINDENT
