...
.
.TH "API-GATEWAY_API_CONTENT_GET" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
api-gateway_api_content_get \- 
.
...
.nf
.ft C
oci api\-gateway api content get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The Range HTTP request header indicates the part of a document that the server should return. \fI\%RFC 7233\fP <\fBhttps://tools.ietf.org/html/rfc7233#section-3.1\fP>\&. Note that only a single range of bytes is supported.
...
.ft C
    ...
    export file=<substitute\-value\-of\-file> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/api\-gateway/api/content/get.html#cmdoption\-file

    api_id=$(oci api\-gateway api create \-\-compartment\-id $compartment_id \-\-query data.id \-\-raw\-output)

    oci api\-gateway api content get \-\-api\-id $api_id \-\-file $file
.ft P
.fi
.UNINDENT
.UNINDENT
