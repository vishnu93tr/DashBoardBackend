...
.
.TH "ANOMALY-DETECTION_DETECT-ANOMALY-JOB_CREATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
anomaly-detection_detect-anomaly-job_create \- 
.
...
.nf
.ft C
oci anomaly\-detection detect\-anomaly\-job create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci anomaly\-detection detect\-anomaly\-job create \-\-compartment\-id $compartment_id \-\-input\-details file://input\-details.json \-\-model\-id $model_id \-\-output\-details file://output\-details.json
.ft P
.fi
.UNINDENT
.UNINDENT
