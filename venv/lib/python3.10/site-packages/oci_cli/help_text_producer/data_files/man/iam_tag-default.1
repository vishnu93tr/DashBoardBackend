...
.
.TH "IAM_TAG-DEFAULT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
iam_tag-default \- 
.
...
.SH DESCRIPTION
.sp
Tag defaults let you specify a default tag (tagnamespace.tag=”value”) to apply to all resource types in a specified compartment. The tag default is applied at the time the resource is created. Resources that exist in the compartment before you create the tag default are not tagged. The \fITagDefault\fP object specifies the tag and compartment details.
.sp
Tag defaults are inherited by child compartments. This means that if you set a tag default on the root compartment for a tenancy, all resources that are created in the tenancy are tagged. For more information about using tag defaults, see \fI\%Managing Tag Defaults\fP <\fBhttps://docs.cloud.oracle.com/Content/Tagging/Tasks/managingtagdefaults.htm\fP>\&.
.sp
...
.nf
.ft C
oci iam tag\-default add [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export type=<substitute\-value\-of\-type> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/iam/tag\-default/add.html#cmdoption\-type

    tag_default_id=$(oci iam tag\-default create \-\-compartment\-id $compartment_id \-\-tag\-definition\-id $tag_definition_id \-\-value $value \-\-query data.id \-\-raw\-output)

    oci iam tag\-default add \-\-tag\-default\-id $tag_default_id \-\-type $type
.ft P
.fi
.UNINDENT
.UNINDENT
.SS \fBassemble\-effective\-tag\-set\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.nf
.ft C
oci iam tag\-default assemble\-effective\-tag\-set [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/iam/tag\-default/assemble\-effective\-tag\-set.html#cmdoption\-compartment\-id

    oci iam tag\-default assemble\-effective\-tag\-set \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.IP \(bu 2
If the \fIisRequired\fP flag is set to “true”, the value is set during resource creation. * If the \fIisRequired\fP flag is set to “false”, the value you enter is set during resource creation.
.UNINDENT
.SS Usage
.INDENT 0.0
.INDENT 3.5
...
.nf
.ft C
oci iam tag\-default get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci iam tag\-default list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci iam tag\-default remove [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export tag_definition_id=<substitute\-value\-of\-tag_definition_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/iam/tag\-default/create.html#cmdoption\-tag\-definition\-id
    export value=<substitute\-value\-of\-value> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/iam/tag\-default/create.html#cmdoption\-value
    export type=<substitute\-value\-of\-type> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/iam/tag\-default/remove.html#cmdoption\-type

    tag_default_id=$(oci iam tag\-default create \-\-compartment\-id $compartment_id \-\-tag\-definition\-id $tag_definition_id \-\-value $value \-\-query data.id \-\-raw\-output)

    oci iam tag\-default remove \-\-tag\-default\-id $tag_default_id \-\-type $type
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci iam tag\-default update \-\-tag\-default\-id $tag_default_id \-\-value $value
.ft P
.fi
.UNINDENT
.UNINDENT
