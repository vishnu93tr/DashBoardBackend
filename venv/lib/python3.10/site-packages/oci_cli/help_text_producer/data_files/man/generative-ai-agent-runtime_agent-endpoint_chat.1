...
.
.TH "GENERATIVE-AI-AGENT-RUNTIME_AGENT-ENDPOINT_CHAT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
generative-ai-agent-runtime_agent-endpoint_chat \- 
.
...
.INDENT 0.0
.TP
.B \-\-performed\-actions [complex type]
.UNINDENT
.sp
A list of actions that have been performed based on prior required actions.
.sp
This option is a JSON list with items of type PerformedAction.  For documentation on PerformedAction please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/generativeaiagentruntime/20240531/datatypes/PerformedAction\fP\&.
...
.INDENT 0.0
.TP
.B \-\-should\-stream [boolean]
.UNINDENT
.sp
Whether to stream the response.
.INDENT 0.0
.TP
.B \-\-tool\-parameters [complex type]
.UNINDENT
.sp
