...
.
.TH "IDENTITY-DOMAINS_DYNAMIC-RESOURCE-GROUPS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_dynamic-resource-groups \- 
.
...
.nf
.ft C
oci identity\-domains dynamic\-resource\-groups list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains dynamic\-resource\-groups search [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains dynamic\-resource\-groups search \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains dynamic\-resource\-groups search \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
