...
.
.TH "NETWORK_VLAN" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network_vlan \- 
.
...
.sp
Conceptually, a virtual LAN (VLAN) is a broadcast domain that is created by partitioning and isolating a network at the data link layer (a \fIlayer 2 network\fP). VLANs work by using IEEE 802.1Q VLAN tags. Layer 2 traffic is forwarded within the VLAN based on MAC learning.
.sp
...
.SS Description
.sp
Moves a VLAN into a different compartment within the same tenancy. For information about moving resources between compartments, see \fI\%Moving Resources to a Different Compartment\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Identity/Tasks/managingcompartments.htm#moveRes\fP>\&.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci network vlan change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the compartment to move the VLAN to.
.INDENT 0.0
.TP
.B \-\-vlan\-id [text]
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the VLAN.
...
.ft C
    ...
    vlan_id=$(oci network vlan create \-\-cidr\-block $cidr_block \-\-compartment\-id $compartment_id \-\-vcn\-id $vcn_id \-\-query data.id \-\-raw\-output)

    oci network vlan change\-compartment \-\-compartment\-id $compartment_id \-\-vlan\-id $vlan_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci network vlan create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.IP 1. 3
The CIDR block is valid and correctly formatted. 2. The new range is within one of the parent VCN ranges.
.UNINDENT
.sp
Example:
.INDENT 0.0
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the compartment to contain the VLAN.
.INDENT 0.0
.TP
.B \-\-vcn\-id [text]
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the VCN to contain the VLAN.
.SS Optional Parameters
.INDENT 0.0
.TP
...
.UNINDENT
.sp
A list of the OCIDs of the network security groups (NSGs) to add all VNICs in the VLAN to. For more information about NSGs, see \fI\%NetworkSecurityGroup\fP <\fBhttps://docs.cloud.oracle.com/api/#/en/iaas/latest/NetworkSecurityGroup/\fP>\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the route table the VLAN will use. If you don’t provide a value, the VLAN uses the VCN’s default route table.
.INDENT 0.0
.TP
.B \-\-vlan\-tag [integer]
.UNINDENT
...
.ft C
    ...
    oci network vlan create \-\-cidr\-block $cidr_block \-\-compartment\-id $compartment_id \-\-vcn\-id $vcn_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci network vlan delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci network vlan delete \-\-vlan\-id $vlan_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci network vlan get \-\-vlan\-id $vlan_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/network/vlan/list.html#cmdoption\-compartment\-id

    oci network vlan list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci network vlan update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
A list of the OCIDs of the network security groups (NSGs) to use with this VLAN. All VNICs in the VLAN will belong to these NSGs. For more information about NSGs, see \fI\%NetworkSecurityGroup\fP <\fBhttps://docs.cloud.oracle.com/api/#/en/iaas/latest/NetworkSecurityGroup/\fP>\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the route table the VLAN will use.
.INDENT 0.0
.TP
.B \-\-wait\-for\-state [text]
.UNINDENT
...
.ft C
    ...
    oci network vlan update \-\-vlan\-id $vlan_id
.ft P
.fi
.UNINDENT
.UNINDENT
