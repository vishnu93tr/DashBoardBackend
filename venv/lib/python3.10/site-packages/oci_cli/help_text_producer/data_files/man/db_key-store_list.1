...
.
.TH "DB_KEY-STORE_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_key-store_list \- 
.
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/db/key\-store/list.html#cmdoption\-compartment\-id

    oci db key\-store list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
