...
.
.TH "DISASTER-RECOVERY_DR-PROTECTION-GROUP_CREATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
disaster-recovery_dr-protection-group_create \- 
.
...
.sp
This option is a JSON list with items of type CreateDrProtectionGroupMemberDetails.  For documentation on CreateDrProtectionGroupMemberDetails please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/disasterrecovery/20220125/datatypes/CreateDrProtectionGroupMemberDetails\fP\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
.ft C
    ...
    oci disaster\-recovery dr\-protection\-group create \-\-compartment\-id $compartment_id \-\-display\-name $display_name \-\-log\-location file://log\-location.json
.ft P
.fi
.UNINDENT
.UNINDENT
