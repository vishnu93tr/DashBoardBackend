...
.
.TH "FS_FILE-SYSTEM_DELETE-QUOTA-RULE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
fs_file-system_delete-quota-rule \- 
.
...
.SH DESCRIPTION
.sp
Remove a file system, user, or group quota rule given the \fIfileSystemId\fP and \fIquotaRuleId\fP parameters.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci fs file\-system delete\-quota\-rule [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export quota_rule_id=<substitute\-value\-of\-quota_rule_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/fs/file\-system/delete\-quota\-rule.html#cmdoption\-quota\-rule\-id
    ...
    oci fs file\-system delete\-quota\-rule \-\-file\-system\-id $file_system_id \-\-quota\-rule\-id $quota_rule_id
.ft P
.fi
.UNINDENT
.UNINDENT
