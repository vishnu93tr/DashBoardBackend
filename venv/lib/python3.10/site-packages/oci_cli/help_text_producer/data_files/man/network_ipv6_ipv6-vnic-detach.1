...
.
.TH "NETWORK_IPV6_IPV6-VNIC-DETACH" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network_ipv6_ipv6-vnic-detach \- 
.
...
.SH DESCRIPTION
.sp
Unassign the specified IPv6 address from Virtual Network Interface Card (VNIC). You must specify the IPv6 \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP>\&.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
...
.ft C
    ...
    oci network ipv6 ipv6\-vnic\-detach \-\-ipv6\-id $ipv6_id
.ft P
.fi
.UNINDENT
.UNINDENT
