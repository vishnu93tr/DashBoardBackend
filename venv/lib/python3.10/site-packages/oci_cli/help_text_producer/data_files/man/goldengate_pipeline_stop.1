...
.
.TH "GOLDENGATE_PIPELINE_STOP" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
...
.nf
.ft C
oci goldengate pipeline stop [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export pipeline_id=<substitute\-value\-of\-pipeline_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/goldengate/pipeline/stop.html#cmdoption\-pipeline\-id

    oci goldengate pipeline stop \-\-pipeline\-id $pipeline_id
.ft P
.fi
.UNINDENT
.UNINDENT
