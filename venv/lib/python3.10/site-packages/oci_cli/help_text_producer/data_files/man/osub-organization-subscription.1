...
.
.TH "OSUB-ORGANIZATION-SUBSCRIPTION" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
...
.SH DESCRIPTION
.sp
CLI that returns data for the list of subscription ids returned from Organizations CLI
...
.nf
.ft C
oci osub\-organization\-subscription subscription list\-organization [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/osub\-organization\-subscription/subscription/list\-organization.html#cmdoption\-compartment\-id
