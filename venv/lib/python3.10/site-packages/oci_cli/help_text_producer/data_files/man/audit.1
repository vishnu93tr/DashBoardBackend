...
.
.TH "AUDIT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
audit \- 
.
...
.SH DESCRIPTION
.sp
CLI for the Audit Service. Use this CLI for compliance monitoring in your tenancy.
For more information, see \fI\%Overview of Audit\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Audit/Concepts/auditoverview.htm\fP>\&.
.sp
\fBTip\fP: This CLI is good for queries, but not bulk\-export operations.
...
.SS Description
.sp
The retention period setting, specified in days. For more information, see \fI\%Setting Audit Log Retention Period\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Audit/Tasks/settingretentionperiod.htm\fP>\&.
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/audit/config/get.html#cmdoption\-compartment\-id

    oci audit config get \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-retention\-period\-days [integer]
.UNINDENT
.sp
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/audit/config/update.html#cmdoption\-compartment\-id
    export retention_period_days=<substitute\-value\-of\-retention_period_days> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/audit/config/update.html#cmdoption\-retention\-period\-days

    oci audit config update \-\-compartment\-id $compartment_id \-\-retention\-period\-days $retention_period_days
.ft P
.fi
.UNINDENT
.UNINDENT
