...
.
.TH "OS-MANAGEMENT-HUB_MANAGED-INSTANCE_LIST-INSTALLED-PACKAGES" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
os-management-hub_managed-instance_list-installed-packages \- 
.
...
.nf
.ft C
oci os\-management\-hub managed\-instance list\-installed\-packages [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
displayName, timeCreated, timeInstalled
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-time\-install\-date\-end [datetime]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-time\-install\-date\-start [datetime]
.UNINDENT
.sp
...
.nf
.ft C
    export managed_instance_id=<substitute\-value\-of\-managed_instance_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/os\-management\-hub/managed\-instance/list\-installed\-packages.html#cmdoption\-managed\-instance\-id

    oci os\-management\-hub managed\-instance list\-installed\-packages \-\-managed\-instance\-id $managed_instance_id
.ft P
.fi
.UNINDENT
.UNINDENT
