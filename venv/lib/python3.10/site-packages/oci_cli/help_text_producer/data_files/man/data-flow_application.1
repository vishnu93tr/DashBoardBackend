...
.
.TH "DATA-FLOW_APPLICATION" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
...
.SS Description
.sp
Deletes an application using an \fIapplicationId\fP and terminates related runs. This operation will timeout in approximate 30 minutes if any related Runs are not terminated successfully.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci data\-flow application cascading\-delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci data\-flow application cascading\-delete \-\-application\-id $application_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.SS Description
.sp
Deletes an application using an \fIapplicationId\fP\&.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
...
.SS Description
.sp
Retrieves an application using an \fIapplicationId\fP\&.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
