...
.
.TH "IDENTITY-DOMAINS_O-AUTH2-CLIENT-CREDENTIALS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_o-auth2-client-credentials \- 
.
...
.nf
.ft C
oci identity\-domains o\-auth2\-client\-credentials list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains o\-auth2\-client\-credentials list
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains o\-auth2\-client\-credentials search [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains o\-auth2\-client\-credentials search \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains o\-auth2\-client\-credentials search \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
