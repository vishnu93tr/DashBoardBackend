...
.
.TH "DEVOPS_DEPLOY-STAGE_UPDATE-OKE-CANARY-TRAFFIC-SHIFT-STAGE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
devops_deploy-stage_update-oke-canary-traffic-shift-stage \- 
.
...
.nf
.ft C
oci devops deploy\-stage update\-oke\-canary\-traffic\-shift\-stage [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export stage_id=<substitute\-value\-of\-stage_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/devops/deploy\-stage/update\-oke\-canary\-traffic\-shift\-stage.html#cmdoption\-stage\-id

    oci devops deploy\-stage update\-oke\-canary\-traffic\-shift\-stage \-\-stage\-id $stage_id
.ft P
.fi
.UNINDENT
.UNINDENT
