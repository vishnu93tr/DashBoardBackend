...
.
.TH "LOG-ANALYTICS_INGEST-TIME-RULE_GET" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
log-analytics_ingest-time-rule_get \- 
.
...
.nf
.ft C
oci log\-analytics ingest\-time\-rule get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci log\-analytics ingest\-time\-rule get \-\-ingest\-time\-rule\-id $ingest_time_rule_id \-\-namespace\-name $namespace_name
.ft P
.fi
.UNINDENT
.UNINDENT
