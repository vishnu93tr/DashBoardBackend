...
.
.TH "OCVS_ESXI-HOST_UPDATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
ocvs_esxi-host_update \- 
.
...
.INDENT 0.0
.TP
.B \-\-billing\-donor\-host\-id [text]
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the deleted ESXi Host with LeftOver billing cycle.
.INDENT 0.0
.TP
...
.INDENT 0.0
.TP
.B \-\-next\-commitment [text]
.UNINDENT
.sp
The billing option to switch to after the existing billing cycle ends. If \fInextCommitment\fP is null or empty, \fIcurrentCommitment\fP continues to the next billing cycle. \fI\%ListSupportedCommitments\fP <\fBhttps://docs.cloud.oracle.com/api/#/en/vmware/20200501/SupportedCommitmentSummary/ListSupportedCommitments\fP>\&.
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
