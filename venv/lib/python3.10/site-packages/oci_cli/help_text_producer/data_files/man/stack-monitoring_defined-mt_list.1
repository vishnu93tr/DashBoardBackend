...
.
.TH "STACK-MONITORING_DEFINED-MT_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
stack-monitoring_defined-mt_list \- 
.
...
.nf
.ft C
oci stack\-monitoring defined\-mt list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the tenancy(root) for which defined monitored templates should be listed.
...
.UNINDENT
.sp
The field to sort by. Only one sort order may be provided. Default order for ‘namespace’ is ascending.
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/stack\-monitoring/defined\-mt/list.html#cmdoption\-compartment\-id

    oci stack\-monitoring defined\-mt list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
