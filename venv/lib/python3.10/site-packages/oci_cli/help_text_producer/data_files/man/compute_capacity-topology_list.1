...
.
.TH "COMPUTE_CAPACITY-TOPOLOGY_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
compute_capacity-topology_list \- 
.
...
.nf
.ft C
oci compute capacity\-topology list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/compute/capacity\-topology/list.html#cmdoption\-compartment\-id

    oci compute capacity\-topology list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
