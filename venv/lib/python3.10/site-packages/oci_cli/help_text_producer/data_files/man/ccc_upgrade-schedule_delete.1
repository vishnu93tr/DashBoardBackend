...
.
.TH "CCC_UPGRADE-SCHEDULE_DELETE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
ccc_upgrade-schedule_delete \- 
.
...
.SH DESCRIPTION
.sp
Deletes a Compute \fI\%Cloud@Customer\fP <\fBCloud@Customer\fP> upgrade schedule by the specified OCID
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci ccc upgrade\-schedule delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci ccc upgrade\-schedule delete \-\-upgrade\-schedule\-id $upgrade_schedule_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.SS Description
.sp
Deletes the specified upgrade schedule by the specified OCID.
.SS Command
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
 oci ccc upgrade\-schedule delete \-\-upgrade\-schedule\-id <upgrade_schedule_OCID>
.ft P
.fi
.UNINDENT
.UNINDENT
...
.SS Description
.sp
Deletes the upgrade schedule without prompting for confirmation.
.SS Command
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
 oci ccc upgrade\-schedule delete \-\-upgrade\-schedule\-id <upgrade_schedule_OCID> \-\-force
.ft P
.fi
.UNINDENT
.UNINDENT
