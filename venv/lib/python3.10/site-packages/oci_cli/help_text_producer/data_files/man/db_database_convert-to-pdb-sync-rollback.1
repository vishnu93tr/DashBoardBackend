...
.
.TH "DB_DATABASE_CONVERT-TO-PDB-SYNC-ROLLBACK" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_database_convert-to-pdb-sync-rollback \- 
.
...
.nf
.ft C
oci db database convert\-to\-pdb\-sync\-rollback [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci db database convert\-to\-pdb\-sync\-rollback \-\-database\-id $database_id
.ft P
.fi
.UNINDENT
.UNINDENT
