...
.
.TH "OPSI_DATABASE-INSIGHTS_LIST-DATABASE-CONFIGURATIONS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
opsi_database-insights_list-database-configurations \- 
.
...
.UNINDENT
.sp
Database configuration list sort options. If \fIfields\fP parameter is selected, the \fIsortBy\fP parameter must be one of the fields specified.
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
