...
.
.TH "DATA-SAFE_MASKING-COLUMN_GET-COMPATIBLE-FORMATS-FOR-SENSITIVE-TYPES" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_masking-column_get-compatible-formats-for-sensitive-types \- 
.
...
.nf
.ft C
oci data\-safe masking\-column get\-compatible\-formats\-for\-sensitive\-types [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-safe/masking\-column/get\-compatible\-formats\-for\-sensitive\-types.html#cmdoption\-compartment\-id

    oci data\-safe masking\-column get\-compatible\-formats\-for\-sensitive\-types \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
