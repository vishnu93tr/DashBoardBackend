...
.
.TH "IAM_USER_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
iam_user_list \- 
.
...
.SH DESCRIPTION
.sp
Lists the users in your tenancy. You must specify your tenancy’s OCID as the value for the compartment ID (remember that the tenancy is simply the root compartment). See \fI\%Where to Get the Tenancy’s OCID and User’s OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/API/Concepts/apisigningkey.htm#five\fP>\&.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
