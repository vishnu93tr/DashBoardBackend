...
.
.TH "OMA_ACCESS-REQUESTS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
oma_access-requests \- 
.
...
list
.UNINDENT
.SS \fBexport\-access\-requests\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.nf
.ft C
oci oma access\-requests export\-access\-requests [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
Date and time after which access requests were created, as described in \fI\%RFC 3339\fP <\fBhttps://tools.ietf.org/rfc/rfc3339\fP>
.INDENT 0.0
.INDENT 3.5
...
.UNINDENT
.sp
Date and time before which access requests were created, as described in 
.nf
\(ga
.fi
RFC 3339 <\fI\%https://tools.ietf.org/rfc/rfc3339\fP>\(ga__s
.INDENT 0.0
.INDENT 3.5
The following datetime formats are supported:
.UNINDENT
...
.nf
.ft C
oci oma access\-requests list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
Date and time on or after which Access Requests were created, as described in \fI\%RFC 3339\fP <\fBhttps://tools.ietf.org/rfc/rfc3339\fP>
.INDENT 0.0
.INDENT 3.5
The following datetime formats are supported:
.UNINDENT
...
.UNINDENT
.sp
Date and time on or before which Access requests were created, as described in \fI\%RFC 3339\fP <\fBhttps://tools.ietf.org/rfc/rfc3339\fP>
.INDENT 0.0
.INDENT 3.5
The following datetime formats are supported:
.UNINDENT
