...
.
.TH "DATA-SAFE_REFERENTIAL-RELATION_DELETE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_referential-relation_delete \- 
.
...
.nf
.ft C
oci data\-safe referential\-relation delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-referential\-relation\-key [text]
.UNINDENT
.sp
...
.ft C
    ...
    export referential_relation_key=<substitute\-value\-of\-referential_relation_key> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-safe/referential\-relation/delete.html#cmdoption\-referential\-relation\-key
    ...
    oci data\-safe referential\-relation delete \-\-referential\-relation\-key $referential_relation_key \-\-sensitive\-data\-model\-id $sensitive_data_model_id
.ft P
.fi
.UNINDENT
.UNINDENT
