...
.
.TH "IDENTITY-DOMAINS_OCI-CONSOLE-SIGN-ON-POLICY-CONSENT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_oci-console-sign-on-policy-consent \- 
.
...
.nf
.ft C
oci identity\-domains oci\-console\-sign\-on\-policy\-consent get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-oci\-console\-sign\-on\-policy\-consent\-id [text]
.UNINDENT
.sp
ID of the resource
...
.nf
.ft C
    export oci_console_sign_on_policy_consent_id=<substitute\-value\-of\-oci_console_sign_on_policy_consent_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/identity\-domains/oci\-console\-sign\-on\-policy\-consent/get.html#cmdoption\-oci\-console\-sign\-on\-policy\-consent\-id

    oci identity\-domains oci\-console\-sign\-on\-policy\-consent get \-\-oci\-console\-sign\-on\-policy\-consent\-id $oci_console_sign_on_policy_consent_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains oci\-console\-sign\-on\-policy\-consent list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains oci\-console\-sign\-on\-policy\-consent search [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
