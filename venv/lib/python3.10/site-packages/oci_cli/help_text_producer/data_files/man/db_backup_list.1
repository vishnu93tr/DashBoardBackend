...
.
.TH "DB_BACKUP_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_backup_list \- 
.
...
.SH DESCRIPTION
.sp
Gets a list of backups based on the \fIdatabaseId\fP or \fIcompartmentId\fP specified. Either one of these query parameters must be provided.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
...
.INDENT 0.0
.TP
.B \-\-backup\-destination\-type [text]
.UNINDENT
.sp
