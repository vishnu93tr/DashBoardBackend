...
.
.TH "MANAGEMENT-DASHBOARD_DASHBOARD_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
management-dashboard_dashboard_list \- 
.
...
.nf
.ft C
oci management\-dashboard dashboard list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/management\-dashboard/dashboard/list.html#cmdoption\-compartment\-id

    oci management\-dashboard dashboard list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
