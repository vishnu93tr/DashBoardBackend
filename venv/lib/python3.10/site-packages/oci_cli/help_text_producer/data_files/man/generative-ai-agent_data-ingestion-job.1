...
.
.TH "GENERATIVE-AI-AGENT_DATA-INGESTION-JOB" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
generative-ai-agent_data-ingestion-job \- 
.
...
.nf
.ft C
oci generative\-ai\-agent data\-ingestion\-job create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the compartment to create the data ingestion job in.
.INDENT 0.0
.TP
.B \-\-data\-source\-id [text]
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the parent DataSource.
...
.ft C
    ...
    oci generative\-ai\-agent data\-ingestion\-job create \-\-compartment\-id $compartment_id \-\-data\-source\-id $data_source_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci generative\-ai\-agent data\-ingestion\-job delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-data\-ingestion\-job\-id [text]
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the data ingestion job.
.SS Optional Parameters
.INDENT 0.0
.TP
.B \-\-force
...
.ft C
    ...
    oci generative\-ai\-agent data\-ingestion\-job delete \-\-data\-ingestion\-job\-id $data_ingestion_job_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci generative\-ai\-agent data\-ingestion\-job get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci generative\-ai\-agent data\-ingestion\-job get \-\-data\-ingestion\-job\-id $data_ingestion_job_id
.ft P
.fi
.UNINDENT
.UNINDENT
.SS \fBget\-log\-content\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.nf
.ft C
oci generative\-ai\-agent data\-ingestion\-job get\-log\-content [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci generative\-ai\-agent data\-ingestion\-job list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
ACCEPTED, DELETED, DELETING, FAILED, IN_PROGRESS, SUCCEEDED, WAITING
.ft P
.fi
.UNINDENT
.UNINDENT
