...
.
.TH "OPCTL_OPERATOR-CONTROL-ASSIGNMENT_VALIDATE-OPERATOR-ASSIGNMENT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
opctl_operator-control-assignment_validate-operator-assignment \- 
.
...
.nf
.ft C
oci opctl operator\-control\-assignment validate\-operator\-assignment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci opctl operator\-control\-assignment validate\-operator\-assignment \-\-operator\-control\-assignment\-id $operator_control_assignment_id
.ft P
.fi
.UNINDENT
.UNINDENT
