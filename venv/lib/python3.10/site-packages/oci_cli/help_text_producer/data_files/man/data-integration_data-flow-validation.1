...
.
.TH "DATA-INTEGRATION_DATA-FLOW-VALIDATION" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-integration_data-flow-validation \- 
.
...
.INDENT 0.0
.TP
.B \-\-target\-field\-map\-summary [complex type]
.UNINDENT
.sp
A hash map that maps TypedObject keys to a field map that maps to the typed object as a target, for java sdk.
.sp
This option is a JSON dictionary of type dict(str, FieldMapWrapper).  For documentation on FieldMapWrapper please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/dataintegration/20200430/datatypes/FieldMapWrapper\fP\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
.INDENT 0.0
.TP
.B \-\-typed\-object\-map [complex type]
.UNINDENT
.sp
A hash map that maps TypedObject keys to the object itself, for java sdk.
.sp
This option is a JSON dictionary of type dict(str, TypedObjectWrapper).  For documentation on TypedObjectWrapper please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/dataintegration/20200430/datatypes/TypedObjectWrapper\fP\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
.nf
.ft C
oci data\-integration data\-flow\-validation delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export display_name=<substitute\-value\-of\-display_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/workspace/create.html#cmdoption\-display\-name
    export is_private_network=<substitute\-value\-of\-is_private_network> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/workspace/create.html#cmdoption\-is\-private\-network
    export df_validation_key=<substitute\-value\-of\-df_validation_key> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/data\-flow\-validation/delete.html#cmdoption\-df\-validation\-key

    workspace_id=$(oci data\-integration workspace create \-\-compartment\-id $compartment_id \-\-display\-name $display_name \-\-is\-private\-network $is_private_network \-\-query data.id \-\-raw\-output)

    oci data\-integration data\-flow\-validation delete \-\-df\-validation\-key $df_validation_key \-\-workspace\-id $workspace_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci data\-integration data\-flow\-validation get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export display_name=<substitute\-value\-of\-display_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/workspace/create.html#cmdoption\-display\-name
    export is_private_network=<substitute\-value\-of\-is_private_network> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/workspace/create.html#cmdoption\-is\-private\-network
    export df_validation_key=<substitute\-value\-of\-df_validation_key> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/data\-flow\-validation/get.html#cmdoption\-df\-validation\-key

    workspace_id=$(oci data\-integration workspace create \-\-compartment\-id $compartment_id \-\-display\-name $display_name \-\-is\-private\-network $is_private_network \-\-query data.id \-\-raw\-output)

    oci data\-integration data\-flow\-validation get \-\-df\-validation\-key $df_validation_key \-\-workspace\-id $workspace_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci data\-integration data\-flow\-validation list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci data\-integration data\-flow\-validation list \-\-workspace\-id $workspace_id
.ft P
.fi
.UNINDENT
.UNINDENT
