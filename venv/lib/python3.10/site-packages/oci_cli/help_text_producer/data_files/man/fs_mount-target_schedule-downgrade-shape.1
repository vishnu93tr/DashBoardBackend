...
.
.TH "FS_MOUNT-TARGET_SCHEDULE-DOWNGRADE-SHAPE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
fs_mount-target_schedule-downgrade-shape \- 
.
...
.nf
.ft C
oci fs mount\-target schedule\-downgrade\-shape [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-requested\-throughput [integer]
.UNINDENT
.sp
New throughput for mount target in Gbps. Available shapes and corresponding throughput are listed at \fI\%Mount Target Performance\fP <\fBhttps://docs.oracle.com/iaas/Content/File/Tasks/managingmounttargets.htm#performance\fP>\&.
.INDENT 0.0
.TP
...
.ft C
    ...
    oci fs mount\-target schedule\-downgrade\-shape \-\-mount\-target\-id $mount_target_id
.ft P
.fi
.UNINDENT
.UNINDENT
