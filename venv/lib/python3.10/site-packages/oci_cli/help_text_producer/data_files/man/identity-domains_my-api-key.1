...
.
.TH "IDENTITY-DOMAINS_MY-API-KEY" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_my-api-key \- 
.
...
.nf
.ft C
oci identity\-domains my\-api\-key create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.sp
\fBSCIM++ Properties:\fP  \- caseExact: true  \- idcsSearchable: true  \- type: string  \- mutability: readOnly  \- required: true  \- returned: default
.INDENT 0.0
.TP
.B \-\-key [text]
.UNINDENT
...
\fBAdded In:\fP 2010242156
.sp
\fBSCIM++ Properties:\fP  \- caseExact: true  \- idcsPii: true  \- type: string  \- mutability: immutable  \- required: true  \- returned: default
.INDENT 0.0
.TP
...
.nf
.ft C
    oci identity\-domains my\-api\-key create \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export fingerprint=<substitute\-value\-of\-fingerprint> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/identity\-domains/my\-api\-key/create.html#cmdoption\-fingerprint
    export key=<substitute\-value\-of\-key> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/identity\-domains/my\-api\-key/create.html#cmdoption\-key

    oci identity\-domains my\-api\-key create \-\-fingerprint $fingerprint \-\-key $key \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains my\-api\-key delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    my_api_key_id=$(oci identity\-domains my\-api\-key create \-\-fingerprint $fingerprint \-\-key $key \-\-schemas file://schemas.json \-\-query data.id \-\-raw\-output)

    oci identity\-domains my\-api\-key delete \-\-my\-api\-key\-id $my_api_key_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains my\-api\-key get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains my\-api\-key get \-\-my\-api\-key\-id $my_api_key_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains my\-api\-key patch [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains my\-api\-key patch \-\-generate\-param\-json\-input operations > operations.json
    oci identity\-domains my\-api\-key patch \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains my\-api\-key patch \-\-my\-api\-key\-id $my_api_key_id \-\-operations file://operations.json \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
