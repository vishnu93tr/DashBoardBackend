...
.
.TH "DATA-INTEGRATION_CONNECTION_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-integration_connection_list \- 
.
...
.nf
.ft C
oci data\-integration connection list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export data_asset_key=<substitute\-value\-of\-data_asset_key> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/connection/list.html#cmdoption\-data\-asset\-key
    ...
    oci data\-integration connection list \-\-data\-asset\-key $data_asset_key \-\-workspace\-id $workspace_id
.ft P
.fi
.UNINDENT
.UNINDENT
