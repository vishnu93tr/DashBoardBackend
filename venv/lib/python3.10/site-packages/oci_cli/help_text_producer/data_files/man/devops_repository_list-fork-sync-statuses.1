...
.
.TH "DEVOPS_REPOSITORY_LIST-FORK-SYNC-STATUSES" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
devops_repository_list-fork-sync-statuses \- 
.
...
.nf
.ft C
oci devops repository list\-fork\-sync\-statuses [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-branch\-name\-query\-param [text]
.UNINDENT
.sp
...
.ft C
    ...
    export branch_name_query_param=<substitute\-value\-of\-branch_name_query_param> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/devops/repository/list\-fork\-sync\-statuses.html#cmdoption\-branch\-name\-query\-param
    ...
    oci devops repository list\-fork\-sync\-statuses \-\-branch\-name\-query\-param $branch_name_query_param \-\-repository\-id $repository_id
.ft P
.fi
.UNINDENT
.UNINDENT
