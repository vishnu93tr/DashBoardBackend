...
.
.TH "DB_PLUGGABLE-DATABASE_REFRESH" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_pluggable-database_refresh \- 
.
...
.nf
.ft C
oci db pluggable\-database refresh [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export pdb_id=<substitute\-value\-of\-pdb_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/db/pluggable\-database/refresh.html#cmdoption\-pdb\-id

    oci db pluggable\-database refresh \-\-pdb\-id $pdb_id
.ft P
.fi
.UNINDENT
.UNINDENT
