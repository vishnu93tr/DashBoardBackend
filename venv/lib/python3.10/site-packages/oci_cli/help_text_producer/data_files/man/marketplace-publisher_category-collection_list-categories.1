...
.
.TH "MARKETPLACE-PUBLISHER_CATEGORY-COLLECTION_LIST-CATEGORIES" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
marketplace-publisher_category-collection_list-categories \- 
.
...
.nf
.ft C
oci marketplace\-publisher category\-collection list\-categories [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/marketplace\-publisher/category\-collection/list\-categories.html#cmdoption\-compartment\-id

    oci marketplace\-publisher category\-collection list\-categories \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
