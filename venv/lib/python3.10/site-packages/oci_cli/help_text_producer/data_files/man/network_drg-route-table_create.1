...
.
.TH "NETWORK_DRG-ROUTE-TABLE_CREATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network_drg-route-table_create \- 
.
...
.SH DESCRIPTION
.sp
Creates a new DRG route table for the specified DRG. Assign the DRG route table to a DRG attachment using the \fIUpdateDrgAttachment\fP or \fICreateDrgAttachment\fP operations.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci network drg\-route\-table create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-import\-route\-distribution\-id [text]
.UNINDENT
.sp
...
.ft C
    ...
    oci network drg\-route\-table create \-\-drg\-id $drg_id
.ft P
.fi
.UNINDENT
.UNINDENT
