...
.
.TH "DB_DATA-GUARD-ASSOCIATION_MIGRATE-TO-MULTIPLE-STANDBY-MODEL" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_data-guard-association_migrate-to-multiple-standby-model \- 
.
...
.nf
.ft C
oci db data\-guard\-association migrate\-to\-multiple\-standby\-model [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export data_guard_association_id=<substitute\-value\-of\-data_guard_association_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/db/data\-guard\-association/migrate\-to\-multiple\-standby\-model.html#cmdoption\-data\-guard\-association\-id
    ...
    oci db data\-guard\-association migrate\-to\-multiple\-standby\-model \-\-data\-guard\-association\-id $data_guard_association_id \-\-database\-id $database_id
.ft P
.fi
.UNINDENT
.UNINDENT
