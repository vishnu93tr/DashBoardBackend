...
.
.TH "NETWORK-FIREWALL_NETWORK-FIREWALL-POLICY_MIGRATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network-firewall_network-firewall-policy_migrate \- 
.
...
.nf
.ft C
oci network\-firewall network\-firewall\-policy migrate [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci network\-firewall network\-firewall\-policy migrate \-\-network\-firewall\-policy\-id $network_firewall_policy_id
.ft P
.fi
.UNINDENT
.UNINDENT
