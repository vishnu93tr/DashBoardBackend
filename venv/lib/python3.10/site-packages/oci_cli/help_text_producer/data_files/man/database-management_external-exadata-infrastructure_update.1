...
.
.TH "DATABASE-MANAGEMENT_EXTERNAL-EXADATA-INFRASTRUCTURE_UPDATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
database-management_external-exadata-infrastructure_update \- 
.
...
.nf
.ft C
oci database\-management external\-exadata\-infrastructure update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-storage\-server\-names [complex type]
.UNINDENT
.sp
...
.ft C
    ...
    oci database\-management external\-exadata\-infrastructure update \-\-compartment\-id $compartment_id \-\-external\-exadata\-infrastructure\-id $external_exadata_infrastructure_id
.ft P
.fi
.UNINDENT
.UNINDENT
