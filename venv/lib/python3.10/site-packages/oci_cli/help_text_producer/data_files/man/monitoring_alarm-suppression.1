...
.
.TH "MONITORING_ALARM-SUPPRESSION" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
monitoring_alarm-suppression \- 
.
...
get
.IP \(bu 2
summarize\-alarm\-suppression\-history
.UNINDENT
.SS \fBcreate\fP
.INDENT 0.0
.IP \(bu 2
...
.SS Description
.sp
Creates a new alarm suppression at the specified level (alarm\-wide or dimension\-specific). For more information, see \fI\%Adding an Alarm\-wide Suppression\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Monitoring/Tasks/add-alarm-suppression.htm\fP> and \fI\%Adding a Dimension\-Specific Alarm Suppression\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Monitoring/Tasks/create-alarm-suppression.htm\fP>\&.
.sp
For important limits information, see \fI\%Limits on Monitoring\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Monitoring/Concepts/monitoringoverview.htm#limits\fP>\&.
.sp
...
.INDENT 0.0
.TP
.B \-\-alarm\-suppression\-target [complex type]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-time\-suppress\-from [datetime]
.UNINDENT
.sp
The start date and time for the suppression to take place, inclusive. Format defined by RFC3339.
.sp
Example: \fI2023\-02\-01T01:02:29.600Z\fP
.INDENT 0.0
.INDENT 3.5
...
.INDENT 0.0
.TP
.B \-\-time\-suppress\-until [datetime]
.UNINDENT
.sp
The end date and time for the suppression to take place, inclusive. Format defined by RFC3339.
.sp
Example: \fI2023\-02\-01T02:02:29.600Z\fP
.INDENT 0.0
.INDENT 3.5
The following datetime formats are supported:
.UNINDENT
...
.sp
This is required only when the value of level is \fIDIMENSION\fP\&. If required, the value cannot be an empty object. Only a single value is allowed per key. No grouping of multiple values is allowed under the same key. Maximum characters (after serialization): 4000. This maximum satisfies typical use cases. The response for an exceeded maximum is \fIHTTP 400\fP with an “dimensions values are too long” message.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
.UNINDENT
.sp
The level of this alarm suppression. \fIALARM\fP indicates a suppression of the entire alarm, regardless of dimension. \fIDIMENSION\fP indicates a suppression configured for specified dimensions.
.sp
Defaut: \fIDIMENSION\fP
.INDENT 0.0
.TP
...
.INDENT 0.0
.TP
.B \-\-suppression\-conditions [complex type]
.UNINDENT
.sp
Array of all preconditions for alarm suppression. Example: \fI[{   conditionType: “RECURRENCE”,   suppressionRecurrence: “FRQ=DAILY;BYHOUR=10”,   suppressionDuration: “PT1H” }]\fP
.sp
This option is a JSON list with items of type SuppressionCondition.  For documentation on SuppressionCondition please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/monitoring/20180401/datatypes/SuppressionCondition\fP\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
.SS Description
.sp
Deletes the specified alarm suppression. For more information, see \fI\%Removing an Alarm\-wide Suppression\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Monitoring/Tasks/remove-alarm-suppression.htm\fP> and \fI\%Removing a Dimension\-Specific Alarm Suppression\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Monitoring/Tasks/delete-alarm-suppression.htm\fP>\&.
.sp
For important limits information, see \fI\%Limits on Monitoring\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Monitoring/Concepts/monitoringoverview.htm#limits\fP>\&.
.sp
This call is subject to a Monitoring limit that applies to the total number of requests across all alarm operations. Monitoring might throttle this call to reject an otherwise valid request when the total rate of alarm operations exceeds 10 requests, or transactions, per second (TPS) for a given tenancy.
...
.INDENT 0.0
.TP
.B \-\-alarm\-suppression\-id [text]
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the alarm suppression.
.SS Optional Parameters
.INDENT 0.0
.TP
.B \-\-force
...
.ft C
    ...
    alarm_suppression_id=$(oci monitoring alarm\-suppression create \-\-alarm\-suppression\-target file://alarm\-suppression\-target.json \-\-display\-name $display_name \-\-time\-suppress\-from $time_suppress_from \-\-time\-suppress\-until $time_suppress_until \-\-query data.id \-\-raw\-output)

    oci monitoring alarm\-suppression delete \-\-alarm\-suppression\-id $alarm_suppression_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.SS Description
.sp
Gets the specified alarm suppression. For more information, see \fI\%Getting an Alarm\-wide Suppression\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Monitoring/Tasks/get-alarm-suppression.htm\fP>\&.
.sp
For important limits information, see \fI\%Limits on Monitoring\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Monitoring/Concepts/monitoringoverview.htm#limits\fP>\&.
.sp
This call is subject to a Monitoring limit that applies to the total number of requests across all alarm operations. Monitoring might throttle this call to reject an otherwise valid request when the total rate of alarm operations exceeds 10 requests, or transactions, per second (TPS) for a given tenancy.
...
.ft C
    ...
    oci monitoring alarm\-suppression get \-\-alarm\-suppression\-id $alarm_suppression_id
.ft P
.fi
.UNINDENT
.UNINDENT
.SS \fBsummarize\-alarm\-suppression\-history\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.SS Description
.sp
Returns history of suppressions for the specified alarm, including both dimension\-specific and and alarm\-wide suppressions. For more information, see \fI\%Getting Suppression History for an Alarm\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Monitoring/Tasks/summarize-alarm-suppression-history.htm\fP>\&.
.sp
For important limits information, see \fI\%Limits on Monitoring\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Monitoring/Concepts/monitoringoverview.htm#limits\fP>\&.
.sp
This call is subject to a Monitoring limit that applies to the total number of requests across all alarm operations. Monitoring might throttle this call to reject an otherwise valid request when the total rate of alarm operations exceeds 10 requests, or transactions, per second (TPS) for a given tenancy.
...
.nf
.ft C
oci monitoring alarm\-suppression summarize\-alarm\-suppression\-history [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-time\-suppress\-from\-greater\-than\-or\-equal\-to [datetime]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-time\-suppress\-from\-less\-than [datetime]
.UNINDENT
.sp
...
.ft C
    ...
    oci monitoring alarm\-suppression summarize\-alarm\-suppression\-history \-\-alarm\-id $alarm_id
.ft P
.fi
.UNINDENT
.UNINDENT
