...
.
.TH "DATA-INTEGRATION_IMPORT-REQUEST_CREATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-integration_import-request_create \- 
.
...
.INDENT 0.0
.TP
.B \-\-are\-data\-asset\-references\-included [boolean]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-import\-conflict\-resolution [complex type]
.UNINDENT
.sp
...
.ft C
    ...
    export bucket_name=<substitute\-value\-of\-bucket_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/import\-request/create.html#cmdoption\-bucket\-name
    export file_name=<substitute\-value\-of\-file_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/import\-request/create.html#cmdoption\-file\-name
    ...
    oci data\-integration import\-request create \-\-bucket\-name $bucket_name \-\-file\-name $file_name \-\-workspace\-id $workspace_id
.ft P
.fi
.UNINDENT
.UNINDENT
