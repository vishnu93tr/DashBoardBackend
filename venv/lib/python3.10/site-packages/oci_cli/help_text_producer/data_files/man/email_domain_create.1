...
.
.TH "EMAIL_DOMAIN_CREATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
email_domain_create \- 
.
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the compartment for this email domain.
.INDENT 0.0
.TP
.B \-\-name [text]
.UNINDENT
.sp
The name of the email domain in the Internet Domain Name System (DNS). The email domain name must be unique in the region for this tenancy. Domain names limited to ASCII characters use alphanumeric, dash (“\-“), and dot (“.”) characters. The dash and dot are only allowed between alphanumeric characters. For details, see \fI\%RFC 5321, section 4.1.2\fP <\fBhttps://tools.ietf.org/html/rfc5321#section-4.1.2\fP> Non\-ASCII domain names should adopt IDNA2008 normalization (RFC 5891\-5892).
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/email/domain/create.html#cmdoption\-compartment\-id
    export name=<substitute\-value\-of\-name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/email/domain/create.html#cmdoption\-name

    oci email domain create \-\-compartment\-id $compartment_id \-\-name $name
.ft P
.fi
.UNINDENT
.UNINDENT
