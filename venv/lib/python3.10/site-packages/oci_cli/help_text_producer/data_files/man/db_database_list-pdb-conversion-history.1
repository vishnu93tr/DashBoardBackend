...
.
.TH "DB_DATABASE_LIST-PDB-CONVERSION-HISTORY" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_database_list-pdb-conversion-history \- 
.
...
.nf
.ft C
oci db database list\-pdb\-conversion\-history [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
CONVERT, PRECHECK, SYNC, SYNC_ROLLBACK
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The field to sort by. You can provide one sort order (\fIsortOrder\fP). The default order for \fITIMECREATED\fP is ascending.
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
...
.ft C
    ...
    oci db database list\-pdb\-conversion\-history \-\-database\-id $database_id
.ft P
.fi
.UNINDENT
.UNINDENT
