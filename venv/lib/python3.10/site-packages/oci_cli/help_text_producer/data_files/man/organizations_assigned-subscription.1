...
.
.TH "ORGANIZATIONS_ASSIGNED-SUBSCRIPTION" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
organizations_assigned-subscription \- 
.
...
.nf
.ft C
oci organizations assigned\-subscription get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-assigned\-subscription\-id [text]
.UNINDENT
.sp
...
.nf
.ft C
    export assigned_subscription_id=<substitute\-value\-of\-assigned_subscription_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/organizations/assigned\-subscription/get.html#cmdoption\-assigned\-subscription\-id

    oci organizations assigned\-subscription get \-\-assigned\-subscription\-id $assigned_subscription_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci organizations assigned\-subscription list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/organizations/assigned\-subscription/list.html#cmdoption\-compartment\-id

    oci organizations assigned\-subscription list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
