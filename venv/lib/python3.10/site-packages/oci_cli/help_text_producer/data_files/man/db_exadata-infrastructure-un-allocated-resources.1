...
.
.TH "DB_EXADATA-INFRASTRUCTURE-UN-ALLOCATED-RESOURCES" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_exadata-infrastructure-un-allocated-resources \- 
.
...
.SH DESCRIPTION
.sp
Un allocated resources details of the Exadata \fI\%Cloud@Customer\fP <\fBCloud@Customer\fP> infrastructure. Applies to Exadata \fI\%Cloud@Customer\fP <\fBCloud@Customer\fP> instances only.
...
.SS Description
.sp
Gets un allocated resources information for the specified Exadata infrastructure. Applies to Exadata \fI\%Cloud@Customer\fP <\fBCloud@Customer\fP> instances only.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci db exadata\-infrastructure\-un\-allocated\-resources get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci db exadata\-infrastructure\-un\-allocated\-resources get \-\-exadata\-infrastructure\-id $exadata_infrastructure_id
.ft P
.fi
.UNINDENT
.UNINDENT
