...
.
.TH "STACK-MONITORING_CONFIG_UPDATE-LICENSE-ENTERPRISE-EXTENSIBILITY-CONFIG" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
stack-monitoring_config_update-license-enterprise-extensibility-config \- 
.
...
.nf
.ft C
oci stack\-monitoring config update\-license\-enterprise\-extensibility\-config [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci stack\-monitoring config update\-license\-enterprise\-extensibility\-config \-\-config\-id $config_id
.ft P
.fi
.UNINDENT
.UNINDENT
