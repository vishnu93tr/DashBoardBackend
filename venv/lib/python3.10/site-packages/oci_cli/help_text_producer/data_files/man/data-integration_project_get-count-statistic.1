...
.
.TH "DATA-INTEGRATION_PROJECT_GET-COUNT-STATISTIC" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-integration_project_get-count-statistic \- 
.
...
.nf
.ft C
oci data\-integration project get\-count\-statistic [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export count_statistic_key=<substitute\-value\-of\-count_statistic_key> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/project/get\-count\-statistic.html#cmdoption\-count\-statistic\-key
    ...
    oci data\-integration project get\-count\-statistic \-\-count\-statistic\-key $count_statistic_key \-\-workspace\-id $workspace_id
.ft P
.fi
.UNINDENT
.UNINDENT
