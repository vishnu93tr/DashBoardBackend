...
.
.TH "DEVOPS_BUILD-RUN_CREATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
devops_build-run_create \- 
.
...
.nf
.ft C
oci devops build\-run create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-build\-run\-arguments [complex type]
.UNINDENT
.sp
...
.ft C
    ...
    oci devops build\-run create \-\-build\-pipeline\-id $build_pipeline_id
.ft P
.fi
.UNINDENT
.UNINDENT
