...
.
.TH "DATA-LABELING-SERVICE-DATAPLANE_ANNOTATION_UPDATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-labeling-service-dataplane_annotation_update \- 
.
...
.INDENT 0.0
.TP
.B \-\-entities [complex type]
.UNINDENT
.sp
The entity types are validated against the dataset to ensure consistency.
.sp
This option is a JSON list with items of type Entity.  For documentation on Entity please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/datalabeling/20211001/datatypes/Entity\fP\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
