...
.
.TH "OPSI_HOST-INSIGHTS_DELETE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
opsi_host-insights_delete \- 
.
...
.nf
.ft C
oci opsi host\-insights delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export host_insight_id=<substitute\-value\-of\-host_insight_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/opsi/host\-insights/delete.html#cmdoption\-host\-insight\-id

    oci opsi host\-insights delete \-\-host\-insight\-id $host_insight_id
.ft P
.fi
.UNINDENT
.UNINDENT
