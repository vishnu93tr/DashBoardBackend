...
.
.TH "DB_DB-HOME" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_db-home \- 
.
...
.SS Description
.sp
Deletes a Database Home. Applies to bare metal DB systems, Exadata Cloud Service, and Exadata \fI\%Cloud@Customer\fP <\fBCloud@Customer\fP> systems.
.sp
Oracle recommends that you use the \fIperformFinalBackup\fP parameter to back up any data on a bare metal DB system before you delete a Database Home. On an Exadata \fI\%Cloud@Customer\fP <\fBCloud@Customer\fP> system or an Exadata Cloud Service system, you can delete a Database Home only when there are no databases in it and therefore you cannot use the \fIperformFinalBackup\fP parameter to back up data.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
...
.INDENT 0.0
.TP
.B \-\-perform\-final\-backup [boolean]
.UNINDENT
.sp
...
.ft C
    ...
    oci db db\-home delete \-\-db\-home\-id $db_home_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci db db\-home get \-\-db\-home\-id $db_home_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/db/db\-home/list.html#cmdoption\-compartment\-id
...
.ft C
    ...
    oci db db\-home update \-\-db\-home\-id $db_home_id
.ft P
.fi
.UNINDENT
.UNINDENT
