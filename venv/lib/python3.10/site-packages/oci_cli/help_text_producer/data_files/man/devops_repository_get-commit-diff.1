...
.
.TH "DEVOPS_REPOSITORY_GET-COMMIT-DIFF" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
devops_repository_get-commit-diff \- 
.
...
.nf
.ft C
oci devops repository get\-commit\-diff [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export target_version=<substitute\-value\-of\-target_version> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/devops/repository/get\-commit\-diff.html#cmdoption\-target\-version
    ...
    oci devops repository get\-commit\-diff \-\-repository\-id $repository_id \-\-target\-version $target_version
.ft P
.fi
.UNINDENT
.UNINDENT
