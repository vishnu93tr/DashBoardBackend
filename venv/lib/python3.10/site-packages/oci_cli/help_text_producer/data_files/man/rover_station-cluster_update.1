...
.
.TH "ROVER_STATION-CLUSTER_UPDATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
rover_station-cluster_update \- 
.
...
.nf
.ft C
oci rover station\-cluster update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export cluster_id=<substitute\-value\-of\-cluster_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/rover/station\-cluster/update.html#cmdoption\-cluster\-id

    oci rover station\-cluster update \-\-cluster\-id $cluster_id
.ft P
.fi
.UNINDENT
.UNINDENT
