...
.
.TH "DATABASE-MIGRATION_MIGRATION_ADD-MYSQL-OBJECTS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
database-migration_migration_add-mysql-objects \- 
.
...
.nf
.ft C
oci database\-migration migration add\-mysql\-objects [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci database\-migration migration add\-mysql\-objects \-\-generate\-param\-json\-input items > items.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export migration_id=<substitute\-value\-of\-migration_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/database\-migration/migration/add\-mysql\-objects.html#cmdoption\-migration\-id

    oci database\-migration migration add\-mysql\-objects \-\-items file://items.json \-\-migration\-id $migration_id
.ft P
.fi
.UNINDENT
.UNINDENT
