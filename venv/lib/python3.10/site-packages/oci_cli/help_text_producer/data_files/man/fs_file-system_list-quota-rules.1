...
.
.TH "FS_FILE-SYSTEM_LIST-QUOTA-RULES" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
fs_file-system_list-quota-rules \- 
.
...
.INDENT 0.0
.TP
.B \-\-are\-violators\-only [boolean]
.UNINDENT
.sp
An option to display only the users or groups that violate their quota rules. If \fIareViolatorsOnly\fP is false, results report all the quota and usage. If \fIareViolatorsOnly\fP is true, results only report the quota and usage for the users or groups that violate their quota rules.
.INDENT 0.0
.TP
.B \-\-from\-json [text]
.UNINDENT
