...
.
.TH "DB_AUTONOMOUS-CONTAINER-DATABASE_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_autonomous-container-database_list \- 
.
...
.nf
.ft C
oci db autonomous\-container\-database list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The cloud Autonomous VM Cluster \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP>\&.
.INDENT 0.0
.TP
.B \-\-display\-name [text]
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/db/autonomous\-container\-database/list.html#cmdoption\-compartment\-id

    oci db autonomous\-container\-database list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
