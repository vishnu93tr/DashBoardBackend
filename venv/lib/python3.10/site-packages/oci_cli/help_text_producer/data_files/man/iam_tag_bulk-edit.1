...
.
.TH "IAM_TAG_BULK-EDIT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
iam_tag_bulk-edit \- 
.
...
.UNINDENT
.sp
See \fI\%BulkEditOperationDetails\fP <\fBhttps://docs.cloud.oracle.com/api/#/en/identity/latest/datatypes/BulkEditOperationDetails\fP> for more information.
.sp
The edits can include a combination of operations and tag sets. However, multiple operations cannot apply to one key definition in the same request. For example, if one request adds \fItag set\-1\fP to a resource and sets a tag value to \fItag set\-2\fP, \fItag set\-1\fP and \fItag set\-2\fP cannot have any common tag definitions.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
