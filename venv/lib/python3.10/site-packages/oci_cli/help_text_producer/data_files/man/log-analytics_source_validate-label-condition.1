...
.
.TH "LOG-ANALYTICS_SOURCE_VALIDATE-LABEL-CONDITION" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
log-analytics_source_validate-label-condition \- 
.
...
.nf
.ft C
oci log\-analytics source validate\-label\-condition [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-condition\-block [complex type]
.UNINDENT
.sp
...
.nf
.ft C
    export namespace_name=<substitute\-value\-of\-namespace_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/log\-analytics/source/validate\-label\-condition.html#cmdoption\-namespace\-name

    oci log\-analytics source validate\-label\-condition \-\-namespace\-name $namespace_name
.ft P
.fi
.UNINDENT
.UNINDENT
