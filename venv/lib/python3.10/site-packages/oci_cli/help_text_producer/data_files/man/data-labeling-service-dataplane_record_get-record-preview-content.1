...
.
.TH "DATA-LABELING-SERVICE-DATAPLANE_RECORD_GET-RECORD-PREVIEW-CONTENT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-labeling-service-dataplane_record_get-record-preview-content \- 
.
...
.UNINDENT
.sp
For optimistic concurrency control. In the GET call for a resource, set the \fIif\-none\-match\fP parameter to the value of the etag from a previous GET or POST response for that resource. The resource will be fetched only if the etag you provide does not match the resource’s current etag value.
