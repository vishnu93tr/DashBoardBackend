...
.
.TH "DB_CLOUD-EXA-INFRA_DELETE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_cloud-exa-infra_delete \- 
.
...
.nf
.ft C
oci db cloud\-exa\-infra delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-is\-delete\-vm\-clusters [boolean]
.UNINDENT
.sp
If \fItrue\fP, forces the deletion the specified cloud Exadata infrastructure resource as well as all associated VM clusters. If \fIfalse\fP, the cloud Exadata infrastructure resource can be deleted only if it has no associated VM clusters. Default value is \fIfalse\fP\&.
.INDENT 0.0
.TP
...
.ft C
    ...
    oci db cloud\-exa\-infra delete \-\-cloud\-exa\-infra\-id $cloud_exa_infra_id
.ft P
.fi
.UNINDENT
.UNINDENT
