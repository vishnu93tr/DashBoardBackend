...
.
.TH "QUEUE_MESSAGES_UPDATE-MESSAGES" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
queue_messages_update-messages \- 
.
...
.SH DESCRIPTION
.sp
Updates multiple messages in the queue or the consumer group. Only messages from the same queue/consumer group can be updated at once. You must use the \fI\%messages endpoint\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/queue/messages.htm#messages__messages-endpoint\fP> to update messages. The messages endpoint may be different for different queues. Use 
.nf
\(ga\(ga
.fi
...
.nf
.ft C
oci queue messages update\-messages [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci queue messages update\-messages \-\-generate\-param\-json\-input entries > entries.json
.ft P
.fi
.UNINDENT
.UNINDENT
