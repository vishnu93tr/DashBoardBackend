...
.
.TH "DEVOPS_REPOSITORY_GET-REPOSITORY-NOTIFICATION-PREFERENCE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
devops_repository_get-repository-notification-preference \- 
.
...
.nf
.ft C
oci devops repository get\-repository\-notification\-preference [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export principal_id=<substitute\-value\-of\-principal_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/devops/repository/get\-repository\-notification\-preference.html#cmdoption\-principal\-id
    ...
    oci devops repository get\-repository\-notification\-preference \-\-principal\-id $principal_id \-\-repository\-id $repository_id
.ft P
.fi
.UNINDENT
.UNINDENT
