...
.
.TH "DATABASE-MANAGEMENT_EXTERNAL-DB-SYSTEM-CONNECTOR_CREATE-MACS-CONNECTOR" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
database-management_external-db-system-connector_create-macs-connector \- 
.
...
.nf
.ft C
oci database\-management external\-db\-system\-connector create\-macs\-connector [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the management agent used for the external DB system connector.
.INDENT 0.0
.TP
...
.ft C
    ...
    export agent_id=<substitute\-value\-of\-agent_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/database\-management/external\-db\-system\-connector/create\-macs\-connector.html#cmdoption\-agent\-id
    ...
    oci database\-management external\-db\-system\-connector create\-macs\-connector \-\-agent\-id $agent_id \-\-external\-db\-system\-id $external_db_system_id
.ft P
.fi
.UNINDENT
.UNINDENT
