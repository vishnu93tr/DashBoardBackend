...
.
.TH "NETWORK_NSG_CREATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network_nsg_create \- 
.
...
.nf
.ft C
oci network nsg create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the compartment to contain the network security group.
.INDENT 0.0
.TP
.B \-\-vcn\-id [text]
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the VCN to create the network security group in.
...
.ft C
    ...
    oci network nsg create \-\-compartment\-id $compartment_id \-\-vcn\-id $vcn_id
.ft P
.fi
.UNINDENT
.UNINDENT
