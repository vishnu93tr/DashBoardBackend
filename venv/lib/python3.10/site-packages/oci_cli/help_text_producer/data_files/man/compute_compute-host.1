...
.
.TH "COMPUTE_COMPUTE-HOST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
compute_compute-host \- 
.
...
.SS Description
.sp
Moves a compute host into a different compartment. For information about moving resources between compartments, see \fI\%Moving Resources to a Different Compartment\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Identity/Tasks/managingcompartments.htm#moveRes\fP>\&.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci compute compute\-host change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the compartment to move the compute host to.
.INDENT 0.0
.TP
.B \-\-compute\-host\-id [text]
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the compute host.
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/compute/compute\-host/change\-compartment.html#cmdoption\-compartment\-id
    export compute_host_id=<substitute\-value\-of\-compute_host_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/compute/compute\-host/change\-compartment.html#cmdoption\-compute\-host\-id

    oci compute compute\-host change\-compartment \-\-compartment\-id $compartment_id \-\-compute\-host\-id $compute_host_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci compute compute\-host get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compute_host_id=<substitute\-value\-of\-compute_host_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/compute/compute\-host/get.html#cmdoption\-compute\-host\-id

    oci compute compute\-host get \-\-compute\-host\-id $compute_host_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci compute compute\-host list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-network\-resource\-id [text]
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the compute host network resoruce. \- Customer\-unique HPC island ID \- Customer\-unique network block ID \- Customer\-unique local block ID
.INDENT 0.0
.TP
.B \-\-page [text]
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/compute/compute\-host/list.html#cmdoption\-compartment\-id

    oci compute compute\-host list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci compute compute\-host update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compute_host_id=<substitute\-value\-of\-compute_host_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/compute/compute\-host/update.html#cmdoption\-compute\-host\-id

    oci compute compute\-host update \-\-compute\-host\-id $compute_host_id
.ft P
.fi
.UNINDENT
.UNINDENT
