...
.
.TH "DEVOPS_PULL-REQUEST_GET-PULL-REQUEST-NOTIFICATION-PREFERENCE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
devops_pull-request_get-pull-request-notification-preference \- 
.
...
.nf
.ft C
oci devops pull\-request get\-pull\-request\-notification\-preference [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export principal_id=<substitute\-value\-of\-principal_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/devops/pull\-request/get\-pull\-request\-notification\-preference.html#cmdoption\-principal\-id
    ...
    oci devops pull\-request get\-pull\-request\-notification\-preference \-\-principal\-id $principal_id \-\-pull\-request\-id $pull_request_id
.ft P
.fi
.UNINDENT
.UNINDENT
