...
.
.TH "DB_CONSOLE-HISTORY_UPDATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_console-history_update \- 
.
...
.nf
.ft C
oci db console\-history update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
DELETED, DELETING, FAILED, GETTING_HISTORY, REQUESTED, SUCCEEDED
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci db console\-history update \-\-console\-history\-id $console_history_id \-\-db\-node\-id $db_node_id
.ft P
.fi
.UNINDENT
.UNINDENT
