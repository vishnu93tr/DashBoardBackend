...
.
.TH "IAM_DOMAIN_CHANGE-DOMAIN-LICENSE-TYPE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
iam_domain_change-domain-license-type \- 
.
...
.SH DESCRIPTION
.sp
(For tenancies that support identity domains) Changes the license type of the given identity domain. The identity domain’s \fIlifecycleState\fP must be set to ACTIVE and the requested \fIlicenseType\fP must be allowed. To retrieve the allowed \fIlicenseType\fP for the identity domain, use \fI\%ListAllowedDomainLicenseTypes\fP <\fBhttps://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/iam/domain/list-license-types.html\fP>\&.
.sp
After you send your request, the \fIlifecycleDetails\fP of this identity domain is set to UPDATING. When the update of the identity domain completes, then the \fIlifecycleDetails\fP is set to null.
.sp
...
.nf
.ft C
oci iam domain change\-domain\-license\-type [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci iam domain change\-domain\-license\-type \-\-domain\-id $domain_id
.ft P
.fi
.UNINDENT
.UNINDENT
