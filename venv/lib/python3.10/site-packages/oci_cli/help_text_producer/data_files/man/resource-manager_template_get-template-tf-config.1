...
.
.TH "RESOURCE-MANAGER_TEMPLATE_GET-TEMPLATE-TF-CONFIG" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
resource-manager_template_get-template-tf-config \- 
.
...
.nf
.ft C
oci resource\-manager template get\-template\-tf\-config [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export file=<substitute\-value\-of\-file> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/resource\-manager/template/get\-template\-tf\-config.html#cmdoption\-file
    ...
    oci resource\-manager template get\-template\-tf\-config \-\-file $file \-\-template\-id $template_id
.ft P
.fi
.UNINDENT
.UNINDENT
