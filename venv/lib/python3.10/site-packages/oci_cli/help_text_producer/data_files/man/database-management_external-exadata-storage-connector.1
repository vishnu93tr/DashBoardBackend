...
.
.TH "DATABASE-MANAGEMENT_EXTERNAL-EXADATA-STORAGE-CONNECTOR" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
database-management_external-exadata-storage-connector \- 
.
...
.nf
.ft C
oci database\-management external\-exadata\-storage\-connector create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the agent for the Exadata storage server.
.INDENT 0.0
.TP
.B \-\-connection\-uri [text]
.UNINDENT
.sp
The unique string of the connection. For example, “\fI\%https:/\fP/<storage\-server\-name>/MS/RESTService/”.
.INDENT 0.0
.TP
.B \-\-connector\-name [text]
.UNINDENT
.sp
The name of the Exadata storage server connector.
.INDENT 0.0
.TP
.B \-\-credential\-info [complex type]
.UNINDENT
.sp
...
.ft C
    ...
    oci database\-management external\-exadata\-storage\-connector create \-\-agent\-id $agent_id \-\-connection\-uri $connection_uri \-\-connector\-name $connector_name \-\-credential\-info file://credential\-info.json \-\-storage\-server\-id $storage_server_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci database\-management external\-exadata\-storage\-connector delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci database\-management external\-exadata\-storage\-connector delete \-\-external\-exadata\-storage\-connector\-id $external_exadata_storage_connector_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci database\-management external\-exadata\-storage\-connector get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci database\-management external\-exadata\-storage\-connector get \-\-external\-exadata\-storage\-connector\-id $external_exadata_storage_connector_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci database\-management external\-exadata\-storage\-connector list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci database\-management external\-exadata\-storage\-connector list \-\-compartment\-id $compartment_id \-\-external\-exadata\-infrastructure\-id $external_exadata_infrastructure_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci database\-management external\-exadata\-storage\-connector update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci database\-management external\-exadata\-storage\-connector update \-\-external\-exadata\-storage\-connector\-id $external_exadata_storage_connector_id
.ft P
.fi
.UNINDENT
.UNINDENT
