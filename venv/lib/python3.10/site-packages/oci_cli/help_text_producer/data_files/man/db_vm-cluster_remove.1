...
.
.TH "DB_VM-CLUSTER_REMOVE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_vm-cluster_remove \- 
.
...
.SH DESCRIPTION
.sp
Remove Virtual Machines from the VM cluster. Applies to Exadata \fI\%Cloud@Customer\fP <\fBCloud@Customer\fP> instances only.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci db vm\-cluster remove [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci db vm\-cluster remove \-\-generate\-param\-json\-input db\-servers > db\-servers.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci db vm\-cluster remove \-\-db\-servers file://db\-servers.json \-\-vm\-cluster\-id $vm_cluster_id
.ft P
.fi
.UNINDENT
.UNINDENT
