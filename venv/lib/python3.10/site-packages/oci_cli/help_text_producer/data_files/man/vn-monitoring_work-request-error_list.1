...
.
.TH "VN-MONITORING_WORK-REQUEST-ERROR_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
vn-monitoring_work-request-error_list \- 
.
...
.nf
.ft C
oci vn\-monitoring work\-request\-error list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The field to sort by. Only one sort order may be provided. The default order for \fItimeCreated\fP is descending.
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
...
.nf
.ft C
    export work_request_id=<substitute\-value\-of\-work_request_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/vn\-monitoring/work\-request\-error/list.html#cmdoption\-work\-request\-id

    oci vn\-monitoring work\-request\-error list \-\-work\-request\-id $work_request_id
.ft P
.fi
.UNINDENT
.UNINDENT
