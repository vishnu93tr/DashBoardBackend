...
.
.TH "KMS_MANAGEMENT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
kms_management \- 
.
...
.nf
.ft C
oci kms management key backup [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci kms management key backup \-\-key\-id $key_id
.ft P
.fi
.UNINDENT
.UNINDENT
.SS \fBcancel\-deletion\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.nf
.ft C
oci kms management key cancel\-deletion [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci kms management key cancel\-deletion \-\-key\-id $key_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.SS Description
.sp
Moves a key into a different compartment within the same tenancy. For information about moving resources between compartments, see \fI\%Moving Resources to a Different Compartment\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Identity/Tasks/managingcompartments.htm#moveRes\fP>\&.
.sp
...
.nf
.ft C
oci kms management key change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the compartment that you want to move the key to.
.INDENT 0.0
.TP
.B \-\-key\-id [text]
.UNINDENT
...
.ft C
    ...
    oci kms management key change\-compartment \-\-compartment\-id $compartment_id \-\-key\-id $key_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-auto\-key\-rotation\-details [complex type]
.UNINDENT
.sp
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
...
.INDENT 0.0
.TP
.B \-\-external\-key\-reference [complex type]
.UNINDENT
.sp
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
...
.INDENT 0.0
.TP
.B \-\-is\-auto\-rotation\-enabled [boolean]
.UNINDENT
.sp
...
.UNINDENT
.sp
The key’s protection mode indicates how the key persists and where cryptographic operations that use the key are performed. A protection mode of \fIHSM\fP means that the key persists on a hardware security module (HSM) and all cryptographic operations are performed inside the HSM. A protection mode of \fISOFTWARE\fP means that the key persists on the server, protected by the vault’s RSA wrapping key which persists on the HSM. All cryptographic operations that use a key with a protection mode of \fISOFTWARE\fP are performed on the server. By default, a key’s protection mode is set to \fIHSM\fP\&. You can’t change a key’s protection mode after the key is created or imported. A protection mode of \fIEXTERNAL\fP mean that the key persists on the customer’s external key manager which is hosted externally outside of oracle. Oracle only hold a reference to that key. All cryptographic operations that use a key with a protection mode of \fIEXTERNAL\fP are performed by external key manager.
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
...
.ft C
    ...
    oci kms management key disable \-\-key\-id $key_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci kms management key enable \-\-key\-id $key_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-wrapped\-import\-key [complex type]
.UNINDENT
.sp
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
...
.UNINDENT
.sp
The key’s protection mode indicates how the key persists and where cryptographic operations that use the key are performed. A protection mode of \fIHSM\fP means that the key persists on a hardware security module (HSM) and all cryptographic operations are performed inside the HSM. A protection mode of \fISOFTWARE\fP means that the key persists on the server, protected by the vault’s RSA wrapping key which persists on the HSM. All cryptographic operations that use a key with a protection mode of \fISOFTWARE\fP are performed on the server. By default, a key’s protection mode is set to \fIHSM\fP\&. You can’t change a key’s protection mode after the key is created or imported.
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
...
.UNINDENT
.sp
A key’s protection mode indicates how the key persists and where cryptographic operations that use the key are performed. A protection mode of \fIHSM\fP means that the key persists on a hardware security module (HSM) and all cryptographic operations are performed inside the HSM. A protection mode of \fISOFTWARE\fP means that the key persists on the server, protected by the vault’s RSA wrapping key which persists on the HSM. All cryptographic operations that use a key with a protection mode of \fISOFTWARE\fP are performed on the server. A protection mode of \fIEXTERNAL\fP mean that the key persists on the customer’s external key manager which is hosted externally outside of oracle. Oracle only hold a reference to that key. All cryptographic operations that use a key with a protection mode of \fIEXTERNAL\fP are performed by external key manager.
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
...
.UNINDENT
.sp
The field to sort by. You can specify only one sort order. The default order for \fITIMECREATED\fP is descending. The default order for \fIDISPLAYNAME\fP is ascending.
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
...
.nf
.ft C
oci kms management key restore [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-restore\-key\-from\-file\-location [text]
.UNINDENT
.sp
The file location of the encrypted payload to upload to restore the key.
.SS Optional Parameters
.INDENT 0.0
.TP
.B \-\-content\-length [integer]
.UNINDENT
.sp
...
.UNINDENT
.sp
The base64\-encoded MD5 hash value of the body, as described in \fI\%RFC 2616\fP <\fBhttps://tools.ietf.org/rfc/rfc2616\fP>, section 14.15. If the Content\-MD5 header is present, Key Management performs an integrity check on the body of the HTTP request by computing the MD5 hash for the body and comparing it to the MD5 hash supplied in the header. If the two hashes don’t match, the object is rejected and a response with 400 Unmatched Content MD5 error is returned, along with the message: “The computed MD5 of the request body (ACTUAL_MD5) does not match the Content\-MD5 header (HEADER_MD5).”
.INDENT 0.0
.TP
.B \-\-from\-json [text]
.UNINDENT
...
.SS Description
.sp
Schedules the deletion of the specified key. This sets the lifecycle state of the key to \fIPENDING_DELETION\fP and then deletes it after the specified retention period ends.
.sp
As a provisioning operation, this call is subject to a Key Management limit that applies to the total number of requests across all provisioning write operations. Key Management might throttle this call to reject an otherwise valid request when the total rate of provisioning write operations exceeds 10 requests per second for a given tenancy.
.sp
The top level –endpoint parameter must be supplied for this operation.
...
.UNINDENT
.sp
An optional property to indicate when to delete the vault, expressed in \fI\%RFC 3339\fP <\fBhttps://tools.ietf.org/html/rfc3339\fP> timestamp format. The specified time must be between 7 and 30 days from when the request is received. If this property is missing, it will be set to 30 days from the time of the request by default.
.INDENT 0.0
.INDENT 3.5
...
.ft C
    ...
    oci kms management key schedule\-deletion \-\-key\-id $key_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.SS Description
.sp
Updates the properties of a master encryption key. Specifically, you can update the \fIdisplayName\fP, \fIfreeformTags\fP, and \fIdefinedTags\fP properties. Furthermore, the key must be in an \fIENABLED\fP or \fICREATING\fP state to be updated.
.sp
As a management operation, this call is subject to a Key Management limit that applies to the total number of requests across all management write operations. Key Management might throttle this call to reject an otherwise valid request when the total rate of management write operations exceeds 10 requests per second for a given tenancy.
.sp
The top level –endpoint parameter must be supplied for this operation.
...
.ft C
    ...
    oci kms management key update \-\-key\-id $key_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci kms management key\-version cancel\-deletion [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
CANCELLING_DELETION, CREATING, DELETED, DELETING, DISABLED, DISABLING, ENABLED, ENABLING, PENDING_DELETION, SCHEDULING_DELETION
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci kms management key\-version cancel\-deletion \-\-key\-id $key_id \-\-key\-version\-id $key_version_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.SS Description
.sp
Generates a new \fI\%KeyVersion\fP <\fBhttps://docs.cloud.oracle.com/api/#/en/key/latest/KeyVersion/\fP> resource that provides new cryptographic material for a master encryption key. The key must be in an \fIENABLED\fP state to be rotated.
.sp
As a management operation, this call is subject to a Key Management limit that applies to the total number of requests across all  management write operations. Key Management might throttle this call to reject an otherwise valid request when the total rate of management write operations exceeds 10 requests per second for a given tenancy.
.sp
The top level –endpoint parameter must be supplied for this operation.
...
.INDENT 0.0
.TP
.B \-\-external\-key\-version\-id [text]
.UNINDENT
.sp
...
.nf
.ft C
oci kms management key\-version import [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci kms management key\-version import \-\-generate\-param\-json\-input wrapped\-import\-key > wrapped\-import\-key.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci kms management key\-version import \-\-key\-id $key_id \-\-wrapped\-import\-key file://wrapped\-import\-key.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.SS Description
.sp
Lists all \fI\%KeyVersion\fP <\fBhttps://docs.cloud.oracle.com/api/#/en/key/latest/KeyVersion/\fP> resources for the specified master encryption key.
.sp
As a management operation, this call is subject to a Key Management limit that applies to the total number of requests across all management read operations. Key Management might throttle this call to reject an otherwise valid request when the total rate of management read operations exceeds 10 requests per second for a given tenancy.
.sp
The top level –endpoint parameter must be supplied for this operation.
...
.ft C
    ...
    oci kms management key\-version list \-\-key\-id $key_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.SS Description
.sp
Schedules the deletion of the specified key version. This sets the lifecycle state of the key version to \fIPENDING_DELETION\fP and then deletes it after the specified retention period ends.
.sp
As a provisioning operation, this call is subject to a Key Management limit that applies to the total number of requests across all provisioning write operations. Key Management might throttle this call to reject an otherwise valid request when the total rate of provisioning write operations exceeds 10 requests per second for a given tenancy.
.sp
The top level –endpoint parameter must be supplied for this operation.
...
.nf
.ft C
oci kms management key\-version schedule\-deletion [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
An optional property to indicate when to delete the key version, expressed in \fI\%RFC 3339\fP <\fBhttps://tools.ietf.org/html/rfc3339\fP> timestamp format. The specified time must be between 7 and 30 days from the time when the request is received. If this property is missing, it will be set to 30 days from the time of the request by default.
.INDENT 0.0
.INDENT 3.5
The following datetime formats are supported:
.UNINDENT
...
.ft C
    ...
    oci kms management key\-version schedule\-deletion \-\-key\-id $key_id \-\-key\-version\-id $key_version_id
.ft P
.fi
.UNINDENT
.UNINDENT
.SS replication\-status\-details
.SS Description
.sp
...
get\-replication\-status
.UNINDENT
.SS \fBget\-replication\-status\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.nf
.ft C
oci kms management replication\-status\-details get\-replication\-status [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export replication_id=<substitute\-value\-of\-replication_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/kms/management/replication\-status\-details/get\-replication\-status.html#cmdoption\-replication\-id

    oci kms management replication\-status\-details get\-replication\-status \-\-replication\-id $replication_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci kms management vault backup [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci kms management vault backup \-\-vault\-id $vault_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci kms management vault cancel\-deletion \-\-vault\-id $vault_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.SS Description
.sp
Moves a vault into a different compartment within the same tenancy. For information about moving resources between compartments, see \fI\%Moving Resources to a Different Compartment\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Identity/Tasks/managingcompartments.htm#moveRes\fP>\&.
.sp
...
.nf
.ft C
oci kms management vault change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the compartment to move the vault to.
.INDENT 0.0
.TP
.B \-\-vault\-id [text]
.UNINDENT
...
.ft C
    ...
    oci kms management vault change\-compartment \-\-compartment\-id $compartment_id \-\-vault\-id $vault_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
DEFAULT, EXTERNAL, VIRTUAL_PRIVATE
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-external\-key\-manager\-metadata [complex type]
.UNINDENT
.sp
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
...
.ft C
    ...
    oci kms management vault create \-\-compartment\-id $compartment_id \-\-display\-name $display_name \-\-vault\-type $vault_type
.ft P
.fi
.UNINDENT
.UNINDENT
.SS \fBcreate\-vault\-replica\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.nf
.ft C
oci kms management vault create\-vault\-replica [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-replica\-vault\-metadata [complex type]
.UNINDENT
.sp
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
...
.ft C
    ...
    export display_name=<substitute\-value\-of\-display_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/kms/management/vault/create.html#cmdoption\-display\-name
    export vault_type=<substitute\-value\-of\-vault_type> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/kms/management/vault/create.html#cmdoption\-vault\-type
    export replica_region=<substitute\-value\-of\-replica_region> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/kms/management/vault/create\-vault\-replica.html#cmdoption\-replica\-region

    vault_id=$(oci kms management vault create \-\-compartment\-id $compartment_id \-\-display\-name $display_name \-\-vault\-type $vault_type \-\-query data.id \-\-raw\-output)

    oci kms management vault create\-vault\-replica \-\-replica\-region $replica_region \-\-vault\-id $vault_id
.ft P
.fi
.UNINDENT
.UNINDENT
.SS \fBdelete\-vault\-replica\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.ft C
    ...
    export display_name=<substitute\-value\-of\-display_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/kms/management/vault/create.html#cmdoption\-display\-name
    export vault_type=<substitute\-value\-of\-vault_type> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/kms/management/vault/create.html#cmdoption\-vault\-type
    export replica_region=<substitute\-value\-of\-replica_region> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/kms/management/vault/delete\-vault\-replica.html#cmdoption\-replica\-region

    vault_id=$(oci kms management vault create \-\-compartment\-id $compartment_id \-\-display\-name $display_name \-\-vault\-type $vault_type \-\-query data.id \-\-raw\-output)

    oci kms management vault delete\-vault\-replica \-\-replica\-region $replica_region \-\-vault\-id $vault_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/kms/management/vault/list.html#cmdoption\-compartment\-id
...
.nf
.ft C
oci kms management vault list\-vault\-replicas [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci kms management vault list\-vault\-replicas \-\-vault\-id $vault_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci kms management vault restore [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/kms/management/vault/restore.html#cmdoption\-compartment\-id
...
.nf
.ft C
oci kms management vault restore\-from\-file [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-restore\-vault\-from\-file\-location [text]
.UNINDENT
.sp
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/kms/management/vault/restore\-from\-file.html#cmdoption\-compartment\-id
    export restore_vault_from_file_location=<substitute\-value\-of\-restore_vault_from_file_location> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/kms/management/vault/restore\-from\-file.html#cmdoption\-restore\-vault\-from\-file\-location

    oci kms management vault restore\-from\-file \-\-compartment\-id $compartment_id \-\-restore\-vault\-from\-file\-location $restore_vault_from_file_location
.ft P
.fi
.UNINDENT
.UNINDENT
...
.SS Description
.sp
Updates the properties of a vault. Specifically, you can update the \fIdisplayName\fP, \fIfreeformTags\fP, and \fIdefinedTags\fP properties. Furthermore, the vault must be in an ACTIVE or CREATING state to be updated.
.sp
As a provisioning operation, this call is subject to a Key Management limit that applies to the total number of requests across all provisioning write operations. Key Management might throttle this call to reject an otherwise valid request when the total rate of provisioning write operations exceeds 10 requests per second for a given tenancy.
.SS Usage
.INDENT 0.0
...
.nf
.ft C
oci kms management vault usage get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci kms management vault usage get \-\-vault\-id $vault_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci kms management wrapping\-key get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
