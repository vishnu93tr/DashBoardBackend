...
.
.TH "DATA-SAFE_SENSITIVE-DATA-MODEL_CREATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_sensitive-data-model_create \- 
.
...
.INDENT 0.0
.TP
.B \-\-is\-app\-defined\-relation\-discovery\-enabled [boolean]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-is\-include\-all\-schemas [boolean]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-is\-sample\-data\-collection\-enabled [boolean]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-schemas\-for\-discovery [complex type]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-sensitive\-type\-group\-ids\-for\-discovery [complex type]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-sensitive\-type\-ids\-for\-discovery [complex type]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-tables\-for\-discovery [complex type]
.UNINDENT
.sp
...
.sp
This option is a JSON list with items of type TablesForDiscovery.  For documentation on TablesForDiscovery please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/datasafe/20181201/datatypes/TablesForDiscovery\fP\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
