...
.
.TH "DB_SCHEDULING-PLAN" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_scheduling-plan \- 
.
...
.nf
.ft C
oci db scheduling\-plan cascading\-delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-scheduling\-plan\-id [text]
.UNINDENT
.sp
The Schedule Plan \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP>\&.
...
.ft C
    ...
    oci db scheduling\-plan cascading\-delete \-\-scheduling\-plan\-id $scheduling_plan_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci db scheduling\-plan change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci db scheduling\-plan change\-compartment \-\-compartment\-id $compartment_id \-\-scheduling\-plan\-id $scheduling_plan_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-scheduling\-policy\-id [text]
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the Scheduling Policy.
.INDENT 0.0
.TP
.B \-\-service\-type [text]
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-is\-using\-recommended\-scheduled\-actions [boolean]
.UNINDENT
.sp
...
.nf
.ft C
oci db scheduling\-plan delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci db scheduling\-plan delete \-\-scheduling\-plan\-id $scheduling_plan_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci db scheduling\-plan get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci db scheduling\-plan get \-\-scheduling\-plan\-id $scheduling_plan_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The field to sort by. You can provide one sort order (\fIsortOrder\fP).  Default order for TIMECREATED is descending.
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
...
.UNINDENT
.UNINDENT
.SS \fBreorder\-scheduled\-actions\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.nf
.ft C
oci db scheduling\-plan reorder\-scheduled\-actions [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-scheduled\-action\-id\-orders [complex type]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-scheduling\-window\-id [text]
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the Scheduling Window.
.SS Optional Parameters
.INDENT 0.0
.TP
.B \-\-from\-json [text]
...
.ft C
    ...
    oci db scheduling\-plan reorder\-scheduled\-actions \-\-generate\-param\-json\-input scheduled\-action\-id\-orders > scheduled\-action\-id\-orders.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci db scheduling\-plan reorder\-scheduled\-actions \-\-scheduled\-action\-id\-orders file://scheduled\-action\-id\-orders.json \-\-scheduling\-plan\-id $scheduling_plan_id \-\-scheduling\-window\-id $scheduling_window_id
.ft P
.fi
.UNINDENT
.UNINDENT
