...
.
.TH "DATA-SAFE_SECURITY-POLICY-DEPLOYMENT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_security-policy-deployment \- 
.
...
.nf
.ft C
oci data\-safe security\-policy\-deployment change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-security\-policy\-deployment\-id [text]
.UNINDENT
.sp
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-safe/security\-policy\-deployment/change\-compartment.html#cmdoption\-compartment\-id
    export security_policy_deployment_id=<substitute\-value\-of\-security_policy_deployment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-safe/security\-policy\-deployment/change\-compartment.html#cmdoption\-security\-policy\-deployment\-id

    oci data\-safe security\-policy\-deployment change\-compartment \-\-compartment\-id $compartment_id \-\-security\-policy\-deployment\-id $security_policy_deployment_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci data\-safe security\-policy\-deployment get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export security_policy_deployment_id=<substitute\-value\-of\-security_policy_deployment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-safe/security\-policy\-deployment/get.html#cmdoption\-security\-policy\-deployment\-id

    oci data\-safe security\-policy\-deployment get \-\-security\-policy\-deployment\-id $security_policy_deployment_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.sp
The ListSecurityPolicyDeployments operation returns only the security policy deployments in the specified \fIcompartmentId\fP\&.
.sp
...
.nf
.ft C
oci data\-safe security\-policy\-deployment list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
CREATING, DELETED, DELETING, DEPLOYED, FAILED, NEEDS_ATTENTION, UPDATING
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-safe/security\-policy\-deployment/list.html#cmdoption\-compartment\-id

    oci data\-safe security\-policy\-deployment list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci data\-safe security\-policy\-deployment update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export security_policy_deployment_id=<substitute\-value\-of\-security_policy_deployment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-safe/security\-policy\-deployment/update.html#cmdoption\-security\-policy\-deployment\-id

    oci data\-safe security\-policy\-deployment update \-\-security\-policy\-deployment\-id $security_policy_deployment_id
.ft P
.fi
.UNINDENT
.UNINDENT
