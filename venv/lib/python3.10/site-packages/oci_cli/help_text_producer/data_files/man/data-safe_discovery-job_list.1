...
.
.TH "DATA-SAFE_DISCOVERY-JOB_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_discovery-job_list \- 
.
...
.nf
.ft C
oci data\-safe discovery\-job list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The field to sort by. You can specify only one sorting parameter (sortOrder). The default order for timeFinished is descending. The default order for displayName is ascending.
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-safe/discovery\-job/list.html#cmdoption\-compartment\-id

    oci data\-safe discovery\-job list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
