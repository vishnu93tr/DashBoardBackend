...
.
.TH "OPSI_AWR-HUBS_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
opsi_awr-hubs_list \- 
.
...
.nf
.ft C
oci opsi awr\-hubs list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export operations_insights_warehouse_id=<substitute\-value\-of\-operations_insights_warehouse_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/opsi/awr\-hubs/list.html#cmdoption\-operations\-insights\-warehouse\-id

    oci opsi awr\-hubs list \-\-operations\-insights\-warehouse\-id $operations_insights_warehouse_id
.ft P
.fi
.UNINDENT
.UNINDENT
