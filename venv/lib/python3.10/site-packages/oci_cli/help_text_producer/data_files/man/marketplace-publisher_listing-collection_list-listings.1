...
.
.TH "MARKETPLACE-PUBLISHER_LISTING-COLLECTION_LIST-LISTINGS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
marketplace-publisher_listing-collection_list-listings \- 
.
...
.nf
.ft C
oci marketplace\-publisher listing\-collection list\-listings [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/marketplace\-publisher/listing\-collection/list\-listings.html#cmdoption\-compartment\-id

    oci marketplace\-publisher listing\-collection list\-listings \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
