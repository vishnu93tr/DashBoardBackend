...
.
.TH "GOLDENGATE_CONNECTION_UPDATE-GENERIC-CONNECTION" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
goldengate_connection_update-generic-connection \- 
.
...
.nf
.ft C
oci goldengate connection update\-generic\-connection [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
Host and port separated by colon. Example: \fI“server.example.com:1234”\fP
.sp
For multiple hosts, provide a comma separated list. Example: \fI“server1.example.com:1000,server1.example.com:2000”\fP
.INDENT 0.0
.TP
.B \-\-if\-match [text]
.UNINDENT
...
.nf
.ft C
    export connection_id=<substitute\-value\-of\-connection_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/goldengate/connection/update\-generic\-connection.html#cmdoption\-connection\-id

    oci goldengate connection update\-generic\-connection \-\-connection\-id $connection_id
.ft P
.fi
.UNINDENT
.UNINDENT
