...
.
.TH "DATA-SAFE_SECURITY-ASSESSMENT_UPDATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_security-assessment_update \- 
.
...
.nf
.ft C
oci data\-safe security\-assessment update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-is\-assessment\-scheduled [boolean]
.UNINDENT
.sp
...
.UNINDENT
.sp
This is applicable only for save schedule and latest assessment. It updates the existing schedule in a specified format: <version\-string>;<version\-specific\-schedule>
.sp
...
.ft C
    ...
    oci data\-safe security\-assessment update \-\-security\-assessment\-id $security_assessment_id
.ft P
.fi
.UNINDENT
.UNINDENT
