...
.
.TH "DB_EXADATA-INFRASTRUCTURE_CONFIGURE-EXASCALE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_exadata-infrastructure_configure-exascale \- 
.
...
.SH DESCRIPTION
.sp
Configures Exascale on Exadata infrastructure resource. Applies to Exadata \fI\%Cloud@Customer\fP <\fBCloud@Customer\fP> instances only.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci db exadata\-infrastructure configure\-exascale [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-total\-storage\-in\-gbs [integer]
.UNINDENT
.sp
...
.ft C
    ...
    export total_storage_in_gbs=<substitute\-value\-of\-total_storage_in_gbs> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/db/exadata\-infrastructure/configure\-exascale.html#cmdoption\-total\-storage\-in\-gbs
    ...
    oci db exadata\-infrastructure configure\-exascale \-\-exadata\-infrastructure\-id $exadata_infrastructure_id \-\-total\-storage\-in\-gbs $total_storage_in_gbs
.ft P
.fi
.UNINDENT
.UNINDENT
