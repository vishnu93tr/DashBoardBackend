...
.
.TH "IDENTITY-DOMAINS_CLOUD-GATE-SERVERS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_cloud-gate-servers \- 
.
...
.nf
.ft C
oci identity\-domains cloud\-gate\-servers list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains cloud\-gate\-servers list
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains cloud\-gate\-servers search [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains cloud\-gate\-servers search \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains cloud\-gate\-servers search \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
