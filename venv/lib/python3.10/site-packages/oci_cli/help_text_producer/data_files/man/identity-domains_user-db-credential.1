...
.
.TH "IDENTITY-DOMAINS_USER-DB-CREDENTIAL" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_user-db-credential \- 
.
...
.nf
.ft C
oci identity\-domains user\-db\-credential create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains user\-db\-credential create \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export db_password=<substitute\-value\-of\-db_password> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/identity\-domains/user\-db\-credential/create.html#cmdoption\-db\-password

    oci identity\-domains user\-db\-credential create \-\-db\-password $db_password \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains user\-db\-credential delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    user_db_credential_id=$(oci identity\-domains user\-db\-credential create \-\-db\-password $db_password \-\-schemas file://schemas.json \-\-query data.id \-\-raw\-output)

    oci identity\-domains user\-db\-credential delete \-\-user\-db\-credential\-id $user_db_credential_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains user\-db\-credential get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains user\-db\-credential get \-\-user\-db\-credential\-id $user_db_credential_id
.ft P
.fi
.UNINDENT
.UNINDENT
