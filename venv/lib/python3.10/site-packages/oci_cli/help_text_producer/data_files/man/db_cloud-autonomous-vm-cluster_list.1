...
.
.TH "DB_CLOUD-AUTONOMOUS-VM-CLUSTER_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_cloud-autonomous-vm-cluster_list \- 
.
...
.SH DESCRIPTION
.sp
Lists Autonomous Exadata VM clusters in the Oracle cloud. For Exadata \fI\%Cloud@Customer\fP <\fBCloud@Customer\fP> systems, see \fI\%ListAutonomousVmClusters\fP <\fBhttps://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/db/autonomous-vm-cluster/list.html\fP>\&.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci db cloud\-autonomous\-vm\-cluster list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/db/cloud\-autonomous\-vm\-cluster/list.html#cmdoption\-compartment\-id

    oci db cloud\-autonomous\-vm\-cluster list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
