...
.
.TH "EMAIL_SENDER_CHANGE-COMPARTMENT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
email_sender_change-compartment \- 
.
...
.nf
.ft C
oci email sender change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the compartment into which the sender should be moved.
.INDENT 0.0
.TP
.B \-\-sender\-id [text]
.UNINDENT
...
.ft C
    ...
    oci email sender change\-compartment \-\-compartment\-id $compartment_id \-\-sender\-id $sender_id
.ft P
.fi
.UNINDENT
.UNINDENT
