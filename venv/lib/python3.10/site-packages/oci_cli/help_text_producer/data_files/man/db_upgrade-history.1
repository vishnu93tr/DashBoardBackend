...
.
.TH "DB_UPGRADE-HISTORY" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_upgrade-history \- 
.
...
.sp
For information about access control and compartments, see \fI\%Overview of the Identity Service\fP <\fBhttps://docs.cloud.oracle.com/Content/Identity/Concepts/overview.htm\fP>\&.
.sp
...
.nf
.ft C
oci db upgrade\-history get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The database upgrade History \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP>\&.
...
.ft C
    ...
    export upgrade_history_id=<substitute\-value\-of\-upgrade_history_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/db/upgrade\-history/get.html#cmdoption\-upgrade\-history\-id
    ...
    oci db upgrade\-history get \-\-database\-id $database_id \-\-upgrade\-history\-id $upgrade_history_id
.ft P
.fi
.UNINDENT
.UNINDENT
