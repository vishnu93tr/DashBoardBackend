...
.
.TH "COMPUTE-MANAGEMENT_CLUSTER-NETWORK_LIST-INSTANCES" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
compute-management_cluster-network_list-instances \- 
.
...
.SH DESCRIPTION
.sp
Lists the instances in a \fI\%cluster network with instance pools\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Compute/Tasks/managingclusternetworks.htm\fP>\&.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci compute\-management cluster\-network list\-instances [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci compute\-management cluster\-network list\-instances \-\-cluster\-network\-id $cluster_network_id \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
