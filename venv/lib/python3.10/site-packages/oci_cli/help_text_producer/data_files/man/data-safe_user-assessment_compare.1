...
.
.TH "DATA-SAFE_USER-ASSESSMENT_COMPARE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_user-assessment_compare \- 
.
...
.nf
.ft C
oci data\-safe user\-assessment compare [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export comparison_user_assessment_id=<substitute\-value\-of\-comparison_user_assessment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-safe/user\-assessment/compare.html#cmdoption\-comparison\-user\-assessment\-id
    ...
    oci data\-safe user\-assessment compare \-\-comparison\-user\-assessment\-id $comparison_user_assessment_id \-\-user\-assessment\-id $user_assessment_id
.ft P
.fi
.UNINDENT
.UNINDENT
