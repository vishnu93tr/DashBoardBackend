...
.
.TH "DATA-SAFE_AUDIT-PROFILE-ANALYTIC-COLLECTION_LIST-AUDIT-PROFILE-ANALYTICS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_audit-profile-analytic-collection_list-audit-profile-analytics \- 
.
...
.sp
The parameter \fIcompartmentIdInSubtree\fP applies when you perform AuditProfileAnalytics on the \fIcompartmentId\fP passed and when it is set to true, the entire hierarchy of compartments can be returned. To get a full list of all compartments and subcompartments in the tenancy (root compartment), set the parameter \fIcompartmentIdInSubtree\fP to true and \fIaccessLevel\fP to ACCESSIBLE.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci data\-safe audit\-profile\-analytic\-collection list\-audit\-profile\-analytics [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-safe/audit\-profile\-analytic\-collection/list\-audit\-profile\-analytics.html#cmdoption\-compartment\-id

    oci data\-safe audit\-profile\-analytic\-collection list\-audit\-profile\-analytics \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
