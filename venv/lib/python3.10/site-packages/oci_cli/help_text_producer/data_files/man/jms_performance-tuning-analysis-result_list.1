...
.
.TH "JMS_PERFORMANCE-TUNING-ANALYSIS-RESULT_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
jms_performance-tuning-analysis-result_list \- 
.
...
.nf
.ft C
oci jms performance\-tuning\-analysis\-result list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The field to sort performance tuning analysis results. Only one sort order may be provided. Default order for _timeCreated_, and _jreVersion_ is \fBdescending\fP\&. Default order for _managedInstanceId_, _jreDistribution_, _jreVendor_ and _osName_ is \fBascending\fP\&. If no value is specified _timeCreated_ is default.
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
...
.nf
.ft C
managedInstanceId, timeCreated, warningCount, workRequestId
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci jms performance\-tuning\-analysis\-result list \-\-fleet\-id $fleet_id
.ft P
.fi
.UNINDENT
.UNINDENT
