...
.
.TH "CERTS-MGMT_CERTIFICATE_UPDATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
certs-mgmt_certificate_update \- 
.
...
.nf
.ft C
oci certs\-mgmt certificate update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export certificate_id=<substitute\-value\-of\-certificate_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/certs\-mgmt/certificate/update.html#cmdoption\-certificate\-id

    oci certs\-mgmt certificate update \-\-certificate\-id $certificate_id
.ft P
.fi
.UNINDENT
.UNINDENT
