...
.
.TH "DATA-SAFE_PEER-TARGET-DATABASE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_peer-target-database \- 
.
...
.nf
.ft C
oci data\-safe peer\-target\-database create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-database\-details [complex type]
.UNINDENT
.sp
...
.ft C
    ...
    oci data\-safe peer\-target\-database create \-\-generate\-param\-json\-input database\-details > database\-details.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci data\-safe peer\-target\-database create \-\-database\-details file://database\-details.json \-\-target\-database\-id $target_database_id
.ft P
.fi
.UNINDENT
.UNINDENT
.SS \fBcreate\-peer\-target\-database\-database\-cloud\-service\-details\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.nf
.ft C
oci data\-safe peer\-target\-database delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-peer\-target\-database\-id [integer]
.UNINDENT
.sp
...
.ft C
    ...
    oci data\-safe peer\-target\-database delete \-\-peer\-target\-database\-id $peer_target_database_id \-\-target\-database\-id $target_database_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci data\-safe peer\-target\-database get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci data\-safe peer\-target\-database get \-\-peer\-target\-database\-id $peer_target_database_id \-\-target\-database\-id $target_database_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci data\-safe peer\-target\-database list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci data\-safe peer\-target\-database list \-\-target\-database\-id $target_database_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci data\-safe peer\-target\-database update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci data\-safe peer\-target\-database update \-\-peer\-target\-database\-id $peer_target_database_id \-\-target\-database\-id $target_database_id
.ft P
.fi
.UNINDENT
.UNINDENT
.SS \fBupdate\-peer\-target\-database\-database\-cloud\-service\-details\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.nf
.ft C
oci data\-safe peer\-target\-database update\-peer\-target\-database\-database\-cloud\-service\-details [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci data\-safe peer\-target\-database update\-peer\-target\-database\-database\-cloud\-service\-details \-\-database\-details\-infrastructure\-type $database_details_infrastructure_type \-\-database\-details\-service\-name $database_details_service_name \-\-peer\-target\-database\-id $peer_target_database_id \-\-target\-database\-id $target_database_id
.ft P
.fi
.UNINDENT
.UNINDENT
