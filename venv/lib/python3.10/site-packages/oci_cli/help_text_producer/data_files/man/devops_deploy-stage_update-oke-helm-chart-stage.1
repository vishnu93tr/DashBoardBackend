...
.
.TH "DEVOPS_DEPLOY-STAGE_UPDATE-OKE-HELM-CHART-STAGE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
devops_deploy-stage_update-oke-helm-chart-stage \- 
.
...
.nf
.ft C
oci devops deploy\-stage update\-oke\-helm\-chart\-stage [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-helm\-command\-artifact\-ids [complex type]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-is\-uninstall\-on\-stage\-delete [boolean]
.UNINDENT
.sp
...
.nf
.ft C
    export stage_id=<substitute\-value\-of\-stage_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/devops/deploy\-stage/update\-oke\-helm\-chart\-stage.html#cmdoption\-stage\-id

    oci devops deploy\-stage update\-oke\-helm\-chart\-stage \-\-stage\-id $stage_id
.ft P
.fi
.UNINDENT
.UNINDENT
