...
.
.TH "MARKETPLACE-PUBLISHER_MARKET-COLLECTION_LIST-MARKETS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
marketplace-publisher_market-collection_list-markets \- 
.
...
.nf
.ft C
oci marketplace\-publisher market\-collection list\-markets [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/marketplace\-publisher/market\-collection/list\-markets.html#cmdoption\-compartment\-id

    oci marketplace\-publisher market\-collection list\-markets \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
