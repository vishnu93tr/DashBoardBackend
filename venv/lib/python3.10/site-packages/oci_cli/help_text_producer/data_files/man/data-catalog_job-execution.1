...
.
.TH "DATA-CATALOG_JOB-EXECUTION" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-catalog_job-execution \- 
.
...
.INDENT 0.0
.TP
.B \-\-time\-ended [datetime]
.UNINDENT
.sp
Time that the job execution ended or null if it hasn’t yet completed. An \fI\%RFC3339\fP <\fBhttps://tools.ietf.org/html/rfc3339\fP> formatted datetime string.
.INDENT 0.0
.INDENT 3.5
...
.INDENT 0.0
.TP
.B \-\-time\-started [datetime]
.UNINDENT
.sp
Time that job execution started. An \fI\%RFC3339\fP <\fBhttps://tools.ietf.org/html/rfc3339\fP> formatted datetime string.
.INDENT 0.0
.INDENT 3.5
The following datetime formats are supported:
.UNINDENT
...
.nf
.ft C
oci data\-catalog job\-execution get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
createdById, dataEntityKey, errorCode, errorMessage, eventKey, externalUrl, jobKey, jobType, key, lifecycleState, parentKey, processKey, properties, scheduleInstanceKey, subType, timeCreated, timeEnded, timeStarted, updatedById, uri
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-catalog/catalog/create.html#cmdoption\-compartment\-id
    export job_execution_key=<substitute\-value\-of\-job_execution_key> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-catalog/job\-execution/get.html#cmdoption\-job\-execution\-key
    export job_key=<substitute\-value\-of\-job_key> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-catalog/job\-execution/get.html#cmdoption\-job\-key

    catalog_id=$(oci data\-catalog catalog create \-\-compartment\-id $compartment_id \-\-query data.id \-\-raw\-output)

    oci data\-catalog job\-execution get \-\-catalog\-id $catalog_id \-\-job\-execution\-key $job_execution_key \-\-job\-key $job_key
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci data\-catalog job\-execution list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
jobKey, jobType, key, lifecycleState, parentKey, scheduleInstanceKey, timeCreated, timeEnded, timeStarted, uri
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
Time that the job execution ended or null if the job is still running or hasn’t run yet. An \fI\%RFC3339\fP <\fBhttps://tools.ietf.org/html/rfc3339\fP> formatted datetime string.
.INDENT 0.0
.INDENT 3.5
The following datetime formats are supported:
.UNINDENT
...
.UNINDENT
.sp
Time that the job execution was started or in the case of a future time, the time when the job will start. An \fI\%RFC3339\fP <\fBhttps://tools.ietf.org/html/rfc3339\fP> formatted datetime string.
.INDENT 0.0
.INDENT 3.5
The following datetime formats are supported:
.UNINDENT
...
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-catalog/catalog/create.html#cmdoption\-compartment\-id
    export job_key=<substitute\-value\-of\-job_key> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-catalog/job\-execution/list.html#cmdoption\-job\-key

    catalog_id=$(oci data\-catalog catalog create \-\-compartment\-id $compartment_id \-\-query data.id \-\-raw\-output)

    oci data\-catalog job\-execution list \-\-catalog\-id $catalog_id \-\-job\-key $job_key
.ft P
.fi
.UNINDENT
.UNINDENT
