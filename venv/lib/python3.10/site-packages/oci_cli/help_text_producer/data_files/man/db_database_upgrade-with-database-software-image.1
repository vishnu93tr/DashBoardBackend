...
.
.TH "DB_DATABASE_UPGRADE-WITH-DATABASE-SOFTWARE-IMAGE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_database_upgrade-with-database-software-image \- 
.
...
.nf
.ft C
oci db database upgrade\-with\-database\-software\-image [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export action=<substitute\-value\-of\-action> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/db/database/upgrade\-with\-database\-software\-image.html#cmdoption\-action
    ...
    oci db database upgrade\-with\-database\-software\-image \-\-action $action \-\-database\-id $database_id \-\-database\-software\-image\-id $database_software_image_id
.ft P
.fi
.UNINDENT
.UNINDENT
