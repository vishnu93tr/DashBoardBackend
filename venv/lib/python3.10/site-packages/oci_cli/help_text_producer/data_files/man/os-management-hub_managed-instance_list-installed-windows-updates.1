...
.
.TH "OS-MANAGEMENT-HUB_MANAGED-INSTANCE_LIST-INSTALLED-WINDOWS-UPDATES" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
os-management-hub_managed-instance_list-installed-windows-updates \- 
.
...
.nf
.ft C
oci os\-management\-hub managed\-instance list\-installed\-windows\-updates [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export managed_instance_id=<substitute\-value\-of\-managed_instance_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/os\-management\-hub/managed\-instance/list\-installed\-windows\-updates.html#cmdoption\-managed\-instance\-id

    oci os\-management\-hub managed\-instance list\-installed\-windows\-updates \-\-managed\-instance\-id $managed_instance_id
.ft P
.fi
.UNINDENT
.UNINDENT
