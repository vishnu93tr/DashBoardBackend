...
.
.TH "DATA-INTEGRATION_CONNECTION-VALIDATION_DELETE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-integration_connection-validation_delete \- 
.
...
.nf
.ft C
oci data\-integration connection\-validation delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export con_validation_key=<substitute\-value\-of\-con_validation_key> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/connection\-validation/delete.html#cmdoption\-con\-validation\-key
    ...
    oci data\-integration connection\-validation delete \-\-con\-validation\-key $con_validation_key \-\-workspace\-id $workspace_id
.ft P
.fi
.UNINDENT
.UNINDENT
