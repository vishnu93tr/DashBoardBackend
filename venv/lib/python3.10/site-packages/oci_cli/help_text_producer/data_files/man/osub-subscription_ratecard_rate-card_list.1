...
.
.TH "OSUB-SUBSCRIPTION_RATECARD_RATE-CARD_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
osub-subscription_ratecard_rate-card_list \- 
.
...
.nf
.ft C
oci osub\-subscription ratecard rate\-card list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/osub\-subscription/ratecard/rate\-card/list.html#cmdoption\-compartment\-id
    export subscription_id=<substitute\-value\-of\-subscription_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/osub\-subscription/ratecard/rate\-card/list.html#cmdoption\-subscription\-id

    oci osub\-subscription ratecard rate\-card list \-\-compartment\-id $compartment_id \-\-subscription\-id $subscription_id
.ft P
.fi
.UNINDENT
.UNINDENT
