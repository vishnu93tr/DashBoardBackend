...
.
.TH "STACK-MONITORING_CONFIG_CREATE-LICENSE-ENTERPRISE-EXTENSIBILITY-CONFIG" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
stack-monitoring_config_create-license-enterprise-extensibility-config \- 
.
...
.nf
.ft C
oci stack\-monitoring config create\-license\-enterprise\-extensibility\-config [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/stack\-monitoring/config/create\-license\-enterprise\-extensibility\-config.html#cmdoption\-compartment\-id
    export is_enabled=<substitute\-value\-of\-is_enabled> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/stack\-monitoring/config/create\-license\-enterprise\-extensibility\-config.html#cmdoption\-is\-enabled

    oci stack\-monitoring config create\-license\-enterprise\-extensibility\-config \-\-compartment\-id $compartment_id \-\-is\-enabled $is_enabled
.ft P
.fi
.UNINDENT
.UNINDENT
