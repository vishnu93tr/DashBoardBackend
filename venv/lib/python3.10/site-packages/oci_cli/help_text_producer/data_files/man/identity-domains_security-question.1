...
.
.TH "IDENTITY-DOMAINS_SECURITY-QUESTION" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_security-question \- 
.
...
.nf
.ft C
oci identity\-domains security\-question create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.sp
\fBSCIM++ Properties:\fP  \- idcsSearchable: true  \- multiValued: false  \- mutability: readWrite  \- required: true  \- returned: always  \- type: boolean  \- uniqueness: none
.INDENT 0.0
.TP
.B \-\-question\-text [complex type]
.UNINDENT
.sp
Locale values for the Question
.sp
\fBSCIM++ Properties:\fP  \- caseExact: false  \- idcsSearchable: true  \- multiValued: true  \- mutability: readWrite  \- required: true  \- returned: always  \- idcsCompositeKey: [locale]  \- type: complex  \- uniqueness: none
...
.nf
.ft C
    oci identity\-domains security\-question create \-\-generate\-param\-json\-input question\-text > question\-text.json
    oci identity\-domains security\-question create \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export active=<substitute\-value\-of\-active> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/identity\-domains/security\-question/create.html#cmdoption\-active
    export type=<substitute\-value\-of\-type> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/identity\-domains/security\-question/create.html#cmdoption\-type

    oci identity\-domains security\-question create \-\-active $active \-\-question\-text file://question\-text.json \-\-schemas file://schemas.json \-\-type $type
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains security\-question delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    security_question_id=$(oci identity\-domains security\-question create \-\-active $active \-\-question\-text file://question\-text.json \-\-schemas file://schemas.json \-\-type $type \-\-query data.id \-\-raw\-output)

    oci identity\-domains security\-question delete \-\-security\-question\-id $security_question_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains security\-question get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains security\-question get \-\-security\-question\-id $security_question_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains security\-question patch [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains security\-question patch \-\-generate\-param\-json\-input operations > operations.json
    oci identity\-domains security\-question patch \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains security\-question patch \-\-operations file://operations.json \-\-schemas file://schemas.json \-\-security\-question\-id $security_question_id
.ft P
.fi
.UNINDENT
.UNINDENT
