...
.
.TH "NETWORK_SUBNET" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network_subnet \- 
.
...
.SH DESCRIPTION
.sp
A logical subdivision of a VCN. Each subnet consists of a contiguous range of IP addresses that do not overlap with other subnets in the VCN. Example: 172.16.1.0/24. For more information, see \fI\%Overview of the Networking Service\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Network/Concepts/overview.htm\fP> and \fI\%VCNs and Subnets\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Network/Tasks/managingVCNs.htm\fP>\&.
.sp
...
.UNINDENT
.sp
This field is not required and should only be specified when adding an IPv6 prefix to a subnet’s IPv6 address space. See\(gaIPv6 Addresses <\fI\%https://docs.cloud.oracle.com/iaas/Content/Network/Concepts/ipv6.htm\fP>\(ga__.
.sp
Example:
.INDENT 0.0
.INDENT 3.5
...
.UNINDENT
.sp
Specify the \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the subnet.
...
.SS Description
.sp
Moves a subnet into a different compartment within the same tenancy. For information about moving resources between compartments, see \fI\%Moving Resources to a Different Compartment\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Identity/Tasks/managingcompartments.htm#moveRes\fP>\&.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the compartment to move the subnet to.
.INDENT 0.0
.TP
.B \-\-subnet\-id [text]
.UNINDENT
...
.SS Description
.sp
Creates a new subnet in the specified VCN. You can’t change the size of the subnet after creation, so it’s important to think about the size of subnets you need before creating them. For more information, see \fI\%VCNs and Subnets\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Network/Tasks/managingVCNs.htm\fP>\&. For information on the number of subnets you can have in a VCN, see \fI\%Service Limits\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/servicelimits.htm\fP>\&.
.sp
For the purposes of access control, you must provide the \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the compartment where you want the subnet to reside. Notice that the subnet doesn’t have to be in the same compartment as the VCN, route tables, or other Networking Service components. If you’re not sure which compartment to use, put the subnet in the same compartment as the VCN. For more information about compartments and access control, see \fI\%Overview of the IAM Service\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Identity/Concepts/overview.htm\fP>\&. For information about OCIDs, see \fI\%Resource Identifiers\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP>\&.
.sp
You may optionally associate a route table with the subnet. If you don’t, the subnet will use the VCN’s default route table. For more information about route tables, see \fI\%Route Tables\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Network/Tasks/managingroutetables.htm\fP>\&.
.sp
You may optionally associate a security list with the subnet. If you don’t, the subnet will use the VCN’s default security list. For more information about security lists, see \fI\%Security Lists\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Network/Concepts/securitylists.htm\fP>\&.
.sp
You may optionally associate a set of DHCP options with the subnet. If you don’t, the subnet will use the VCN’s default set. For more information about DHCP options, see \fI\%DHCP Options\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Network/Tasks/managingDHCP.htm\fP>\&.
.sp
You may optionally specify a \fIdisplay name\fP for the subnet, otherwise a default is provided. It does not have to be unique, and you can change it. Avoid entering confidential information.
.sp
You can also add a DNS label for the subnet, which is required if you want the Internet and VCN Resolver to resolve hostnames for instances in the subnet. For more information, see \fI\%DNS in Your Virtual Cloud Network\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Network/Concepts/dns.htm\fP>\&.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the compartment to contain the subnet.
.INDENT 0.0
.TP
.B \-\-vcn\-id [text]
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the VCN to contain the subnet.
.SS Optional Parameters
.INDENT 0.0
.TP
...
.INDENT 0.0
.TP
.B \-\-dhcp\-options\-id [text]
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the set of DHCP options the subnet will use. If you don’t provide a value, the subnet uses the VCN’s default set of DHCP options.
.INDENT 0.0
.TP
.B \-\-display\-name [text]
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-ipv6\-cidr\-blocks [complex type]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-prohibit\-internet\-ingress [boolean]
.UNINDENT
.sp
Whether to disallow ingress internet traffic to VNICs within this subnet. Defaults to false.
.sp
For IPv6, if \fIprohibitInternetIngress\fP is set to \fItrue\fP, internet access is not allowed for any IPv6s assigned to VNICs in the subnet. Otherwise, ingress internet traffic is allowed by default.
.sp
\fIprohibitPublicIpOnVnic\fP will be set to the value of \fIprohibitInternetIngress\fP to dictate IPv4 behavior in this subnet. Only one or the other flag should be specified.
.sp
Example:
.INDENT 0.0
.INDENT 3.5
...
.INDENT 0.0
.TP
.B \-\-prohibit\-public\-ip\-on\-vnic [boolean]
.UNINDENT
.sp
Whether VNICs within this subnet can have public IP addresses. Defaults to false, which means VNICs created in this subnet will automatically be assigned public IP addresses unless specified otherwise during instance launch (with the \fI–assign\-public\-ip\fP flag). If \fI–prohibit\-public\-ip\-on\-vnic\fP is set to true, VNICs created in this subnet cannot have public IP addresses (i.e., it’s a private subnet).
.sp
Example:
.INDENT 0.0
.INDENT 3.5
...
.INDENT 0.0
.TP
.B \-\-route\-table\-id [text]
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the route table the subnet will use. If you don’t provide a value, the subnet uses the VCN’s default route table.
.INDENT 0.0
.TP
.B \-\-security\-list\-ids [complex type]
.UNINDENT
.sp
The OCIDs of the security list or lists the subnet will use. If you don’t provide a value, the subnet uses the VCN’s default security list. Remember that security lists are associated \fIwith the subnet\fP, but the rules are applied to the individual VNICs in the subnet.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
.nf
.ft C
\(aq["ocid1.securitylist.oc1.phx.aaaaaaaadyndu2n3hcmdsjfiljwyq7vpxsvv7ynp4ori7aealcvhzicnzhyq"]\(aq
.ft P
.fi
.UNINDENT
.UNINDENT
...
.SS Description
.sp
Deletes the specified subnet, but only if there are no instances in the subnet. This is an asynchronous operation. The subnet’s \fIlifecycleState\fP will change to TERMINATING temporarily. If there are any instances in the subnet, the state will instead change back to AVAILABLE.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the VCN.
.SS Global Parameters
.sp
Use \fBoci \-\-help\fP for help on global parameters.
.sp
...
.UNINDENT
.UNINDENT
.SS \fBremove\-ipv6\-subnet\-cidr\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.UNINDENT
.sp
This field is not required and should only be specified when removing an IPv6 prefix from a subnet’s IPv6 address space. See\(gaIPv6 Addresses <\fI\%https://docs.cloud.oracle.com/iaas/Content/Network/Concepts/ipv6.htm\fP>\(ga__.
.sp
Example:
.INDENT 0.0
.INDENT 3.5
...
.INDENT 0.0
.IP \(bu 2
Must be valid. \- The CIDR block’s IP range must be completely within one of the VCN’s CIDR block ranges. \- The old and new CIDR block ranges must use the same network address. Example: \fI10.0.0.0/25\fP and \fI10.0.0.0/24\fP\&. \- Must contain all IP addresses in use in the old CIDR range. \- The new CIDR range’s broadcast address (last IP address of CIDR range) must not be an IP address in use in the old CIDR range.
.UNINDENT
.sp
\fBNote:\fP If you are changing the CIDR block, you cannot create VNICs or private IPs for this resource while the update is in progress.
.sp
Example:
.INDENT 0.0
.INDENT 3.5
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the set of DHCP options the subnet will use.
.INDENT 0.0
.TP
.B \-\-display\-name [text]
.UNINDENT
...
.UNINDENT
.sp
This is the IPv6 prefix for the subnet’s IP address space. The subnet size is always /64. See \fI\%IPv6 Addresses\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Network/Concepts/ipv6.htm\fP>\&. The provided prefix must maintain the following rules \-
.INDENT 0.0
.IP a. 3
The IPv6 prefix is valid and correctly formatted. b. The IPv6 prefix is within the parent VCN IPv6 range.
.UNINDENT
.sp
Example:
.INDENT 0.0
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the route table the subnet will use.
.INDENT 0.0
.TP
.B \-\-security\-list\-ids [complex type]
.UNINDENT
.sp
The OCIDs of the security list or lists the subnet will use. This replaces the entire current set of security lists. Remember that security lists are associated \fIwith the subnet\fP, but the rules are applied to the individual VNICs in the subnet.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
