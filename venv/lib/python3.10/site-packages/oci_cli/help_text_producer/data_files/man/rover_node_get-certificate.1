...
.
.TH "ROVER_NODE_GET-CERTIFICATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
rover_node_get-certificate \- 
.
...
.nf
.ft C
oci rover node get\-certificate [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export output_file_path=<substitute\-value\-of\-output_file_path> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/rover/node/get\-certificate.html#cmdoption\-output\-file\-path
    ...
    oci rover node get\-certificate \-\-node\-id $node_id \-\-output\-file\-path $output_file_path
.ft P
.fi
.UNINDENT
.UNINDENT
