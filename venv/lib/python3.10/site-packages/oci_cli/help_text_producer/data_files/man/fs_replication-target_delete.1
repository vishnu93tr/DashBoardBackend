...
.
.TH "FS_REPLICATION-TARGET_DELETE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
fs_replication-target_delete \- 
.
...
.nf
.ft C
oci fs replication\-target delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-replication\-target\-id [text]
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the replication target.
...
.nf
.ft C
    export replication_target_id=<substitute\-value\-of\-replication_target_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/fs/replication\-target/delete.html#cmdoption\-replication\-target\-id

    oci fs replication\-target delete \-\-replication\-target\-id $replication_target_id
.ft P
.fi
.UNINDENT
.UNINDENT
