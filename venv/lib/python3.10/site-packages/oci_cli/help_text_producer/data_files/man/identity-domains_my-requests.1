...
.
.TH "IDENTITY-DOMAINS_MY-REQUESTS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_my-requests \- 
.
...
.nf
.ft C
oci identity\-domains my\-requests list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains my\-requests list
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains my\-requests search [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains my\-requests search \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains my\-requests search \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
