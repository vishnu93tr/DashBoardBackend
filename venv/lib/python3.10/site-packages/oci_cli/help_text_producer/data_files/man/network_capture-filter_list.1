...
.
.TH "NETWORK_CAPTURE-FILTER_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network_capture-filter_list \- 
.
...
.nf
.ft C
oci network capture\-filter list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
A filter to only return resources that match the given capture \fIfilterType\fP\&. The \fIfilterType\fP value is the string representation of enum \- \fIVTAP\fP, \fIFLOWLOG\fP\&.
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/network/capture\-filter/list.html#cmdoption\-compartment\-id

    oci network capture\-filter list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
