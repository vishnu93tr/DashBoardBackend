...
.
.TH "LOGGING_AGENT-CONFIGURATION_UPDATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
logging_agent-configuration_update \- 
.
...
.nf
.ft C
oci logging agent\-configuration update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci logging agent\-configuration update \-\-generate\-param\-json\-input service\-configuration > service\-configuration.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export config_id=<substitute\-value\-of\-config_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/logging/agent\-configuration/update.html#cmdoption\-config\-id
    export display_name=<substitute\-value\-of\-display_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/logging/agent\-configuration/update.html#cmdoption\-display\-name
    export is_enabled=<substitute\-value\-of\-is_enabled> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/logging/agent\-configuration/update.html#cmdoption\-is\-enabled

    oci logging agent\-configuration update \-\-config\-id $config_id \-\-display\-name $display_name \-\-is\-enabled $is_enabled \-\-service\-configuration file://service\-configuration.json
.ft P
.fi
.UNINDENT
.UNINDENT
