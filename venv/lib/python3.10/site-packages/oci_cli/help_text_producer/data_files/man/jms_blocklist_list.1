...
.
.TH "JMS_BLOCKLIST_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
jms_blocklist_list \- 
.
...
.UNINDENT
.sp
The field used to sort blocklist records. Only one sort order may be provided. Default order for _operation_ is \fBascending\fP\&. If no value is specified, _operation_ is default.
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
