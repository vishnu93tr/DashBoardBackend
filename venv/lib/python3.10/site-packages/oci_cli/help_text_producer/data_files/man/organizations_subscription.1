...
.
.TH "ORGANIZATIONS_SUBSCRIPTION" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
organizations_subscription \- 
.
...
.nf
.ft C
oci organizations subscription get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export subscription_id=<substitute\-value\-of\-subscription_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/organizations/subscription/get.html#cmdoption\-subscription\-id

    oci organizations subscription get \-\-subscription\-id $subscription_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci organizations subscription list
.ft P
.fi
.UNINDENT
.UNINDENT
.SS \fBlist\-available\-regions\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.nf
.ft C
oci organizations subscription list\-available\-regions [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export subscription_id=<substitute\-value\-of\-subscription_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/organizations/subscription/list\-available\-regions.html#cmdoption\-subscription\-id

    oci organizations subscription list\-available\-regions \-\-subscription\-id $subscription_id
.ft P
.fi
.UNINDENT
.UNINDENT
