...
.
.TH "IDENTITY-DOMAINS_APP-ROLE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_app-role \- 
.
...
.nf
.ft C
oci identity\-domains app\-role create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
AppRole name
.sp
\fBSCIM++ Properties:\fP  \- caseExact: false  \- idcsCsvAttributeName: Display Name  \- idcsCsvAttributeNameMappings: [[columnHeaderName:Entitlement Value]]  \- idcsSearchable: true  \- multiValued: false  \- mutability: immutable  \- required: true  \- returned: always  \- type: string  \- uniqueness: none
.INDENT 0.0
.TP
...
.INDENT 0.0
.TP
.B \-\-available\-to\-clients [boolean]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-limited\-to\-one\-or\-more\-groups [boolean]
.UNINDENT
.sp
...
.sp
\fBSCIM++ Properties:\fP  \- idcsSearchable: false  \- multiValued: false  \- mutability: readOnly  \- required: false  \- returned: default  \- type: boolean  \- uniqueness: none
.INDENT 0.0
.TP
.B \-\-localized\-display\-name [text]
.UNINDENT
.sp
...
.sp
\fBSCIM++ Properties:\fP  \- idcsCompositeKey: [value, type]  \- idcsCsvAttributeNameMappings: [[columnHeaderName:Grantee Name, mapsTo:members.value], [columnHeaderName:Grantee Type, mapsTo:members.type]]  \- idcsSearchable: true  \- multiValued: true  \- mutability: readOnly  \- required: false  \- returned: request  \- idcsPaginateResponse: true  \- type: complex  \- uniqueness: none
.sp
This option is a JSON list with items of type AppRoleMembers.  For documentation on AppRoleMembers please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/identitydomains/v1/datatypes/AppRoleMembers\fP\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
AppRole unique name
.sp
\fBSCIM++ Properties:\fP  \- idcsSearchable: false  \- multiValued: false  \- mutability: readOnly  \- required: false  \- returned: always  \- type: string  \- uniqueness: server
...
.ft C
    ...
    oci identity\-domains app\-role create \-\-generate\-param\-json\-input app > app.json
    oci identity\-domains app\-role create \-\-generate\-param\-json\-input display\-name > display\-name.json
    oci identity\-domains app\-role create \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains app\-role create \-\-app file://app.json \-\-display\-name file://display\-name.json \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains app\-role delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    app_role_id=$(oci identity\-domains app\-role create \-\-app file://app.json \-\-display\-name file://display\-name.json \-\-schemas file://schemas.json \-\-query data.id \-\-raw\-output)

    oci identity\-domains app\-role delete \-\-app\-role\-id $app_role_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains app\-role get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains app\-role get \-\-app\-role\-id $app_role_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains app\-role patch [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains app\-role patch \-\-generate\-param\-json\-input operations > operations.json
    oci identity\-domains app\-role patch \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains app\-role patch \-\-app\-role\-id $app_role_id \-\-operations file://operations.json \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
