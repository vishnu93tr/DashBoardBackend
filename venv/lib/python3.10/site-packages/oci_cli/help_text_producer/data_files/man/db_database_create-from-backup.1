...
.
.TH "DB_DATABASE_CREATE-FROM-BACKUP" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_database_create-from-backup \- 
.
...
.UNINDENT
.sp
The Db System Id to restore this database under. Either –db\-system\-id or –vm\-cluster\-id must be specified, but if both are passed, –vm\-cluster\-id will be ignored.
.INDENT 0.0
.TP
