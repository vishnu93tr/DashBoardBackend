...
.
.TH "DEVOPS_BUILD-PIPELINE-STAGE_CREATE-TRIGGER-DEPLOYMENT-STAGE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
devops_build-pipeline-stage_create-trigger-deployment-stage \- 
.
...
.nf
.ft C
oci devops build\-pipeline\-stage create\-trigger\-deployment\-stage [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-build\-pipeline\-id [text]
.UNINDENT
.sp
The OCID of the build pipeline.
.INDENT 0.0
.TP
.B \-\-deploy\-pipeline\-id [text]
.UNINDENT
.sp
A target deployment pipeline OCID that will run in this stage.
.INDENT 0.0
.TP
.B \-\-is\-pass\-all\-parameters\-enabled [boolean]
.UNINDENT
.sp
...
.ft C
    ...
    oci devops build\-pipeline\-stage create\-trigger\-deployment\-stage \-\-generate\-param\-json\-input stage\-predecessor\-collection > stage\-predecessor\-collection.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export project_id=<substitute\-value\-of\-project_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/devops/deploy\-pipeline/create.html#cmdoption\-project\-id
    export is_pass_all_parameters_enabled=<substitute\-value\-of\-is_pass_all_parameters_enabled> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/devops/build\-pipeline\-stage/create\-trigger\-deployment\-stage.html#cmdoption\-is\-pass\-all\-parameters\-enabled
    ...
    deploy_pipeline_id=$(oci devops deploy\-pipeline create \-\-project\-id $project_id \-\-query data.id \-\-raw\-output)

    oci devops build\-pipeline\-stage create\-trigger\-deployment\-stage \-\-build\-pipeline\-id $build_pipeline_id \-\-deploy\-pipeline\-id $deploy_pipeline_id \-\-is\-pass\-all\-parameters\-enabled $is_pass_all_parameters_enabled \-\-stage\-predecessor\-collection file://stage\-predecessor\-collection.json
.ft P
.fi
.UNINDENT
.UNINDENT
