...
.
.TH "IDENTITY-DOMAINS_SECURITY-QUESTION-SETTINGS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_security-question-settings \- 
.
...
.nf
.ft C
oci identity\-domains security\-question\-settings list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains security\-question\-settings list
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains security\-question\-settings search [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains security\-question\-settings search \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains security\-question\-settings search \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
