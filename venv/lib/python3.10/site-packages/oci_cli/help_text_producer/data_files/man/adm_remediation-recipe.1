...
.
.TH "ADM_REMEDIATION-RECIPE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
adm_remediation-recipe \- 
.
...
.nf
.ft C
oci adm remediation\-recipe activate [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-remediation\-recipe\-id [text]
.UNINDENT
.sp
The Oracle Cloud Identifier (\fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP>) of a Remediation Recipe, as a URL path parameter.
...
.ft C
    ...
    oci adm remediation\-recipe activate \-\-remediation\-recipe\-id $remediation_recipe_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci adm remediation\-recipe change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The compartment Oracle Cloud Identifier (\fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP>) to which the resource must be moved.
.INDENT 0.0
.TP
.B \-\-remediation\-recipe\-id [text]
.UNINDENT
...
.ft C
    ...
    oci adm remediation\-recipe change\-compartment \-\-compartment\-id $compartment_id \-\-remediation\-recipe\-id $remediation_recipe_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci adm remediation\-recipe create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The compartment Oracle Cloud Identifier (\fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP>) of the remediation recipe.
.INDENT 0.0
.TP
.B \-\-detect\-configuration [complex type]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-is\-run\-triggered\-on\-kb\-change [boolean]
.UNINDENT
.sp
...
.UNINDENT
.sp
The Oracle Cloud Identifier (\fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP>) of the knowledge base.
.INDENT 0.0
.TP
...
.INDENT 0.0
.TP
.B \-\-scm\-configuration [complex type]
.UNINDENT
.sp
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
...
.INDENT 0.0
.TP
.B \-\-verify\-configuration [complex type]
.UNINDENT
.sp
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
...
.ft C
    ...
    oci adm remediation\-recipe create \-\-compartment\-id $compartment_id \-\-detect\-configuration file://detect\-configuration.json \-\-is\-run\-triggered\-on\-kb\-change $is_run_triggered_on_kb_change \-\-knowledge\-base\-id $knowledge_base_id \-\-network\-configuration file://network\-configuration.json \-\-scm\-configuration file://scm\-configuration.json \-\-verify\-configuration file://verify\-configuration.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci adm remediation\-recipe deactivate [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci adm remediation\-recipe deactivate \-\-remediation\-recipe\-id $remediation_recipe_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci adm remediation\-recipe delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci adm remediation\-recipe delete \-\-remediation\-recipe\-id $remediation_recipe_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci adm remediation\-recipe get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci adm remediation\-recipe get \-\-remediation\-recipe\-id $remediation_recipe_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.SS Description
.sp
Returns a list of Remediation Recipes based on the specified query parameters. The query parameters \fIcompartmentId\fP or \fIid\fP must be provided.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
...
.UNINDENT
.sp
The field used to sort Remediation Recipes. Only one sort order is allowed. Default order for _displayName_ is \fBascending alphabetical order\fP\&. Default order for _lifecyleState_ is the following sequence: \fBCREATING, ACTIVE, UPDATING, INACTIVE, FAILED, DELETING, and DELETED\fP\&. Default order for _timeCreated_ is \fBdescending\fP\&. Default order for _timeUpdated_ is \fBdescending\fP\&. Default order for _type_ is the following sequence: \fBADM\fP\&.
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
...
.nf
.ft C
DISPLAY_NAME, LIFECYCLE_STATE, TIME_CREATED, TIME_UPDATED, TYPE
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci adm remediation\-recipe update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci adm remediation\-recipe update \-\-remediation\-recipe\-id $remediation_recipe_id
.ft P
.fi
.UNINDENT
.UNINDENT
