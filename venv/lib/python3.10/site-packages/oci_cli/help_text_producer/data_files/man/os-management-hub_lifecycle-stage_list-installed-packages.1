...
.
.TH "OS-MANAGEMENT-HUB_LIFECYCLE-STAGE_LIST-INSTALLED-PACKAGES" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
os-management-hub_lifecycle-stage_list-installed-packages \- 
.
...
.nf
.ft C
oci os\-management\-hub lifecycle\-stage list\-installed\-packages [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export stage_id=<substitute\-value\-of\-stage_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/os\-management\-hub/lifecycle\-stage/list\-installed\-packages.html#cmdoption\-stage\-id

    oci os\-management\-hub lifecycle\-stage list\-installed\-packages \-\-stage\-id $stage_id
.ft P
.fi
.UNINDENT
.UNINDENT
