...
.
.TH "NLB_BACKEND_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
nlb_backend_list \- 
.
...
.UNINDENT
.sp
The system returns the requested resource, with a 200 status, only if the resource has no etag matching the one specified. If the condition fails for the GET and HEAD methods, then the system returns the HTTP status code \fI304 (Not Modified)\fP\&.
.sp
Example:
.INDENT 0.0
.INDENT 3.5
...
.ft C
    ...
    export backend_set_name=<substitute\-value\-of\-backend_set_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/nlb/backend/list.html#cmdoption\-backend\-set\-name
    ...
    oci nlb backend list \-\-backend\-set\-name $backend_set_name \-\-network\-load\-balancer\-id $network_load_balancer_id
.ft P
.fi
.UNINDENT
.UNINDENT
