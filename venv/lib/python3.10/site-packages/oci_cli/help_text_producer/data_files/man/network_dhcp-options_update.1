...
.
.TH "NETWORK_DHCP-OPTIONS_UPDATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network_dhcp-options_update \- 
.
...
.UNINDENT
.sp
This option is a JSON list with items of type DhcpOption.  For documentation on DhcpOption please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/iaas/20160918/datatypes/DhcpOption\fP\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
.nf
.ft C
    export dhcp_id=<substitute\-value\-of\-dhcp_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/network/dhcp\-options/update.html#cmdoption\-dhcp\-id

    oci network dhcp\-options update \-\-dhcp\-id $dhcp_id
.ft P
.fi
.UNINDENT
.UNINDENT
