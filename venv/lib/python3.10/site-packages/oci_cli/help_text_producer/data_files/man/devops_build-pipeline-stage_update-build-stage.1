...
.
.TH "DEVOPS_BUILD-PIPELINE-STAGE_UPDATE-BUILD-STAGE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
devops_build-pipeline-stage_update-build-stage \- 
.
...
.nf
.ft C
oci devops build\-pipeline\-stage update\-build\-stage [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-build\-runner\-config [complex type]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-build\-source\-collection [complex type]
.UNINDENT
.sp
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
...
.INDENT 0.0
.TP
.B \-\-network\-channel [complex type]
.UNINDENT
.sp
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
...
.INDENT 0.0
.TP
.B \-\-stage\-execution\-timeout\-in\-seconds [integer]
.UNINDENT
.sp
...
.nf
.ft C
    export stage_id=<substitute\-value\-of\-stage_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/devops/build\-pipeline\-stage/update\-build\-stage.html#cmdoption\-stage\-id

    oci devops build\-pipeline\-stage update\-build\-stage \-\-stage\-id $stage_id
.ft P
.fi
.UNINDENT
.UNINDENT
