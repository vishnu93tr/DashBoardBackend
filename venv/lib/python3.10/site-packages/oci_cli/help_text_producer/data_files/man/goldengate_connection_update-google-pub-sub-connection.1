...
.
.TH "GOLDENGATE_CONNECTION_UPDATE-GOOGLE-PUB-SUB-CONNECTION" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
goldengate_connection_update-google-pub-sub-connection \- 
.
...
.nf
.ft C
oci goldengate connection update\-google\-pub\-sub\-connection [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-service\-account\-key\-file [text]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-service\-account\-key\-file\-secret\-id [text]
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the Secret where the content of the service account key file is stored, which containing the credentials required to use Google PubSub. Note: When provided, ‘serviceAccountKeyFile’ field must not be provided.
.INDENT 0.0
.TP
.B \-\-subnet\-id [text]
.UNINDENT
...
.nf
.ft C
    export connection_id=<substitute\-value\-of\-connection_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/goldengate/connection/update\-google\-pub\-sub\-connection.html#cmdoption\-connection\-id

    oci goldengate connection update\-google\-pub\-sub\-connection \-\-connection\-id $connection_id
.ft P
.fi
.UNINDENT
.UNINDENT
