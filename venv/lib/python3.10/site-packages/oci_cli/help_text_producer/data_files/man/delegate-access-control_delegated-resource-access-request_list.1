...
.
.TH "DELEGATE-ACCESS-CONTROL_DELEGATED-RESOURCE-ACCESS-REQUEST_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
delegate-access-control_delegated-resource-access-request_list \- 
.
...
.nf
.ft C
oci delegate\-access\-control delegated\-resource\-access\-request list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
APPROVAL_WAITING, APPROVED, APPROVED_FOR_FUTURE, CLOSE_FAILED, COMPLETED, COMPLETING, CREATED, DEPLOYED, DEPLOY_FAILED, EXPIRED, EXPIRY_FAILED, EXTENDED, EXTENDING, EXTENSION_FAILED, EXTENSION_REJECTED, OPERATOR_ASSIGNMENT_WAITING, PREAPPROVED, REJECTED, REVOKED, REVOKE_FAILED, REVOKING, UNDEPLOYED, UNDEPLOY_FAILED
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/delegate\-access\-control/delegated\-resource\-access\-request/list.html#cmdoption\-compartment\-id

    oci delegate\-access\-control delegated\-resource\-access\-request list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
