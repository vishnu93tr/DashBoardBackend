...
.
.TH "FS_MOUNT-TARGET_REMOVE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
fs_mount-target_remove \- 
.
...
.nf
.ft C
oci fs mount\-target remove [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export type=<substitute\-value\-of\-type> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/fs/mount\-target/remove.html#cmdoption\-type
    ...
    oci fs mount\-target remove \-\-mount\-target\-id $mount_target_id \-\-type $type
.ft P
.fi
.UNINDENT
.UNINDENT
