...
.
.TH "DATA-FLOW_POOL" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-flow_pool \- 
.
...
.nf
.ft C
oci data\-flow pool change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci data\-flow pool create \-\-generate\-param\-json\-input configurations > configurations.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-flow/pool/create.html#cmdoption\-compartment\-id
    export display_name=<substitute\-value\-of\-display_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-flow/pool/create.html#cmdoption\-display\-name

    pool_id=$(oci data\-flow pool create \-\-compartment\-id $compartment_id \-\-configurations file://configurations.json \-\-display\-name $display_name \-\-query data.id \-\-raw\-output)

    oci data\-flow pool change\-compartment \-\-compartment\-id $compartment_id \-\-pool\-id $pool_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.sp
This option is a JSON list with items of type PoolSchedule.  For documentation on PoolSchedule please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/dataflow/20200129/datatypes/PoolSchedule\fP\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
.ft C
    ...
    oci data\-flow pool create \-\-compartment\-id $compartment_id \-\-configurations file://configurations.json \-\-display\-name $display_name
.ft P
.fi
.UNINDENT
.UNINDENT
...
.SS Description
.sp
Deletes a pool using a \fIpoolId\fP\&.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci data\-flow pool delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
ACCEPTED, ACTIVE, CREATING, DELETED, DELETING, FAILED, SCHEDULED, STOPPED, STOPPING, UPDATING
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci data\-flow pool delete \-\-pool\-id $pool_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.SS Description
.sp
Retrieves a pool using a \fIpoolId\fP\&.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci data\-flow pool get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci data\-flow pool list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-display\-name\-starts\-with [text]
.UNINDENT
.sp
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-flow/pool/list.html#cmdoption\-compartment\-id

    oci data\-flow pool list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.SS Description
.sp
Starts the dataflow pool for a given \fIpoolId\fP\&. When provided, If\-Match is checked against ETag values of the resource.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci data\-flow pool start [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci data\-flow pool start \-\-pool\-id $pool_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.SS Description
.sp
Stops the dataflow pool for a given \fIpoolId\fP\&. When provided, If\-Match is checked against ETag values of the resource.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci data\-flow pool stop [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci data\-flow pool stop \-\-pool\-id $pool_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.SS Description
.sp
Updates a pool using a \fIpoolId\fP\&.If changes to a pool doesn’t match a previously defined pool,then a 409 status code will be returned.This indicates that a conflict has been detected.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
...
List of PoolConfig items.
.sp
This option is a JSON list with items of type PoolConfig.  For documentation on PoolConfig please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/dataflow/20200129/datatypes/PoolConfig\fP\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
.ft C
    ...
    oci data\-flow pool update \-\-pool\-id $pool_id
.ft P
.fi
.UNINDENT
.UNINDENT
