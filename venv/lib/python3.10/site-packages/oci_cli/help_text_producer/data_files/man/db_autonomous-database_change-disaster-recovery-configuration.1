...
.
.TH "DB_AUTONOMOUS-DATABASE_CHANGE-DISASTER-RECOVERY-CONFIGURATION" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_autonomous-database_change-disaster-recovery-configuration \- 
.
...
.nf
.ft C
oci db autonomous\-database change\-disaster\-recovery\-configuration [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci db autonomous\-database change\-disaster\-recovery\-configuration \-\-autonomous\-database\-id $autonomous_database_id
.ft P
.fi
.UNINDENT
.UNINDENT
