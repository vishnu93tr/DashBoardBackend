...
.
.TH "DB_AUTONOMOUS-DATABASE-BACKUP" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_autonomous-database-backup \- 
.
...
.nf
.ft C
oci db autonomous\-database\-backup create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the Autonomous Database backup.
.SS Optional Parameters
.INDENT 0.0
.TP
.B \-\-backup\-destination\-details [complex type]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-retention\-period\-in\-days [integer]
.UNINDENT
.sp
...
.ft C
    ...
    oci db autonomous\-database\-backup create \-\-autonomous\-database\-id $autonomous_database_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci db autonomous\-database\-backup delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-autonomous\-database\-backup\-id [text]
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the Autonomous Database backup.
.SS Optional Parameters
...
.ft C
    ...
    autonomous_database_backup_id=$(oci db autonomous\-database\-backup create \-\-autonomous\-database\-id $autonomous_database_id \-\-query data.id \-\-raw\-output)

    oci db autonomous\-database\-backup delete \-\-autonomous\-database\-backup\-id $autonomous_database_backup_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci db autonomous\-database\-backup get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci db autonomous\-database\-backup get \-\-autonomous\-database\-backup\-id $autonomous_database_backup_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.SS Description
.sp
Gets a list of Autonomous Database backups based on either the \fIautonomousDatabaseId\fP or \fIcompartmentId\fP specified as a query parameter.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci db autonomous\-database\-backup list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci db autonomous\-database\-backup update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci db autonomous\-database\-backup update \-\-autonomous\-database\-backup\-id $autonomous_database_backup_id
.ft P
.fi
.UNINDENT
.UNINDENT
