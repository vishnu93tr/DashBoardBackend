...
.
.TH "COMPUTE_IMAGE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
compute_image \- 
.
...
.SH DESCRIPTION
.sp
A boot disk image for launching an instance. For more information, see \fI\%Overview of the Compute Service\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Compute/Concepts/computeoverview.htm\fP>\&.
.sp
...
.SS Description
.sp
Moves an image into a different compartment within the same tenancy. For information about moving resources between compartments, see \fI\%Moving Resources to a Different Compartment\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Identity/Tasks/managingcompartments.htm#moveRes\fP>\&.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the compartment to move the image to.
.INDENT 0.0
.TP
.B \-\-image\-id [text]
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/compute/image/change\-compartment.html#cmdoption\-compartment\-id
    export image_id=<substitute\-value\-of\-image_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/compute/image/change\-compartment.html#cmdoption\-image\-id

    oci compute image change\-compartment \-\-compartment\-id $compartment_id \-\-image\-id $image_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export image_id=<substitute\-value\-of\-image_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/compute/image/delete.html#cmdoption\-image\-id

    oci compute image delete \-\-image\-id $image_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export image_id=<substitute\-value\-of\-image_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/compute/image/get.html#cmdoption\-image\-id
...
.SS Description
.sp
Lists a subset of images available in the specified compartment, including \fI\%platform images\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Compute/References/images.htm\fP> and \fI\%custom images\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Compute/Tasks/managingcustomimages.htm\fP>\&. The list of platform images includes the three most recently published versions of each major distribution. The list does not support filtering based on image tags.
.sp
The list of images returned is ordered to first show the recent platform images, then all of the custom images.
.sp
\fBCaution:\fP Platform images are refreshed regularly. When new images are released, older versions are replaced. The image OCIDs remain available, but when the platform image is replaced, the image OCIDs are no longer returned as part of the platform image list.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/compute/image/list.html#cmdoption\-compartment\-id
...
.nf
.ft C
    export image_id=<substitute\-value\-of\-image_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/compute/image/update.html#cmdoption\-image\-id

    oci compute image update \-\-image\-id $image_id
.ft P
.fi
.UNINDENT
.UNINDENT
