...
.
.TH "ONESUBSCRIPTION_SUBSCRIPTION_SUBSCRIPTION_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
onesubscription_subscription_subscription_list \- 
.
...
.nf
.ft C
oci onesubscription subscription subscription list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-is\-commit\-info\-required [boolean]
.UNINDENT
.sp
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/onesubscription/subscription/subscription/list.html#cmdoption\-compartment\-id

    oci onesubscription subscription subscription list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
