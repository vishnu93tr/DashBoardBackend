...
.
.TH "CERTS-MGMT_CERTIFICATE_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
certs-mgmt_certificate_list \- 
.
...
.SH DESCRIPTION
.sp
Lists all certificates that match the query parameters. Optionally, you can use the parameter \fIFilterByCertificateIdQueryParam\fP to limit the result set to a single item that matches the specified certificate.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci certs\-mgmt certificate list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
