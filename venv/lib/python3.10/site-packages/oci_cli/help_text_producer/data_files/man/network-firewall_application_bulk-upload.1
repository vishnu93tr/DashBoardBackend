...
.
.TH "NETWORK-FIREWALL_APPLICATION_BULK-UPLOAD" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network-firewall_application_bulk-upload \- 
.
...
.nf
.ft C
oci network\-firewall application bulk\-upload [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-bulk\-upload\-applications\-details [complex type]
.UNINDENT
.sp
Request Details to bulk import applications for the Network Firewall Policy Resource.
.INDENT 0.0
.TP
...
.nf
.ft C
    oci network\-firewall application bulk\-upload \-\-generate\-param\-json\-input bulk\-upload\-applications\-details > bulk\-upload\-applications\-details.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci network\-firewall application bulk\-upload \-\-bulk\-upload\-applications\-details file://bulk\-upload\-applications\-details.json \-\-network\-firewall\-policy\-id $network_firewall_policy_id
.ft P
.fi
.UNINDENT
.UNINDENT
