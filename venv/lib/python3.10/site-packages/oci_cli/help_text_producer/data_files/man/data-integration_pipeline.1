...
.
.TH "DATA-INTEGRATION_PIPELINE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-integration_pipeline \- 
.
...
.INDENT 0.0
.TP
.B \-\-flow\-config\-values [complex type]
.UNINDENT
.sp
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
...
.sp
This option is a JSON list with items of type FlowNode.  For documentation on FlowNode please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/dataintegration/20200430/datatypes/FlowNode\fP\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
.sp
This option is a JSON list with items of type Parameter.  For documentation on Parameter please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/dataintegration/20200430/datatypes/Parameter\fP\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
.sp
This option is a JSON list with items of type Variable.  For documentation on Variable please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/dataintegration/20200430/datatypes/Variable\fP\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
.nf
.ft C
    oci data\-integration pipeline create \-\-generate\-param\-json\-input registry\-metadata > registry\-metadata.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export identifier=<substitute\-value\-of\-identifier> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/pipeline/create.html#cmdoption\-identifier
    ...
    oci data\-integration pipeline create \-\-identifier $identifier \-\-name $name \-\-registry\-metadata file://registry\-metadata.json \-\-workspace\-id $workspace_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export display_name=<substitute\-value\-of\-display_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/workspace/create.html#cmdoption\-display\-name
    export is_private_network=<substitute\-value\-of\-is_private_network> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/workspace/create.html#cmdoption\-is\-private\-network
    export pipeline_key=<substitute\-value\-of\-pipeline_key> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/pipeline/delete.html#cmdoption\-pipeline\-key

    workspace_id=$(oci data\-integration workspace create \-\-compartment\-id $compartment_id \-\-display\-name $display_name \-\-is\-private\-network $is_private_network \-\-query data.id \-\-raw\-output)

    oci data\-integration pipeline delete \-\-pipeline\-key $pipeline_key \-\-workspace\-id $workspace_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci data\-integration pipeline get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export display_name=<substitute\-value\-of\-display_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/workspace/create.html#cmdoption\-display\-name
    export is_private_network=<substitute\-value\-of\-is_private_network> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/workspace/create.html#cmdoption\-is\-private\-network
    export pipeline_key=<substitute\-value\-of\-pipeline_key> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/pipeline/get.html#cmdoption\-pipeline\-key

    workspace_id=$(oci data\-integration workspace create \-\-compartment\-id $compartment_id \-\-display\-name $display_name \-\-is\-private\-network $is_private_network \-\-query data.id \-\-raw\-output)

    oci data\-integration pipeline get \-\-pipeline\-key $pipeline_key \-\-workspace\-id $workspace_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci data\-integration pipeline list \-\-workspace\-id $workspace_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export display_name=<substitute\-value\-of\-display_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/workspace/create.html#cmdoption\-display\-name
    export is_private_network=<substitute\-value\-of\-is_private_network> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/workspace/create.html#cmdoption\-is\-private\-network
    export key=<substitute\-value\-of\-key> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/pipeline/update.html#cmdoption\-key
    export model_type=<substitute\-value\-of\-model_type> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/pipeline/update.html#cmdoption\-model\-type
    export object_version=<substitute\-value\-of\-object_version> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/pipeline/update.html#cmdoption\-object\-version
    export pipeline_key=<substitute\-value\-of\-pipeline_key> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/pipeline/update.html#cmdoption\-pipeline\-key

    workspace_id=$(oci data\-integration workspace create \-\-compartment\-id $compartment_id \-\-display\-name $display_name \-\-is\-private\-network $is_private_network \-\-query data.id \-\-raw\-output)

    oci data\-integration pipeline update \-\-key $key \-\-model\-type $model_type \-\-object\-version $object_version \-\-pipeline\-key $pipeline_key \-\-workspace\-id $workspace_id
.ft P
.fi
.UNINDENT
.UNINDENT
