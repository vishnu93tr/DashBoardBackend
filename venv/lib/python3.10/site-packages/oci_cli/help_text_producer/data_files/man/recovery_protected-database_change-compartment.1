...
.
.TH "RECOVERY_PROTECTED-DATABASE_CHANGE-COMPARTMENT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
recovery_protected-database_change-compartment \- 
.
...
.nf
.ft C
oci recovery protected\-database change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the compartment into which the protected database should be moved.
.INDENT 0.0
.TP
...
.ft C
    ...
    oci recovery protected\-database change\-compartment \-\-compartment\-id $compartment_id \-\-protected\-database\-id $protected_database_id
.ft P
.fi
.UNINDENT
.UNINDENT
