...
.
.TH "FLEET-APPS-MANAGEMENT_FLEET_REQUEST-TARGET-DISCOVERY" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
fleet-apps-management_fleet_request-target-discovery \- 
.
...
.nf
.ft C
oci fleet\-apps\-management fleet request\-target\-discovery [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-is\-applicable\-to\-all\-resources [boolean]
.UNINDENT
.sp
...
.ft C
    ...
    oci fleet\-apps\-management fleet request\-target\-discovery \-\-fleet\-id $fleet_id
.ft P
.fi
.UNINDENT
.UNINDENT
