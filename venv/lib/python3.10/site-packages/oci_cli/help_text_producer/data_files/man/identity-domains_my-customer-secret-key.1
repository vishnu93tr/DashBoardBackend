...
.
.TH "IDENTITY-DOMAINS_MY-CUSTOMER-SECRET-KEY" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_my-customer-secret-key \- 
.
...
.nf
.ft C
oci identity\-domains my\-customer\-secret\-key create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
The access key.
.sp
\fBSCIM++ Properties:\fP  \- caseExact: true  \- type: string  \- mutability: readOnly  \- required: false  \- returned: default
.INDENT 0.0
.TP
...
.nf
.ft C
    oci identity\-domains my\-customer\-secret\-key create \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains my\-customer\-secret\-key create \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains my\-customer\-secret\-key delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-my\-customer\-secret\-key\-id [text]
.UNINDENT
.sp
ID of the resource
.SS Optional Parameters
...
.nf
.ft C
    my_customer_secret_key_id=$(oci identity\-domains my\-customer\-secret\-key create \-\-schemas file://schemas.json \-\-query data.id \-\-raw\-output)

    oci identity\-domains my\-customer\-secret\-key delete \-\-my\-customer\-secret\-key\-id $my_customer_secret_key_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains my\-customer\-secret\-key get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains my\-customer\-secret\-key get \-\-my\-customer\-secret\-key\-id $my_customer_secret_key_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains my\-customer\-secret\-key patch [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains my\-customer\-secret\-key patch \-\-generate\-param\-json\-input operations > operations.json
    oci identity\-domains my\-customer\-secret\-key patch \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains my\-customer\-secret\-key patch \-\-my\-customer\-secret\-key\-id $my_customer_secret_key_id \-\-operations file://operations.json \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
