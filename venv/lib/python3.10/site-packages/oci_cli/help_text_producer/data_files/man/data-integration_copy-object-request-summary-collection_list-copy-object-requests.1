...
.
.TH "DATA-INTEGRATION_COPY-OBJECT-REQUEST-SUMMARY-COLLECTION_LIST-COPY-OBJECT-REQUESTS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-integration_copy-object-request-summary-collection_list-copy-object-requests \- 
.
...
.nf
.ft C
oci data\-integration copy\-object\-request\-summary\-collection list\-copy\-object\-requests [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
ALL, FAILED, IN_PROGRESS, QUEUED, SUCCESSFUL, TERMINATED, TERMINATING
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-time\-ended\-in\-millis [integer]
.UNINDENT
.sp
Specifies end time of a copy object request.
.INDENT 0.0
.TP
.B \-\-time\-started\-in\-millis [integer]
.UNINDENT
.sp
...
.ft C
    ...
    oci data\-integration copy\-object\-request\-summary\-collection list\-copy\-object\-requests \-\-workspace\-id $workspace_id
.ft P
.fi
.UNINDENT
.UNINDENT
