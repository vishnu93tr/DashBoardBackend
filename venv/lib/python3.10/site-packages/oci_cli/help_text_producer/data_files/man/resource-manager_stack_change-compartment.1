...
.
.TH "RESOURCE-MANAGER_STACK_CHANGE-COMPARTMENT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
resource-manager_stack_change-compartment \- 
.
...
.SH DESCRIPTION
.sp
Moves a stack (and its associated jobs) into a different compartment within the same tenancy. For information about moving resources between compartments, see \fI\%Moving Resources to a Different Compartment\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Identity/Tasks/managingcompartments.htm#moveRes\fP>\&.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci resource\-manager stack change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the compartment into which the Stack should be moved.
.INDENT 0.0
.TP
.B \-\-stack\-id [text]
.UNINDENT
...
.ft C
    ...
    oci resource\-manager stack change\-compartment \-\-compartment\-id $compartment_id \-\-stack\-id $stack_id
.ft P
.fi
.UNINDENT
.UNINDENT
