...
.
.TH "FLEET-SOFTWARE-UPDATE_FSU-COLLECTION-SUMMARY_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
fleet-software-update_fsu-collection-summary_list \- 
.
...
.nf
.ft C
oci fleet\-software\-update fsu\-collection\-summary list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/fleet\-software\-update/fsu\-collection\-summary/list.html#cmdoption\-compartment\-id

    oci fleet\-software\-update fsu\-collection\-summary list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
