...
.
.TH "NLB_NETWORK-LOAD-BALANCER_UPDATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
nlb_network-load-balancer_update \- 
.
...
.INDENT 0.0
.TP
.B \-\-is\-preserve\-source\-destination [boolean]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-is\-symmetric\-hash\-enabled [boolean]
.UNINDENT
.sp
...
.UNINDENT
.sp
ZPR tags for this resource. Each tag is a simple key\-value pair with no predefined name, type, or namespace. For more information, see \fI\%Resource Tags\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/resourcetags.htm\fP>\&.
.sp
Example:
.INDENT 0.0
.INDENT 3.5
