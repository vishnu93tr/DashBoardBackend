...
.
.TH "STACK-MONITORING_MONITORING-TEMPLATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
stack-monitoring_monitoring-template \- 
.
...
.nf
.ft C
oci stack\-monitoring monitoring\-template apply [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci stack\-monitoring monitoring\-template apply \-\-monitoring\-template\-id $monitoring_template_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci stack\-monitoring monitoring\-template create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci stack\-monitoring monitoring\-template create \-\-compartment\-id $compartment_id \-\-destinations file://destinations.json \-\-display\-name $display_name \-\-members file://members.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci stack\-monitoring monitoring\-template delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci stack\-monitoring monitoring\-template delete \-\-monitoring\-template\-id $monitoring_template_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci stack\-monitoring monitoring\-template export [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci stack\-monitoring monitoring\-template export \-\-file $file \-\-monitoring\-template\-id $monitoring_template_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci stack\-monitoring monitoring\-template get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci stack\-monitoring monitoring\-template get \-\-monitoring\-template\-id $monitoring_template_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci stack\-monitoring monitoring\-template list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
displayName, lifeCycleState, status, timeCreated, timeUpdated
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
APPLIED, NOT_APPLIED, PARTIAL_APPLIED
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci stack\-monitoring monitoring\-template list
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci stack\-monitoring monitoring\-template unapply [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci stack\-monitoring monitoring\-template unapply \-\-monitoring\-template\-id $monitoring_template_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci stack\-monitoring monitoring\-template update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
List of members of this monitoring template.
.sp
This option is a JSON list with items of type MemberReference.  For documentation on MemberReference please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/stackmonitoring/20210330/datatypes/MemberReference\fP\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
.ft C
    ...
    oci stack\-monitoring monitoring\-template update \-\-monitoring\-template\-id $monitoring_template_id
.ft P
.fi
.UNINDENT
.UNINDENT
