...
.
.TH "GOLDENGATE_CONNECTION_UPDATE-AMAZON-S3-CONNECTION" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
goldengate_connection_update-amazon-s3-connection \- 
.
...
.nf
.ft C
oci goldengate connection update\-amazon\-s3\-connection [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export connection_id=<substitute\-value\-of\-connection_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/goldengate/connection/update\-amazon\-s3\-connection.html#cmdoption\-connection\-id

    oci goldengate connection update\-amazon\-s3\-connection \-\-connection\-id $connection_id
.ft P
.fi
.UNINDENT
.UNINDENT
