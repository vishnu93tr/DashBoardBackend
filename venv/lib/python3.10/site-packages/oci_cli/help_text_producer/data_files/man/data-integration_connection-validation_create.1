...
.
.TH "DATA-INTEGRATION_CONNECTION-VALIDATION_CREATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-integration_connection-validation_create \- 
.
...
.nf
.ft C
oci data\-integration connection\-validation create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci data\-integration connection\-validation create \-\-workspace\-id $workspace_id
.ft P
.fi
.UNINDENT
.UNINDENT
