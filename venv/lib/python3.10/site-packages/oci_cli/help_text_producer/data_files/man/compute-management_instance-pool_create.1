...
.
.TH "COMPUTE-MANAGEMENT_INSTANCE-POOL_CREATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
compute-management_instance-pool_create \- 
.
...
.sp
To determine whether capacity is available for a specific shape before you create an instance pool, use the \fI\%CreateComputeCapacityReport\fP <\fBhttps://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/compute/compute-capacity-report/create.html\fP> operation.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the compartment containing the instance pool.
.INDENT 0.0
.TP
.B \-\-instance\-configuration\-id [text]
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the instance configuration associated with the instance pool.
.INDENT 0.0
.TP
...
.INDENT 0.0
.TP
.B \-\-instance\-display\-name\-formatter [text]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-instance\-hostname\-formatter [text]
.UNINDENT
.sp
