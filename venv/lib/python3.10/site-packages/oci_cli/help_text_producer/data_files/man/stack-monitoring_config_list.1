...
.
.TH "STACK-MONITORING_CONFIG_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
stack-monitoring_config_list \- 
.
...
.nf
.ft C
oci stack\-monitoring config list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
configType, displayName, timeCreated
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
AUTO_PROMOTE, COMPUTE_AUTO_ACTIVATE_PLUGIN, LICENSE_AUTO_ASSIGN, LICENSE_ENTERPRISE_EXTENSIBILITY, ONBOARD
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/stack\-monitoring/config/list.html#cmdoption\-compartment\-id

    oci stack\-monitoring config list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
