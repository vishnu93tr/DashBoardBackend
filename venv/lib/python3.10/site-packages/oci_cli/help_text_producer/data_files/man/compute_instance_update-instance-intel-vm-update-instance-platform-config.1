...
.
.TH "COMPUTE_INSTANCE_UPDATE-INSTANCE-INTEL-VM-UPDATE-INSTANCE-PLATFORM-CONFIG" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
compute_instance_update-instance-intel-vm-update-instance-platform-config \- 
.
...
.nf
.ft C
oci compute instance update\-instance\-intel\-vm\-update\-instance\-platform\-config [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-platform\-config\-is\-symmetric\-multi\-threading\-enabled [boolean]
.UNINDENT
.sp
...
.ft C
    ...
    oci compute instance update\-instance\-intel\-vm\-update\-instance\-platform\-config \-\-instance\-id $instance_id
.ft P
.fi
.UNINDENT
.UNINDENT
