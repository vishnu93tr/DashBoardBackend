...
.
.TH "DATA-SAFE_USER-ASSESSMENT_GENERATE-USER-ASSESSMENT-REPORT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_user-assessment_generate-user-assessment-report \- 
.
...
.nf
.ft C
oci data\-safe user\-assessment generate\-user\-assessment\-report [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export format=<substitute\-value\-of\-format> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-safe/user\-assessment/generate\-user\-assessment\-report.html#cmdoption\-format
    ...
    oci data\-safe user\-assessment generate\-user\-assessment\-report \-\-format $format \-\-user\-assessment\-id $user_assessment_id
.ft P
.fi
.UNINDENT
.UNINDENT
