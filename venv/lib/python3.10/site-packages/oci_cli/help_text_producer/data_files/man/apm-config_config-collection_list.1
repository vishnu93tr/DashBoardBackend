...
.
.TH "APM-CONFIG_CONFIG-COLLECTION_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
apm-config_config-collection_list \- 
.
...
.nf
.ft C
oci apm\-config config\-collection list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The maximum number of results per page, or items to return in a paginated “List” call. For information on how pagination works, see \fI\%List Pagination\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/API/Concepts/usingapi.htm#nine\fP>\&. Example: \fI50\fP
.INDENT 0.0
.TP
.B \-\-page\-size [integer]
.UNINDENT
...
.nf
.ft C
    export apm_domain_id=<substitute\-value\-of\-apm_domain_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/apm\-config/config\-collection/list.html#cmdoption\-apm\-domain\-id

    oci apm\-config config\-collection list \-\-apm\-domain\-id $apm_domain_id
.ft P
.fi
.UNINDENT
.UNINDENT
