...
.
.TH "DB_APPLICATION-VIP" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_application-vip \- 
.
...
.nf
.ft C
oci db application\-vip create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the cloud VM cluster associated with the application virtual IP (VIP) address.
.INDENT 0.0
.TP
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the subnet associated with the application virtual IP (VIP) address.
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the DB node associated with the application virtual IP (VIP) address.
.INDENT 0.0
.TP
.B \-\-from\-json [text]
.UNINDENT
...
.ft C
    ...
    oci db application\-vip create \-\-cloud\-vm\-cluster\-id $cloud_vm_cluster_id \-\-hostname\-label $hostname_label \-\-subnet\-id $subnet_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci db application\-vip get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci db application\-vip get \-\-application\-vip\-id $application_vip_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci db application\-vip list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci db application\-vip list \-\-cloud\-vm\-cluster\-id $cloud_vm_cluster_id \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
