...
.
.TH "FLEET-APPS-MANAGEMENT_FLEET-PROPERTY-COLLECTION_LIST-FLEET-PROPERTIES" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
fleet-apps-management_fleet-property-collection_list-fleet-properties \- 
.
...
.nf
.ft C
oci fleet\-apps\-management fleet\-property\-collection list\-fleet\-properties [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci fleet\-apps\-management fleet\-property\-collection list\-fleet\-properties \-\-fleet\-id $fleet_id
.ft P
.fi
.UNINDENT
.UNINDENT
