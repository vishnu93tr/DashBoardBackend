...
.
.TH "NETWORK_REMOTE-PEERING-CONNECTION" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network_remote-peering-connection \- 
.
...
.SH DESCRIPTION
.sp
A remote peering connection (RPC) is an object on a DRG that lets the VCN that is attached to the DRG peer with a VCN in a different region. \fIPeering\fP means that the two VCNs can communicate using private IP addresses, but without the traffic traversing the internet or routing through your on\-premises network. For more information, see \fI\%VCN Peering\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Network/Tasks/VCNpeering.htm\fP>\&.
.sp
...
.SS Description
.sp
Moves a remote peering connection (RPC) into a different compartment within the same tenancy. For information about moving resources between compartments, see \fI\%Moving Resources to a Different Compartment\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Identity/Tasks/managingcompartments.htm#moveRes\fP>\&.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci network remote\-peering\-connection change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the compartment to move the remote peering connection to.
.INDENT 0.0
.TP
.B \-\-remote\-peering\-connection\-id [text]
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the remote peering connection (RPC).
...
.ft C
    ...
    oci network remote\-peering\-connection change\-compartment \-\-compartment\-id $compartment_id \-\-remote\-peering\-connection\-id $remote_peering_connection_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.sp
This operation must be called by the VCN administrator who is designated as the \fIrequestor\fP in the peering relationship. The \fIacceptor\fP must implement an Identity and Access Management (IAM) policy that gives the requestor permission to connect to RPCs in the acceptor’s compartment. Without that permission, this operation will fail. For more information, see \fI\%VCN Peering\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Network/Tasks/VCNpeering.htm\fP>\&.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the RPC you want to peer with.
.INDENT 0.0
.TP
.B \-\-peer\-region\-name [text]
.UNINDENT
.sp
The name of the region that contains the RPC you want to peer with.
.sp
The region names that could be used are listed here: \fI\%https://docs.cloud.oracle.com/Content/General/Concepts/regions.htm\fP
.sp
Example:
.INDENT 0.0
.INDENT 3.5
...
.nf
.ft C
oci network remote\-peering\-connection create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the compartment to contain the RPC.
.INDENT 0.0
.TP
.B \-\-drg\-id [text]
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the DRG the RPC belongs to.
.SS Optional Parameters
.INDENT 0.0
.TP
...
.ft C
    ...
    oci network remote\-peering\-connection create \-\-compartment\-id $compartment_id \-\-drg\-id $drg_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.sp
This is an asynchronous operation; the RPC’s \fIlifecycleState\fP changes to TERMINATING temporarily until the RPC is completely removed.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci network remote\-peering\-connection delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci network remote\-peering\-connection delete \-\-remote\-peering\-connection\-id $remote_peering_connection_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci network remote\-peering\-connection get \-\-remote\-peering\-connection\-id $remote_peering_connection_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci network remote\-peering\-connection list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/network/remote\-peering\-connection/list.html#cmdoption\-compartment\-id

    oci network remote\-peering\-connection list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci network remote\-peering\-connection update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci network remote\-peering\-connection update \-\-remote\-peering\-connection\-id $remote_peering_connection_id
.ft P
.fi
.UNINDENT
.UNINDENT
