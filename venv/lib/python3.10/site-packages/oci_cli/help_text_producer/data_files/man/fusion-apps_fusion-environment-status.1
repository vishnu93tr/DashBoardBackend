...
.
.TH "FUSION-APPS_FUSION-ENVIRONMENT-STATUS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
fusion-apps_fusion-environment-status \- 
.
...
.SH DESCRIPTION
.sp
The health status of the Fusion Applications environment. For more information, see \fI\%Environment Status\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/fusion-applications/manage-environment.htm#environment-status\fP>\&.
...
.nf
.ft C
oci fusion\-apps fusion\-environment\-status get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci fusion\-apps fusion\-environment\-status get \-\-fusion\-environment\-id $fusion_environment_id
.ft P
.fi
.UNINDENT
.UNINDENT
