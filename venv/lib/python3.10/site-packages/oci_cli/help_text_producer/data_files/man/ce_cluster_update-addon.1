...
.
.TH "CE_CLUSTER_UPDATE-ADDON" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
ce_cluster_update-addon \- 
.
...
.nf
.ft C
oci ce cluster update\-addon [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export addon_name=<substitute\-value\-of\-addon_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/ce/cluster/update\-addon.html#cmdoption\-addon\-name
    ...
    oci ce cluster update\-addon \-\-addon\-name $addon_name \-\-cluster\-id $cluster_id
.ft P
.fi
.UNINDENT
.UNINDENT
