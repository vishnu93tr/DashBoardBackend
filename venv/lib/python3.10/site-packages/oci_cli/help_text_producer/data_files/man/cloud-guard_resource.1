...
.
.TH "CLOUD-GUARD_RESOURCE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
cloud-guard_resource \- 
.
...
.nf
.ft C
oci cloud\-guard resource get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export resource_id=<substitute\-value\-of\-resource_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/cloud\-guard/resource/get.html#cmdoption\-resource\-id

    oci cloud\-guard resource get \-\-resource\-id $resource_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.sp
The ListResources operation returns only the resources in \fIcompartmentId\fP passed. The list does not include any subcompartments of the compartmentId passed.
.sp
...
.sp
The parameter \fIcompartmentIdInSubtree\fP applies when you perform ListResources on the \fIcompartmentId\fP passed and when it is set to true, the entire hierarchy of compartments can be returned. To get a full list of all compartments and subcompartments in the tenancy (root compartment), set the parameter \fIcompartmentIdInSubtree\fP to true and \fIaccessLevel\fP to ACCESSIBLE.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci cloud\-guard resource list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-region\-parameterconflict [text]
.UNINDENT
.sp
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/cloud\-guard/resource/list.html#cmdoption\-compartment\-id

    oci cloud\-guard resource list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
