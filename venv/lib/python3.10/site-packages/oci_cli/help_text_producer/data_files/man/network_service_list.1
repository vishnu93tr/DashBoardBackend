...
.
.TH "NETWORK_SERVICE_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
...
.SH DESCRIPTION
.sp
Lists the available \fI\%Service\fP <\fBhttps://docs.cloud.oracle.com/api/#/en/iaas/latest/Service/\fP> objects that you can enable for a service gateway in this region.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci network service list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
