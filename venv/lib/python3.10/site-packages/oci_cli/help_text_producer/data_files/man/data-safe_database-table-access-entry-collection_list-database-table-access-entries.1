...
.
.TH "DATA-SAFE_DATABASE-TABLE-ACCESS-ENTRY-COLLECTION_LIST-DATABASE-TABLE-ACCESS-ENTRIES" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_database-table-access-entry-collection_list-database-table-access-entries \- 
.
...
.nf
.ft C
oci data\-safe database\-table\-access\-entry\-collection list\-database\-table\-access\-entries [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-security\-policy\-report\-id [text]
.UNINDENT
.sp
...
.sp
\fBExample:\fP query=(accessType eq ‘SELECT’) and (grantee eq ‘ADMIN’)
.INDENT 0.0
.TP
.B \-\-sort\-by [text]
.UNINDENT
...
.nf
.ft C
    export security_policy_report_id=<substitute\-value\-of\-security_policy_report_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-safe/database\-table\-access\-entry\-collection/list\-database\-table\-access\-entries.html#cmdoption\-security\-policy\-report\-id

    oci data\-safe database\-table\-access\-entry\-collection list\-database\-table\-access\-entries \-\-security\-policy\-report\-id $security_policy_report_id
.ft P
.fi
.UNINDENT
.UNINDENT
