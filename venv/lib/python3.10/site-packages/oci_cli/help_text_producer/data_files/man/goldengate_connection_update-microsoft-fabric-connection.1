...
.
.TH "GOLDENGATE_CONNECTION_UPDATE-MICROSOFT-FABRIC-CONNECTION" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
goldengate_connection_update-microsoft-fabric-connection \- 
.
...
.nf
.ft C
oci goldengate connection update\-microsoft\-fabric\-connection [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export connection_id=<substitute\-value\-of\-connection_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/goldengate/connection/update\-microsoft\-fabric\-connection.html#cmdoption\-connection\-id

    oci goldengate connection update\-microsoft\-fabric\-connection \-\-connection\-id $connection_id
.ft P
.fi
.UNINDENT
.UNINDENT
