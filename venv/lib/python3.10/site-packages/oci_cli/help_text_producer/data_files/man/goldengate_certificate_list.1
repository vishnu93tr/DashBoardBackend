...
.
.TH "GOLDENGATE_CERTIFICATE_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
goldengate_certificate_list \- 
.
...
.nf
.ft C
oci goldengate certificate list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export deployment_id=<substitute\-value\-of\-deployment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/goldengate/certificate/list.html#cmdoption\-deployment\-id

    oci goldengate certificate list \-\-deployment\-id $deployment_id
.ft P
.fi
.UNINDENT
.UNINDENT
