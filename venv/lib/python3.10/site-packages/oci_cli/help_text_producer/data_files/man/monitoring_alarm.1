...
.
.TH "MONITORING_ALARM" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
monitoring_alarm \- 
.
...
.SS Description
.sp
Moves an alarm into a different compartment within the same tenancy. For more information, see \fI\%Moving an Alarm\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Monitoring/Tasks/change-compartment-alarm.htm\fP>\&.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci monitoring alarm change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the compartment to move the alarm to.
...
.ft C
    ...
    oci monitoring alarm change\-compartment \-\-alarm\-id $alarm_id \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-alarm\-summary [text]
.UNINDENT
.sp
Customizable alarm summary (\fIalarmSummary\fP \fI\%alarm message parameter\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Monitoring/alarm-message-format.htm\fP>). Optionally include \fI\%dynamic variables\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Monitoring/Tasks/update-alarm-dynamic-variables.htm\fP>\&. The alarm summary appears within the body of the alarm message and in responses to \fI\%ListAlarmStatus\fP <\fBhttps://docs.cloud.oracle.com/api/#/en/monitoring/latest/AlarmStatusSummary/ListAlarmsStatus\fP> \fI\%GetAlarmHistory\fP <\fBhttps://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/monitoring/alarm-history-collection/get-alarm-history.html\fP> and \fI\%RetrieveDimensionStates\fP <\fBhttps://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/monitoring/alarm-dimension-states-collection/retrieve-dimension-states.html\fP>\&.
.INDENT 0.0
.TP
.B \-\-body [text]
.UNINDENT
.sp
The human\-readable content of the delivered alarm notification. Optionally include \fI\%dynamic variables\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Monitoring/Tasks/update-alarm-dynamic-variables.htm\fP>\&. Oracle recommends providing guidance to operators for resolving the alarm condition. Consider adding links to standard runbook practices. Avoid entering confidential information.
.sp
Example:
.INDENT 0.0
.INDENT 3.5
...
.INDENT 0.0
.TP
.B \-\-evaluation\-slack\-duration [text]
.UNINDENT
.sp
Customizable slack period to wait for metric ingestion before evaluating the alarm. Specify a string in ISO 8601 format (\fIPT10M\fP for ten minutes or \fIPT1H\fP for one hour). Minimum: PT3M. Maximum: PT2H. Default: PT3M. For more information about the slack period, see \fI\%About the Internal Reset Period\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Monitoring/Concepts/monitoringoverview.htm#reset\fP>\&.
.INDENT 0.0
.TP
...
.INDENT 0.0
.TP
.B \-\-notification\-title [text]
.UNINDENT
.sp
Customizable notification title (\fItitle\fP \fI\%alarm message parameter\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Monitoring/alarm-message-format.htm\fP>). Optionally include \fI\%dynamic variables\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Monitoring/Tasks/update-alarm-dynamic-variables.htm\fP>\&. The notification title appears as the subject line in a formatted email message and as the title in a Slack message.
.INDENT 0.0
.TP
...
.UNINDENT
.sp
Identifier of the alarm’s base values for alarm evaluation, for use when the alarm contains overrides. Default value is \fIBASE\fP\&. For information about alarm overrides, see \fI\%AlarmOverride\fP <\fBhttps://docs.cloud.oracle.com/api/#/en/monitoring/latest/datatypes/AlarmOverride\fP>\&.
.INDENT 0.0
.TP
...
.SS Description
.sp
Deletes the specified alarm. For more information, see \fI\%Deleting an Alarm\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Monitoring/Tasks/delete-alarm.htm\fP>\&. For important limits information, see \fI\%Limits on Monitoring\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Monitoring/Concepts/monitoringoverview.htm#limits\fP>\&.
.sp
...
.SS Description
.sp
Gets the specified alarm. For more information, see \fI\%Getting an Alarm\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Monitoring/Tasks/get-alarm.htm\fP>\&. For important limits information, see \fI\%Limits on Monitoring\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Monitoring/Concepts/monitoringoverview.htm#limits\fP>\&.
.sp
This call is subject to a Monitoring limit that applies to the total number of requests across all alarm operations. Monitoring might throttle this call to reject an otherwise valid request when the total rate of alarm operations exceeds 10 requests, or transactions, per second (TPS) for a given tenancy.
.SS Usage
.INDENT 0.0
...
.SS Description
.sp
Lists the alarms for the specified compartment. For more information, see \fI\%Listing Alarms\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Monitoring/Tasks/list-alarm.htm\fP>\&. For important limits information, see \fI\%Limits on Monitoring\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Monitoring/Concepts/monitoringoverview.htm#limits\fP>\&.
.sp
This call is subject to a Monitoring limit that applies to the total number of requests across all alarm operations. Monitoring might throttle this call to reject an otherwise valid request when the total rate of alarm operations exceeds 10 requests, or transactions, per second (TPS) for a given tenancy.
.SS Usage
.INDENT 0.0
...
.UNINDENT
.sp
When set to \fItrue\fP, splits alarm notifications per metric stream. When set to \fIfalse\fP, groups alarm notifications across metric streams.
.INDENT 0.0
.TP
.B \-\-max\-wait\-seconds [integer]
.UNINDENT
