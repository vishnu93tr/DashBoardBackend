...
.
.TH "API-GATEWAY_GATEWAY" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
api-gateway_gateway \- 
.
...
.nf
.ft C
oci api\-gateway gateway change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci api\-gateway gateway change\-compartment \-\-compartment\-id $compartment_id \-\-gateway\-id $gateway_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci api\-gateway gateway create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-endpoint\-type [text]
.UNINDENT
.sp
Gateway endpoint type. \fIPUBLIC\fP will have a public ip address assigned to it, while \fIPRIVATE\fP will only be accessible on a private IP address on the subnet.
.sp
Example:
.INDENT 0.0
.INDENT 3.5
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the subnet in which related resources are created.
.SS Optional Parameters
.INDENT 0.0
.TP
.B \-\-ca\-bundles [complex type]
.UNINDENT
.sp
An array of CA bundles that should be used on the Gateway for TLS validation.
.sp
This option is a JSON list with items of type CaBundle.  For documentation on CaBundle please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/gateway/20190501/datatypes/CaBundle\fP\&.
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the resource.
.INDENT 0.0
.TP
...
.INDENT 0.0
.TP
.B \-\-response\-cache\-details [complex type]
.UNINDENT
.sp
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
...
.ft C
    ...
    oci api\-gateway gateway create \-\-compartment\-id $compartment_id \-\-endpoint\-type $endpoint_type \-\-subnet\-id $subnet_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci api\-gateway gateway delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci api\-gateway gateway delete \-\-gateway\-id $gateway_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci api\-gateway gateway get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci api\-gateway gateway list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/api\-gateway/gateway/list.html#cmdoption\-compartment\-id

    oci api\-gateway gateway list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci api\-gateway gateway update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci api\-gateway gateway update \-\-gateway\-id $gateway_id
.ft P
.fi
.UNINDENT
.UNINDENT
