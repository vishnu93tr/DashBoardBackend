...
.
.TH "ROVER_NODE_ADD-WORKLOAD" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
rover_node_add-workload \- 
.
...
.SH DESCRIPTION
.sp
Add workload information to Rover Node
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci rover node add\-workload [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export type=<substitute\-value\-of\-type> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/rover/node/add\-workload.html#cmdoption\-type
    ...
    oci rover node add\-workload \-\-node\-id $node_id \-\-type $type
.ft P
.fi
.UNINDENT
.UNINDENT
