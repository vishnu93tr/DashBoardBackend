...
.
.TH "NOSQL_TABLE_CREATE-REPLICA" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
nosql_table_create-replica \- 
.
...
.nf
.ft C
oci nosql table create\-replica [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export replica_region=<substitute\-value\-of\-replica_region> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/nosql/table/create\-replica.html#cmdoption\-replica\-region
    export table_name_or_id=<substitute\-value\-of\-table_name_or_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/nosql/table/create\-replica.html#cmdoption\-table\-name\-or\-id

    oci nosql table create\-replica \-\-replica\-region $replica_region \-\-table\-name\-or\-id $table_name_or_id
.ft P
.fi
.UNINDENT
.UNINDENT
