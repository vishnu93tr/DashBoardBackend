...
.
.TH "DISASTER-RECOVERY_DR-PLAN" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
disaster-recovery_dr-plan \- 
.
...
refresh
.IP \(bu 2
refresh\-dr\-plan\-refresh\-dr\-plan\-default\-details
.IP \(bu 2
update
.IP \(bu 2
verify
.IP \(bu 2
verify\-dr\-plan\-verify\-dr\-plan\-default\-details
.UNINDENT
.SS \fBcreate\fP
.INDENT 0.0
.IP \(bu 2
...
.ft C
    ...
    export type=<substitute\-value\-of\-type> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/disaster\-recovery/dr\-plan/create.html#cmdoption\-type
    ...
    oci disaster\-recovery dr\-plan create \-\-display\-name $display_name \-\-dr\-protection\-group\-id $dr_protection_group_id \-\-type $type
.ft P
.fi
.UNINDENT
.UNINDENT
...
.SS Description
.sp
Delete the DR plan identified by \fIdrPlanId\fP\&.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci disaster\-recovery dr\-plan delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    dr_plan_id=$(oci disaster\-recovery dr\-plan create \-\-display\-name $display_name \-\-dr\-protection\-group\-id $dr_protection_group_id \-\-type $type \-\-query data.id \-\-raw\-output)

    oci disaster\-recovery dr\-plan delete \-\-dr\-plan\-id $dr_plan_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.SS Description
.sp
Get details for the DR plan identified by \fIdrPlanId\fP\&.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci disaster\-recovery dr\-plan get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci disaster\-recovery dr\-plan get \-\-dr\-plan\-id $dr_plan_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci disaster\-recovery dr\-plan list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.SS Description
.sp
Refresh DR Plan identified by \fIdrPlanId\fP\&.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci disaster\-recovery dr\-plan refresh [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci disaster\-recovery dr\-plan refresh \-\-dr\-plan\-id $dr_plan_id \-\-type $type
.ft P
.fi
.UNINDENT
.UNINDENT
.SS \fBrefresh\-dr\-plan\-refresh\-dr\-plan\-default\-details\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.nf
.ft C
oci disaster\-recovery dr\-plan refresh\-dr\-plan\-refresh\-dr\-plan\-default\-details [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci disaster\-recovery dr\-plan refresh\-dr\-plan\-refresh\-dr\-plan\-default\-details \-\-dr\-plan\-id $dr_plan_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.SS Description
.sp
Update the DR plan identified by \fIdrPlanId\fP\&.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci disaster\-recovery dr\-plan update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-plan\-groups [complex type]
.UNINDENT
.sp
An ordered list of groups in a DR plan.
.sp
This option is a JSON list with items of type UpdateDrPlanGroupDetails.  For documentation on UpdateDrPlanGroupDetails please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/disasterrecovery/20220125/datatypes/UpdateDrPlanGroupDetails\fP\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
.ft C
    ...
    oci disaster\-recovery dr\-plan update \-\-dr\-plan\-id $dr_plan_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.SS Description
.sp
Verify DR Plan identified by \fIdrPlanId\fP\&.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci disaster\-recovery dr\-plan verify [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci disaster\-recovery dr\-plan verify \-\-dr\-plan\-id $dr_plan_id \-\-type $type
.ft P
.fi
.UNINDENT
.UNINDENT
.SS \fBverify\-dr\-plan\-verify\-dr\-plan\-default\-details\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.nf
.ft C
oci disaster\-recovery dr\-plan verify\-dr\-plan\-verify\-dr\-plan\-default\-details [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci disaster\-recovery dr\-plan verify\-dr\-plan\-verify\-dr\-plan\-default\-details \-\-dr\-plan\-id $dr_plan_id
.ft P
.fi
.UNINDENT
.UNINDENT
