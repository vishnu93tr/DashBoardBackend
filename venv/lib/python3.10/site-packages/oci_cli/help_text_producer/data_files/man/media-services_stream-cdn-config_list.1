...
.
.TH "MEDIA-SERVICES_STREAM-CDN-CONFIG_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
media-services_stream-cdn-config_list \- 
.
...
.nf
.ft C
oci media\-services stream\-cdn\-config list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export distribution_channel_id=<substitute\-value\-of\-distribution_channel_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/media\-services/stream\-cdn\-config/list.html#cmdoption\-distribution\-channel\-id

    oci media\-services stream\-cdn\-config list \-\-distribution\-channel\-id $distribution_channel_id
.ft P
.fi
.UNINDENT
.UNINDENT
