...
.
.TH "DATA-SAFE_SENSITIVE-DATA-MODEL_UPLOAD" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_sensitive-data-model_upload \- 
.
...
.nf
.ft C
oci data\-safe sensitive\-data\-model upload [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-upload\-sensitive\-data\-model\-details [text]
.UNINDENT
.sp
...
.ft C
    ...
    export upload_sensitive_data_model_details=<substitute\-value\-of\-upload_sensitive_data_model_details> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-safe/sensitive\-data\-model/upload.html#cmdoption\-upload\-sensitive\-data\-model\-details
    ...
    oci data\-safe sensitive\-data\-model upload \-\-sensitive\-data\-model\-id $sensitive_data_model_id \-\-upload\-sensitive\-data\-model\-details $upload_sensitive_data_model_details
.ft P
.fi
.UNINDENT
.UNINDENT
