...
.
.TH "JMS_MANAGED-INSTANCE-USAGE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
...
.nf
.ft C
ORACLE_CLOUD_AGENT, ORACLE_MANAGEMENT_AGENT
.ft P
.fi
.UNINDENT
.UNINDENT
...
.fi
, _approximateInstallationCount_ and _approximateApplicationCount_  is \fBdescending\fP\&. Default order for _osName_ is \fBascending\fP\&. If no value is specified _timeLastSeen_ is default.
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
