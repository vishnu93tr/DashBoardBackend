...
.
.TH "NETWORK-FIREWALL_NETWORK-FIREWALL-POLICY_CLONE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network-firewall_network-firewall-policy_clone \- 
.
...
.nf
.ft C
oci network\-firewall network\-firewall\-policy clone [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the compartment containing the NetworkFirewall Policy.
.INDENT 0.0
.TP
...
.ft C
    ...
    oci network\-firewall network\-firewall\-policy clone \-\-network\-firewall\-policy\-id $network_firewall_policy_id
.ft P
.fi
.UNINDENT
.UNINDENT
