...
.
.TH "DB_SYSTEM" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_system \- 
.
...
.SS Description
.sp
Moves the DB system and its dependent resources to the specified compartment. For more information about moving DB systems, see \fI\%Moving Database Resources to a Different Compartment\fP <\fBhttps://docs.cloud.oracle.com/Content/Database/Concepts/databaseoverview.htm#moveRes\fP>\&.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
...
.UNINDENT
.UNINDENT
.SS \fBget\-exadata\-iorm\-config\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
For Exadata Cloud Service instances, support for this API will end on May 15th, 2021. See \fI\%Switching an Exadata DB System to the New Resource Model and APIs\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Database/Concepts/exaflexsystem_topic-resource_model_conversion.htm\fP> for details on converting existing Exadata DB systems to the new resource model.
.sp
The \fI\%GetCloudVmClusterIormConfig\fP <\fBhttps://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/db/cloud-vm-cluster/get-exadata-iorm-config.html\fP> API is used for this operation with Exadata systems using the new resource model.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
...
.INDENT 0.0
.TP
.B \-\-auto\-full\-backup\-day [text]
.UNINDENT
.sp
Day of the week the full backup should be applied on the database system. If no option is selected, the value is null and we will default to Sunday.
.INDENT 0.0
.TP
.B \-\-auto\-full\-backup\-window [text]
.UNINDENT
.sp
Specifying a two hour slot when the full backup should kick in eg:\- SLOT_ONE,SLOT_TWO. Default is anytime
.INDENT 0.0
.TP
...
.INDENT 0.0
.TP
.B \-\-is\-unified\-auditing\-enabled [boolean]
.UNINDENT
.sp
Indicates whether unified auditing is enabled or not. Set to True to enable unified auditing on respective DBHome.
.INDENT 0.0
.TP
.B \-\-kms\-key\-id [text]
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-run\-immediate\-full\-backup [boolean]
.UNINDENT
.sp
...
.SS Description
.sp
Lists the DB systems in the specified compartment. You can specify a \fIbackupId\fP to list only the DB systems that support creating a database using this backup in this compartment.
.sp
\fBNote:\fP Deprecated for Exadata Cloud Service systems. Use the \fI\%new resource model APIs\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Database/Concepts/exaflexsystem.htm#exaflexsystem_topic-resource_model\fP> instead.
.sp
For Exadata Cloud Service instances, support for this API will end on May 15th, 2021. See \fI\%Switching an Exadata DB System to the New Resource Model and APIs\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Database/Concepts/exaflexsystem_topic-resource_model_conversion.htm\fP> for details on converting existing Exadata DB systems to the new resource model.
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the backup. Specify a backupId to list only the DB systems or DB homes that support creating a database using this backup in this compartment.
.INDENT 0.0
.TP
.B \-\-display\-name [text]
.UNINDENT
...
.UNINDENT
.UNINDENT
.SS \fBlist\-db\-system\-compute\-performances\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.UNINDENT
.UNINDENT
.SS \fBlist\-db\-system\-storage\-performances\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.UNINDENT
.sp
The DB system storage management option. Used to list database versions available for that storage manager. Valid values are \fIASM\fP and \fILVM\fP\&. * ASM specifies Oracle Automatic Storage Management * LVM specifies logical volume manager, sometimes called logical disk manager.
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
...
.SS Description
.sp
Migrates the Exadata DB system to the new \fI\%Exadata resource model\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Database/Concepts/exaflexsystem.htm#exaflexsystem_topic-resource_model\fP>\&. All related resources will be migrated.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
...
.INDENT 0.0
.TP
.B \-\-reco\-storage\-size\-in\-gbs [integer]
.UNINDENT
.sp
...
.UNINDENT
.UNINDENT
.SS \fBupdate\-exadata\-iorm\-config\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
For Exadata Cloud Service instances, support for this API will end on May 15th, 2021. See \fI\%Switching an Exadata DB System to the New Resource Model and APIs\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Database/Concepts/exaflexsystem_topic-resource_model_conversion.htm\fP> for details on converting existing Exadata DB systems to the new resource model.
.sp
The \fI\%UpdateCloudVmClusterIormConfig\fP <\fBhttps://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/db/cloud-vm-cluster/update-exadata-iorm-config.html\fP> API is used for Exadata systems using the new resource model.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
...
.INDENT 0.0
.TP
.B \-\-db\-plans [complex type]
.UNINDENT
.sp
Array of IORM Setting for all the database in this Exadata DB System
.sp
This option is a JSON list with items of type DbIormConfigUpdateDetail.  For documentation on dbIormConfigUpdateDetail please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/database/20160918/datatypes/DbIormConfigUpdateDetail\fP\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
.INDENT 0.0
.TP
.B \-\-new\-gi\-version [text]
.UNINDENT
.sp
A valid Oracle Grid Infrastructure (GI) software version.
.INDENT 0.0
.TP
.B \-\-new\-os\-version [text]
.UNINDENT
.sp
A valid Oracle Software (OS) version eg. Oracle Linux Server release 8
.INDENT 0.0
.TP
.B \-\-snapshot\-retention\-period [integer]
.UNINDENT
.sp
