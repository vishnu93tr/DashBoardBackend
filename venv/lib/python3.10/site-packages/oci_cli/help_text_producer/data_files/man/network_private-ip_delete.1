...
.
.TH "NETWORK_PRIVATE-IP_DELETE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
...
.SH DESCRIPTION
.sp
Unassigns and deletes the specified private IP. You must specify the object’s \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP>\&. The private IP address is returned to the subnet’s pool of available addresses.
.sp
...
.sp
\fBImportant:\fP If a secondary private IP is the \fI\%target of a route rule\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Network/Tasks/managingroutetables.htm#privateip\fP>, unassigning it from the VNIC causes that route rule to blackhole and the traffic will be dropped.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
