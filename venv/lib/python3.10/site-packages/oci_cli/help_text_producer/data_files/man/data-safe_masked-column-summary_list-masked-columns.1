...
.
.TH "DATA-SAFE_MASKED-COLUMN-SUMMARY_LIST-MASKED-COLUMNS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_masked-column-summary_list-masked-columns \- 
.
...
.nf
.ft C
oci data\-safe masked\-column\-summary list\-masked\-columns [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
maskingColumnGroupId, objectName, schemaName, sensitiveTypeId
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export masking_report_id=<substitute\-value\-of\-masking_report_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-safe/masked\-column\-summary/list\-masked\-columns.html#cmdoption\-masking\-report\-id

    oci data\-safe masked\-column\-summary list\-masked\-columns \-\-masking\-report\-id $masking_report_id
.ft P
.fi
.UNINDENT
.UNINDENT
