...
.
.TH "JMS_CRYPTO-ANALYSIS-RESULT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
jms_crypto-analysis-result \- 
.
...
.nf
.ft C
oci jms crypto\-analysis\-result delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-crypto\-analysis\-result\-id [text]
.UNINDENT
.sp
...
.ft C
    ...
    export crypto_analysis_result_id=<substitute\-value\-of\-crypto_analysis_result_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/jms/crypto\-analysis\-result/delete.html#cmdoption\-crypto\-analysis\-result\-id
    ...
    oci jms crypto\-analysis\-result delete \-\-crypto\-analysis\-result\-id $crypto_analysis_result_id \-\-fleet\-id $fleet_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci jms crypto\-analysis\-result get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/jms/fleet/create.html#cmdoption\-compartment\-id
    export display_name=<substitute\-value\-of\-display_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/jms/fleet/create.html#cmdoption\-display\-name
    export crypto_analysis_result_id=<substitute\-value\-of\-crypto_analysis_result_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/jms/crypto\-analysis\-result/get.html#cmdoption\-crypto\-analysis\-result\-id

    fleet_id=$(oci jms fleet create \-\-compartment\-id $compartment_id \-\-display\-name $display_name \-\-inventory\-log file://inventory\-log.json \-\-query data.id \-\-raw\-output)

    oci jms crypto\-analysis\-result get \-\-crypto\-analysis\-result\-id $crypto_analysis_result_id \-\-fleet\-id $fleet_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci jms crypto\-analysis\-result list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-finding\-count [integer]
.UNINDENT
.sp
FindingCount of CryptoAnalysis Report.
.INDENT 0.0
.TP
.B \-\-finding\-count\-greater\-than [integer]
.UNINDENT
.sp
FindingCount of CryptoAnalysis Report.
.INDENT 0.0
...
.UNINDENT
.sp
The host \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the managed instance.
.INDENT 0.0
.TP
.B \-\-limit [integer]
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-non\-compliant\-finding\-count [integer]
.UNINDENT
.sp
Non Compliant Finding Count of CryptoAnalysis Report.
.INDENT 0.0
.TP
.B \-\-non\-compliant\-finding\-count\-greater\-than [integer]
.UNINDENT
.sp
Non Compliant Finding Count of CryptoAnalysis Report.
.INDENT 0.0
...
.UNINDENT
.sp
The field to sort crypto event analysis results. Only one sort order can be provided. Default order for _timeCreated_, and _jreVersion_ is \fBdescending\fP\&. Default order for _managedInstanceId_, _jreDistribution_, _jreVendor_ and _osName_ is \fBascending\fP\&. If no value is specified _timeCreated_ is default.
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
...
.nf
.ft C
managedInstanceId, timeCreated, workRequestId
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The end of the time period during which resources are searched (formatted according to \fI\%RFC3339\fP <\fBhttps://datatracker.ietf.org/doc/html/rfc3339\fP>).
.INDENT 0.0
.INDENT 3.5
...
.UNINDENT
.sp
The start of the time period during which resources are searched (formatted according to \fI\%RFC3339\fP <\fBhttps://datatracker.ietf.org/doc/html/rfc3339\fP>).
.INDENT 0.0
.INDENT 3.5
The following datetime formats are supported:
.UNINDENT
...
.ft C
    ...
    oci jms crypto\-analysis\-result list \-\-fleet\-id $fleet_id
.ft P
.fi
.UNINDENT
.UNINDENT
