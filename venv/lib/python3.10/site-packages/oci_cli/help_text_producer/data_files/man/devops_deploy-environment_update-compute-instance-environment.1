...
.
.TH "DEVOPS_DEPLOY-ENVIRONMENT_UPDATE-COMPUTE-INSTANCE-ENVIRONMENT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
devops_deploy-environment_update-compute-instance-environment \- 
.
...
.nf
.ft C
oci devops deploy\-environment update\-compute\-instance\-environment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-compute\-instance\-group\-selectors [complex type]
.UNINDENT
.sp
...
.nf
.ft C
    export environment_id=<substitute\-value\-of\-environment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/devops/deploy\-environment/update\-compute\-instance\-environment.html#cmdoption\-environment\-id

    oci devops deploy\-environment update\-compute\-instance\-environment \-\-environment\-id $environment_id
.ft P
.fi
.UNINDENT
.UNINDENT
