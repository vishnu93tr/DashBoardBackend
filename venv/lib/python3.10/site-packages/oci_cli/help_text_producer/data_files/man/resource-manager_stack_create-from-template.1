...
.
.TH "RESOURCE-MANAGER_STACK_CREATE-FROM-TEMPLATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
resource-manager_stack_create-from-template \- 
.
...
.nf
.ft C
oci resource\-manager stack create\-from\-template [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-working\-directory [text]
.UNINDENT
.sp
File path to the directory from which Terraform runs. If not specified, the root directory is used. This parameter is ignored for the \fIconfigSourceType\fP value of \fICOMPARTMENT_CONFIG_SOURCE\fP\&.
...
.ft C
    ...
    oci resource\-manager stack create\-from\-template \-\-compartment\-id $compartment_id \-\-template\-id $template_id
.ft P
.fi
.UNINDENT
.UNINDENT
