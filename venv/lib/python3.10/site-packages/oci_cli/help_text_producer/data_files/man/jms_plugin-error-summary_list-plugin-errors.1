...
.
.TH "JMS_PLUGIN-ERROR-SUMMARY_LIST-PLUGIN-ERRORS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
jms_plugin-error-summary_list-plugin-errors \- 
.
...
.nf
.ft C
oci jms plugin\-error\-summary list\-plugin\-errors [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The field to sort PluginError. Only one sort order may be provided. Default order is \fBdescending\fP\&. If no value is specified _timeLastSeen_ is default.
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
...
.INDENT 0.0
.TP
.B \-\-time\-first\-seen\-greater\-than\-or\-equal\-to [datetime]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-time\-first\-seen\-less\-than\-or\-equal\-to [datetime]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-time\-last\-seen\-greater\-than\-or\-equal\-to [datetime]
.UNINDENT
.sp
