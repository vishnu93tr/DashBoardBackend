...
.
.TH "DATA-SAFE_REPORT-SUMMARY_LIST-REPORTS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_report-summary_list-reports \- 
.
...
.nf
.ft C
oci data\-safe report\-summary list\-reports [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-time\-generated\-greater\-than\-or\-equal\-to [datetime]
.UNINDENT
.sp
A filter to return only the resources that were generated after the specified date and time, as defined by \fI\%RFC3339\fP <\fBhttps://tools.ietf.org/html/rfc3339\fP>\&. Using TimeGeneratedGreaterThanOrEqualToQueryParam parameter retrieves all resources generated after that date.
.sp
...
.INDENT 0.0
.TP
.B \-\-time\-generated\-less\-than [datetime]
.UNINDENT
.sp
Search for resources that were generated before a specific date. Specifying this parameter corresponding \fItimeGeneratedLessThan\fP parameter will retrieve all resources generated before the specified generated date, in “YYYY\-MM\-ddThh:mmZ” format with a Z offset, as defined by RFC 3339.
.sp
\fBExample:\fP 2016\-12\-19T16:39:57.600Z
.INDENT 0.0
.INDENT 3.5
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-safe/report\-summary/list\-reports.html#cmdoption\-compartment\-id

    oci data\-safe report\-summary list\-reports \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
