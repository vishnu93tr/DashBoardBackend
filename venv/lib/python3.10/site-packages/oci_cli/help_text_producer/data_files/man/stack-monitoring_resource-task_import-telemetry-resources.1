...
.
.TH "STACK-MONITORING_RESOURCE-TASK_IMPORT-TELEMETRY-RESOURCES" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
stack-monitoring_resource-task_import-telemetry-resources \- 
.
...
.INDENT 0.0
.TP
.B \-\-availability\-proxy\-metric\-collection\-interval [integer]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-availability\-proxy\-metrics [complex type]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-console\-path\-prefix [text]
.UNINDENT
.sp
The console path prefix to use for providing service home url page navigation. For example if the prefix provided is ‘security/bastion/bastions’, the URL used for navigation will be \fI\%https:/\fP/<cloudhostname>/security/bastion/bastions/<resourceOcid>. If not provided, service home page link will not be shown in the stack monitoring home page.
.INDENT 0.0
.TP
...
.INDENT 0.0
.TP
.B \-\-up\-status\-mappings [complex type]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-use\-metrics\-for\-status [boolean]
.UNINDENT
.sp
