...
.
.TH "OPSI_DATABASE-INSIGHTS_LIST-ADDM-DBS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
opsi_database-insights_list-addm-dbs \- 
.
...
.nf
.ft C
oci opsi database\-insights list\-addm\-dbs [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/opsi/database\-insights/list\-addm\-dbs.html#cmdoption\-compartment\-id

    oci opsi database\-insights list\-addm\-dbs \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
