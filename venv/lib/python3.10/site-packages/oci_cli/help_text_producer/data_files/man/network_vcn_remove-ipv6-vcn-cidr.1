...
.
.TH "NETWORK_VCN_REMOVE-IPV6-VCN-CIDR" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network_vcn_remove-ipv6-vcn-cidr \- 
.
...
.nf
.ft C
oci network vcn remove\-ipv6\-vcn\-cidr [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
This field is not required and should only be specified when removing ULA or private IPv6 prefix or an IPv6 GUA assigned by Oracle or BYOIPv6 prefix from a VCN’s IPv6 address space. See\(gaIPv6 Addresses <\fI\%https://docs.cloud.oracle.com/iaas/Content/Network/Concepts/ipv6.htm\fP>\(ga__.
.sp
Example:
.INDENT 0.0
.INDENT 3.5
...
.ft C
    ...
    oci network vcn remove\-ipv6\-vcn\-cidr \-\-vcn\-id $vcn_id
.ft P
.fi
.UNINDENT
.UNINDENT
