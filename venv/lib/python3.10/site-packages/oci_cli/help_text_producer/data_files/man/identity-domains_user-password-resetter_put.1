...
.
.TH "IDENTITY-DOMAINS_USER-PASSWORD-RESETTER_PUT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_user-password-resetter_put \- 
.
...
.nf
.ft C
oci identity\-domains user\-password\-resetter put [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-user\-password\-resetter\-id [text]
.UNINDENT
.sp
ID of the resource
...
.INDENT 0.0
.TP
.B \-\-user\-flow\-controlled\-by\-external\-client [boolean]
.UNINDENT
.sp
...
.sp
\fBSCIM++ Properties:\fP  \- type: boolean  \- caseExact: false  \- idcsSearchable: false  \- multiValued: false  \- mutability: immutable  \- required: false  \- returned: never  \- uniqueness: none
.INDENT 0.0
.TP
.B \-\-user\-token [complex type]
.UNINDENT
.sp
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
...
.nf
.ft C
    oci identity\-domains user\-password\-resetter put \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export user_password_resetter_id=<substitute\-value\-of\-user_password_resetter_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/identity\-domains/user\-password\-resetter/put.html#cmdoption\-user\-password\-resetter\-id

    oci identity\-domains user\-password\-resetter put \-\-schemas file://schemas.json \-\-user\-password\-resetter\-id $user_password_resetter_id
.ft P
.fi
.UNINDENT
.UNINDENT
