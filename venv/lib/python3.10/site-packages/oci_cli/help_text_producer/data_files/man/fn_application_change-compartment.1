...
.
.TH "FN_APPLICATION_CHANGE-COMPARTMENT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
fn_application_change-compartment \- 
.
...
.SH DESCRIPTION
.sp
Moves an application into a different compartment within the same tenancy. For information about moving resources between compartments, see \fI\%Moving Resources Between Compartments\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Identity/Tasks/managingcompartments.htm#moveRes\fP>\&.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci fn application change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of this application.
.INDENT 0.0
.TP
...
.ft C
    ...
    oci fn application change\-compartment \-\-application\-id $application_id \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
