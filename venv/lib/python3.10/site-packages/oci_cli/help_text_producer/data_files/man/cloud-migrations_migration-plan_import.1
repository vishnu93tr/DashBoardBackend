...
.
.TH "CLOUD-MIGRATIONS_MIGRATION-PLAN_IMPORT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
cloud-migrations_migration-plan_import \- 
.
...
.nf
.ft C
oci cloud\-migrations migration\-plan import [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-import\-migration\-plan\-details [text]
.UNINDENT
.sp
...
.ft C
    ...
    export import_migration_plan_details=<substitute\-value\-of\-import_migration_plan_details> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/cloud\-migrations/migration\-plan/import.html#cmdoption\-import\-migration\-plan\-details
    ...
    oci cloud\-migrations migration\-plan import \-\-import\-migration\-plan\-details $import_migration_plan_details \-\-migration\-plan\-id $migration_plan_id
.ft P
.fi
.UNINDENT
.UNINDENT
