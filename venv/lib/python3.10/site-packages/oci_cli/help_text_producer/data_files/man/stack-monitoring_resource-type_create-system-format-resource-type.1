...
.
.TH "STACK-MONITORING_RESOURCE-TYPE_CREATE-SYSTEM-FORMAT-RESOURCE-TYPE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
stack-monitoring_resource-type_create-system-format-resource-type \- 
.
...
.nf
.ft C
oci stack\-monitoring resource\-type create\-system\-format\-resource\-type [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-agent\-properties [complex type]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-metric\-namespace [text]
.UNINDENT
.sp
Metric namespace for resource type.
.INDENT 0.0
.TP
.B \-\-required\-properties [complex type]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-sub\-resource\-types [complex type]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-unique\-property\-sets [complex type]
.UNINDENT
.sp
...
.sp
This option is a JSON list with items of type UniquePropertySet.  For documentation on UniquePropertySet please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/stackmonitoring/20210330/datatypes/UniquePropertySet\fP\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
.INDENT 0.0
.TP
.B \-\-valid\-properties\-for\-create [complex type]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-valid\-properties\-for\-update [complex type]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-valid\-property\-values [complex type]
.UNINDENT
.sp
List of valid values for the properties. This is useful when resource type wants to restrict only certain values for some properties. For instance for ‘osType’ property, supported values can be restricted to be either Linux or Windows. Example: \fI{ “osType”: [“Linux”,”Windows”,”Solaris”]}\fP
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/stack\-monitoring/resource\-type/create\-system\-format\-resource\-type.html#cmdoption\-compartment\-id
    export name=<substitute\-value\-of\-name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/stack\-monitoring/resource\-type/create\-system\-format\-resource\-type.html#cmdoption\-name

    oci stack\-monitoring resource\-type create\-system\-format\-resource\-type \-\-compartment\-id $compartment_id \-\-name $name
.ft P
.fi
.UNINDENT
.UNINDENT
