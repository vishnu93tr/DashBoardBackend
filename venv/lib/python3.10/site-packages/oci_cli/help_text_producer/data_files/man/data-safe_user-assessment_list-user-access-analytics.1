...
.
.TH "DATA-SAFE_USER-ASSESSMENT_LIST-USER-ACCESS-ANALYTICS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_user-assessment_list-user-access-analytics \- 
.
...
.nf
.ft C
oci data\-safe user\-assessment list\-user\-access\-analytics [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci data\-safe user\-assessment list\-user\-access\-analytics \-\-user\-assessment\-id $user_assessment_id
.ft P
.fi
.UNINDENT
.UNINDENT
