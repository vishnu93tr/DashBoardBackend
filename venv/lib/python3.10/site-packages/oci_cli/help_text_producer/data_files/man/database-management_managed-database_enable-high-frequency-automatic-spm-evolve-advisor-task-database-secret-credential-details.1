...
.
.TH "DATABASE-MANAGEMENT_MANAGED-DATABASE_ENABLE-HIGH-FREQUENCY-AUTOMATIC-SPM-EVOLVE-ADVISOR-TASK-DATABASE-SECRET-CREDENTIAL-DETAILS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
database-management_managed-database_enable-high-frequency-automatic-spm-evolve-advisor-task-database-secret-credential-details \- 
.
...
.nf
.ft C
oci database\-management managed\-database enable\-high\-frequency\-automatic\-spm\-evolve\-advisor\-task\-database\-secret\-credential\-details [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci database\-management managed\-database enable\-high\-frequency\-automatic\-spm\-evolve\-advisor\-task\-database\-secret\-credential\-details \-\-database\-credential\-password\-secret\-id $database_credential_password_secret_id \-\-managed\-database\-id $managed_database_id
.ft P
.fi
.UNINDENT
.UNINDENT
