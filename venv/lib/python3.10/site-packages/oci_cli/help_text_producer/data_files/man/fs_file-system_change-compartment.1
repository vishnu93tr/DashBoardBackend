...
.
.TH "FS_FILE-SYSTEM_CHANGE-COMPARTMENT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
fs_file-system_change-compartment \- 
.
...
.nf
.ft C
oci fs file\-system change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the compartment to move the file system to.
.INDENT 0.0
.TP
...
.ft C
    ...
    oci fs file\-system change\-compartment \-\-compartment\-id $compartment_id \-\-file\-system\-id $file_system_id
.ft P
.fi
.UNINDENT
.UNINDENT
