...
.
.TH "NETWORK_DRG-ATTACHMENT_DELETE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network_drg-attachment_delete \- 
.
...
.SH DESCRIPTION
.sp
Detaches a DRG from a network resource by deleting the corresponding \fIDrgAttachment\fP resource. This is an asynchronous operation. The attachment’s \fIlifecycleState\fP will temporarily change to DETACHING until the attachment is completely removed.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci network drg\-attachment delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci network drg\-attachment delete \-\-drg\-attachment\-id $drg_attachment_id
.ft P
.fi
.UNINDENT
.UNINDENT
