...
.
.TH "NETWORK_DHCP-OPTIONS_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network_dhcp-options_list \- 
.
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/network/dhcp\-options/list.html#cmdoption\-compartment\-id

    oci network dhcp\-options list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
