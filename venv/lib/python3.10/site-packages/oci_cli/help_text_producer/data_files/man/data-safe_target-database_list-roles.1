...
.
.TH "DATA-SAFE_TARGET-DATABASE_LIST-ROLES" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_target-database_list-roles \- 
.
...
.nf
.ft C
oci data\-safe target\-database list\-roles [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci data\-safe target\-database list\-roles \-\-target\-database\-id $target_database_id
.ft P
.fi
.UNINDENT
.UNINDENT
