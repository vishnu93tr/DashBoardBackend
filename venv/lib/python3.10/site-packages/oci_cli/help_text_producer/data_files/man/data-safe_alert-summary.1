...
.
.TH "DATA-SAFE_ALERT-SUMMARY" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_alert-summary \- 
.
...
.nf
.ft C
oci data\-safe alert\-summary list\-alert\-analytics [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
alertPolicyRuleKey, alertPolicyRuleName, alertSeverity, alertStatus, alertType, policyId, targetIds, targetNames, timeCreated
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
alertPolicyRuleKey, alertPolicyRuleName, alertSeverity, alertStatus, alertType, alertcount, closed, critical, high, low, medium, open, policyId, targetIds, targetNames, throttled, timeCreated
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-safe/alert\-summary/list\-alert\-analytics.html#cmdoption\-compartment\-id

    oci data\-safe alert\-summary list\-alert\-analytics \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci data\-safe alert\-summary list\-alerts [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
alertType, displayName, id, lifecycleState, operation, operationStatus, operationTime, policyId, severity, status, targetIds, targetNames, timeCreated, timeUpdated
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-safe/alert\-summary/list\-alerts.html#cmdoption\-compartment\-id

    oci data\-safe alert\-summary list\-alerts \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
