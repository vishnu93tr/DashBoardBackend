...
.
.TH "DB_AUTONOMOUS-EXADATA-INFRASTRUCTURE_ROTATE-SSL-CERTS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_autonomous-exadata-infrastructure_rotate-ssl-certs \- 
.
...
.SH DESCRIPTION
.sp
\fBDeprecated.\fP Use the \fI\%RotateCloudAutonomousVmClusterSslCerts\fP <\fBhttps://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/db/cloud-autonomous-vm-cluster/rotate-cloud-autonomous-vm-cluster-ssl-certs.html\fP> to rotate SSL certs for an Autonomous Exadata VM cluster instead.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci db autonomous\-exadata\-infrastructure rotate\-ssl\-certs [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci db autonomous\-exadata\-infrastructure rotate\-ssl\-certs \-\-autonomous\-exadata\-infrastructure\-id $autonomous_exadata_infrastructure_id
.ft P
.fi
.UNINDENT
.UNINDENT
