...
.
.TH "APM-CONFIG_CONFIG_UPDATE-SPAN-FILTER" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
apm-config_config_update-span-filter \- 
.
...
.nf
.ft C
oci apm\-config config update\-span\-filter [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export apm_domain_id=<substitute\-value\-of\-apm_domain_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/apm\-config/config/update\-span\-filter.html#cmdoption\-apm\-domain\-id
    export config_id=<substitute\-value\-of\-config_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/apm\-config/config/update\-span\-filter.html#cmdoption\-config\-id

    oci apm\-config config update\-span\-filter \-\-apm\-domain\-id $apm_domain_id \-\-config\-id $config_id
.ft P
.fi
.UNINDENT
.UNINDENT
