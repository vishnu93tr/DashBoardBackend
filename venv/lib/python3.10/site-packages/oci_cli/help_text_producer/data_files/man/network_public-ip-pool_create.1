...
.
.TH "NETWORK_PUBLIC-IP-POOL_CREATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network_public-ip-pool_create \- 
.
...
.nf
.ft C
oci network public\-ip\-pool create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the compartment containing the public IP pool.
...
.ft C
    ...
    oci network public\-ip\-pool create \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
