...
.
.TH "NETWORK_NSG_UPDATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network_nsg_update \- 
.
...
.sp
To add or remove an existing VNIC from the group, use \fI\%UpdateVnic\fP <\fBhttps://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/network/vnic/update.html\fP>\&.
.sp
To add a VNIC to the group \fIwhen you create the VNIC\fP, specify the NSG’s \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> during creation. For example, see the \fInsgIds\fP attribute in \fI\%CreateVnicDetails\fP <\fBhttps://docs.cloud.oracle.com/api/#/en/iaas/latest/CreateVnicDetails/\fP>\&.
.sp
To add or remove security rules from the group, use \fI\%AddNetworkSecurityGroupSecurityRules\fP <\fBhttps://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/network/nsg/rules/add.html\fP> or \fI\%RemoveNetworkSecurityGroupSecurityRules\fP <\fBhttps://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/network/nsg/rules/remove.html\fP>\&.
.sp
To edit the contents of existing security rules in the group, use \fI\%UpdateNetworkSecurityGroupSecurityRules\fP <\fBhttps://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/network/nsg/rules/update.html\fP>\&.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci network nsg update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci network nsg update \-\-nsg\-id $nsg_id
.ft P
.fi
.UNINDENT
.UNINDENT
