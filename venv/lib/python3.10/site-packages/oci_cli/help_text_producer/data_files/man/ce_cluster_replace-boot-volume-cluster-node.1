...
.
.TH "CE_CLUSTER_REPLACE-BOOT-VOLUME-CLUSTER-NODE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
ce_cluster_replace-boot-volume-cluster-node \- 
.
...
.nf
.ft C
oci ce cluster replace\-boot\-volume\-cluster\-node [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-node\-eviction\-settings [complex type]
.UNINDENT
.sp
...
.ft C
    ...
    export node_id=<substitute\-value\-of\-node_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/ce/cluster/replace\-boot\-volume\-cluster\-node.html#cmdoption\-node\-id
    ...
    oci ce cluster replace\-boot\-volume\-cluster\-node \-\-cluster\-id $cluster_id \-\-node\-id $node_id
.ft P
.fi
.UNINDENT
.UNINDENT
