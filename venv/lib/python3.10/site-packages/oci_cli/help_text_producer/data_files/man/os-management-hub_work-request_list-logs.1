...
.
.TH "OS-MANAGEMENT-HUB_WORK-REQUEST_LIST-LOGS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
os-management-hub_work-request_list-logs \- 
.
...
.nf
.ft C
oci os\-management\-hub work\-request list\-logs [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export work_request_id=<substitute\-value\-of\-work_request_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/os\-management\-hub/work\-request/list\-logs.html#cmdoption\-work\-request\-id

    oci os\-management\-hub work\-request list\-logs \-\-work\-request\-id $work_request_id
.ft P
.fi
.UNINDENT
.UNINDENT
