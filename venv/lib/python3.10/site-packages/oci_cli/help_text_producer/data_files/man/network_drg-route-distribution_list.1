...
.
.TH "NETWORK_DRG-ROUTE-DISTRIBUTION_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network_drg-route-distribution_list \- 
.
...
.nf
.ft C
oci network drg\-route\-distribution list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci network drg\-route\-distribution list \-\-drg\-id $drg_id
.ft P
.fi
.UNINDENT
.UNINDENT
