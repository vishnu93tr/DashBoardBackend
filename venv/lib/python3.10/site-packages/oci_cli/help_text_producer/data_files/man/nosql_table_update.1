...
.
.TH "NOSQL_TABLE_UPDATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
nosql_table_update \- 
.
...
.nf
.ft C
oci nosql table update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export table_name_or_id=<substitute\-value\-of\-table_name_or_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/nosql/table/update.html#cmdoption\-table\-name\-or\-id

    oci nosql table update \-\-table\-name\-or\-id $table_name_or_id
.ft P
.fi
.UNINDENT
.UNINDENT
