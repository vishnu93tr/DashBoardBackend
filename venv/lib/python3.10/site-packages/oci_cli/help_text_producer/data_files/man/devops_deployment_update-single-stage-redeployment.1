...
.
.TH "DEVOPS_DEPLOYMENT_UPDATE-SINGLE-STAGE-REDEPLOYMENT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
devops_deployment_update-single-stage-redeployment \- 
.
...
.nf
.ft C
oci devops deployment update\-single\-stage\-redeployment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export deployment_id=<substitute\-value\-of\-deployment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/devops/deployment/update\-single\-stage\-redeployment.html#cmdoption\-deployment\-id

    oci devops deployment update\-single\-stage\-redeployment \-\-deployment\-id $deployment_id
.ft P
.fi
.UNINDENT
.UNINDENT
