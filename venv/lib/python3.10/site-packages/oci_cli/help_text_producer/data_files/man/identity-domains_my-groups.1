...
.
.TH "IDENTITY-DOMAINS_MY-GROUPS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_my-groups \- 
.
...
.nf
.ft C
oci identity\-domains my\-groups list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains my\-groups list
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains my\-groups search [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains my\-groups search \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains my\-groups search \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
