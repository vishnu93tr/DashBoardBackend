...
.
.TH "DATABASE-MANAGEMENT_EXTERNAL-DB-SYSTEM_CHANGE-COMPARTMENT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
database-management_external-db-system_change-compartment \- 
.
...
.nf
.ft C
oci database\-management external\-db\-system change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the compartment to move the external DB system to.
.INDENT 0.0
.TP
...
.ft C
    ...
    oci database\-management external\-db\-system change\-compartment \-\-compartment\-id $compartment_id \-\-external\-db\-system\-id $external_db_system_id
.ft P
.fi
.UNINDENT
.UNINDENT
