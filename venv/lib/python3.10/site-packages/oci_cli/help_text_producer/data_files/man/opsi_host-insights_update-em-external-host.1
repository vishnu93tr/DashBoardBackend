...
.
.TH "OPSI_HOST-INSIGHTS_UPDATE-EM-EXTERNAL-HOST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
opsi_host-insights_update-em-external-host \- 
.
...
.SH DESCRIPTION
.sp
Update tags for an EM Managed External Host Insight resource in Operations Insights.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci opsi host\-insights update\-em\-external\-host [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export host_insight_id=<substitute\-value\-of\-host_insight_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/opsi/host\-insights/update\-em\-external\-host.html#cmdoption\-host\-insight\-id

    oci opsi host\-insights update\-em\-external\-host \-\-host\-insight\-id $host_insight_id
.ft P
.fi
.UNINDENT
.UNINDENT
