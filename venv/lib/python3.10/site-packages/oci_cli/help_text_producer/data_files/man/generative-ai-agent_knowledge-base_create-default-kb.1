...
.
.TH "GENERATIVE-AI-AGENT_KNOWLEDGE-BASE_CREATE-DEFAULT-KB" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
generative-ai-agent_knowledge-base_create-default-kb \- 
.
...
.nf
.ft C
oci generative\-ai\-agent knowledge\-base create\-default\-kb [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-index\-config\-should\-enable\-hybrid\-search [boolean]
.UNINDENT
.sp
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/generative\-ai\-agent/knowledge\-base/create\-default\-kb.html#cmdoption\-compartment\-id

    oci generative\-ai\-agent knowledge\-base create\-default\-kb \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
