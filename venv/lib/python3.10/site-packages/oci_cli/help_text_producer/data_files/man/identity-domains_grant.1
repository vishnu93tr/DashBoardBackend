...
.
.TH "IDENTITY-DOMAINS_GRANT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_grant \- 
.
...
.nf
.ft C
oci identity\-domains grant create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.sp
\fBSCIM++ Properties:\fP  \- caseExact: true  \- idcsCsvAttributeNameMappings: [[defaultValue:IMPORT_GRANTS]]  \- idcsSearchable: true  \- multiValued: false  \- mutability: immutable  \- required: true  \- returned: default  \- type: string  \- uniqueness: none
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
...
.nf
.ft C
ACCESS_REQUEST, ADMINISTRATOR_TO_APP, ADMINISTRATOR_TO_DELEGATED_USER, ADMINISTRATOR_TO_DYNAMIC_RESOURCE_GROUP, ADMINISTRATOR_TO_GROUP, ADMINISTRATOR_TO_USER, APP_ENTITLEMENT_COLLECTION, GROUP_MEMBERSHIP, IMPORT_APPROLE_MEMBERS, IMPORT_GRANTS, OPC_INFRA_TO_APP, SERVICE_MANAGER_TO_APP, SERVICE_MANAGER_TO_USER, SYNC_TO_USER
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-app\-entitlement\-collection [complex type]
.UNINDENT
.sp
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
...
.sp
\fBSCIM++ Properties:\fP  \- caseExact: true  \- idcsSearchable: true  \- multiValued: false  \- mutability: readOnly  \- required: false  \- returned: request  \- type: string  \- uniqueness: server
.INDENT 0.0
.TP
...
.nf
.ft C
    oci identity\-domains grant create \-\-generate\-param\-json\-input grantee > grantee.json
    oci identity\-domains grant create \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export grant_mechanism=<substitute\-value\-of\-grant_mechanism> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/identity\-domains/grant/create.html#cmdoption\-grant\-mechanism

    oci identity\-domains grant create \-\-grant\-mechanism $grant_mechanism \-\-grantee file://grantee.json \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains grant delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    grant_id=$(oci identity\-domains grant create \-\-grant\-mechanism $grant_mechanism \-\-grantee file://grantee.json \-\-schemas file://schemas.json \-\-query data.id \-\-raw\-output)

    oci identity\-domains grant delete \-\-grant\-id $grant_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains grant get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains grant get \-\-grant\-id $grant_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains grant patch [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains grant patch \-\-generate\-param\-json\-input operations > operations.json
    oci identity\-domains grant patch \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains grant patch \-\-grant\-id $grant_id \-\-operations file://operations.json \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
