...
.
.TH "MONITORING_ALARM-SUPPRESSION-COLLECTION_LIST-ALARM-SUPPRESSIONS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
monitoring_alarm-suppression-collection_list-alarm-suppressions \- 
.
...
.SH DESCRIPTION
.sp
Lists alarm suppressions for the specified alarm. For more information, see \fI\%Listing Alarm Suppressions\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Monitoring/Tasks/list-alarm-suppression.htm\fP>\&.
.sp
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the alarm that is the target of the alarm suppression.
.INDENT 0.0
.TP
.B \-\-all
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the compartment for searching. Use the tenancy OCID to search in the root compartment.
.sp
If targetType is not specified, searches all suppressions defined under the compartment. If targetType is \fICOMPARTMENT\fP, searches suppressions in the specified compartment only.
.sp
Example:
.INDENT 0.0
.INDENT 3.5
...
.INDENT 0.0
.TP
.B \-\-is\-all\-suppressions [boolean]
.UNINDENT
.sp
Setting this parameter to true requires the query to specify the alarm (\fIalarmId\fP).
.sp
...
.UNINDENT
.sp
The target type to use when listing alarm suppressions. \fIALARM\fP lists all suppression records for the specified alarm. \fICOMPARTMENT\fP lists all suppression records for the specified compartment or tenancy.
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
