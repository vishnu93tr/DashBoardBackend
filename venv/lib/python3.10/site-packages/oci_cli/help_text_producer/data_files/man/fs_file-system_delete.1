...
.
.TH "FS_FILE-SYSTEM_DELETE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
fs_file-system_delete \- 
.
...
.INDENT 0.0
.TP
.B \-\-can\-detach\-child\-file\-system [boolean]
.UNINDENT
.sp
If the value is set to true, then the file system will be deleted by detaching its child file system, turning the child file system into an independent File System.
.INDENT 0.0
.TP
.B \-\-force
.UNINDENT
...
.ft C
    ...
    oci fs file\-system delete \-\-file\-system\-id $file_system_id
.ft P
.fi
.UNINDENT
.UNINDENT
