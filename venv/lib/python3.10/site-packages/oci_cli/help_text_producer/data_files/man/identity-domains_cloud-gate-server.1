...
.
.TH "IDENTITY-DOMAINS_CLOUD-GATE-SERVER" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_cloud-gate-server \- 
.
...
.sp
\fBSCIM++ Properties:\fP  \- caseExact: true  \- idcsSearchable: true  \- multiValued: false  \- mutability: readWrite  \- required: true  \- returned: always  \- type: string  \- uniqueness: server
.INDENT 0.0
.TP
.B \-\-host\-name [text]
.UNINDENT
...
.sp
\fBSCIM++ Properties:\fP  \- caseExact: true  \- idcsMaxValue: 65535  \- idcsMinValue: 1  \- idcsSearchable: false  \- multiValued: false  \- mutability: readWrite  \- required: true  \- returned: default  \- type: integer  \- uniqueness: none
.INDENT 0.0
.TP
...
.sp
\fBSCIM++ Properties:\fP  \- caseExact: true  \- idcsSearchable: false  \- multiValued: false  \- mutability: readWrite  \- required: true  \- returned: default  \- type: boolean  \- uniqueness: none
...
.nf
.ft C
oci identity\-domains cloud\-gate\-server delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    cloud_gate_server_id=$(oci identity\-domains cloud\-gate\-server create \-\-cloud\-gate file://cloud\-gate.json \-\-display\-name file://display\-name.json \-\-host\-name $host_name \-\-port $port \-\-schemas file://schemas.json \-\-ssl $ssl \-\-query data.id \-\-raw\-output)

    oci identity\-domains cloud\-gate\-server delete \-\-cloud\-gate\-server\-id $cloud_gate_server_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains cloud\-gate\-server get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains cloud\-gate\-server get \-\-cloud\-gate\-server\-id $cloud_gate_server_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains cloud\-gate\-server patch [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains cloud\-gate\-server patch \-\-generate\-param\-json\-input operations > operations.json
    oci identity\-domains cloud\-gate\-server patch \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains cloud\-gate\-server patch \-\-cloud\-gate\-server\-id $cloud_gate_server_id \-\-operations file://operations.json \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains cloud\-gate\-server put [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains cloud\-gate\-server put \-\-generate\-param\-json\-input cloud\-gate > cloud\-gate.json
    oci identity\-domains cloud\-gate\-server put \-\-generate\-param\-json\-input display\-name > display\-name.json
    oci identity\-domains cloud\-gate\-server put \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains cloud\-gate\-server put \-\-cloud\-gate file://cloud\-gate.json \-\-cloud\-gate\-server\-id $cloud_gate_server_id \-\-display\-name file://display\-name.json \-\-host\-name $host_name \-\-port $port \-\-schemas file://schemas.json \-\-ssl $ssl
.ft P
.fi
.UNINDENT
.UNINDENT
