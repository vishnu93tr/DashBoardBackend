...
.
.TH "DATA-SAFE_ON-PREM-CONNECTOR" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_on-prem-connector \- 
.
...
.nf
.ft C
oci data\-safe on\-prem\-connector change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci data\-safe on\-prem\-connector change\-compartment \-\-compartment\-id $compartment_id \-\-on\-prem\-connector\-id $on_prem_connector_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci data\-safe on\-prem\-connector create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci data\-safe on\-prem\-connector delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci data\-safe on\-prem\-connector delete \-\-on\-prem\-connector\-id $on_prem_connector_id
.ft P
.fi
.UNINDENT
.UNINDENT
.SS \fBgenerate\-on\-prem\-connector\-configuration\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.nf
.ft C
oci data\-safe on\-prem\-connector get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci data\-safe on\-prem\-connector get \-\-on\-prem\-connector\-id $on_prem_connector_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci data\-safe on\-prem\-connector list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-on\-prem\-connector\-lifecycle\-state [text]
.UNINDENT
.sp
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-safe/on\-prem\-connector/list.html#cmdoption\-compartment\-id

    oci data\-safe on\-prem\-connector list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci data\-safe on\-prem\-connector update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci data\-safe on\-prem\-connector update \-\-on\-prem\-connector\-id $on_prem_connector_id
.ft P
.fi
.UNINDENT
.UNINDENT
.SS \fBupdate\-on\-prem\-connector\-wallet\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.nf
.ft C
oci data\-safe on\-prem\-connector update\-on\-prem\-connector\-wallet [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci data\-safe on\-prem\-connector update\-on\-prem\-connector\-wallet \-\-on\-prem\-connector\-id $on_prem_connector_id
.ft P
.fi
.UNINDENT
.UNINDENT
