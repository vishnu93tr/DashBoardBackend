...
.
.TH "IAM_USER_UI-PASSWORD_CREATE-OR-RESET" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
...
.SH DESCRIPTION
.sp
Creates a new Console one\-time password for the specified user. For more information about user credentials, see \fI\%User Credentials\fP <\fBhttps://docs.cloud.oracle.com/Content/Identity/usercred/usercredentials.htm\fP>\&.
.sp
...
.sp
\fBNote:\fP The user’s Console login is the unique name you specified when you created the user (see \fI\%CreateUser\fP <\fBhttps://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/iam/user/create.html\fP>).
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
