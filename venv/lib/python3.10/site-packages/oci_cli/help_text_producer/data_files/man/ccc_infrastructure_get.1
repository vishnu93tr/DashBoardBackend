...
.
.TH "CCC_INFRASTRUCTURE_GET" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
ccc_infrastructure_get \- 
.
...
.SH DESCRIPTION
.sp
Gets a Compute \fI\%Cloud@Customer\fP <\fBCloud@Customer\fP> infrastructure.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci ccc infrastructure get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci ccc infrastructure get \-\-infrastructure\-id $infrastructure_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.SS Description
.sp
Gets information about a Compute \fI\%Cloud@Customer\fP <\fBCloud@Customer\fP> infrastructure by the specified OCID.
.SS Command
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
 oci ccc infrastructure get \-\-infrastructure\-id <infrastructure_OCID>
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
{
 ...
 "etag": "ea95ff53ae48e8d442b9c3f801a88aff522c311b4cf0fc9f7decee5b89ffb7a1\-\-gzip"
}
.ft P
.fi
.UNINDENT
