...
.
.TH "IDENTITY-DOMAINS_CLOUD-GATE-MAPPINGS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_cloud-gate-mappings \- 
.
...
.nf
.ft C
oci identity\-domains cloud\-gate\-mappings list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains cloud\-gate\-mappings list
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains cloud\-gate\-mappings search [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains cloud\-gate\-mappings search \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains cloud\-gate\-mappings search \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
