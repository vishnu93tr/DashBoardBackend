...
.
.TH "COMPUTE_CAPACITY-TOPOLOGY_BARE-METAL-HOST_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
compute_capacity-topology_bare-metal-host_list \- 
.
...
.nf
.ft C
oci compute capacity\-topology bare\-metal\-host list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-local\-block\-id [text]
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the compute local block.
.INDENT 0.0
.TP
.B \-\-network\-block\-id [text]
.UNINDENT
.sp
...
.ft C
    ...
    oci compute capacity\-topology bare\-metal\-host list \-\-capacity\-topology\-id $capacity_topology_id
.ft P
.fi
.UNINDENT
.UNINDENT
