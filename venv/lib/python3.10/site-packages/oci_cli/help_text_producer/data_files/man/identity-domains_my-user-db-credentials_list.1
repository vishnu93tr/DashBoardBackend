...
.
.TH "IDENTITY-DOMAINS_MY-USER-DB-CREDENTIALS_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_my-user-db-credentials_list \- 
.
...
.nf
.ft C
oci identity\-domains my\-user\-db\-credentials list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains my\-user\-db\-credentials list
.ft P
.fi
.UNINDENT
.UNINDENT
