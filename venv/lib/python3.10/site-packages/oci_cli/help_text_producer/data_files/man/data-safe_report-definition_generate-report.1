...
.
.TH "DATA-SAFE_REPORT-DEFINITION_GENERATE-REPORT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_report-definition_generate-report \- 
.
...
.nf
.ft C
oci data\-safe report\-definition generate\-report [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.sp
\fBExample:\fP query=(dateGenerated ge ‘2021\-12\-18T01\-00\-26’) and (ilmTarget eq ‘dscs\-target’)
.INDENT 0.0
.TP
.B \-\-target\-ids [complex type]
.UNINDENT
.sp
...
.ft C
    ...
    export mime_type=<substitute\-value\-of\-mime_type> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-safe/report\-definition/generate\-report.html#cmdoption\-mime\-type
    ...
    oci data\-safe report\-definition generate\-report \-\-compartment\-id $compartment_id \-\-display\-name $display_name \-\-mime\-type $mime_type \-\-report\-definition\-id $report_definition_id
.ft P
.fi
.UNINDENT
.UNINDENT
