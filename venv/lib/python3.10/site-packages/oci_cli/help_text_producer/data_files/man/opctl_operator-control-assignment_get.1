...
.
.TH "OPCTL_OPERATOR-CONTROL-ASSIGNMENT_GET" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
opctl_operator-control-assignment_get \- 
.
...
.nf
.ft C
oci opctl operator\-control\-assignment get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci opctl operator\-control\-assignment get \-\-operator\-control\-assignment\-id $operator_control_assignment_id
.ft P
.fi
.UNINDENT
.UNINDENT
