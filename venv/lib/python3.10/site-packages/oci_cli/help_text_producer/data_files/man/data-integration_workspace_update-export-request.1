...
.
.TH "DATA-INTEGRATION_WORKSPACE_UPDATE-EXPORT-REQUEST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-integration_workspace_update-export-request \- 
.
...
.nf
.ft C
oci data\-integration workspace update\-export\-request [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export export_request_key=<substitute\-value\-of\-export_request_key> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/workspace/update\-export\-request.html#cmdoption\-export\-request\-key
    ...
    oci data\-integration workspace update\-export\-request \-\-export\-request\-key $export_request_key \-\-workspace\-id $workspace_id
.ft P
.fi
.UNINDENT
.UNINDENT
