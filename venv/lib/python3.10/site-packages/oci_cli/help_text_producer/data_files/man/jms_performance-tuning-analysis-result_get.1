...
.
.TH "JMS_PERFORMANCE-TUNING-ANALYSIS-RESULT_GET" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
jms_performance-tuning-analysis-result_get \- 
.
...
.nf
.ft C
oci jms performance\-tuning\-analysis\-result get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-performance\-tuning\-analysis\-result\-id [text]
.UNINDENT
.sp
...
.ft C
    ...
    export performance_tuning_analysis_result_id=<substitute\-value\-of\-performance_tuning_analysis_result_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/jms/performance\-tuning\-analysis\-result/get.html#cmdoption\-performance\-tuning\-analysis\-result\-id
    ...
    oci jms performance\-tuning\-analysis\-result get \-\-fleet\-id $fleet_id \-\-performance\-tuning\-analysis\-result\-id $performance_tuning_analysis_result_id
.ft P
.fi
.UNINDENT
.UNINDENT
