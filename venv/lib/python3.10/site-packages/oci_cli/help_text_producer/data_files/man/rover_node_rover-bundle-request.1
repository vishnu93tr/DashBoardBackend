...
.
.TH "ROVER_NODE_ROVER-BUNDLE-REQUEST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
rover_node_rover-bundle-request \- 
.
...
.SH DESCRIPTION
.sp
Rover Bundle Requests for Node.
...
.nf
.ft C
oci rover node rover\-bundle\-request list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export rover_node_id=<substitute\-value\-of\-rover_node_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/rover/node/rover\-bundle\-request/list.html#cmdoption\-rover\-node\-id

    oci rover node rover\-bundle\-request list \-\-rover\-node\-id $rover_node_id
.ft P
.fi
.UNINDENT
.UNINDENT
