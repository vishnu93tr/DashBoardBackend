...
.
.TH "DB_DATABASE_UPGRADE-ROLLBACK" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_database_upgrade-rollback \- 
.
...
.nf
.ft C
oci db database upgrade\-rollback [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci db database upgrade\-rollback \-\-database\-id $database_id
.ft P
.fi
.UNINDENT
.UNINDENT
