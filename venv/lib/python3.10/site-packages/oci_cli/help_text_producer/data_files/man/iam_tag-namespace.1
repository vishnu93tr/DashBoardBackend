...
.
.TH "IAM_TAG-NAMESPACE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
iam_tag-namespace \- 
.
...
.SH DESCRIPTION
.sp
A managed container for defined tags. A tag namespace is unique in a tenancy. For more information, see \fI\%Managing Tags and Tag Namespaces\fP <\fBhttps://docs.cloud.oracle.com/Content/Tagging/Tasks/managingtagsandtagnamespaces.htm\fP>\&.
.sp
...
.nf
.ft C
oci iam tag\-namespace add [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export type=<substitute\-value\-of\-type> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/iam/tag\-namespace/add.html#cmdoption\-type
    ...
    oci iam tag\-namespace add \-\-tag\-namespace\-id $tag_namespace_id \-\-type $type
.ft P
.fi
.UNINDENT
.UNINDENT
...
.sp
After you start this operation, you cannot start either the \fI\%DeleteTag\fP <\fBhttps://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/iam/tag/delete.html\fP> or the \fI\%BulkDeleteTags\fP <\fBhttps://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/iam/tag/bulk-delete.html\fP> operation until this process completes.
.sp
To delete a tag namespace, you must first retire it. Use \fI\%UpdateTagNamespace\fP <\fBhttps://docs.cloud.oracle.com/api/#/en/identity/latest/TagNamespace/UpdateTagNamespace\fP> to retire a tag namespace.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
...
.sp
To move the tag namespace, you must have the manage tag\-namespaces permission on both compartments. For more information about IAM policies, see \fI\%Details for IAM\fP <\fBhttps://docs.cloud.oracle.com/Content/Identity/policyreference/iampolicyreference.htm\fP>\&.
.sp
...
.nf
.ft C
oci iam tag\-namespace change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci iam tag\-namespace change\-compartment \-\-compartment\-id $compartment_id \-\-tag\-namespace\-id $tag_namespace_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.sp
You must also specify a \fIdescription\fP for the namespace. It does not have to be unique, and you can change it with \fI\%UpdateTagNamespace\fP <\fBhttps://docs.cloud.oracle.com/api/#/en/identity/latest/TagNamespace/UpdateTagNamespace\fP>\&.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
...
.sp
This option is a JSON list with items of type AddLockDetails.  For documentation on AddLockDetails please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/identity/20160918/datatypes/AddLockDetails\fP\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
.ft C
    ...
    oci iam tag\-namespace create \-\-compartment\-id $compartment_id \-\-description $description \-\-name $name
.ft P
.fi
.UNINDENT
.UNINDENT
...
.sp
Use \fI\%CascadeDeleteTagNamespace\fP <\fBhttps://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/iam/tag-namespace/cascade-delete.html\fP> to delete a tag namespace along with all of the tag definitions contained within that namespace.
.sp
Use \fI\%DeleteTag\fP <\fBhttps://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/iam/tag/delete.html\fP> to delete a tag definition.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
...
.ft C
    ...
    oci iam tag\-namespace delete \-\-tag\-namespace\-id $tag_namespace_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-include\-subcompartments [boolean]
.UNINDENT
.sp
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/iam/tag\-namespace/list.html#cmdoption\-compartment\-id

    oci iam tag\-namespace list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci iam tag\-namespace remove [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export description=<substitute\-value\-of\-description> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/iam/tag\-namespace/create.html#cmdoption\-description
    export name=<substitute\-value\-of\-name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/iam/tag\-namespace/create.html#cmdoption\-name
    export type=<substitute\-value\-of\-type> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/iam/tag\-namespace/remove.html#cmdoption\-type

    tag_namespace_id=$(oci iam tag\-namespace create \-\-compartment\-id $compartment_id \-\-description $description \-\-name $name \-\-query data.id \-\-raw\-output)

    oci iam tag\-namespace remove \-\-tag\-namespace\-id $tag_namespace_id \-\-type $type
.ft P
.fi
.UNINDENT
.UNINDENT
...
.SS Description
.sp
Retire the namespace, all the contained tags and the related rules. Reactivating a namespace  will not reactivate any tag definition that is retired when the namespace was retired. They will have to be individually reactivated \fIafter\fP the namespace is reactivated. You can’t add a namespace with the same name as a retired namespace in the same tenant.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
...
.ft C
    ...
    oci iam tag\-namespace update \-\-tag\-namespace\-id $tag_namespace_id
.ft P
.fi
.UNINDENT
.UNINDENT
