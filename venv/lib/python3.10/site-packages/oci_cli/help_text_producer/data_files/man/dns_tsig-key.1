...
.
.TH "DNS_TSIG-KEY" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
dns_tsig-key \- 
.
...
.SH DESCRIPTION
.sp
A TSIG key. \fBWarning:\fP Oracle recommends that you avoid using any confidential information when you supply string values using the API.
...
.nf
.ft C
oci dns tsig\-key change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the compartment into which the TSIG key should be moved.
.INDENT 0.0
.TP
.B \-\-tsig\-key\-id [text]
.UNINDENT
...
.nf
.ft C
    export algorithm=<substitute\-value\-of\-algorithm> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/dns/tsig\-key/create.html#cmdoption\-algorithm
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/dns/tsig\-key/create.html#cmdoption\-compartment\-id
    export name=<substitute\-value\-of\-name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/dns/tsig\-key/create.html#cmdoption\-name
    export secret=<substitute\-value\-of\-secret> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/dns/tsig\-key/create.html#cmdoption\-secret

    tsig_key_id=$(oci dns tsig\-key create \-\-algorithm $algorithm \-\-compartment\-id $compartment_id \-\-name $name \-\-secret $secret \-\-query data.id \-\-raw\-output)

    oci dns tsig\-key change\-compartment \-\-compartment\-id $compartment_id \-\-tsig\-key\-id $tsig_key_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.SS Description
.sp
Creates a new TSIG key in the specified compartment. There is no \fIopc\-retry\-token\fP header since TSIG key names must be globally unique.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
...
.UNINDENT
.sp
TSIG key algorithms are encoded as domain names, but most consist of only one non\-empty label, which is not required to be explicitly absolute. Applicable algorithms include: hmac\-sha1, hmac\-sha224, hmac\-sha256, hmac\-sha512. For more information on these algorithms, see \fI\%RFC 4635\fP <\fBhttps://tools.ietf.org/html/rfc4635#section-2\fP>\&.
.INDENT 0.0
.TP
.B \-\-compartment\-id, \-c [text]
.UNINDENT
...
.ft C
    ...
    oci dns tsig\-key create \-\-algorithm $algorithm \-\-compartment\-id $compartment_id \-\-name $name \-\-secret $secret
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci dns tsig\-key delete \-\-tsig\-key\-id $tsig_key_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci dns tsig\-key get \-\-tsig\-key\-id $tsig_key_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The field by which to sort TSIG keys. If unspecified, defaults to \fItimeCreated\fP\&.
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/dns/tsig\-key/list.html#cmdoption\-compartment\-id

    oci dns tsig\-key list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci dns tsig\-key update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci dns tsig\-key update \-\-tsig\-key\-id $tsig_key_id
.ft P
.fi
.UNINDENT
.UNINDENT
