...
.
.TH "DB_VM-CLUSTER_GET-UPDATE-HISTORY" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_vm-cluster_get-update-history \- 
.
...
.SH DESCRIPTION
.sp
Gets the maintenance update history details for the specified update history entry. Applies to Exadata \fI\%Cloud@Customer\fP <\fBCloud@Customer\fP> instances only.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci db vm\-cluster get\-update\-history [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export update_history_entry_id=<substitute\-value\-of\-update_history_entry_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/db/vm\-cluster/get\-update\-history.html#cmdoption\-update\-history\-entry\-id
    ...
    oci db vm\-cluster get\-update\-history \-\-update\-history\-entry\-id $update_history_entry_id \-\-vm\-cluster\-id $vm_cluster_id
.ft P
.fi
.UNINDENT
.UNINDENT
