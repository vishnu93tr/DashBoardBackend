...
.
.TH "IAM_USER_CREATE-DB-CREDENTIAL" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
iam_user_create-db-credential \- 
.
...
.nf
.ft C
oci iam user create\-db\-credential [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export password=<substitute\-value\-of\-password> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/iam/user/create\-db\-credential.html#cmdoption\-password

    user_id=$(oci iam user create \-\-description $description \-\-name $name \-\-query data.id \-\-raw\-output)

    oci iam user create\-db\-credential \-\-description $description \-\-password $password \-\-user\-id $user_id
.ft P
.fi
.UNINDENT
.UNINDENT
