...
.
.TH "INSTANCE-AGENT_PLUGIN" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
instance-agent_plugin \- 
.
...
.nf
.ft C
oci instance\-agent plugin get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/instance\-agent/plugin/get.html#cmdoption\-compartment\-id
    export instanceagent_id=<substitute\-value\-of\-instanceagent_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/instance\-agent/plugin/get.html#cmdoption\-instanceagent\-id
    export plugin_name=<substitute\-value\-of\-plugin_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/instance\-agent/plugin/get.html#cmdoption\-plugin\-name

    oci instance\-agent plugin get \-\-compartment\-id $compartment_id \-\-instanceagent\-id $instanceagent_id \-\-plugin\-name $plugin_name
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci instance\-agent plugin list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
INVALID, NOT_SUPPORTED, RUNNING, STOPPED
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/instance\-agent/plugin/list.html#cmdoption\-compartment\-id
    export instanceagent_id=<substitute\-value\-of\-instanceagent_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/instance\-agent/plugin/list.html#cmdoption\-instanceagent\-id

    oci instance\-agent plugin list \-\-compartment\-id $compartment_id \-\-instanceagent\-id $instanceagent_id
.ft P
.fi
.UNINDENT
.UNINDENT
