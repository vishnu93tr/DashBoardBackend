...
.
.TH "ANNOUNCE_ANNOUNCEMENTS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
...
.nf
.ft C
oci announce announcements get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export announcement_id=<substitute\-value\-of\-announcement_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/announce/announcements/get.html#cmdoption\-announcement\-id
...
.INDENT 0.0
.TP
.B \-\-should\-show\-only\-latest\-in\-chain [boolean]
.UNINDENT
.sp
...
.nf
.ft C
announcementType, referenceTicketNumber, summary, timeCreated, timeOneValue, timeTwoValue
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The sort order to use. (Sorting by \fIannouncementType\fP orders the announcements list according to importance.)
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
...
.INDENT 0.0
.TP
.B \-\-time\-one\-earliest\-time [datetime]
.UNINDENT
.sp
The boundary for the earliest \fItimeOneValue\fP date on announcements that you want to see.
.INDENT 0.0
.INDENT 3.5
...
.INDENT 0.0
.TP
.B \-\-time\-one\-latest\-time [datetime]
.UNINDENT
.sp
The boundary for the latest \fItimeOneValue\fP date on announcements that you want to see.
.INDENT 0.0
.INDENT 3.5
The following datetime formats are supported:
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/announce/announcements/list.html#cmdoption\-compartment\-id
