...
.
.TH "DATA-SAFE_SQL-FIREWALL-POLICY-ANALYTICS_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_sql-firewall-policy-analytics_list \- 
.
...
.sp
The parameter \fIcompartmentIdInSubtree\fP applies when you perform SummarizedSqlFirewallPolicyInfo on the specified \fIcompartmentId\fP and when it is set to true, the entire hierarchy of compartments can be returned. To get a full list of all compartments and subcompartments in the tenancy (root compartment), set the parameter \fIcompartmentIdInSubtree\fP to true and \fIaccessLevel\fP to ACCESSIBLE.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci data\-safe sql\-firewall\-policy\-analytics list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
enforcementScope, lifecycleState, securityPolicyId, violationAction
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
An optional filter to return the summary of the SQL Firewall policies created before the date\-time specified, in the format defined by \fI\%RFC3339\fP <\fBhttps://tools.ietf.org/html/rfc3339\fP>\&.
.INDENT 0.0
.INDENT 3.5
...
.UNINDENT
.sp
An optional filter to return the summary of the SQL Firewall policies created after the date\-time specified, in the format defined by \fI\%RFC3339\fP <\fBhttps://tools.ietf.org/html/rfc3339\fP>\&.
.INDENT 0.0
.INDENT 3.5
The following datetime formats are supported:
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-safe/sql\-firewall\-policy\-analytics/list.html#cmdoption\-compartment\-id

    oci data\-safe sql\-firewall\-policy\-analytics list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
