...
.
.TH "IAM_USER_DELETE-DB-CREDENTIAL" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
iam_user_delete-db-credential \- 
.
...
.nf
.ft C
oci iam user delete\-db\-credential [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export db_credential_id=<substitute\-value\-of\-db_credential_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/iam/user/delete\-db\-credential.html#cmdoption\-db\-credential\-id

    user_id=$(oci iam user create \-\-description $description \-\-name $name \-\-query data.id \-\-raw\-output)

    oci iam user delete\-db\-credential \-\-db\-credential\-id $db_credential_id \-\-user\-id $user_id
.ft P
.fi
.UNINDENT
.UNINDENT
