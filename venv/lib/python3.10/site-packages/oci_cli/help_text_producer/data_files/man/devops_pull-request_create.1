...
.
.TH "DEVOPS_PULL-REQUEST_CREATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
devops_pull-request_create \- 
.
...
.nf
.ft C
oci devops pull\-request create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-reviewers [complex type]
.UNINDENT
.sp
Reviewers for this pull request.
.sp
This option is a JSON list with items of type CreateReviewerDetails.  For documentation on CreateReviewerDetails please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/devops/20210630/datatypes/CreateReviewerDetails\fP\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
.ft C
    ...
    oci devops pull\-request create \-\-display\-name $display_name \-\-repository\-id $repository_id \-\-source\-branch $source_branch
.ft P
.fi
.UNINDENT
.UNINDENT
