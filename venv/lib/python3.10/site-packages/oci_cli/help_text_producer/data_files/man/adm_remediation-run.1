...
.
.TH "ADM_REMEDIATION-RUN" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
adm_remediation-run \- 
.
...
.nf
.ft C
oci adm remediation\-run cancel [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci adm remediation\-run cancel \-\-remediation\-run\-id $remediation_run_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci adm remediation\-run change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci adm remediation\-run change\-compartment \-\-compartment\-id $compartment_id \-\-remediation\-run\-id $remediation_run_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci adm remediation\-run create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The Oracle Cloud identifier (\fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP>) of the Remediation Recipe.
.SS Optional Parameters
.INDENT 0.0
.TP
...
.ft C
    ...
    oci adm remediation\-run create \-\-remediation\-recipe\-id $remediation_recipe_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci adm remediation\-run delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci adm remediation\-run delete \-\-remediation\-run\-id $remediation_run_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci adm remediation\-run get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci adm remediation\-run get \-\-remediation\-run\-id $remediation_run_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.SS Description
.sp
Returns a list of remediation runs contained by a compartment. The query parameter \fIcompartmentId\fP is required unless the query parameter \fIid\fP is specified.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci adm remediation\-run list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The field used to sort Remediation Runs. Only one sort order is allowed. Default order for _timeCreated_ is \fBdescending\fP\&. Default order for _timeFinished_ is \fBdescending\fP\&. Default order for _timeStarted_ is \fBdescending\fP\&. Default order for _displayName_ is \fBascending alphabetical order\fP\&. Default order for _lifecycleState_ is the following sequence: \fBCREATING, ACTIVE, UPDATING, DELETING, DELETED, and FAILED\fP\&. Default order for currentStageType is the following sequence: \fBDETECT, RECOMMEND, VERIFY, and APPLY\fP\&.
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
...
.nf
.ft C
currentStageType, displayName, lifecycleState, timeCreated, timeFinished, timeStarted
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.UNINDENT
.SS \fBlist\-application\-dependency\-recommendations\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.nf
.ft C
oci adm remediation\-run update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci adm remediation\-run update \-\-remediation\-run\-id $remediation_run_id
.ft P
.fi
.UNINDENT
.UNINDENT
