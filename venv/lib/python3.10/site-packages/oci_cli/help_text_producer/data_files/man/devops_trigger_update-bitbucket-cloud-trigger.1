...
.
.TH "DEVOPS_TRIGGER_UPDATE-BITBUCKET-CLOUD-TRIGGER" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
devops_trigger_update-bitbucket-cloud-trigger \- 
.
...
.nf
.ft C
oci devops trigger update\-bitbucket\-cloud\-trigger [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export trigger_id=<substitute\-value\-of\-trigger_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/devops/trigger/update\-bitbucket\-cloud\-trigger.html#cmdoption\-trigger\-id

    oci devops trigger update\-bitbucket\-cloud\-trigger \-\-trigger\-id $trigger_id
.ft P
.fi
.UNINDENT
.UNINDENT
