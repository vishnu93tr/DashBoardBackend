...
.
.TH "DATA-SAFE_TARGET-DATABASE_CHANGE-COMPARTMENT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_target-database_change-compartment \- 
.
...
.nf
.ft C
oci data\-safe target\-database change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci data\-safe target\-database change\-compartment \-\-compartment\-id $compartment_id \-\-target\-database\-id $target_database_id
.ft P
.fi
.UNINDENT
.UNINDENT
