...
.
.TH "CE_ADDON-OPTION_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
ce_addon-option_list \- 
.
...
.nf
.ft C
oci ce addon\-option list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export kubernetes_version=<substitute\-value\-of\-kubernetes_version> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/ce/addon\-option/list.html#cmdoption\-kubernetes\-version

    oci ce addon\-option list \-\-kubernetes\-version $kubernetes_version
.ft P
.fi
.UNINDENT
.UNINDENT
