...
.
.TH "GDD_PRIVATE-ENDPOINT-COLLECTION_LIST-PRIVATE-ENDPOINTS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
gdd_private-endpoint-collection_list-private-endpoints \- 
.
...
.nf
.ft C
oci gdd private\-endpoint\-collection list\-private\-endpoints [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/gdd/private\-endpoint\-collection/list\-private\-endpoints.html#cmdoption\-compartment\-id

    oci gdd private\-endpoint\-collection list\-private\-endpoints \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
