...
.
.TH "JMS_FLEET_REQUEST-DEPLOYED-APPLICATION-MIGRATION-ANALYSES" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
jms_fleet_request-deployed-application-migration-analyses \- 
.
...
.nf
.ft C
oci jms fleet request\-deployed\-application\-migration\-analyses [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci jms fleet request\-deployed\-application\-migration\-analyses \-\-generate\-param\-json\-input targets > targets.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci jms fleet request\-deployed\-application\-migration\-analyses \-\-fleet\-id $fleet_id \-\-targets file://targets.json
.ft P
.fi
.UNINDENT
.UNINDENT
