...
.
.TH "CERTS-MGMT_CERTIFICATE_UPDATE-CERTIFICATE-MANAGED-INTERNALLY" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
certs-mgmt_certificate_update-certificate-managed-internally \- 
.
...
.nf
.ft C
oci certs\-mgmt certificate update\-certificate\-managed\-internally [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export certificate_id=<substitute\-value\-of\-certificate_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/certs\-mgmt/certificate/update\-certificate\-managed\-internally.html#cmdoption\-certificate\-id

    oci certs\-mgmt certificate update\-certificate\-managed\-internally \-\-certificate\-id $certificate_id
.ft P
.fi
.UNINDENT
.UNINDENT
