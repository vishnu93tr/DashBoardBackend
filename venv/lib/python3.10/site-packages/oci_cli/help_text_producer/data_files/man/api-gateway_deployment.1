...
.
.TH "API-GATEWAY_DEPLOYMENT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
api-gateway_deployment \- 
.
...
.SH DESCRIPTION
.sp
A deployment deploys an API on a gateway. Avoid entering confidential information. For more information, see \fI\%API Gateway Concepts\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/APIGateway/Concepts/apigatewayconcepts.htm\fP>\&.
...
.nf
.ft C
oci api\-gateway deployment change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci api\-gateway deployment change\-compartment \-\-compartment\-id $compartment_id \-\-deployment\-id $deployment_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci api\-gateway deployment create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
A path on which to deploy all routes contained in the API deployment specification. For more information, see \fI\%Deploying an API on an API Gateway by Creating an API Deployment\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/APIGateway/Tasks/apigatewaycreatingdeployment.htm\fP>\&.
.INDENT 0.0
.TP
...
.ft C
    ...
    oci api\-gateway deployment create \-\-compartment\-id $compartment_id \-\-gateway\-id $gateway_id \-\-path\-prefix $path_prefix \-\-specification file://specification.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci api\-gateway deployment delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci api\-gateway deployment delete \-\-deployment\-id $deployment_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci api\-gateway deployment get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/api\-gateway/deployment/list.html#cmdoption\-compartment\-id

    oci api\-gateway deployment list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci api\-gateway deployment update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
