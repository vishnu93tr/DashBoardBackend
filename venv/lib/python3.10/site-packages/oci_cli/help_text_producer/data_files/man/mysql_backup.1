...
.
.TH "MYSQL_BACKUP" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
mysql_backup \- 
.
...
.nf
.ft C
oci mysql backup change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
For optimistic concurrency control. In the PUT or DELETE call for a resource, set the \fIIf\-Match\fP header to the value of the etag from a previous GET or POST response for that resource. The resource will be updated or deleted only if the etag you provide matches the resource’s current etag value.
.INDENT 0.0
.TP
...
.ft C
    ...
    oci mysql backup change\-compartment \-\-backup\-id $backup_id \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.sp
\fBNote:\fP The compartment must be the same as the compartment of the DB system backup in the source region.
.INDENT 0.0
.TP
.B \-\-source\-backup\-id [text]
.UNINDENT
.sp
The OCID of DB system backup to be copied.
.INDENT 0.0
.TP
.B \-\-source\-region [text]
.UNINDENT
.sp
The region identifier of the source region where the DB system backup exists. For more information, please see \fI\%Regions and Availability Domains\fP <\fBhttps://docs.oracle.com/en-us/iaas/Content/General/Concepts/regions.htm\fP>\&.
.SS Optional Parameters
.INDENT 0.0
.TP
.B \-\-backup\-copy\-retention\-in\-days [integer]
.UNINDENT
.sp
Number of days to retain the copied DB system backup.
.sp
\fBNote:\fP The maximum value for an automatic backup is 35, and the maximum value for a manual backup is 365.
.INDENT 0.0
.TP
.B \-\-description [text]
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/mysql/backup/copy.html#cmdoption\-compartment\-id
    export source_backup_id=<substitute\-value\-of\-source_backup_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/mysql/backup/copy.html#cmdoption\-source\-backup\-id
    export source_region=<substitute\-value\-of\-source_region> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/mysql/backup/copy.html#cmdoption\-source\-region

    oci mysql backup copy \-\-compartment\-id $compartment_id \-\-source\-backup\-id $source_backup_id \-\-source\-region $source_region
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci mysql backup create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci mysql backup delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci mysql backup delete \-\-backup\-id $backup_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci mysql backup get \-\-backup\-id $backup_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The maximum number of items to return in a paginated list call. For information about pagination, see \fI\%List Pagination\fP\&.
.INDENT 0.0
.TP
.B \-\-page [text]
.UNINDENT
.sp
The value of the \fIopc\-next\-page\fP or \fIopc\-prev\-page\fP response header from the previous list call. For information about pagination, see \fI\%List Pagination\fP\&.
.INDENT 0.0
.TP
.B \-\-page\-size [integer]
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/mysql/backup/list.html#cmdoption\-compartment\-id

    oci mysql backup list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci mysql backup update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci mysql backup update \-\-backup\-id $backup_id
.ft P
.fi
.UNINDENT
.UNINDENT
