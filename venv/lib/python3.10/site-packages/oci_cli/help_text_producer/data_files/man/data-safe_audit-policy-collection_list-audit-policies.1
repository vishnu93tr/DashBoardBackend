...
.
.TH "DATA-SAFE_AUDIT-POLICY-COLLECTION_LIST-AUDIT-POLICIES" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_audit-policy-collection_list-audit-policies \- 
.
...
.sp
The ListAuditPolicies operation returns only the audit policies in the specified \fIcompartmentId\fP\&. The list does not include any subcompartments of the compartmentId passed.
.sp
...
.nf
.ft C
oci data\-safe audit\-policy\-collection list\-audit\-policies [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-safe/audit\-policy\-collection/list\-audit\-policies.html#cmdoption\-compartment\-id

    oci data\-safe audit\-policy\-collection list\-audit\-policies \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
