...
.
.TH "NETWORK-FIREWALL_APPLICATION_UPDATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network-firewall_application_update \- 
.
...
.nf
.ft C
oci network\-firewall application update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export application_name=<substitute\-value\-of\-application_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/network\-firewall/application/update.html#cmdoption\-application\-name
    export type=<substitute\-value\-of\-type> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/network\-firewall/application/update.html#cmdoption\-type
    ...
    oci network\-firewall application update \-\-application\-name $application_name \-\-network\-firewall\-policy\-id $network_firewall_policy_id \-\-type $type
.ft P
.fi
.UNINDENT
.UNINDENT
