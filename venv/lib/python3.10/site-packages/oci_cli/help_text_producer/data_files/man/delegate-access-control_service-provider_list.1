...
.
.TH "DELEGATE-ACCESS-CONTROL_SERVICE-PROVIDER_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
delegate-access-control_service-provider_list \- 
.
...
.nf
.ft C
oci delegate\-access\-control service\-provider list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-supported\-resource\-type [text]
.UNINDENT
.sp
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/delegate\-access\-control/service\-provider/list.html#cmdoption\-compartment\-id

    oci delegate\-access\-control service\-provider list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
