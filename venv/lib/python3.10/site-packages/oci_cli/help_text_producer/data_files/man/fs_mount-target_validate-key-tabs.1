...
.
.TH "FS_MOUNT-TARGET_VALIDATE-KEY-TABS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
fs_mount-target_validate-key-tabs \- 
.
...
.nf
.ft C
oci fs mount\-target validate\-key\-tabs [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-key\-tab\-secret\-details [complex type]
.UNINDENT
.sp
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the mount target whose keytabs are to be validated.
