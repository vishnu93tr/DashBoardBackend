...
.
.TH "DATA-SAFE_WORK-REQUEST_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_work-request_list \- 
.
...
.UNINDENT
.sp
The field used for sorting. Only one sorting parameter can be specified. The default order is descending.
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-safe/work\-request/list.html#cmdoption\-compartment\-id

    oci data\-safe work\-request list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
