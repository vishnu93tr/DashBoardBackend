...
.
.TH "CE_CLUSTER_CREATE-KUBECONFIG" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
...
.UNINDENT
.sp
Appends the current authentication context (values configured in –auth and –profile) of the OCI CLI command to the kubeconfig user exec command if –with\-auth\-context is used or not append those information if –with\-auth\-context is not used
