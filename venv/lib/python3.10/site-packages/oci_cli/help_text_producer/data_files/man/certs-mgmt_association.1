...
.
.TH "CERTS-MGMT_ASSOCIATION" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
certs-mgmt_association \- 
.
...
.nf
.ft C
oci certs\-mgmt association get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export association_id=<substitute\-value\-of\-association_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/certs\-mgmt/association/get.html#cmdoption\-association\-id

    oci certs\-mgmt association get \-\-association\-id $association_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.SS Description
.sp
Lists all associations that match the query parameters. Optionally, you can use the parameter \fIFilterByAssociationIdQueryParam\fP to limit the result set to a single item that matches the specified association.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci certs\-mgmt association list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
CA_BUNDLE, CERTIFICATE, CERTIFICATE_AUTHORITY
.ft P
.fi
.UNINDENT
.UNINDENT
.INDENT 0.0
.TP
.B \-\-certificates\-resource\-id [text]
.UNINDENT
.sp
...
.nf
.ft C
    oci certs\-mgmt association list
.ft P
.fi
.UNINDENT
.UNINDENT
