...
.
.TH "IDENTITY-DOMAINS_CLOUD-GATES" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_cloud-gates \- 
.
...
.nf
.ft C
oci identity\-domains cloud\-gates list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains cloud\-gates list
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains cloud\-gates search [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains cloud\-gates search \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains cloud\-gates search \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
