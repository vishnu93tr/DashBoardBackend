...
.
.TH "NLB_BACKEND-OPERATIONAL-STATUS_GET" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
nlb_backend-operational-status_get \- 
.
...
.nf
.ft C
oci nlb backend\-operational\-status get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
10.0.0.3:8080\(ga or \(gaocid1.privateip..oc1.<var>&lt;unique_ID&gt;</var>:8080
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export backend_name=<substitute\-value\-of\-backend_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/nlb/backend\-operational\-status/get.html#cmdoption\-backend\-name
    export backend_set_name=<substitute\-value\-of\-backend_set_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/nlb/backend\-operational\-status/get.html#cmdoption\-backend\-set\-name
    ...
    oci nlb backend\-operational\-status get \-\-backend\-name $backend_name \-\-backend\-set\-name $backend_set_name \-\-network\-load\-balancer\-id $network_load_balancer_id
.ft P
.fi
.UNINDENT
.UNINDENT
