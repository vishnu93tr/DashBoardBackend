...
.
.TH "IDENTITY-DOMAINS_API-KEY" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_api-key \- 
.
...
.nf
.ft C
oci identity\-domains api\-key create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains api\-key create \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export fingerprint=<substitute\-value\-of\-fingerprint> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/identity\-domains/api\-key/create.html#cmdoption\-fingerprint
    export key=<substitute\-value\-of\-key> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/identity\-domains/api\-key/create.html#cmdoption\-key

    oci identity\-domains api\-key create \-\-fingerprint $fingerprint \-\-key $key \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains api\-key delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    api_key_id=$(oci identity\-domains api\-key create \-\-fingerprint $fingerprint \-\-key $key \-\-schemas file://schemas.json \-\-query data.id \-\-raw\-output)

    oci identity\-domains api\-key delete \-\-api\-key\-id $api_key_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains api\-key get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains api\-key get \-\-api\-key\-id $api_key_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains api\-key patch [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains api\-key patch \-\-generate\-param\-json\-input operations > operations.json
    oci identity\-domains api\-key patch \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains api\-key patch \-\-api\-key\-id $api_key_id \-\-operations file://operations.json \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
