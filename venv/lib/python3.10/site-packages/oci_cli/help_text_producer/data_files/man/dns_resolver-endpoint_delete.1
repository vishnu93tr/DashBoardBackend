...
.
.TH "DNS_RESOLVER-ENDPOINT_DELETE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
dns_resolver-endpoint_delete \- 
.
...
.sp
Note that attempting to delete a resolver endpoint in the DELETED lifecycle state will result in a \fI404\fP response to be consistent with other operations of the API. Resolver endpoints may not be deleted if they are referenced by a resolver rule.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
