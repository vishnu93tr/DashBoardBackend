...
.
.TH "CE_CLUSTER_CLUSTER-MIGRATE-TO-NATIVE-VCN" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
ce_cluster_cluster-migrate-to-native-vcn \- 
.
...
.nf
.ft C
oci ce cluster cluster\-migrate\-to\-native\-vcn [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-endpoint\-config [complex type]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-decommission\-delay\-duration [text]
.UNINDENT
.sp
...
.nf
.ft C
    oci ce cluster cluster\-migrate\-to\-native\-vcn \-\-generate\-param\-json\-input endpoint\-config > endpoint\-config.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci ce cluster cluster\-migrate\-to\-native\-vcn \-\-cluster\-id $cluster_id \-\-endpoint\-config file://endpoint\-config.json
.ft P
.fi
.UNINDENT
.UNINDENT
