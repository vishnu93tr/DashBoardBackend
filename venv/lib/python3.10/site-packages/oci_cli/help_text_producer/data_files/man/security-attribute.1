...
.
.TH "SECURITY-ATTRIBUTE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
security-attribute \- 
.
...
.SH DESCRIPTION
.sp
Use the Security Attributes CLI to manage security attributes and security attribute namespaces. For more information, see the documentation for \fI\%Security Attributes\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/zero-trust-packet-routing/managing-security-attributes.htm\fP> and \fI\%Security Attribute Namespaces\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/zero-trust-packet-routing/managing-security-attribute-namespaces.htm\fP>\&.
...
.UNINDENT
.UNINDENT
.SS security\-attribute
.SS Description
.sp
A security attribute that belongs to a specific security attribute namespace. Security attributes must be created in a tenancy before a user can apply them to resources. For more information, see \fI\%Managing Security Attributes\fP <\fBhttps://docs.cloud.oracle.com/Content/zero-trust-packet-routing/managing-security-attributes.htm\fP>\&.
.sp
...
.sp
After you start this operation, you cannot start either the \fI\%DeleteSecurityAttribute\fP <\fBhttps://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/security-attribute/security-attribute/delete.html\fP> or the \fI\%CascadeDeleteSecurityAttributeNamespace\fP <\fBhttps://docs.cloud.oracle.com/api/#/en/security-attribute/latest/SecurityAttributeNamespace/CascadingDeleteSecurityAttributeNamespace\fP> operation until this process completes.
.sp
In order to delete security attribute, you must first retire the security attribute. Use \fI\%UpdateSecurityAttribute\fP <\fBhttps://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/security-attribute/security-attribute/update.html\fP> to retire a security attribute.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
...
.INDENT 0.0
.TP
.B \-\-security\-attribute\-ids [complex type]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-bulk\-edit\-operations [complex type]
.UNINDENT
.sp
...
.sp
You must specify a \fIname\fP for the attribute, which must be unique across all attributes in the security attribute namespace and cannot be changed. The only valid characters for security attribute names are:\ 0\-9, A\-Z, a\-z, \-, _ characters. Names are case insensitive. That means, for example, “mySecurityAttribute” and “mysecurityattribute” are not allowed in the same namespace. If you specify a name that’s already in use in the security attribute namespace, a 409 error is returned.
.sp
The security attribute must have a \fIdescription\fP\&. It does not have to be unique, and you can change it with \fI\%UpdateSecurityAttribute\fP <\fBhttps://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/security-attribute/security-attribute/update.html\fP>\&.
.sp
...
.INDENT 0.0
.TP
.B \-\-security\-attribute\-namespace\-id [text]
.UNINDENT
.sp
...
.sp
After you start this operation, you cannot start either the \fI\%BulkDeleteSecurityAttributes\fP <\fBhttps://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/security-attribute/security-attribute/bulk-delete.html\fP> or the \fI\%CascadeDeleteSecurityAttributeNamespace\fP <\fBhttps://docs.cloud.oracle.com/api/#/en/security-attribute/latest/SecurityAttributeNamespace/CascadingDeleteSecurityAttributeNamespace\fP> operation until this process completes.
.sp
To delete a security attribute, you must first retire it. Use \fI\%UpdateSecurityAttribute\fP <\fBhttps://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/security-attribute/security-attribute/update.html\fP> to retire a security attribute.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
...
.INDENT 0.0
.TP
.B \-\-security\-attribute\-name [text]
.UNINDENT
.sp
...
.nf
.ft C
oci security\-attribute security\-attribute get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci security\-attribute security\-attribute get \-\-security\-attribute\-name $security_attribute_name \-\-security\-attribute\-namespace\-id $security_attribute_namespace_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci security\-attribute security\-attribute list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci security\-attribute security\-attribute list \-\-security\-attribute\-namespace\-id $security_attribute_namespace_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.SS Description
.sp
Updates the specified security attribute. You can only update \fIdescription\fP, and \fIisRetired\fP\&.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci security\-attribute security\-attribute update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-is\-retired [boolean]
.UNINDENT
.sp
Whether the security attribute is retired. See \fI\%Managing Security Attributes\fP <\fBhttps://docs.cloud.oracle.com/Content/zero-trust-packet-routing/managing-security-attributes.htm\fP>\&.
.INDENT 0.0
.TP
.B \-\-max\-wait\-seconds [integer]
.UNINDENT
...
.ft C
    ...
    oci security\-attribute security\-attribute update \-\-security\-attribute\-name $security_attribute_name \-\-security\-attribute\-namespace\-id $security_attribute_namespace_id
.ft P
.fi
.UNINDENT
.UNINDENT
.SS security\-attribute\-namespace
.SS Description
.sp
A managed container for security attributes. A security attribute namespace is unique in a tenancy. For more information, see \fI\%Managing Security Attributes Namespaces\fP <\fBhttps://docs.cloud.oracle.com/Content/zero-trust-packet-routing/managing-security-attribute-namespaces.htm\fP>\&.
.sp
\fBWarning:\fP Oracle recommends that you avoid using any confidential information when you supply string values using the API.
.SS Available Commands
.INDENT 0.0
...
.sp
After you start this operation, you cannot start either the \fI\%DeleteSecurityAttribute\fP <\fBhttps://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/security-attribute/security-attribute/delete.html\fP> or the \fI\%BulkDeleteSecurityAttributes\fP <\fBhttps://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/security-attribute/security-attribute/bulk-delete.html\fP> operation until this process completes.
.sp
To delete a security attribute namespace, you must first retire it. Use \fI\%UpdateSecurityAttributeNamespace\fP <\fBhttps://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/security-attribute/security-attribute-namespace/update.html\fP> to retire a security attribute namespace.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
...
.sp
To move the security attribute namespace, you must have the manage security\-attributes permission on both compartments. For more information about IAM policies, see \fI\%Details for IAM\fP <\fBhttps://docs.cloud.oracle.com/Content/Identity/policyreference/iampolicyreference.htm\fP>\&.
.sp
...
.nf
.ft C
oci security\-attribute security\-attribute\-namespace change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci security\-attribute security\-attribute\-namespace change\-compartment \-\-compartment\-id $compartment_id \-\-security\-attribute\-namespace\-id $security_attribute_namespace_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.sp
You must also specify a \fIname\fP for the namespace, which must be unique across all namespaces in your tenancy and cannot be changed. The only valid characters for security attribute names are: \ 0\-9, A\-Z, a\-z, \-, _ characters. Names are case insensitive. That means, for example, “myNamespace” and “mynamespace” are not allowed in the same tenancy. Once you created a namespace, you cannot change the name. If you specify a name that’s already in use in the tenancy, a 409 error is returned.
.sp
You must also specify a \fIdescription\fP for the namespace. It does not have to be unique, and you can change it with \fI\%UpdateSecurityAttributeNamespace\fP <\fBhttps://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/security-attribute/security-attribute-namespace/update.html\fP>\&.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci security\-attribute security\-attribute\-namespace create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci security\-attribute security\-attribute\-namespace create \-\-compartment\-id $compartment_id \-\-description $description \-\-name $name
.ft P
.fi
.UNINDENT
.UNINDENT
...
.SS Description
.sp
Deletes the specified security attribute namespace. Only an empty security attribute namespace can be deleted with this operation. To use this operation to delete a security attribute namespace that contains security attributes, first delete all of its security attributes. Use \fI\%DeleteSecurityAttribute\fP <\fBhttps://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/security-attribute/security-attribute/delete.html\fP> to delete a security attribute.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci security\-attribute security\-attribute\-namespace delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci security\-attribute security\-attribute\-namespace delete \-\-security\-attribute\-namespace\-id $security_attribute_namespace_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci security\-attribute security\-attribute\-namespace get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci security\-attribute security\-attribute\-namespace get \-\-security\-attribute\-namespace\-id $security_attribute_namespace_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci security\-attribute security\-attribute\-namespace list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The field to sort by. You can provide one sort order (\fIsortOrder\fP). Default order for TIMECREATED is descending. Default order for NAME is ascending. The NAME sort order is case sensitive.
.sp
...
.sp
Updating \fIisRetired\fP to ‘true’ retires the namespace and all the security attributes in the namespace. Reactivating a namespace (changing \fIisRetired\fP from ‘true’ to ‘false’) does not reactivate security attributes. To reactivate the security attributes, you must reactivate each one individually \fIafter\fP you reactivate the namespace, using \fI\%UpdateSecurityAttribute\fP <\fBhttps://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/security-attribute/security-attribute/update.html\fP>\&. For more information about retiring security attribute namespaces, see \fI\%Managing Security Attribute Namespaces\fP <\fBhttps://docs.cloud.oracle.com/Content/zero-trust-packet-routing/managing-security-attribute-namespaces.htm\fP>\&.
.sp
...
.nf
.ft C
oci security\-attribute security\-attribute\-namespace update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
Indicates whether the security attribute namespace is retired. See \fI\%Managing Security Attribute Namespaces\fP <\fBhttps://docs.cloud.oracle.com/Content/zero-trust-packet-routing/managing-security-attribute-namespaces.htm\fP>\&.
.INDENT 0.0
.TP
.B \-\-max\-wait\-seconds [integer]
.UNINDENT
...
.ft C
    ...
    oci security\-attribute security\-attribute\-namespace update \-\-security\-attribute\-namespace\-id $security_attribute_namespace_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci security\-attribute work\-request get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export work_request_id=<substitute\-value\-of\-work_request_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/security\-attribute/work\-request/get.html#cmdoption\-work\-request\-id

    oci security\-attribute work\-request get \-\-work\-request\-id $work_request_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci security\-attribute work\-request list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci security\-attribute work\-request list\-errors [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export work_request_id=<substitute\-value\-of\-work_request_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/security\-attribute/work\-request/list\-errors.html#cmdoption\-work\-request\-id

    oci security\-attribute work\-request list\-errors \-\-work\-request\-id $work_request_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci security\-attribute work\-request list\-logs [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export work_request_id=<substitute\-value\-of\-work_request_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/security\-attribute/work\-request/list\-logs.html#cmdoption\-work\-request\-id

    oci security\-attribute work\-request list\-logs \-\-work\-request\-id $work_request_id
.ft P
.fi
.UNINDENT
.UNINDENT
