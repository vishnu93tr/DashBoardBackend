...
.
.TH "DB_SCHEDULED-ACTION" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_scheduled-action \- 
.
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the Scheduling Plan.
.INDENT 0.0
.TP
...
.sp
This option is a JSON list with items of type ActionMember.  For documentation on ActionMember please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/database/20160918/datatypes/ActionMember\fP\&.
...
.nf
.ft C
oci db scheduled\-action delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci db scheduled\-action delete \-\-scheduled\-action\-id $scheduled_action_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci db scheduled\-action list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/db/scheduled\-action/list.html#cmdoption\-compartment\-id

    oci db scheduled\-action list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci db scheduled\-action update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
