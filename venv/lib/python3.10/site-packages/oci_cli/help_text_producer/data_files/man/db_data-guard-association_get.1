...
.
.TH "DB_DATA-GUARD-ASSOCIATION_GET" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_data-guard-association_get \- 
.
...
.nf
.ft C
oci db data\-guard\-association get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export data_guard_association_id=<substitute\-value\-of\-data_guard_association_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/db/data\-guard\-association/get.html#cmdoption\-data\-guard\-association\-id
    ...
    oci db data\-guard\-association get \-\-data\-guard\-association\-id $data_guard_association_id \-\-database\-id $database_id
.ft P
.fi
.UNINDENT
.UNINDENT
