...
.
.TH "DEVOPS_CONNECTION_CREATE-BITBUCKET-SERVER-CONNECTION" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
devops_connection_create-bitbucket-server-connection \- 
.
...
.nf
.ft C
oci devops connection create\-bitbucket\-server\-connection [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-tls\-verify\-config [complex type]
.UNINDENT
.sp
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
...
.ft C
    ...
    export base_url=<substitute\-value\-of\-base_url> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/devops/connection/create\-bitbucket\-server\-connection.html#cmdoption\-base\-url
    export personal_access_token=<substitute\-value\-of\-personal_access_token> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/devops/connection/create\-bitbucket\-server\-connection.html#cmdoption\-personal\-access\-token
    ...
    oci devops connection create\-bitbucket\-server\-connection \-\-base\-url $base_url \-\-personal\-access\-token $personal_access_token \-\-project\-id $project_id
.ft P
.fi
.UNINDENT
.UNINDENT
