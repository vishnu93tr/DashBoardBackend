...
.
.TH "IDENTITY-DOMAINS_USER" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_user \- 
.
...
.nf
.ft C
oci identity\-domains user delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    user_id=$(oci identity\-domains user create \-\-schemas file://schemas.json \-\-user\-name $user_name \-\-query data.id \-\-raw\-output)

    oci identity\-domains user delete \-\-user\-id $user_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains user get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains user get \-\-user\-id $user_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains user patch [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains user patch \-\-generate\-param\-json\-input operations > operations.json
    oci identity\-domains user patch \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains user patch \-\-operations file://operations.json \-\-schemas file://schemas.json \-\-user\-id $user_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains user put [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains user put \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains user put \-\-schemas file://schemas.json \-\-user\-id $user_id \-\-user\-name $user_name
.ft P
.fi
.UNINDENT
.UNINDENT
