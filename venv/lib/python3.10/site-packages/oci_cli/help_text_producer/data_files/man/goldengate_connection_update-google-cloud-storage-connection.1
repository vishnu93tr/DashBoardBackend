...
.
.TH "GOLDENGATE_CONNECTION_UPDATE-GOOGLE-CLOUD-STORAGE-CONNECTION" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
goldengate_connection_update-google-cloud-storage-connection \- 
.
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the Secret where the content of the service account key file is stored, which containing the credentials required to use Google Cloud Storage. Note: When provided, ‘serviceAccountKeyFile’ field must not be provided.
.INDENT 0.0
.TP
.B \-\-subnet\-id [text]
.UNINDENT
