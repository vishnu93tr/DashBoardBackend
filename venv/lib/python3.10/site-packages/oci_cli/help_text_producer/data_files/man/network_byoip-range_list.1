...
.
.TH "NETWORK_BYOIP-RANGE_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network_byoip-range_list \- 
.
...
.SH DESCRIPTION
.sp
Lists the \fIByoipRange\fP resources in the specified compartment. You can filter the list using query parameters.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci network byoip\-range list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/network/byoip\-range/list.html#cmdoption\-compartment\-id

    oci network byoip\-range list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
