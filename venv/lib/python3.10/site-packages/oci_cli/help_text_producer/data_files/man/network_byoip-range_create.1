...
.
.TH "NETWORK_BYOIP-RANGE_CREATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network_byoip-range_create \- 
.
...
.nf
.ft C
oci network byoip\-range create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the compartment containing the BYOIP CIDR block.
...
.UNINDENT
.sp
The BYOIP CIDR block. You can assign some or all of it to a public IP pool after it is validated. Example: \fI10.0.1.0/24\fP
.INDENT 0.0
.TP
...
.ft C
    ...
    oci network byoip\-range create \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
