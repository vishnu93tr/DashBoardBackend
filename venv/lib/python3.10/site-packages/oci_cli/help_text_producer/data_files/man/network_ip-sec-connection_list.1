...
.
.TH "NETWORK_IP-SEC-CONNECTION_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network_ip-sec-connection_list \- 
.
...
.nf
.ft C
oci network ip\-sec\-connection list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/network/ip\-sec\-connection/list.html#cmdoption\-compartment\-id

    oci network ip\-sec\-connection list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
