...
.
.TH "API-GATEWAY_SDK_CREATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
api-gateway_sdk_create \- 
.
...
.nf
.ft C
oci api\-gateway sdk create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of API resource
.INDENT 0.0
.TP
.B \-\-target\-language [text]
.UNINDENT
.sp
...
.ft C
    ...
    export target_language=<substitute\-value\-of\-target_language> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/api\-gateway/sdk/create.html#cmdoption\-target\-language

    api_id=$(oci api\-gateway api create \-\-compartment\-id $compartment_id \-\-query data.id \-\-raw\-output)

    oci api\-gateway sdk create \-\-api\-id $api_id \-\-target\-language $target_language
.ft P
.fi
.UNINDENT
.UNINDENT
