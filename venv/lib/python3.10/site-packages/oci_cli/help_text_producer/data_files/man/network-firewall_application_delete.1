...
.
.TH "NETWORK-FIREWALL_APPLICATION_DELETE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network-firewall_application_delete \- 
.
...
.nf
.ft C
oci network\-firewall application delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export application_name=<substitute\-value\-of\-application_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/network\-firewall/application/delete.html#cmdoption\-application\-name
    ...
    oci network\-firewall application delete \-\-application\-name $application_name \-\-network\-firewall\-policy\-id $network_firewall_policy_id
.ft P
.fi
.UNINDENT
.UNINDENT
