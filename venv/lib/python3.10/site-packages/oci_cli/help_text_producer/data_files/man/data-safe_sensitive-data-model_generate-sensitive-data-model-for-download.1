...
.
.TH "DATA-SAFE_SENSITIVE-DATA-MODEL_GENERATE-SENSITIVE-DATA-MODEL-FOR-DOWNLOAD" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_sensitive-data-model_generate-sensitive-data-model-for-download \- 
.
...
.nf
.ft C
oci data\-safe sensitive\-data\-model generate\-sensitive\-data\-model\-for\-download [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci data\-safe sensitive\-data\-model generate\-sensitive\-data\-model\-for\-download \-\-sensitive\-data\-model\-id $sensitive_data_model_id
.ft P
.fi
.UNINDENT
.UNINDENT
