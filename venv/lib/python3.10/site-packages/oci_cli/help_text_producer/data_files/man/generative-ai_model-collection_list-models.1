...
.
.TH "GENERATIVE-AI_MODEL-COLLECTION_LIST-MODELS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
generative-ai_model-collection_list-models \- 
.
...
.nf
.ft C
CHAT, FINE_TUNE, TEXT_EMBEDDINGS, TEXT_GENERATION, TEXT_SUMMARIZATION
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The field to sort by. You can provide only one sort order. Default order for \fItimeCreated\fP is descending.
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
