...
.
.TH "IDENTITY-DOMAINS_MY-USER-DB-CREDENTIAL" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_my-user-db-credential \- 
.
...
.nf
.ft C
oci identity\-domains my\-user\-db\-credential create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.sp
\fBSCIM++ Properties:\fP  \- type: string  \- mutability: immutable  \- returned: default  \- required: true
.INDENT 0.0
.TP
...
.sp
\fBSCIM++ Properties:\fP  \- type: boolean  \- mutability: readOnly  \- returned: default
.INDENT 0.0
.TP
.B \-\-expires\-on [text]
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-last\-set\-date [text]
.UNINDENT
.sp
A DateTime that specifies the date and time when the current database password was set.
.sp
\fBSCIM++ Properties:\fP  \- type: dateTime  \- mutability: readOnly  \- returned: default
.INDENT 0.0
.TP
.B \-\-meta [complex type]
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-mixed\-db\-password [text]
.UNINDENT
.sp
The user’s database password with mixed salt.
.sp
\fBSCIM++ Properties:\fP  \- type: string  \- mutability: readOnly  \- returned: default  \- required: false
.INDENT 0.0
.TP
.B \-\-mixed\-salt [text]
.UNINDENT
...
\fBAdded In:\fP 2109090424
.sp
\fBSCIM++ Properties:\fP  \- caseExact: false  \- type: string  \- mutability: readOnly  \- required: false  \- returned: default
.INDENT 0.0
.TP
.B \-\-ocid [text]
.UNINDENT
...
.nf
.ft C
    oci identity\-domains my\-user\-db\-credential create \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export db_password=<substitute\-value\-of\-db_password> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/identity\-domains/my\-user\-db\-credential/create.html#cmdoption\-db\-password

    oci identity\-domains my\-user\-db\-credential create \-\-db\-password $db_password \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains my\-user\-db\-credential delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-my\-user\-db\-credential\-id [text]
.UNINDENT
.sp
ID of the resource
.SS Optional Parameters
...
.ft C
    ...
    my_user_db_credential_id=$(oci identity\-domains my\-user\-db\-credential create \-\-db\-password $db_password \-\-schemas file://schemas.json \-\-query data.id \-\-raw\-output)

    oci identity\-domains my\-user\-db\-credential delete \-\-my\-user\-db\-credential\-id $my_user_db_credential_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains my\-user\-db\-credential get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains my\-user\-db\-credential get \-\-my\-user\-db\-credential\-id $my_user_db_credential_id
.ft P
.fi
.UNINDENT
.UNINDENT
