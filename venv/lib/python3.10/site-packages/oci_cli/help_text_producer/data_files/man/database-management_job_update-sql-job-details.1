...
.
.TH "DATABASE-MANAGEMENT_JOB_UPDATE-SQL-JOB-DETAILS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
database-management_job_update-sql-job-details \- 
.
...
.nf
.ft C
oci database\-management job update\-sql\-job\-details [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export job_id=<substitute\-value\-of\-job_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/database\-management/job/update\-sql\-job\-details.html#cmdoption\-job\-id

    oci database\-management job update\-sql\-job\-details \-\-job\-id $job_id
.ft P
.fi
.UNINDENT
.UNINDENT
