...
.
.TH "DNS_RESOLVER" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
dns_resolver \- 
.
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the compartment into which the resolver, along with its protected default view and resolver endpoints, should be moved.
.INDENT 0.0
.TP
.B \-\-resolver\-id [text]
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/dns/resolver/change\-compartment.html#cmdoption\-compartment\-id
    export resolver_id=<substitute\-value\-of\-resolver_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/dns/resolver/change\-compartment.html#cmdoption\-resolver\-id
...
.sp
Note that attempting to get a resolver in the DELETED lifecycleState will result in a \fI404\fP response to be consistent with other operations of the API.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
...
.nf
.ft C
    export resolver_id=<substitute\-value\-of\-resolver_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/dns/resolver/get.html#cmdoption\-resolver\-id

    oci dns resolver get \-\-resolver\-id $resolver_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/dns/resolver/list.html#cmdoption\-compartment\-id

    oci dns resolver list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-attached\-views [complex type]
.UNINDENT
.sp
The attached views. Views are evaluated in order.
.sp
This option is a JSON list with items of type AttachedViewDetails.  For documentation on AttachedViewDetails please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/dns/20180115/datatypes/AttachedViewDetails\fP\&.
...
.sp
This option is a JSON list with items of type ResolverRuleDetails.  For documentation on ResolverRuleDetails please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/dns/20180115/datatypes/ResolverRuleDetails\fP\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
