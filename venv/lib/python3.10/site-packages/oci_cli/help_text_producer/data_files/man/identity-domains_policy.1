...
.
.TH "IDENTITY-DOMAINS_POLICY" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_policy \- 
.
...
.nf
.ft C
oci identity\-domains policy create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
Policy name
.sp
\fBSCIM++ Properties:\fP  \- caseExact: false  \- idcsSearchable: true  \- multiValued: false  \- mutability: readWrite  \- required: true  \- returned: always  \- type: string  \- uniqueness: none
.INDENT 0.0
.TP
...
.sp
\fBSCIM++ Properties:\fP  \- idcsCompositeKey: [value]  \- idcsSearchable: true  \- multiValued: true  \- mutability: readWrite  \- required: false  \- returned: request  \- type: complex  \- uniqueness: none
.sp
This option is a JSON list with items of type PolicyRules.  For documentation on PolicyRules please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/identitydomains/v1/datatypes/PolicyRules\fP\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
.nf
.ft C
    oci identity\-domains policy create \-\-generate\-param\-json\-input policy\-type > policy\-type.json
    oci identity\-domains policy create \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export name=<substitute\-value\-of\-name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/identity\-domains/policy/create.html#cmdoption\-name

    oci identity\-domains policy create \-\-name $name \-\-policy\-type file://policy\-type.json \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains policy delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    policy_id=$(oci identity\-domains policy create \-\-name $name \-\-policy\-type file://policy\-type.json \-\-schemas file://schemas.json \-\-query data.id \-\-raw\-output)

    oci identity\-domains policy delete \-\-policy\-id $policy_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains policy get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains policy get \-\-policy\-id $policy_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains policy list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains policy list
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains policy patch [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains policy patch \-\-generate\-param\-json\-input operations > operations.json
    oci identity\-domains policy patch \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains policy patch \-\-operations file://operations.json \-\-policy\-id $policy_id \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains policy put [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains policy put \-\-generate\-param\-json\-input policy\-type > policy\-type.json
    oci identity\-domains policy put \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains policy put \-\-name $name \-\-policy\-id $policy_id \-\-policy\-type file://policy\-type.json \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains policy search [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains policy search \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains policy search \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
