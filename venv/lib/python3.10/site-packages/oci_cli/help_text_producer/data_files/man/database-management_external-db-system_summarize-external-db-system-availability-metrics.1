...
.
.TH "DATABASE-MANAGEMENT_EXTERNAL-DB-SYSTEM_SUMMARIZE-EXTERNAL-DB-SYSTEM-AVAILABILITY-METRICS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
database-management_external-db-system_summarize-external-db-system-availability-metrics \- 
.
...
.SH DESCRIPTION
.sp
Gets availability metrics for the components present in the external DB system specified by \fIexternalDbSystemId\fP\&.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
...
.INDENT 0.0
.TP
.B \-\-filter\-by\-component\-types [text]
.UNINDENT
.sp
