...
.
.TH "CCC_INFRASTRUCTURE_CHANGE-COMPARTMENT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
ccc_infrastructure_change-compartment \- 
.
...
.SH DESCRIPTION
.sp
Moves a Compute \fI\%Cloud@Customer\fP <\fBCloud@Customer\fP> infrastructure resource from one compartment to another.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci ccc infrastructure change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci ccc infrastructure change\-compartment \-\-compartment\-id $compartment_id \-\-infrastructure\-id $infrastructure_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.SS Description
.sp
Moves a Compute \fI\%Cloud@Customer\fP <\fBCloud@Customer\fP> infrastructure from one compartment to another using the specified OCID.
.SS Command
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
 oci ccc infrastructure change\-compartment \-\-infrastructure\-id <infrastructure_OCID> \-c <compartment_OCID>
.ft P
.fi
.UNINDENT
.UNINDENT
