...
.
.TH "DATA-SAFE_MASKING-COLUMN_GET" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_masking-column_get \- 
.
...
.nf
.ft C
oci data\-safe masking\-column get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export masking_column_key=<substitute\-value\-of\-masking_column_key> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-safe/masking\-column/get.html#cmdoption\-masking\-column\-key
    ...
    oci data\-safe masking\-column get \-\-masking\-column\-key $masking_column_key \-\-masking\-policy\-id $masking_policy_id
.ft P
.fi
.UNINDENT
.UNINDENT
