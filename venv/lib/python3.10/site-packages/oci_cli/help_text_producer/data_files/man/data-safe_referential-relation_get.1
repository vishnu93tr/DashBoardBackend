...
.
.TH "DATA-SAFE_REFERENTIAL-RELATION_GET" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_referential-relation_get \- 
.
...
.nf
.ft C
oci data\-safe referential\-relation get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export referential_relation_key=<substitute\-value\-of\-referential_relation_key> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-safe/referential\-relation/get.html#cmdoption\-referential\-relation\-key
    ...
    oci data\-safe referential\-relation get \-\-referential\-relation\-key $referential_relation_key \-\-sensitive\-data\-model\-id $sensitive_data_model_id
.ft P
.fi
.UNINDENT
.UNINDENT
