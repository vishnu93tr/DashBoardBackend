...
.
.TH "DATA-CATALOG_RULE-SUMMARY_LIST-RULES" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-catalog_rule-summary_list-rules \- 
.
...
.nf
.ft C
oci data\-catalog rule\-summary list\-rules [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
displayName, externalKey, key, lifecycleState, originType, referencedEntityKey, referencedEntityName, referencedFolderKey, referencedFolderName, referencedRuleKey, referencedRuleName, ruleType, timeCreated, uri
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export data_asset_key=<substitute\-value\-of\-data_asset_key> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-catalog/rule\-summary/list\-rules.html#cmdoption\-data\-asset\-key
    export entity_key=<substitute\-value\-of\-entity_key> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-catalog/rule\-summary/list\-rules.html#cmdoption\-entity\-key

    catalog_id=$(oci data\-catalog catalog create \-\-compartment\-id $compartment_id \-\-query data.id \-\-raw\-output)

    oci data\-catalog rule\-summary list\-rules \-\-catalog\-id $catalog_id \-\-data\-asset\-key $data_asset_key \-\-entity\-key $entity_key
.ft P
.fi
.UNINDENT
.UNINDENT
