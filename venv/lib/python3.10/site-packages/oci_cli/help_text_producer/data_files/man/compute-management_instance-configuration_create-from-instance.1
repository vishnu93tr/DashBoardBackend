...
.
.TH "COMPUTE-MANAGEMENT_INSTANCE-CONFIGURATION_CREATE-FROM-INSTANCE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
compute-management_instance-configuration_create-from-instance \- 
.
...
.nf
.ft C
oci compute\-management instance\-configuration create\-from\-instance [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the compartment containing the instance configuration.
.INDENT 0.0
.TP
.B \-\-instance\-id [text]
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the instance to use to create the instance configuration.
...
.ft C
    ...
    oci compute\-management instance\-configuration create\-from\-instance \-\-compartment\-id $compartment_id \-\-instance\-id $instance_id
.ft P
.fi
.UNINDENT
.UNINDENT
