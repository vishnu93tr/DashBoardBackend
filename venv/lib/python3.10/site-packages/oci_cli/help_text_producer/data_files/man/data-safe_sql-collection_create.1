...
.
.TH "DATA-SAFE_SQL-COLLECTION_CREATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_sql-collection_create \- 
.
...
.nf
.ft C
oci data\-safe sql\-collection create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci data\-safe sql\-collection create \-\-compartment\-id $compartment_id \-\-db\-user\-name $db_user_name \-\-target\-id $target_id
.ft P
.fi
.UNINDENT
.UNINDENT
