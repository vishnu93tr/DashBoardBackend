...
.
.TH "DATA-SAFE_LIBRARY-MASKING-FORMAT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_library-masking-format \- 
.
...
.nf
.ft C
oci data\-safe library\-masking\-format change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-library\-masking\-format\-id [text]
.UNINDENT
.sp
...
.nf
.ft C
    oci data\-safe library\-masking\-format create \-\-generate\-param\-json\-input format\-entries > format\-entries.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-safe/library\-masking\-format/create.html#cmdoption\-compartment\-id

    library_masking_format_id=$(oci data\-safe library\-masking\-format create \-\-compartment\-id $compartment_id \-\-format\-entries file://format\-entries.json \-\-query data.id \-\-raw\-output)

    oci data\-safe library\-masking\-format change\-compartment \-\-compartment\-id $compartment_id \-\-library\-masking\-format\-id $library_masking_format_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci data\-safe library\-masking\-format create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-sensitive\-type\-ids [complex type]
.UNINDENT
.sp
...
.ft C
    ...
    oci data\-safe library\-masking\-format create \-\-compartment\-id $compartment_id \-\-format\-entries file://format\-entries.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci data\-safe library\-masking\-format delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci data\-safe library\-masking\-format delete \-\-library\-masking\-format\-id $library_masking_format_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci data\-safe library\-masking\-format get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci data\-safe library\-masking\-format get \-\-library\-masking\-format\-id $library_masking_format_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci data\-safe library\-masking\-format update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
An array of format entries. The combined output of all the format entries is used for masking.
.sp
This option is a JSON list with items of type FormatEntry.  For documentation on FormatEntry please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/datasafe/20181201/datatypes/FormatEntry\fP\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
.ft C
    ...
    oci data\-safe library\-masking\-format update \-\-library\-masking\-format\-id $library_masking_format_id
.ft P
.fi
.UNINDENT
.UNINDENT
