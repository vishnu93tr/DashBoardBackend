...
.
.TH "OPSI_DATABASE-INSIGHTS_SUMMARIZE-ADDM-DB-PARAMETERS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
opsi_database-insights_summarize-addm-db-parameters \- 
.
...
.nf
.ft C
oci opsi database\-insights summarize\-addm\-db\-parameters [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/opsi/database\-insights/summarize\-addm\-db\-parameters.html#cmdoption\-compartment\-id

    oci opsi database\-insights summarize\-addm\-db\-parameters \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
