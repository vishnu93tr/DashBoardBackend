...
.
.TH "CCC_INFRASTRUCTURE_DELETE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
ccc_infrastructure_delete \- 
.
...
.SH DESCRIPTION
.sp
Deletes a Compute \fI\%Cloud@Customer\fP <\fBCloud@Customer\fP> infrastructure resource specified by the resource OCID.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci ccc infrastructure delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci ccc infrastructure delete \-\-infrastructure\-id $infrastructure_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.SS Description
.sp
Deletes a Compute \fI\%Cloud@Customer\fP <\fBCloud@Customer\fP> infrastructure resource specified by the resource OCID. You can only delete an infrastructure that is not connected to a Compute \fI\%Cloud@Customer\fP <\fBCloud@Customer\fP> infrastructure in your data center. An infrastructure that is not connected is in the REJECT state.
.SS Command
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
 oci ccc infrastructure delete \-\-infrastructure\-id <infrastructure_OCID>
.ft P
.fi
.UNINDENT
.UNINDENT
...
.SS Description
.sp
Deletes an infrastructure without prompting for confirmation.Only an infrastructure that is not connected to a Compute \fI\%Cloud@Customer\fP <\fBCloud@Customer\fP> infrastructure in your data center can be deleted.An infrastructure that is not connected is in the REJECT state.
.SS Command
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
 oci ccc infrastructure delete \-\-infrastructure\-id <infrastructure_OCID> \-\-force
.ft P
.fi
.UNINDENT
.UNINDENT
