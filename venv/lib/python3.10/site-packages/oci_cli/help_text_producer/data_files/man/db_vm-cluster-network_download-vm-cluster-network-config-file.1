...
.
.TH "DB_VM-CLUSTER-NETWORK_DOWNLOAD-VM-CLUSTER-NETWORK-CONFIG-FILE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_vm-cluster-network_download-vm-cluster-network-config-file \- 
.
...
.SH DESCRIPTION
.sp
Downloads the configuration file for the specified VM cluster network. Applies to Exadata \fI\%Cloud@Customer\fP <\fBCloud@Customer\fP> instances only.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci db vm\-cluster\-network download\-vm\-cluster\-network\-config\-file [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci db vm\-cluster\-network download\-vm\-cluster\-network\-config\-file \-\-exadata\-infrastructure\-id $exadata_infrastructure_id \-\-file $file \-\-vm\-cluster\-network\-id $vm_cluster_network_id
.ft P
.fi
.UNINDENT
.UNINDENT
