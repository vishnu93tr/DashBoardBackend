...
.
.TH "DATA-SAFE_TARGET-DATABASE_LIST-SCHEMAS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_target-database_list-schemas \- 
.
...
.nf
.ft C
oci data\-safe target\-database list\-schemas [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-is\-oracle\-maintained [boolean]
.UNINDENT
.sp
...
.ft C
    ...
    oci data\-safe target\-database list\-schemas \-\-target\-database\-id $target_database_id
.ft P
.fi
.UNINDENT
.UNINDENT
