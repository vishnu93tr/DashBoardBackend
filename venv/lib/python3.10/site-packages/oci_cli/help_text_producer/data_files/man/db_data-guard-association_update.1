...
.
.TH "DB_DATA-GUARD-ASSOCIATION_UPDATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_data-guard-association_update \- 
.
...
.SH DESCRIPTION
.sp
Updates the Data Guard association the specified database. This API can be used to change the \fIprotectionMode\fP and \fItransportType\fP of the Data Guard association.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
...
.UNINDENT
.sp
The protection mode for the Data Guard association’s primary and standby database. For more information, see \fI\%Oracle Data Guard Protection Modes\fP <\fBhttp://docs.oracle.com/database/122/SBYDB/oracle-data-guard-protection-modes.htm#SBYDB02000\fP> in the Oracle Data Guard documentation.
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
