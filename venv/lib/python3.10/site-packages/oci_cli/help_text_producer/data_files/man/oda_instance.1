...
.
.TH "ODA_INSTANCE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
oda_instance \- 
.
...
.SH DESCRIPTION
.sp
Description of \fIOdaServiceInstance\fP object.
...
.nf
.ft C
oci oda instance change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/oda/instance/change\-compartment.html#cmdoption\-compartment\-id
    export oda_instance_id=<substitute\-value\-of\-oda_instance_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/oda/instance/change\-compartment.html#cmdoption\-oda\-instance\-id

    oci oda instance change\-compartment \-\-compartment\-id $compartment_id \-\-oda\-instance\-id $oda_instance_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci oda instance create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.SS Description
.sp
Starts an asynchronous job to delete the specified Digital Assistant instance. To monitor the status of the job, take the \fIopc\-work\-request\-id\fP response header value and use it to call \fIGET /workRequests/{workRequestId}\fP\&.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci oda instance delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export oda_instance_id=<substitute\-value\-of\-oda_instance_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/oda/instance/delete.html#cmdoption\-oda\-instance\-id

    oci oda instance delete \-\-oda\-instance\-id $oda_instance_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export oda_instance_id=<substitute\-value\-of\-oda_instance_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/oda/instance/get.html#cmdoption\-oda\-instance\-id

    oci oda instance get \-\-oda\-instance\-id $oda_instance_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci oda instance start [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export oda_instance_id=<substitute\-value\-of\-oda_instance_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/oda/instance/start.html#cmdoption\-oda\-instance\-id

    oci oda instance start \-\-oda\-instance\-id $oda_instance_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export oda_instance_id=<substitute\-value\-of\-oda_instance_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/oda/instance/stop.html#cmdoption\-oda\-instance\-id

    oci oda instance stop \-\-oda\-instance\-id $oda_instance_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci oda instance update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export oda_instance_id=<substitute\-value\-of\-oda_instance_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/oda/instance/update.html#cmdoption\-oda\-instance\-id

    oci oda instance update \-\-oda\-instance\-id $oda_instance_id
.ft P
.fi
.UNINDENT
.UNINDENT
