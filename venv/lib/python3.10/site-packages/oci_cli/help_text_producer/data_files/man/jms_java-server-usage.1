...
.
.TH "JMS_JAVA-SERVER-USAGE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
jms_java-server-usage \- 
.
...
.nf
.ft C
oci jms java\-server\-usage scan [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-managed\-instance\-ids [complex type]
.UNINDENT
.sp
The list of \fI\%OCIDs\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of managed instances to scan.
...
.ft C
    ...
    oci jms java\-server\-usage scan \-\-fleet\-id $fleet_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci jms java\-server\-usage summarize [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The field to sort a Java Server. Only one sort order can be provided. If no value is specified _timeLastSeen_ is default.
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
...
.nf
.ft C
approximateDeployedApplicationCount, serverInstanceCount, serverName, serverVersion, timeFirstSeen, timeLastSeen
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci jms java\-server\-usage summarize \-\-fleet\-id $fleet_id
.ft P
.fi
.UNINDENT
.UNINDENT
