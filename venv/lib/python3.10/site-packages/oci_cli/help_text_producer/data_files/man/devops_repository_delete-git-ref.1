...
.
.TH "DEVOPS_REPOSITORY_DELETE-GIT-REF" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
devops_repository_delete-git-ref \- 
.
...
.nf
.ft C
oci devops repository delete\-git\-ref [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export ref_name=<substitute\-value\-of\-ref_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/devops/repository/delete\-git\-ref.html#cmdoption\-ref\-name
    ...
    oci devops repository delete\-git\-ref \-\-ref\-name $ref_name \-\-repository\-id $repository_id
.ft P
.fi
.UNINDENT
.UNINDENT
