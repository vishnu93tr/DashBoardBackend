...
.
.TH "DEVOPS_CONNECTION_UPDATE-VBS-CONNECTION" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
devops_connection_update-vbs-connection \- 
.
...
.nf
.ft C
oci devops connection update\-vbs\-connection [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export connection_id=<substitute\-value\-of\-connection_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/devops/connection/update\-vbs\-connection.html#cmdoption\-connection\-id

    oci devops connection update\-vbs\-connection \-\-connection\-id $connection_id
.ft P
.fi
.UNINDENT
.UNINDENT
