...
.
.TH "NETWORK-FIREWALL_NETWORK-FIREWALL_CREATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network-firewall_network-firewall_create \- 
.
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the compartment containing the Network Firewall.
.INDENT 0.0
.TP
.B \-\-network\-firewall\-policy\-id [text]
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the Network Firewall Policy.
.INDENT 0.0
.TP
.B \-\-subnet\-id [text]
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the subnet associated with the Network Firewall.
...
.UNINDENT
.sp
Availability Domain where Network Firewall instance is created. To get a list of availability domains for a tenancy, use \fI\%ListAvailabilityDomains\fP <\fBhttps://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/iam/availability-domain/list.html\fP> operation. Example: \fIkIdk:PHX\-AD\-1\fP
.INDENT 0.0
.TP
...
.UNINDENT
.sp
An array of network security groups \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> associated with the Network Firewall.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
