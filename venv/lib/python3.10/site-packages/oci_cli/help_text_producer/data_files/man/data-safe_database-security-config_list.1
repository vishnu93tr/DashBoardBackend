...
.
.TH "DATA-SAFE_DATABASE-SECURITY-CONFIG_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_database-security-config_list \- 
.
...
.sp
The ListDatabaseSecurityConfigs operation returns only the database security configurations in the specified \fIcompartmentId\fP\&.
.sp
...
.nf
.ft C
oci data\-safe database\-security\-config list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-database\-security\-config\-id [text]
.UNINDENT
.sp
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-safe/database\-security\-config/list.html#cmdoption\-compartment\-id

    oci data\-safe database\-security\-config list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
