...
.
.TH "NETWORK_CROSS-CONNECT-MAPPING-DETAILS-COLLECTION_LIST-CROSS-CONNECT-MAPPINGS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network_cross-connect-mapping-details-collection_list-cross-connect-mappings \- 
.
...
.nf
.ft C
oci network cross\-connect\-mapping\-details\-collection list\-cross\-connect\-mappings [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci network cross\-connect\-mapping\-details\-collection list\-cross\-connect\-mappings \-\-virtual\-circuit\-id $virtual_circuit_id
.ft P
.fi
.UNINDENT
.UNINDENT
