...
.
.TH "DB_VM-CLUSTER-NETWORK_CREATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_vm-cluster-network_create \- 
.
...
.SH DESCRIPTION
.sp
Creates the VM cluster network. Applies to Exadata \fI\%Cloud@Customer\fP <\fBCloud@Customer\fP> instances only. To create a cloud VM cluster in an Exadata Cloud Service instance, use the \fI\%CreateCloudVmCluster\fP <\fBhttps://docs.cloud.oracle.com/api/#/en/database/latest/CloudVmCluster/CreateCloudVmCluster\fP> operation.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci db vm\-cluster\-network create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The user\-friendly name for the Exadata \fI\%Cloud@Customer\fP <\fBCloud@Customer\fP> VM cluster network. The name does not need to be unique.
.INDENT 0.0
.TP
...
.INDENT 0.0
.TP
.B \-\-dr\-scans [complex type]
.UNINDENT
.sp
The SCAN details for DR network
.sp
This option is a JSON list with items of type DrScanDetails.  For documentation on DrScanDetails please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/database/20160918/datatypes/DrScanDetails\fP\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
.ft C
    ...
    oci db vm\-cluster\-network create \-\-compartment\-id $compartment_id \-\-display\-name $display_name \-\-exadata\-infrastructure\-id $exadata_infrastructure_id \-\-scans file://scans.json \-\-vm\-networks file://vm\-networks.json
.ft P
.fi
.UNINDENT
.UNINDENT
