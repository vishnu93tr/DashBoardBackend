...
.
.TH "JMS_FLEET-AGENT-CONFIGURATION" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
jms_fleet-agent-configuration \- 
.
...
.nf
.ft C
oci jms fleet\-agent\-configuration get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci jms fleet\-agent\-configuration get \-\-fleet\-id $fleet_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci jms fleet\-agent\-configuration update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-agent\-polling\-interval\-in\-minutes [integer]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-linux\-configuration [complex type]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-mac\-os\-configuration [complex type]
.UNINDENT
.sp
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
...
.INDENT 0.0
.TP
.B \-\-windows\-configuration [complex type]
.UNINDENT
.sp
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
...
.INDENT 0.0
.TP
.B \-\-work\-request\-validity\-period\-in\-days [integer]
.UNINDENT
.sp
...
.ft C
    ...
    oci jms fleet\-agent\-configuration update \-\-fleet\-id $fleet_id
.ft P
.fi
.UNINDENT
.UNINDENT
