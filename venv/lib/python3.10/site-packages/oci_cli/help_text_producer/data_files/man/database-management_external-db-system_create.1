...
.
.TH "DATABASE-MANAGEMENT_EXTERNAL-DB-SYSTEM_CREATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
database-management_external-db-system_create \- 
.
...
.nf
.ft C
oci database\-management external\-db\-system create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-db\-system\-discovery\-id [text]
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the DB system discovery.
.SH OPTIONAL PARAMETERS
.INDENT 0.0
.TP
.B \-\-database\-management\-config [complex type]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-stack\-monitoring\-config [complex type]
.UNINDENT
.sp
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
...
.ft C
    ...
    oci database\-management external\-db\-system create \-\-compartment\-id $compartment_id \-\-db\-system\-discovery\-id $db_system_discovery_id
.ft P
.fi
.UNINDENT
.UNINDENT
