...
.
.TH "COMPUTE_CAPACITY-TOPOLOGY_NETWORK-BLOCK_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
compute_capacity-topology_network-block_list \- 
.
...
.nf
.ft C
oci compute capacity\-topology network\-block list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci compute capacity\-topology network\-block list \-\-capacity\-topology\-id $capacity_topology_id
.ft P
.fi
.UNINDENT
.UNINDENT
