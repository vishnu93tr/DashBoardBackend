...
.
.TH "IDENTITY-DOMAINS_MY-AUTHENTICATION-FACTORS-REMOVER_CREATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_my-authentication-factors-remover_create \- 
.
...
.nf
.ft C
oci identity\-domains my\-authentication\-factors\-remover create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.sp
\fBSCIM++ Properties:\fP  \- type: string  \- multiValued: false  \- required: false  \- mutability: readWrite  \- returned: request  \- uniqueness: none  \- idcsSearchable: false
.INDENT 0.0
.TP
.B \-\-type [text]
.UNINDENT
...
.ft C
    ...
    oci identity\-domains my\-authentication\-factors\-remover create \-\-generate\-param\-json\-input schemas > schemas.json
    oci identity\-domains my\-authentication\-factors\-remover create \-\-generate\-param\-json\-input user > user.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains my\-authentication\-factors\-remover create \-\-schemas file://schemas.json \-\-user file://user.json
.ft P
.fi
.UNINDENT
.UNINDENT
