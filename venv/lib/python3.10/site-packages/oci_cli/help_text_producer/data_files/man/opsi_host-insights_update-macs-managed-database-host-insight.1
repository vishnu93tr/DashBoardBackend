...
.
.TH "OPSI_HOST-INSIGHTS_UPDATE-MACS-MANAGED-DATABASE-HOST-INSIGHT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
opsi_host-insights_update-macs-managed-database-host-insight \- 
.
...
.nf
.ft C
oci opsi host\-insights update\-macs\-managed\-database\-host\-insight [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export host_insight_id=<substitute\-value\-of\-host_insight_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/opsi/host\-insights/update\-macs\-managed\-database\-host\-insight.html#cmdoption\-host\-insight\-id

    oci opsi host\-insights update\-macs\-managed\-database\-host\-insight \-\-host\-insight\-id $host_insight_id
.ft P
.fi
.UNINDENT
.UNINDENT
