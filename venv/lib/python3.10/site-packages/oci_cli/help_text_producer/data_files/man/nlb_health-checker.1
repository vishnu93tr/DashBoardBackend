...
.
.TH "NLB_HEALTH-CHECKER" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
nlb_health-checker \- 
.
...
.SH DESCRIPTION
.sp
The health check policy configuration. For more information, see \fI\%Editing Network Load Balancer Health Check Policies\fP <\fBhttps://docs.cloud.oracle.com/Content/NetworkLoadBalancer/HealthCheckPolicies/update-health-check-management.htm\fP>\&.
...
.nf
.ft C
oci nlb health\-checker get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export backend_set_name=<substitute\-value\-of\-backend_set_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/nlb/health\-checker/get.html#cmdoption\-backend\-set\-name
    ...
    oci nlb health\-checker get \-\-backend\-set\-name $backend_set_name \-\-network\-load\-balancer\-id $network_load_balancer_id
.ft P
.fi
.UNINDENT
.UNINDENT
