...
.
.TH "STACK-MONITORING_CONFIG_UPDATE-ONBOARD-CONFIG" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
stack-monitoring_config_update-onboard-config \- 
.
...
.nf
.ft C
oci stack\-monitoring config update\-onboard\-config [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci stack\-monitoring config update\-onboard\-config \-\-config\-id $config_id
.ft P
.fi
.UNINDENT
.UNINDENT
