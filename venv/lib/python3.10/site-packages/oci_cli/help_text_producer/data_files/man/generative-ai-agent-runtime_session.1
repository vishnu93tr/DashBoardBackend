...
.
.TH "GENERATIVE-AI-AGENT-RUNTIME_SESSION" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
generative-ai-agent-runtime_session \- 
.
...
.nf
.ft C
oci generative\-ai\-agent\-runtime session delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    session_id=$(oci generative\-ai\-agent\-runtime session create \-\-agent\-endpoint\-id $agent_endpoint_id \-\-query data.id \-\-raw\-output)

    oci generative\-ai\-agent\-runtime session delete \-\-agent\-endpoint\-id $agent_endpoint_id \-\-session\-id $session_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci generative\-ai\-agent\-runtime session get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci generative\-ai\-agent\-runtime session get \-\-agent\-endpoint\-id $agent_endpoint_id \-\-session\-id $session_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci generative\-ai\-agent\-runtime session update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci generative\-ai\-agent\-runtime session update \-\-agent\-endpoint\-id $agent_endpoint_id \-\-session\-id $session_id
.ft P
.fi
.UNINDENT
.UNINDENT
