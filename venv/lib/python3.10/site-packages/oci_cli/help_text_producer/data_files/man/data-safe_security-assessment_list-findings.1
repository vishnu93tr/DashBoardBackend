...
.
.TH "DATA-SAFE_SECURITY-ASSESSMENT_LIST-FINDINGS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_security-assessment_list-findings \- 
.
...
.sp
\fBExample:\fP | scimQuery=(severity eq ‘high’) and (targetId eq ‘target_1’) scimQuery=(category eq “Users”) and (targetId eq “target_1”) scimQuery=(reference eq ‘CIS’) and (targetId eq ‘target_1’)
.sp
