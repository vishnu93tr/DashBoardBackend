...
.
.TH "DB_PDB-CONVERSION-HISTORY_GET" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_pdb-conversion-history_get \- 
.
...
.nf
.ft C
oci db pdb\-conversion\-history get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The database conversion history \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP>\&.
...
.ft C
    ...
    export history_id=<substitute\-value\-of\-history_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/db/pdb\-conversion\-history/get.html#cmdoption\-history\-id
    ...
    oci db pdb\-conversion\-history get \-\-database\-id $database_id \-\-history\-id $history_id
.ft P
.fi
.UNINDENT
.UNINDENT
