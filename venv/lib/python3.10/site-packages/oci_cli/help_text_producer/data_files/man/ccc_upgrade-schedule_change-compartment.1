...
.
.TH "CCC_UPGRADE-SCHEDULE_CHANGE-COMPARTMENT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
ccc_upgrade-schedule_change-compartment \- 
.
...
.SH DESCRIPTION
.sp
Moves a Compute \fI\%Cloud@Customer\fP <\fBCloud@Customer\fP> upgrade schedule from one compartment to another using the specified OCID.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci ccc upgrade\-schedule change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci ccc upgrade\-schedule change\-compartment \-\-compartment\-id $compartment_id \-\-upgrade\-schedule\-id $upgrade_schedule_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
 oci ccc upgrade\-schedule change\-compartment \-\-upgrade\-schedule\-id <upgrade_schedule_OCID> \-c <compartment_OCID>
.ft P
.fi
.UNINDENT
.UNINDENT
