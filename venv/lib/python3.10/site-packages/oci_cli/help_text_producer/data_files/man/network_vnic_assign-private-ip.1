...
.
.TH "NETWORK_VNIC_ASSIGN-PRIVATE-IP" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
...
.sp
For more information about secondary private IPs, see \fI\%IP Addresses\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Network/Tasks/managingIPaddresses.htm\fP>
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the subnet from which the private IP is to be drawn. The IP address, \fIif supplied\fP, must be valid for the given subnet.
.INDENT 0.0
.TP
.B \-\-unassign\-if\-already\-assigned
.UNINDENT
.sp
...
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the VLAN from which the private IP is to be drawn. The IP address, \fIif supplied\fP, must be valid for the given VLAN. See \fI\%Vlan\fP <\fBhttps://docs.cloud.oracle.com/api/#/en/iaas/latest/Vlan\fP>\&.
.INDENT 0.0
.TP
.B \-\-vnic\-id [text]
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the VNIC to assign the private IP to. The VNIC and private IP must be in the same subnet.
