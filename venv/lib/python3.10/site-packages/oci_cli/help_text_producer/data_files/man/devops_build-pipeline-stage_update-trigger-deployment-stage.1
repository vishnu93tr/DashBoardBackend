...
.
.TH "DEVOPS_BUILD-PIPELINE-STAGE_UPDATE-TRIGGER-DEPLOYMENT-STAGE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
devops_build-pipeline-stage_update-trigger-deployment-stage \- 
.
...
.nf
.ft C
oci devops build\-pipeline\-stage update\-trigger\-deployment\-stage [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export stage_id=<substitute\-value\-of\-stage_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/devops/build\-pipeline\-stage/update\-trigger\-deployment\-stage.html#cmdoption\-stage\-id

    oci devops build\-pipeline\-stage update\-trigger\-deployment\-stage \-\-stage\-id $stage_id
.ft P
.fi
.UNINDENT
.UNINDENT
