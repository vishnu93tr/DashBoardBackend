...
.
.TH "DEVOPS_REPOSITORY_CREATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
...
.nf
.ft C
oci devops repository create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
Type of repository. Allowed values: \fIMIRRORED\fP \fIHOSTED\fP \fIFORKED\fP
.SH OPTIONAL PARAMETERS
.INDENT 0.0
.TP
.B \-\-default\-branch [text]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-mirror\-repository\-config [complex type]
.UNINDENT
.sp
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
...
.ft C
    ...
    oci devops repository create \-\-name $name \-\-project\-id $project_id \-\-repository\-type $repository_type
.ft P
.fi
.UNINDENT
.UNINDENT
