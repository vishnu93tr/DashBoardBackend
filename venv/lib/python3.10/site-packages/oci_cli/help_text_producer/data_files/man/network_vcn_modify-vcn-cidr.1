...
.
.TH "NETWORK_VCN_MODIFY-VCN-CIDR" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network_vcn_modify-vcn-cidr \- 
.
...
.UNINDENT
.sp
\fBNote:\fP Modifying a CIDR block places your VCN in an updating state until the changes are complete. You cannot create or update the VCN’s subnets, VLANs, LPGs, or route tables during this operation. The time to completion can vary depending on the size of your network. Updating a small network could take about a minute, and updating a large network could take up to an hour. You can use the \fIGetWorkRequest\fP operation to check the status of the update.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
...
.INDENT 0.0
.TP
.B \-\-new\-cidr\-block [text]
.UNINDENT
.sp
The new CIDR IP address.
.INDENT 0.0
.TP
.B \-\-original\-cidr\-block [text]
.UNINDENT
.sp
...
.UNINDENT
.sp
Specify the \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the VCN.
...
.ft C
    ...
    export new_cidr_block=<substitute\-value\-of\-new_cidr_block> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/network/vcn/modify\-vcn\-cidr.html#cmdoption\-new\-cidr\-block
    export original_cidr_block=<substitute\-value\-of\-original_cidr_block> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/network/vcn/modify\-vcn\-cidr.html#cmdoption\-original\-cidr\-block

    vcn_id=$(oci network vcn create \-\-cidr\-block $cidr_block \-\-compartment\-id $compartment_id \-\-query data.id \-\-raw\-output)

    oci network vcn modify\-vcn\-cidr \-\-new\-cidr\-block $new_cidr_block \-\-original\-cidr\-block $original_cidr_block \-\-vcn\-id $vcn_id
.ft P
.fi
.UNINDENT
.UNINDENT
