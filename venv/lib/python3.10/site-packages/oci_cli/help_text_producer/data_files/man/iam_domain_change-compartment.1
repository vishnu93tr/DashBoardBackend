...
.
.TH "IAM_DOMAIN_CHANGE-COMPARTMENT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
iam_domain_change-compartment \- 
.
...
.nf
.ft C
oci iam domain change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the destination compartment into which to move the identity domain.
.INDENT 0.0
.TP
.B \-\-domain\-id [text]
.UNINDENT
...
.ft C
    ...
    oci iam domain change\-compartment \-\-compartment\-id $compartment_id \-\-domain\-id $domain_id
.ft P
.fi
.UNINDENT
.UNINDENT
