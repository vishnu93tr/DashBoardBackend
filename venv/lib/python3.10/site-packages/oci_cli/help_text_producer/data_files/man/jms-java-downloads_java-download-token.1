...
.
.TH "JMS-JAVA-DOWNLOADS_JAVA-DOWNLOAD-TOKEN" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
jms-java-downloads_java-download-token \- 
.
...
.SS Description
.sp
Creates a new JavaDownloadToken in the tenancy with specified attributes. Ensure that you review the license terms before token generation. Visit the <a href=”\fI\%https://www.oracle.com/java/technologies/downloads\fP”/>Oracle Java Downloads</a> page to understand the license terms of the Java version for which you are generating a token. By generating a token, you agree to the associated license terms. See <a href=”\fI\%https://www.oracle.com/cis/java/technologies/javase/jdk\-faqs.html\fP”>Oracle JDK Licensing \- FAQs</a> for detailed information.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci jms\-java\-downloads java\-download\-token create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the tenancy scoped to the JavaDownloadToken.
.INDENT 0.0
.TP
.B \-\-description [text]
.UNINDENT
...
.ft C
    ...
    oci jms\-java\-downloads java\-download\-token create \-\-compartment\-id $compartment_id \-\-description $description \-\-display\-name $display_name \-\-java\-version $java_version \-\-license\-type file://license\-type.json \-\-time\-expires $time_expires
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci jms\-java\-downloads java\-download\-token delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci jms\-java\-downloads java\-download\-token delete \-\-java\-download\-token\-id $java_download_token_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci jms\-java\-downloads java\-download\-token get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci jms\-java\-downloads java\-download\-token get \-\-java\-download\-token\-id $java_download_token_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-search\-by\-user [text]
.UNINDENT
.sp
A filter to return only resources that match the user principal detail. The search string can be any of the property values from the \fI\%Principal\fP <\fBhttps://docs.cloud.oracle.com/api/#/en/jms/latest/datatypes/Principal\fP> object. This object is used as a response datatype for the \fIcreatedBy\fP and \fIlastUpdatedBy\fP fields in applicable resource.
.INDENT 0.0
.TP
.B \-\-sort\-by [text]
.UNINDENT
...
The license type(s) associated with the JavaDownloadToken.
.sp
This option is a JSON list with items of type LicenseType.  For documentation on LicenseType please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/javadownload/20230601/datatypes/LicenseType\fP\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
