...
.
.TH "DATA-FLOW_PRIVATE-ENDPOINT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-flow_private-endpoint \- 
.
...
.nf
.ft C
oci data\-flow private\-endpoint change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci data\-flow private\-endpoint change\-compartment \-\-compartment\-id $compartment_id \-\-private\-endpoint\-id $private_endpoint_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
An array of DNS zone names. Example: \fI[ “app.examplecorp.com”, “app.examplecorp2.com” ]\fP
...
.sp
This option is a JSON list with items of type Scan.  For documentation on Scan please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/dataflow/20200129/datatypes/Scan\fP\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
.SS Description
.sp
Deletes a private endpoint using a \fIprivateEndpointId\fP\&.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
...
.ft C
    ...
    oci data\-flow private\-endpoint delete \-\-private\-endpoint\-id $private_endpoint_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci data\-flow private\-endpoint get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci data\-flow private\-endpoint get \-\-private\-endpoint\-id $private_endpoint_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-flow/private\-endpoint/list.html#cmdoption\-compartment\-id

    oci data\-flow private\-endpoint list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.SS Description
.sp
Updates a private endpoint using a \fIprivateEndpointId\fP\&.  If changes to a private endpoint match a previously defined private endpoint, then a 409 status code will be returned.  This indicates that a conflict has been detected.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
