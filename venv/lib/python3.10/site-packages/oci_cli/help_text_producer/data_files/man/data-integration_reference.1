...
.
.TH "DATA-INTEGRATION_REFERENCE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-integration_reference \- 
.
...
.nf
.ft C
oci data\-integration reference get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export application_key=<substitute\-value\-of\-application_key> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/reference/get.html#cmdoption\-application\-key
    export reference_key=<substitute\-value\-of\-reference_key> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/reference/get.html#cmdoption\-reference\-key
    ...
    oci data\-integration reference get \-\-application\-key $application_key \-\-reference\-key $reference_key \-\-workspace\-id $workspace_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export display_name=<substitute\-value\-of\-display_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/workspace/create.html#cmdoption\-display\-name
    export is_private_network=<substitute\-value\-of\-is_private_network> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/workspace/create.html#cmdoption\-is\-private\-network
    export application_key=<substitute\-value\-of\-application_key> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/reference/list.html#cmdoption\-application\-key

    workspace_id=$(oci data\-integration workspace create \-\-compartment\-id $compartment_id \-\-display\-name $display_name \-\-is\-private\-network $is_private_network \-\-query data.id \-\-raw\-output)

    oci data\-integration reference list \-\-application\-key $application_key \-\-workspace\-id $workspace_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-child\-references [complex type]
.UNINDENT
.sp
The list of child references that also need to be updated.
.sp
This option is a JSON list with items of type ChildReferenceDetail.  For documentation on ChildReferenceDetail please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/dataintegration/20200430/datatypes/ChildReferenceDetail\fP\&.
...
.INDENT 0.0
.TP
.B \-\-options [complex type]
.UNINDENT
.sp
A list of options such as \fIignoreObjectOnError\fP\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
.INDENT 0.0
.TP
.B \-\-target\-object [complex type]
.UNINDENT
.sp
The new target object to reference. This can be of type \fIDataAsset\fP, \fISchema\fP or \fITask\fP\&. In case of \fIDataAsset\fP, the child references can be of type \fIConnection\fP\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
.ft C
    ...
    export display_name=<substitute\-value\-of\-display_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/workspace/create.html#cmdoption\-display\-name
    export is_private_network=<substitute\-value\-of\-is_private_network> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/workspace/create.html#cmdoption\-is\-private\-network
    export application_key=<substitute\-value\-of\-application_key> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/reference/update.html#cmdoption\-application\-key
    export reference_key=<substitute\-value\-of\-reference_key> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/reference/update.html#cmdoption\-reference\-key

    workspace_id=$(oci data\-integration workspace create \-\-compartment\-id $compartment_id \-\-display\-name $display_name \-\-is\-private\-network $is_private_network \-\-query data.id \-\-raw\-output)

    oci data\-integration reference update \-\-application\-key $application_key \-\-reference\-key $reference_key \-\-workspace\-id $workspace_id
.ft P
.fi
.UNINDENT
.UNINDENT
