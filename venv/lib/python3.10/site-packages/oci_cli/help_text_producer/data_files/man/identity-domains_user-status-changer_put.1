...
.
.TH "IDENTITY-DOMAINS_USER-STATUS-CHANGER_PUT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_user-status-changer_put \- 
.
...
.nf
.ft C
oci identity\-domains user\-status\-changer put [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains user\-status\-changer put \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export user_status_changer_id=<substitute\-value\-of\-user_status_changer_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/identity\-domains/user\-status\-changer/put.html#cmdoption\-user\-status\-changer\-id

    oci identity\-domains user\-status\-changer put \-\-schemas file://schemas.json \-\-user\-status\-changer\-id $user_status_changer_id
.ft P
.fi
.UNINDENT
.UNINDENT
