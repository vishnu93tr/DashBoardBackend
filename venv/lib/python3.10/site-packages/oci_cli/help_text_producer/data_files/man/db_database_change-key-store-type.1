...
.
.TH "DB_DATABASE_CHANGE-KEY-STORE-TYPE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_database_change-key-store-type \- 
.
...
.nf
.ft C
oci db database change\-key\-store\-type [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export key_store_id=<substitute\-value\-of\-key_store_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/db/database/change\-key\-store\-type.html#cmdoption\-key\-store\-id
    ...
    oci db database change\-key\-store\-type \-\-database\-id $database_id \-\-key\-store\-id $key_store_id
.ft P
.fi
.UNINDENT
.UNINDENT
