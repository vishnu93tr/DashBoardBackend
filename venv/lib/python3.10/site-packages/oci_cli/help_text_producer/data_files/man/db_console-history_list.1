...
.
.TH "DB_CONSOLE-HISTORY_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_console-history_list \- 
.
...
.nf
.ft C
oci db console\-history list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export db_node_id=<substitute\-value\-of\-db_node_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/db/console\-history/list.html#cmdoption\-db\-node\-id

    oci db console\-history list \-\-db\-node\-id $db_node_id
.ft P
.fi
.UNINDENT
.UNINDENT
