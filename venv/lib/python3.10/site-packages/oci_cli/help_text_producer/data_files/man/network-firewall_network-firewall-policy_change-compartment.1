...
.
.TH "NETWORK-FIREWALL_NETWORK-FIREWALL-POLICY_CHANGE-COMPARTMENT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network-firewall_network-firewall-policy_change-compartment \- 
.
...
.nf
.ft C
oci network\-firewall network\-firewall\-policy change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci network\-firewall network\-firewall\-policy change\-compartment \-\-compartment\-id $compartment_id \-\-network\-firewall\-policy\-id $network_firewall_policy_id
.ft P
.fi
.UNINDENT
.UNINDENT
