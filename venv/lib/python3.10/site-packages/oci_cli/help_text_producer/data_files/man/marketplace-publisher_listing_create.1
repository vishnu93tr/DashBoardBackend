...
.
.TH "MARKETPLACE-PUBLISHER_LISTING_CREATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
marketplace-publisher_listing_create \- 
.
...
.sp
You must also specify a \fIname\fP for the listing and cannot be updated later.
.sp
You must also specify a \fIpackageType\fP for the listing. Allowed values are CONTAINER_IMAGE and HELM_CHART
.sp
After you send your request, the new object’s \fIlifecycleState\fP will be CREATING. Before using the object, first make sure its \fIlifecycleState\fP has changed to ACTIVE.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci marketplace\-publisher listing create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci marketplace\-publisher listing create \-\-compartment\-id $compartment_id \-\-listing\-type $listing_type \-\-name $name \-\-package\-type $package_type
.ft P
.fi
.UNINDENT
.UNINDENT
