...
.
.TH "DEVOPS_TRIGGER_UPDATE-BITBUCKET-SERVER-TRIGGER" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
devops_trigger_update-bitbucket-server-trigger \- 
.
...
.nf
.ft C
oci devops trigger update\-bitbucket\-server\-trigger [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export trigger_id=<substitute\-value\-of\-trigger_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/devops/trigger/update\-bitbucket\-server\-trigger.html#cmdoption\-trigger\-id

    oci devops trigger update\-bitbucket\-server\-trigger \-\-trigger\-id $trigger_id
.ft P
.fi
.UNINDENT
.UNINDENT
