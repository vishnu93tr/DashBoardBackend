...
.
.TH "PSQL_DB-SYSTEM_CREATE-DB-SYSTEM-OCI-OPTIMIZED-STORAGE-DETAILS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
psql_db-system_create-db-system-oci-optimized-storage-details \- 
.
...
.nf
.ft C
oci psql db\-system create\-db\-system\-oci\-optimized\-storage\-details [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-storage\-details\-is\-regionally\-durable [boolean]
.UNINDENT
.sp
Specifies if the block volume used for the database system is regional or AD\-local. If not specified, it will be set to false. If \fIisRegionallyDurable\fP is set to true, \fIavailabilityDomain\fP should not be specified. If \fIisRegionallyDurable\fP is set to false, \fIavailabilityDomain\fP must be specified.
...
.INDENT 0.0
.TP
.B \-\-storage\-details\-availability\-domain [text]
.UNINDENT
.sp
Specifies the availability domain of AD\-local storage. If \fIisRegionallyDurable\fP is set to true, \fIavailabilityDomain\fP should not be specified. If \fIisRegionallyDurable\fP is set to false, \fIavailabilityDomain\fP must be specified.
.INDENT 0.0
.TP
.B \-\-storage\-details\-iops [integer]
.UNINDENT
.sp
