...
.
.TH "CERTS-MGMT_CERTIFICATE_CREATE-CERTIFICATE-ISSUED-BY-INTERNAL-CA" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
certs-mgmt_certificate_create-certificate-issued-by-internal-ca \- 
.
...
.INDENT 0.0
.TP
.B \-\-certificate\-profile\-type [text]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-subject\-alternative\-names [complex type]
.UNINDENT
.sp
A list of subject alternative names.
.sp
This option is a JSON list with items of type CertificateSubjectAlternativeName.  For documentation on CertificateSubjectAlternativeName please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/certificatesmanagement/20210224/datatypes/CertificateSubjectAlternativeName\fP\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
