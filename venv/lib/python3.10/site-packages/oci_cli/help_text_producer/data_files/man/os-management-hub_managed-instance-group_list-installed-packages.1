...
.
.TH "OS-MANAGEMENT-HUB_MANAGED-INSTANCE-GROUP_LIST-INSTALLED-PACKAGES" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
os-management-hub_managed-instance-group_list-installed-packages \- 
.
...
.nf
.ft C
oci os\-management\-hub managed\-instance\-group list\-installed\-packages [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export group_id=<substitute\-value\-of\-group_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/os\-management\-hub/managed\-instance\-group/list\-installed\-packages.html#cmdoption\-group\-id

    oci os\-management\-hub managed\-instance\-group list\-installed\-packages \-\-group\-id $group_id
.ft P
.fi
.UNINDENT
.UNINDENT
