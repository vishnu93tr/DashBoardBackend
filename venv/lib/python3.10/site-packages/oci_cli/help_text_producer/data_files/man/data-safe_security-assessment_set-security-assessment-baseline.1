...
.
.TH "DATA-SAFE_SECURITY-ASSESSMENT_SET-SECURITY-ASSESSMENT-BASELINE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_security-assessment_set-security-assessment-baseline \- 
.
...
.nf
.ft C
oci data\-safe security\-assessment set\-security\-assessment\-baseline [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci data\-safe security\-assessment set\-security\-assessment\-baseline \-\-security\-assessment\-id $security_assessment_id
.ft P
.fi
.UNINDENT
.UNINDENT
