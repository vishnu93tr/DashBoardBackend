...
.
.TH "STACK-MONITORING_CONFIG_CREATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
stack-monitoring_config_create \- 
.
...
.nf
.ft C
oci stack\-monitoring config create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci stack\-monitoring config create \-\-compartment\-id $compartment_id \-\-config\-type $config_type
.ft P
.fi
.UNINDENT
.UNINDENT
