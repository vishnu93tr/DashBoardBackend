...
.
.TH "IDENTITY-DOMAINS_SMTP-CREDENTIALS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_smtp-credentials \- 
.
...
.nf
.ft C
oci identity\-domains smtp\-credentials list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains smtp\-credentials list
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains smtp\-credentials search [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains smtp\-credentials search \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains smtp\-credentials search \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
