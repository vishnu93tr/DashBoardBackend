...
.
.TH "DATA-SAFE_SENSITIVE-DATA-MODEL-SENSITIVE-TYPE-COLLECTION" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_sensitive-data-model-sensitive-type-collection \- 
.
...
.INDENT 0.0
.IP \(bu 2
list\-sensitive\-data\-model\-sensitive\-types
.UNINDENT
.SS \fBlist\-sensitive\-data\-model\-sensitive\-types\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.nf
.ft C
oci data\-safe sensitive\-data\-model\-sensitive\-type\-collection list\-sensitive\-data\-model\-sensitive\-types [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.IP \(bu 2
The field to sort by. You can specify only one sorting parameter (sortorder). The default order is descending.
.UNINDENT
.sp
Accepted values are:
.INDENT 0.0
...
.ft C
    ...
    oci data\-safe sensitive\-data\-model\-sensitive\-type\-collection list\-sensitive\-data\-model\-sensitive\-types \-\-sensitive\-data\-model\-id $sensitive_data_model_id
.ft P
.fi
.UNINDENT
.UNINDENT
