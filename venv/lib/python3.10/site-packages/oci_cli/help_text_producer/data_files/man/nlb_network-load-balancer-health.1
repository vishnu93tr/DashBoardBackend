...
.
.TH "NLB_NETWORK-LOAD-BALANCER-HEALTH" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
nlb_network-load-balancer-health \- 
.
...
.sp
This object does not explicitly enumerate backend sets with a status of \fIOK\fP\&. However, the backend sets are included in the \fItotalBackendSetCount\fP sum.
...
.ft C
    ...
    oci nlb network\-load\-balancer\-health get \-\-network\-load\-balancer\-id $network_load_balancer_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/nlb/network\-load\-balancer\-health/list.html#cmdoption\-compartment\-id

    oci nlb network\-load\-balancer\-health list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
