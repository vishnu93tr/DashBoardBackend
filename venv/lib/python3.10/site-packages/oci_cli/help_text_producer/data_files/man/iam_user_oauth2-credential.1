...
.
.TH "IAM_USER_OAUTH2-CREDENTIAL" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
iam_user_oauth2-credential \- 
.
...
.SH DESCRIPTION
.sp
The \fIOAuth 2.0 Client Credentials\fP grant type is used by clients to obtain an access token outside of the context of a user.
.sp
For more information about OAuth 2.0 client credentials, see \fI\%User Credentials\fP <\fBhttps://docs.cloud.oracle.com/Content/Identity/usercred/usercredentials.htm\fP>\&.
...
.nf
.ft C
oci iam user oauth2\-credential create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci iam user oauth2\-credential create \-\-generate\-param\-json\-input scopes > scopes.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci iam user oauth2\-credential create \-\-description $description \-\-name $name \-\-scopes file://scopes.json \-\-user\-id $user_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci iam user oauth2\-credential delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-oauth2\-client\-credential\-id [text]
.UNINDENT
.sp
...
.ft C
    export description=<substitute\-value\-of\-description> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/iam/user/create.html#cmdoption\-description
    export name=<substitute\-value\-of\-name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/iam/user/create.html#cmdoption\-name
    export oauth2_client_credential_id=<substitute\-value\-of\-oauth2_client_credential_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/iam/user/oauth2\-credential/delete.html#cmdoption\-oauth2\-client\-credential\-id

    user_id=$(oci iam user create \-\-description $description \-\-name $name \-\-query data.id \-\-raw\-output)

    oci iam user oauth2\-credential delete \-\-oauth2\-client\-credential\-id $oauth2_client_credential_id \-\-user\-id $user_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci iam user oauth2\-credential list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci iam user oauth2\-credential list \-\-user\-id $user_id
.ft P
.fi
.UNINDENT
.UNINDENT
