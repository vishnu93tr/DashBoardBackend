...
.
.TH "DISASTER-RECOVERY_DR-PROTECTION-GROUP_CHANGE-COMPARTMENT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
disaster-recovery_dr-protection-group_change-compartment \- 
.
...
.SH DESCRIPTION
.sp
Move the DR protection group identified by \fIdrProtectionGroupId\fP to a different compartment.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci disaster\-recovery dr\-protection\-group change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci disaster\-recovery dr\-protection\-group change\-compartment \-\-compartment\-id $compartment_id \-\-dr\-protection\-group\-id $dr_protection_group_id
.ft P
.fi
.UNINDENT
.UNINDENT
