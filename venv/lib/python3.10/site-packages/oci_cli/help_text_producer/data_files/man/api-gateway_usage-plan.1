...
.
.TH "API-GATEWAY_USAGE-PLAN" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
api-gateway_usage-plan \- 
.
...
.nf
.ft C
oci api\-gateway usage\-plan change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci api\-gateway usage\-plan change\-compartment \-\-compartment\-id $compartment_id \-\-usage\-plan\-id $usage_plan_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci api\-gateway usage\-plan create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci api\-gateway usage\-plan create \-\-compartment\-id $compartment_id \-\-entitlements file://entitlements.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci api\-gateway usage\-plan delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci api\-gateway usage\-plan delete \-\-usage\-plan\-id $usage_plan_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci api\-gateway usage\-plan get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci api\-gateway usage\-plan get \-\-usage\-plan\-id $usage_plan_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci api\-gateway usage\-plan list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/api\-gateway/usage\-plan/list.html#cmdoption\-compartment\-id

    oci api\-gateway usage\-plan list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci api\-gateway usage\-plan update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.sp
This option is a JSON list with items of type Entitlement.  For documentation on Entitlement please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/usageplans/20190501/datatypes/Entitlement\fP\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
.ft C
    ...
    oci api\-gateway usage\-plan update \-\-usage\-plan\-id $usage_plan_id
.ft P
.fi
.UNINDENT
.UNINDENT
