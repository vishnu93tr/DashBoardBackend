...
.
.TH "NETWORK_TUNNEL-ROUTE_LIST-IP-SEC-CONNECTION" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network_tunnel-route_list-ip-sec-connection \- 
.
...
.nf
.ft C
oci network tunnel\-route list\-ip\-sec\-connection [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
Specifies the advertiser of the routes. If set to \fIORACLE\fP, this returns only the routes advertised by Oracle. When set to \fICUSTOMER\fP, this returns only the routes advertised by the CPE.
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
...
.nf
.ft C
    export ipsc_id=<substitute\-value\-of\-ipsc_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/network/tunnel\-route/list\-ip\-sec\-connection.html#cmdoption\-ipsc\-id
    export tunnel_id=<substitute\-value\-of\-tunnel_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/network/tunnel\-route/list\-ip\-sec\-connection.html#cmdoption\-tunnel\-id

    oci network tunnel\-route list\-ip\-sec\-connection \-\-ipsc\-id $ipsc_id \-\-tunnel\-id $tunnel_id
.ft P
.fi
.UNINDENT
.UNINDENT
