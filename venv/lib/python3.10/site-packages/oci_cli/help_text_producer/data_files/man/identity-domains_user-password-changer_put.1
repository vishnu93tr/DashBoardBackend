...
.
.TH "IDENTITY-DOMAINS_USER-PASSWORD-CHANGER_PUT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_user-password-changer_put \- 
.
...
.nf
.ft C
oci identity\-domains user\-password\-changer put [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.sp
\fBSCIM++ Properties:\fP  \- type: string  \- multiValued: false  \- required: true  \- mutability: writeOnly  \- returned: never  \- uniqueness: none  \- idcsSensitive: none
.INDENT 0.0
.TP
...
.INDENT 0.0
.TP
.B \-\-user\-password\-changer\-id [text]
.UNINDENT
.sp
ID of the resource
...
.INDENT 0.0
.TP
.B \-\-bypass\-notification [boolean]
.UNINDENT
.sp
Indicates whether to send an email notification after a password is changed.
.sp
\fBSCIM++ Properties:\fP  \- caseExact: false  \- idcsSearchable: false  \- multiValued: false  \- mutability: immutable  \- required: false  \- returned: never  \- type: boolean  \- uniqueness: none
.INDENT 0.0
.TP
...
.sp
\fBSCIM++ Properties:\fP  \- type: string  \- multiValued: false  \- required: false  \- mutability: readWrite  \- returned: default  \- uniqueness: none
.INDENT 0.0
.TP
.B \-\-force
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-notification\-email\-template\-id [text]
.UNINDENT
.sp
...
.sp
\fBSCIM++ Properties:\fP  \- caseExact: false  \- idcsSearchable: false  \- multiValued: false  \- mutability: writeOnly  \- required: false  \- returned: never  \- type: string  \- uniqueness: none
.INDENT 0.0
.TP
.B \-\-ocid [text]
.UNINDENT
...
.nf
.ft C
    oci identity\-domains user\-password\-changer put \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export password=<substitute\-value\-of\-password> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/identity\-domains/user\-password\-changer/put.html#cmdoption\-password
    export user_password_changer_id=<substitute\-value\-of\-user_password_changer_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/identity\-domains/user\-password\-changer/put.html#cmdoption\-user\-password\-changer\-id

    oci identity\-domains user\-password\-changer put \-\-password $password \-\-schemas file://schemas.json \-\-user\-password\-changer\-id $user_password_changer_id
.ft P
.fi
.UNINDENT
.UNINDENT
