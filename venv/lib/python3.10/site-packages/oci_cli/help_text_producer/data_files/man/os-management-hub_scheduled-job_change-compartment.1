...
.
.TH "OS-MANAGEMENT-HUB_SCHEDULED-JOB_CHANGE-COMPARTMENT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
os-management-hub_scheduled-job_change-compartment \- 
.
...
.nf
.ft C
oci os\-management\-hub scheduled\-job change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the compartment to move the scheduled job to.
.INDENT 0.0
.TP
...
.ft C
    ...
    oci os\-management\-hub scheduled\-job change\-compartment \-\-compartment\-id $compartment_id \-\-scheduled\-job\-id $scheduled_job_id
.ft P
.fi
.UNINDENT
.UNINDENT
