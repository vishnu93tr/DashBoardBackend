...
.
.TH "IAM_USER_API-KEY" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
iam_user_api-key \- 
.
...
.sp
For more information about user credentials, see \fI\%User Credentials\fP <\fBhttps://docs.cloud.oracle.com/Content/Identity/usercred/usercredentials.htm\fP>\&.
...
.ft C
    ...
    export fingerprint=<substitute\-value\-of\-fingerprint> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/iam/user/api\-key/delete.html#cmdoption\-fingerprint

    user_id=$(oci iam user create \-\-description $description \-\-name $name \-\-query data.id \-\-raw\-output)

    oci iam user api\-key delete \-\-fingerprint $fingerprint \-\-user\-id $user_id
.ft P
.fi
.UNINDENT
.UNINDENT
