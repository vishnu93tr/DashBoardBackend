...
.
.TH "MONITORING_METRIC_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
...
.SH DESCRIPTION
.sp
Returns metric definitions that match the criteria specified in the request. Compartment OCID required. For more information, see \fI\%Listing Metric Definitions\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Monitoring/Tasks/list-metric.htm\fP>\&. For information about metrics, see \fI\%Metrics Overview\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Monitoring/Concepts/monitoringoverview.htm#MetricsOverview\fP>\&. For important limits information, see \fI\%Limits on Monitoring\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Monitoring/Concepts/monitoringoverview.htm#limits\fP>\&.
.sp
...
.UNINDENT
.sp
Group metrics by these fields in the response. For example, to list all metric namespaces available           in a compartment, groupBy the “namespace” field. Supported fields: namespace, name, resourceGroup. If \fIgroupBy\fP is used, then \fIdimensionFilters\fP is ignored.
.sp
Example \- group by namespace: \fI[ “namespace” ]\fP
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
