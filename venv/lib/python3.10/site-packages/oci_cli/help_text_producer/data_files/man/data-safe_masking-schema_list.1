...
.
.TH "DATA-SAFE_MASKING-SCHEMA_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_masking-schema_list \- 
.
...
.nf
.ft C
oci data\-safe masking\-schema list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci data\-safe masking\-schema list \-\-masking\-policy\-id $masking_policy_id
.ft P
.fi
.UNINDENT
.UNINDENT
