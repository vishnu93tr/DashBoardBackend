...
.
.TH "IDENTITY-DOMAINS_USER-CAPABILITIES-CHANGER_PUT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_user-capabilities-changer_put \- 
.
...
.nf
.ft C
oci identity\-domains user\-capabilities\-changer put [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-user\-capabilities\-changer\-id [text]
.UNINDENT
.sp
ID of the resource
...
.INDENT 0.0
.TP
.B \-\-can\-use\-console [boolean]
.UNINDENT
.sp
Indicates whether a user can use the Console.
.sp
\fBSCIM++ Properties:\fP  \- caseExact: false  \- idcsSearchable: true  \- multiValued: false  \- mutability: readWrite  \- idcsDefaultValue: false  \- required: false  \- returned: default  \- type: boolean  \- uniqueness: none
.INDENT 0.0
.TP
.B \-\-can\-use\-console\-password [boolean]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-can\-use\-customer\-secret\-keys [boolean]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-can\-use\-db\-credentials [boolean]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-can\-use\-o\-auth2\-client\-credentials [boolean]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-can\-use\-smtp\-credentials [boolean]
.UNINDENT
.sp
...
.nf
.ft C
    oci identity\-domains user\-capabilities\-changer put \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export user_capabilities_changer_id=<substitute\-value\-of\-user_capabilities_changer_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/identity\-domains/user\-capabilities\-changer/put.html#cmdoption\-user\-capabilities\-changer\-id

    oci identity\-domains user\-capabilities\-changer put \-\-schemas file://schemas.json \-\-user\-capabilities\-changer\-id $user_capabilities_changer_id
.ft P
.fi
.UNINDENT
.UNINDENT
