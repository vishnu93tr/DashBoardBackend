...
.
.TH "DB_VM-CLUSTER_ADD" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_vm-cluster_add \- 
.
...
.SH DESCRIPTION
.sp
Add Virtual Machines to the VM cluster. Applies to Exadata \fI\%Cloud@Customer\fP <\fBCloud@Customer\fP> instances only.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
...
.ft C
    ...
    oci db vm\-cluster add \-\-generate\-param\-json\-input db\-servers > db\-servers.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci db vm\-cluster add \-\-db\-servers file://db\-servers.json \-\-vm\-cluster\-id $vm_cluster_id
.ft P
.fi
.UNINDENT
.UNINDENT
