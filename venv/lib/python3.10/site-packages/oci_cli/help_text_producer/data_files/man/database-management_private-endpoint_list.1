...
.
.TH "DATABASE-MANAGEMENT_PRIVATE-ENDPOINT_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
database-management_private-endpoint_list \- 
.
...
.nf
.ft C
oci database\-management private\-endpoint list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-is\-dns\-resolution\-enabled [boolean]
.UNINDENT
.sp
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the VCN.
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/database\-management/private\-endpoint/list.html#cmdoption\-compartment\-id

    oci database\-management private\-endpoint list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
