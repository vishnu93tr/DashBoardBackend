...
.
.TH "RESOURCE-MANAGER_TEMPLATE_CREATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
resource-manager_template_create \- 
.
...
.nf
.ft C
oci resource\-manager template create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the compartment containing this template.
.INDENT 0.0
.TP
...
.ft C
    ...
    oci resource\-manager template create \-\-compartment\-id $compartment_id \-\-config\-source $config_source \-\-description $description \-\-display\-name $display_name
.ft P
.fi
.UNINDENT
.UNINDENT
