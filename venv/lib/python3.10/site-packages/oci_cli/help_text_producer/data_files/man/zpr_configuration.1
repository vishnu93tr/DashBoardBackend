...
.
.TH "ZPR_CONFIGURATION" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
zpr_configuration \- 
.
...
.nf
.ft C
oci zpr configuration create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the tenancy into which ZPR resources will be bootstrapped.
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/zpr/configuration/create.html#cmdoption\-compartment\-id

    oci zpr configuration create \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci zpr configuration get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
