...
.
.TH "IDENTITY-DOMAINS_AUTH-TOKEN" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_auth-token \- 
.
...
.nf
.ft C
oci identity\-domains auth\-token create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains auth\-token create \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains auth\-token create \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains auth\-token delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    auth_token_id=$(oci identity\-domains auth\-token create \-\-schemas file://schemas.json \-\-query data.id \-\-raw\-output)

    oci identity\-domains auth\-token delete \-\-auth\-token\-id $auth_token_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains auth\-token get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains auth\-token get \-\-auth\-token\-id $auth_token_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains auth\-token patch [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains auth\-token patch \-\-generate\-param\-json\-input operations > operations.json
    oci identity\-domains auth\-token patch \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains auth\-token patch \-\-auth\-token\-id $auth_token_id \-\-operations file://operations.json \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
