...
.
.TH "DEVOPS_DEPLOY-ENVIRONMENT_CREATE-FUNCTION-ENVIRONMENT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
devops_deploy-environment_create-function-environment \- 
.
...
.nf
.ft C
oci devops deploy\-environment create\-function\-environment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export function_id=<substitute\-value\-of\-function_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/devops/deploy\-environment/create\-function\-environment.html#cmdoption\-function\-id
    ...
    oci devops deploy\-environment create\-function\-environment \-\-function\-id $function_id \-\-project\-id $project_id
.ft P
.fi
.UNINDENT
.UNINDENT
