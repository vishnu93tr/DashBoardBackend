...
.
.TH "DATA-SAFE_SENSITIVE-TYPE_CREATE-SENSITIVE-TYPE-CREATE-SENSITIVE-TYPE-PATTERN-DETAILS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_sensitive-type_create-sensitive-type-create-sensitive-type-pattern-details \- 
.
...
.nf
.ft C
oci data\-safe sensitive\-type create\-sensitive\-type\-create\-sensitive\-type\-pattern\-details [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-safe/sensitive\-type/create\-sensitive\-type\-create\-sensitive\-type\-pattern\-details.html#cmdoption\-compartment\-id

    oci data\-safe sensitive\-type create\-sensitive\-type\-create\-sensitive\-type\-pattern\-details \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
