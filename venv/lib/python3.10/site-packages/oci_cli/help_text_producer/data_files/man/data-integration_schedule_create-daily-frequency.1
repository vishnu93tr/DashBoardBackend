...
.
.TH "DATA-INTEGRATION_SCHEDULE_CREATE-DAILY-FREQUENCY" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-integration_schedule_create-daily-frequency \- 
.
...
.nf
.ft C
oci data\-integration schedule create\-daily\-frequency [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export application_key=<substitute\-value\-of\-application_key> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/schedule/create\-daily\-frequency.html#cmdoption\-application\-key
    export identifier=<substitute\-value\-of\-identifier> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/schedule/create\-daily\-frequency.html#cmdoption\-identifier
    ...
    oci data\-integration schedule create\-daily\-frequency \-\-application\-key $application_key \-\-identifier $identifier \-\-name $name \-\-workspace\-id $workspace_id
.ft P
.fi
.UNINDENT
.UNINDENT
