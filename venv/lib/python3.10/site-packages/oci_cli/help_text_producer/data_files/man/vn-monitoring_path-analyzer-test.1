...
.
.TH "VN-MONITORING_PATH-ANALYZER-TEST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
vn-monitoring_path-analyzer-test \- 
.
...
.SH DESCRIPTION
.sp
Defines the details saved in a \fIPathAnalyzerTest\fP resource. These configuration details are used to run a \fI\%Network Path Analyzer\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Network/Concepts/path_analyzer.htm\fP> analysis.
...
.SS Description
.sp
Moves a \fIPathAnalyzerTest\fP resource from one compartment to another based on the identifier.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci vn\-monitoring path\-analyzer\-test change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the compartment into which the \fIPathAnalyzerTest\fP resource should be moved.
.INDENT 0.0
.TP
.B \-\-path\-analyzer\-test\-id [text]
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the \fIPathAnalyzerTest\fP resource.
...
.ft C
    ...
    oci vn\-monitoring path\-analyzer\-test change\-compartment \-\-compartment\-id $compartment_id \-\-path\-analyzer\-test\-id $path_analyzer_test_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.SS Description
.sp
Creates a new \fIPathAnalyzerTest\fP resource.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci vn\-monitoring path\-analyzer\-test create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> for the \fIPathAnalyzerTest\fP resource’s compartment.
.INDENT 0.0
.TP
.B \-\-destination\-endpoint [complex type]
.UNINDENT
.sp
...
.UNINDENT
.sp
The IP protocol to use in the \fIPathAnalyzerTest\fP resource.
.INDENT 0.0
.TP
.B \-\-source\-endpoint [complex type]
.UNINDENT
.sp
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
...
.INDENT 0.0
.TP
.B \-\-protocol\-parameters [complex type]
.UNINDENT
.sp
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
...
.ft C
    ...
    oci vn\-monitoring path\-analyzer\-test create \-\-compartment\-id $compartment_id \-\-destination\-endpoint file://destination\-endpoint.json \-\-protocol $protocol \-\-source\-endpoint file://source\-endpoint.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.SS Description
.sp
Deletes a \fIPathAnalyzerTest\fP resource using its identifier.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci vn\-monitoring path\-analyzer\-test delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci vn\-monitoring path\-analyzer\-test delete \-\-path\-analyzer\-test\-id $path_analyzer_test_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.SS Description
.sp
Gets a \fIPathAnalyzerTest\fP using its identifier.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci vn\-monitoring path\-analyzer\-test get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci vn\-monitoring path\-analyzer\-test get \-\-path\-analyzer\-test\-id $path_analyzer_test_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.SS Description
.sp
Returns a list of all \fIPathAnalyzerTests\fP in a compartment.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci vn\-monitoring path\-analyzer\-test list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
A filter that returns only resources whose \fIlifecycleState\fP matches the given \fIlifecycleState\fP\&.
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/vn\-monitoring/path\-analyzer\-test/list.html#cmdoption\-compartment\-id

    oci vn\-monitoring path\-analyzer\-test list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.SS Description
.sp
Updates a \fIPathAnalyzerTest\fP using its identifier.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci vn\-monitoring path\-analyzer\-test update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci vn\-monitoring path\-analyzer\-test update \-\-path\-analyzer\-test\-id $path_analyzer_test_id
.ft P
.fi
.UNINDENT
.UNINDENT
