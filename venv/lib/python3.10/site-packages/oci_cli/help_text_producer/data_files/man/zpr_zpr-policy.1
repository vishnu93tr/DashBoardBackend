...
.
.TH "ZPR_ZPR-POLICY" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
zpr_zpr-policy \- 
.
...
.nf
.ft C
oci zpr zpr\-policy create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the compartment to create the ZprPolicy in.
.INDENT 0.0
.TP
.B \-\-description [text]
.UNINDENT
...
.ft C
    ...
    oci zpr zpr\-policy create \-\-compartment\-id $compartment_id \-\-description $description \-\-name $name \-\-statements file://statements.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci zpr zpr\-policy delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-zpr\-policy\-id [text]
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the ZprPolicy.
.SS Optional Parameters
.INDENT 0.0
.TP
.B \-\-force
...
.ft C
    ...
    oci zpr zpr\-policy delete \-\-zpr\-policy\-id $zpr_policy_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci zpr zpr\-policy get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci zpr zpr\-policy get \-\-zpr\-policy\-id $zpr_policy_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci zpr zpr\-policy list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The field to sort by. You can provide only one sort order. Default order for \fItimeCreated\fP is descending. Default order for \fIname\fP is ascending.
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
