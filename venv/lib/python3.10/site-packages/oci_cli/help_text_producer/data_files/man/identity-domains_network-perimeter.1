...
.
.TH "IDENTITY-DOMAINS_NETWORK-PERIMETER" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_network-perimeter \- 
.
...
.nf
.ft C
oci identity\-domains network\-perimeter create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-ip\-addresses [complex type]
.UNINDENT
.sp
IPAddresses or Ranges assigned to the NetworkPerimeter
.sp
\fBSCIM++ Properties:\fP  \- idcsCompositeKey: [value]  \- idcsSearchable: true  \- multiValued: true  \- mutability: readWrite  \- required: true  \- returned: default  \- type: complex  \- uniqueness: none
...
.nf
.ft C
    oci identity\-domains network\-perimeter create \-\-generate\-param\-json\-input ip\-addresses > ip\-addresses.json
    oci identity\-domains network\-perimeter create \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export name=<substitute\-value\-of\-name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/identity\-domains/network\-perimeter/create.html#cmdoption\-name

    oci identity\-domains network\-perimeter create \-\-ip\-addresses file://ip\-addresses.json \-\-name $name \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains network\-perimeter delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    network_perimeter_id=$(oci identity\-domains network\-perimeter create \-\-ip\-addresses file://ip\-addresses.json \-\-name $name \-\-schemas file://schemas.json \-\-query data.id \-\-raw\-output)

    oci identity\-domains network\-perimeter delete \-\-network\-perimeter\-id $network_perimeter_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains network\-perimeter get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains network\-perimeter get \-\-network\-perimeter\-id $network_perimeter_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains network\-perimeter patch [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains network\-perimeter patch \-\-generate\-param\-json\-input operations > operations.json
    oci identity\-domains network\-perimeter patch \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains network\-perimeter patch \-\-network\-perimeter\-id $network_perimeter_id \-\-operations file://operations.json \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains network\-perimeter put [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains network\-perimeter put \-\-generate\-param\-json\-input ip\-addresses > ip\-addresses.json
    oci identity\-domains network\-perimeter put \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains network\-perimeter put \-\-ip\-addresses file://ip\-addresses.json \-\-name $name \-\-network\-perimeter\-id $network_perimeter_id \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
