...
.
.TH "DATA-CATALOG_ENTITY_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-catalog_entity_list \- 
.
...
.nf
.ft C
oci data\-catalog entity list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
dataAssetKey, description, displayName, externalKey, folderKey, folderName, key, lifecycleState, path, timeCreated, timeUpdated, updatedById, uri
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
DISPLAYNAME, DISPLAYORBUSINESSNAME, TIMECREATED
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export data_asset_key=<substitute\-value\-of\-data_asset_key> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-catalog/entity/list.html#cmdoption\-data\-asset\-key

    catalog_id=$(oci data\-catalog catalog create \-\-compartment\-id $compartment_id \-\-query data.id \-\-raw\-output)

    oci data\-catalog entity list \-\-catalog\-id $catalog_id \-\-data\-asset\-key $data_asset_key
.ft P
.fi
.UNINDENT
.UNINDENT
