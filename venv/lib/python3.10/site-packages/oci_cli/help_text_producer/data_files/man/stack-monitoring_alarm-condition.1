...
.
.TH "STACK-MONITORING_ALARM-CONDITION" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
stack-monitoring_alarm-condition \- 
.
...
.nf
.ft C
oci stack\-monitoring alarm\-condition create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-monitoring\-template\-id [text]
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the monitoring template.
.INDENT 0.0
.TP
.B \-\-namespace [text]
.UNINDENT
...
.ft C
    ...
    oci stack\-monitoring alarm\-condition create \-\-generate\-param\-json\-input conditions > conditions.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export condition_type=<substitute\-value\-of\-condition_type> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/stack\-monitoring/alarm\-condition/create.html#cmdoption\-condition\-type
    export metric_name=<substitute\-value\-of\-metric_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/stack\-monitoring/alarm\-condition/create.html#cmdoption\-metric\-name
    export namespace=<substitute\-value\-of\-namespace> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/stack\-monitoring/alarm\-condition/create.html#cmdoption\-namespace
    ...
    oci stack\-monitoring alarm\-condition create \-\-condition\-type $condition_type \-\-conditions file://conditions.json \-\-metric\-name $metric_name \-\-monitoring\-template\-id $monitoring_template_id \-\-namespace $namespace \-\-resource\-type $resource_type
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci stack\-monitoring alarm\-condition delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-alarm\-condition\-id [text]
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the alarm condition.
.INDENT 0.0
.TP
.B \-\-monitoring\-template\-id [text]
.UNINDENT
...
.ft C
    ...
    alarm_condition_id=$(oci stack\-monitoring alarm\-condition create \-\-condition\-type $condition_type \-\-conditions file://conditions.json \-\-metric\-name $metric_name \-\-monitoring\-template\-id $monitoring_template_id \-\-namespace $namespace \-\-resource\-type $resource_type \-\-query data.id \-\-raw\-output)

    oci stack\-monitoring alarm\-condition delete \-\-alarm\-condition\-id $alarm_condition_id \-\-monitoring\-template\-id $monitoring_template_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci stack\-monitoring alarm\-condition get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci stack\-monitoring alarm\-condition get \-\-alarm\-condition\-id $alarm_condition_id \-\-monitoring\-template\-id $monitoring_template_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci stack\-monitoring alarm\-condition update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
Monitoring template conditions
.sp
This option is a JSON list with items of type Condition.  For documentation on Condition please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/stackmonitoring/20210330/datatypes/Condition\fP\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
.ft C
    ...
    oci stack\-monitoring alarm\-condition update \-\-alarm\-condition\-id $alarm_condition_id \-\-monitoring\-template\-id $monitoring_template_id
.ft P
.fi
.UNINDENT
.UNINDENT
