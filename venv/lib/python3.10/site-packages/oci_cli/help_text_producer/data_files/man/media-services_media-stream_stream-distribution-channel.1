...
.
.TH "MEDIA-SERVICES_MEDIA-STREAM_STREAM-DISTRIBUTION-CHANNEL" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
media-services_media-stream_stream-distribution-channel \- 
.
...
.SS Description
.sp
Gets the playlist content for the specified Packaging Configuration and Media Asset combination. This API call is made using the MediaStreamsClient, which requires the endpoint to be set with the value of the distribution channel domain name (for example, \fI\%https://example_channel.dc.mediaservices.example_region.oci.oraclecloud.com\fP) to generate a session token or playlist for a media asset registered in this distribution channel.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
...
.UNINDENT
.UNINDENT
.SS \fBgenerate\-session\-token\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.nf
.ft C
    export packaging_config_id=<substitute\-value\-of\-packaging_config_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/media\-services/media\-stream/stream\-distribution\-channel/generate\-session\-token.html#cmdoption\-packaging\-config\-id
    export scopes=<substitute\-value\-of\-scopes> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/media\-services/media\-stream/stream\-distribution\-channel/generate\-session\-token.html#cmdoption\-scopes

    oci media\-services media\-stream stream\-distribution\-channel generate\-session\-token \-\-packaging\-config\-id $packaging_config_id \-\-scopes $scopes
.ft P
.fi
.UNINDENT
.UNINDENT
