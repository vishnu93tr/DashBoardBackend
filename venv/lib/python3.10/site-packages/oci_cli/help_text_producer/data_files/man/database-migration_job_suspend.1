...
.
.TH "DATABASE-MIGRATION_JOB_SUSPEND" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
database-migration_job_suspend \- 
.
...
.nf
.ft C
oci database\-migration job suspend [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export job_id=<substitute\-value\-of\-job_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/database\-migration/job/suspend.html#cmdoption\-job\-id

    oci database\-migration job suspend \-\-job\-id $job_id
.ft P
.fi
.UNINDENT
.UNINDENT
