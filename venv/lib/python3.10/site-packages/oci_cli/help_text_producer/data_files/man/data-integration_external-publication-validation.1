...
.
.TH "DATA-INTEGRATION_EXTERNAL-PUBLICATION-VALIDATION" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-integration_external-publication-validation \- 
.
...
.nf
.ft C
oci data\-integration external\-publication\-validation create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export task_key=<substitute\-value\-of\-task_key> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/external\-publication\-validation/create.html#cmdoption\-task\-key
    ...
    oci data\-integration external\-publication\-validation create \-\-task\-key $task_key \-\-workspace\-id $workspace_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci data\-integration external\-publication\-validation delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-external\-publication\-validation\-key [text]
.UNINDENT
.sp
...
.ft C
    ...
    export display_name=<substitute\-value\-of\-display_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/workspace/create.html#cmdoption\-display\-name
    export is_private_network=<substitute\-value\-of\-is_private_network> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/workspace/create.html#cmdoption\-is\-private\-network
    export external_publication_validation_key=<substitute\-value\-of\-external_publication_validation_key> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/external\-publication\-validation/delete.html#cmdoption\-external\-publication\-validation\-key
    export task_key=<substitute\-value\-of\-task_key> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/external\-publication\-validation/delete.html#cmdoption\-task\-key

    workspace_id=$(oci data\-integration workspace create \-\-compartment\-id $compartment_id \-\-display\-name $display_name \-\-is\-private\-network $is_private_network \-\-query data.id \-\-raw\-output)

    oci data\-integration external\-publication\-validation delete \-\-external\-publication\-validation\-key $external_publication_validation_key \-\-task\-key $task_key \-\-workspace\-id $workspace_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci data\-integration external\-publication\-validation get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export display_name=<substitute\-value\-of\-display_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/workspace/create.html#cmdoption\-display\-name
    export is_private_network=<substitute\-value\-of\-is_private_network> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/workspace/create.html#cmdoption\-is\-private\-network
    export external_publication_validation_key=<substitute\-value\-of\-external_publication_validation_key> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/external\-publication\-validation/get.html#cmdoption\-external\-publication\-validation\-key
    export task_key=<substitute\-value\-of\-task_key> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/external\-publication\-validation/get.html#cmdoption\-task\-key

    workspace_id=$(oci data\-integration workspace create \-\-compartment\-id $compartment_id \-\-display\-name $display_name \-\-is\-private\-network $is_private_network \-\-query data.id \-\-raw\-output)

    oci data\-integration external\-publication\-validation get \-\-external\-publication\-validation\-key $external_publication_validation_key \-\-task\-key $task_key \-\-workspace\-id $workspace_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci data\-integration external\-publication\-validation list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export display_name=<substitute\-value\-of\-display_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/workspace/create.html#cmdoption\-display\-name
    export is_private_network=<substitute\-value\-of\-is_private_network> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/workspace/create.html#cmdoption\-is\-private\-network
    export task_key=<substitute\-value\-of\-task_key> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/external\-publication\-validation/list.html#cmdoption\-task\-key

    workspace_id=$(oci data\-integration workspace create \-\-compartment\-id $compartment_id \-\-display\-name $display_name \-\-is\-private\-network $is_private_network \-\-query data.id \-\-raw\-output)

    oci data\-integration external\-publication\-validation list \-\-task\-key $task_key \-\-workspace\-id $workspace_id
.ft P
.fi
.UNINDENT
.UNINDENT
