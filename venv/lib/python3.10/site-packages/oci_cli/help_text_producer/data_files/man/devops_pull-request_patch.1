...
.
.TH "DEVOPS_PULL-REQUEST_PATCH" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
devops_pull-request_patch \- 
.
...
.nf
.ft C
oci devops pull\-request patch [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.sp
This option is a JSON list with items of type PatchInstruction.  For documentation on PatchInstruction please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/devops/20210630/datatypes/PatchInstruction\fP\&.
...
.ft C
    ...
    oci devops pull\-request patch \-\-pull\-request\-id $pull_request_id
.ft P
.fi
.UNINDENT
.UNINDENT
