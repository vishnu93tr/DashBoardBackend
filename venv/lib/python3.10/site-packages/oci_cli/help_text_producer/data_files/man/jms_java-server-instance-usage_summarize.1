...
.
.TH "JMS_JAVA-SERVER-INSTANCE-USAGE_SUMMARIZE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
jms_java-server-instance-usage_summarize \- 
.
...
.nf
.ft C
oci jms java\-server\-instance\-usage summarize [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-server\-instance\-name [text]
.UNINDENT
.sp
The Java Server instance name.
.INDENT 0.0
.TP
.B \-\-server\-instance\-name\-contains [text]
.UNINDENT
.sp
...
.UNINDENT
.sp
The field to sort the Java Server instances. Only one sort order can be provided. If no value is specified _timeLastSeen_ is default.
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
...
.nf
.ft C
approximateDeployedApplicationCount, managedInstanceName, serverInstanceName, timeFirstSeen, timeLastSeen
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci jms java\-server\-instance\-usage summarize \-\-fleet\-id $fleet_id
.ft P
.fi
.UNINDENT
.UNINDENT
