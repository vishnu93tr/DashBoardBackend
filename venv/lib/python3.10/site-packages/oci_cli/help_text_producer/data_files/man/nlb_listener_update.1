...
.
.TH "NLB_LISTENER_UPDATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
nlb_listener_update \- 
.
...
.INDENT 0.0
.TP
.B \-\-is\-ppv2\-enabled [boolean]
.UNINDENT
.sp
Property to enable/disable PPv2 feature for this listener.
.INDENT 0.0
.TP
.B \-\-l3\-ip\-idle\-timeout [integer]
.UNINDENT
.sp
The duration for L3IP idle timeout in seconds. Example: \fI200\fP
.INDENT 0.0
.TP
...
.INDENT 0.0
.TP
.B \-\-tcp\-idle\-timeout [integer]
.UNINDENT
.sp
The duration for TCP idle timeout in seconds. Example: \fI300\fP
.INDENT 0.0
.TP
.B \-\-udp\-idle\-timeout [integer]
.UNINDENT
.sp
The duration for UDP idle timeout in seconds. Example: \fI120\fP
.INDENT 0.0
.TP
...
.ft C
    ...
    export listener_name=<substitute\-value\-of\-listener_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/nlb/listener/update.html#cmdoption\-listener\-name
    ...
    oci nlb listener update \-\-listener\-name $listener_name \-\-network\-load\-balancer\-id $network_load_balancer_id
.ft P
.fi
.UNINDENT
.UNINDENT
