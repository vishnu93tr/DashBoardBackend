...
.
.TH "FS_FILE-SYSTEM_UPDATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
fs_file-system_update \- 
.
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the Key Management master encryption key to associate with the specified file system. If this value is empty, the Update operation will remove the associated key, if there is one, from the file system. (The file system will continue to be encrypted, but with an encryption key managed by Oracle.)
.sp
If updating to a new Key Management key, the old key must remain enabled so that files previously encrypted continue to be accessible. For more information, see \fI\%Overview of Key Management\fP <\fBhttps://docs.cloud.oracle.com/Content/KeyManagement/Concepts/keyoverview.htm\fP>\&.
.INDENT 0.0
.TP
...
.ft C
    ...
    oci fs file\-system update \-\-file\-system\-id $file_system_id
.ft P
.fi
.UNINDENT
.UNINDENT
