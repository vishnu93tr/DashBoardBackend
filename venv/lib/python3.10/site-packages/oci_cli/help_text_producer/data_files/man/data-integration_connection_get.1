...
.
.TH "DATA-INTEGRATION_CONNECTION_GET" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-integration_connection_get \- 
.
...
.nf
.ft C
oci data\-integration connection get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export connection_key=<substitute\-value\-of\-connection_key> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/connection/get.html#cmdoption\-connection\-key
    ...
    oci data\-integration connection get \-\-connection\-key $connection_key \-\-workspace\-id $workspace_id
.ft P
.fi
.UNINDENT
.UNINDENT
