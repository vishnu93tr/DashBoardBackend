...
.
.TH "EMAIL_SENDER_DELETE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
email_sender_delete \- 
.
...
.SH DESCRIPTION
.sp
Deletes an approved sender for a tenancy in a given compartment for a provided \fIsenderId\fP\&.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci email sender delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci email sender delete \-\-sender\-id $sender_id
.ft P
.fi
.UNINDENT
.UNINDENT
