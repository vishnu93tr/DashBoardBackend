...
.
.TH "DEVOPS_PROTECTED-BRANCH" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
devops_protected-branch \- 
.
...
.nf
.ft C
oci devops protected\-branch create\-or\-update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
PULL_REQUEST_MERGE_ONLY, READ_ONLY
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export branch_name=<substitute\-value\-of\-branch_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/devops/protected\-branch/create\-or\-update.html#cmdoption\-branch\-name
    ...
    oci devops protected\-branch create\-or\-update \-\-branch\-name $branch_name \-\-repository\-id $repository_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci devops protected\-branch delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export name=<substitute\-value\-of\-name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/devops/project/create.html#cmdoption\-name
    export repository_type=<substitute\-value\-of\-repository_type> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/devops/repository/create.html#cmdoption\-repository\-type
    export branch_name=<substitute\-value\-of\-branch_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/devops/protected\-branch/delete.html#cmdoption\-branch\-name

    project_id=$(oci devops project create \-\-compartment\-id $compartment_id \-\-name $name \-\-notification\-config file://notification\-config.json \-\-query data.id \-\-raw\-output)

    repository_id=$(oci devops repository create \-\-name $name \-\-project\-id $project_id \-\-repository\-type $repository_type \-\-query data.id \-\-raw\-output)

    oci devops protected\-branch delete \-\-branch\-name $branch_name \-\-repository\-id $repository_id
.ft P
.fi
.UNINDENT
.UNINDENT
.SS \fBlist\-protected\-branches\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
