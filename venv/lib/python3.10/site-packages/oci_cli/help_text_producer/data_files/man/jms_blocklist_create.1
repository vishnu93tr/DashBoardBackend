...
.
.TH "JMS_BLOCKLIST_CREATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
jms_blocklist_create \- 
.
...
.nf
.ft C
oci jms blocklist create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci jms blocklist create \-\-generate\-param\-json\-input target > target.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export operation=<substitute\-value\-of\-operation> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/jms/blocklist/create.html#cmdoption\-operation
    ...
    oci jms blocklist create \-\-fleet\-id $fleet_id \-\-operation $operation \-\-target file://target.json
.ft P
.fi
.UNINDENT
.UNINDENT
