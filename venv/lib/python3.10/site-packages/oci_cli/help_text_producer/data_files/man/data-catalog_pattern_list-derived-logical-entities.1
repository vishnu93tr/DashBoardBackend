...
.
.TH "DATA-CATALOG_PATTERN_LIST-DERIVED-LOGICAL-ENTITIES" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-catalog_pattern_list-derived-logical-entities \- 
.
...
.ft C
    ...
    export pattern_key=<substitute\-value\-of\-pattern_key> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-catalog/pattern/list\-derived\-logical\-entities.html#cmdoption\-pattern\-key

    catalog_id=$(oci data\-catalog catalog create \-\-compartment\-id $compartment_id \-\-query data.id \-\-raw\-output)

    oci data\-catalog pattern list\-derived\-logical\-entities \-\-catalog\-id $catalog_id \-\-pattern\-key $pattern_key
.ft P
.fi
.UNINDENT
.UNINDENT
