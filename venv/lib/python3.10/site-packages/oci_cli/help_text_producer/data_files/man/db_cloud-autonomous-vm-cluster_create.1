...
.
.TH "DB_CLOUD-AUTONOMOUS-VM-CLUSTER_CREATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_cloud-autonomous-vm-cluster_create \- 
.
...
.SH DESCRIPTION
.sp
Creates an Autonomous Exadata VM cluster in the Oracle cloud. For Exadata \fI\%Cloud@Customer\fP <\fBCloud@Customer\fP> systems, see \fI\%CreateAutonomousVmCluster\fP <\fBhttps://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/db/autonomous-vm-cluster/create.html\fP>\&.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the cloud Exadata infrastructure.
.INDENT 0.0
.TP
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the subnet the cloud Autonomous VM Cluster is associated with.
...
.INDENT 0.0
.TP
.B \-\-cluster\-time\-zone [text]
.UNINDENT
.sp
The time zone to use for the Cloud Autonomous VM cluster. For details, see \fI\%DB System Time Zones\fP <\fBhttps://docs.cloud.oracle.com/Content/Database/References/timezones.htm\fP>\&.
.INDENT 0.0
.TP
...
.INDENT 0.0
.TP
.B \-\-is\-mtls\-enabled\-vm\-cluster [boolean]
.UNINDENT
.sp
