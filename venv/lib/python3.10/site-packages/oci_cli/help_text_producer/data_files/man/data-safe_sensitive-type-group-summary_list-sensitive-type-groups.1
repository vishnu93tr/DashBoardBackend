...
.
.TH "DATA-SAFE_SENSITIVE-TYPE-GROUP-SUMMARY_LIST-SENSITIVE-TYPE-GROUPS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_sensitive-type-group-summary_list-sensitive-type-groups \- 
.
...
.nf
.ft C
oci data\-safe sensitive\-type\-group\-summary list\-sensitive\-type\-groups [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-safe/sensitive\-type\-group\-summary/list\-sensitive\-type\-groups.html#cmdoption\-compartment\-id

    oci data\-safe sensitive\-type\-group\-summary list\-sensitive\-type\-groups \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
