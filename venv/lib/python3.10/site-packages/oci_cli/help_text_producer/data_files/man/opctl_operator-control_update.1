...
.
.TH "OPCTL_OPERATOR-CONTROL_UPDATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
opctl_operator-control_update \- 
.
...
.nf
.ft C
oci opctl operator\-control update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-approver\-groups\-list [complex type]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-is\-fully\-pre\-approved [boolean]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-number\-of\-approvers [integer]
.UNINDENT
.sp
Number of approvers required to approve an access request.
.INDENT 0.0
.TP
.B \-\-pre\-approved\-op\-action\-list [complex type]
.UNINDENT
.sp
...
.ft C
    ...
    oci opctl operator\-control update \-\-generate\-param\-json\-input approver\-groups\-list > approver\-groups\-list.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci opctl operator\-control update \-\-approver\-groups\-list file://approver\-groups\-list.json \-\-is\-fully\-pre\-approved $is_fully_pre_approved \-\-operator\-control\-id $operator_control_id \-\-operator\-control\-name $operator_control_name
.ft P
.fi
.UNINDENT
.UNINDENT
