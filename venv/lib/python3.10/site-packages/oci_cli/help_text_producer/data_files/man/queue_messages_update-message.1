...
.
.TH "QUEUE_MESSAGES_UPDATE-MESSAGE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
queue_messages_update-message \- 
.
...
.SH DESCRIPTION
.sp
Updates the visibility of the message represented by the receipt. You must use the \fI\%messages endpoint\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/queue/messages.htm#messages__messages-endpoint\fP> to update messages. The messages endpoint may be different for different queues. Use 
.nf
\(ga\(ga
.fi
...
.nf
.ft C
oci queue messages update\-message [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
