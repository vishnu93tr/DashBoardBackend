...
.
.TH "GOLDENGATE_CONNECTION_UPDATE-SNOWFLAKE-CONNECTION" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
goldengate_connection_update-snowflake-connection \- 
.
...
.nf
.ft C
oci goldengate connection update\-snowflake\-connection [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the Secret that stores the password Oracle GoldenGate uses to connect to Snowflake platform. Note: When provided, ‘password’ field must not be provided.
.INDENT 0.0
.TP
...
.nf
.ft C
    export connection_id=<substitute\-value\-of\-connection_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/goldengate/connection/update\-snowflake\-connection.html#cmdoption\-connection\-id

    oci goldengate connection update\-snowflake\-connection \-\-connection\-id $connection_id
.ft P
.fi
.UNINDENT
.UNINDENT
