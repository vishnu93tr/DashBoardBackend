...
.
.TH "IAM_POLICY_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
iam_policy_list \- 
.
...
.SH DESCRIPTION
.sp
Lists the policies in the specified compartment (either the tenancy or another of your compartments). See \fI\%Where to Get the Tenancy’s OCID and User’s OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/API/Concepts/apisigningkey.htm#five\fP>\&.
.sp
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/iam/policy/list.html#cmdoption\-compartment\-id
