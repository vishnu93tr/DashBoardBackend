...
.
.TH "DB_VM-CLUSTER_UPDATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_vm-cluster_update \- 
.
...
.SH DESCRIPTION
.sp
Updates the specified VM cluster. Applies to Exadata \fI\%Cloud@Customer\fP <\fBCloud@Customer\fP> instances only.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
...
.INDENT 0.0
.TP
.B \-\-cloud\-automation\-update\-details [complex type]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-data\-storage\-size\-in\-gbs [text]
.UNINDENT
.sp
The data disk group size to be allocated in GBs.
.INDENT 0.0
.TP
.B \-\-data\-storage\-size\-in\-tbs [text]
.UNINDENT
.sp
The data disk group size to be allocated in TBs.
.INDENT 0.0
.TP
.B \-\-db\-node\-storage\-size\-in\-gbs [integer]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-file\-system\-configuration\-details [complex type]
.UNINDENT
.sp
Details of the file system configuration of the VM cluster.
.sp
This option is a JSON list with items of type FileSystemConfigurationDetail.  For documentation on FileSystemConfigurationDetail please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/database/20160918/datatypes/FileSystemConfigurationDetail\fP\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> (/Content/General/Concepts/identifiers.htm) of the grid infrastructure software image. This is a database software image of type \fIGRID_IMAGE\fP\&.
.INDENT 0.0
.TP
.B \-\-if\-match [text]
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> (/Content/General/Concepts/identifiers.htm) of the maintenance update.
.INDENT 0.0
.TP
