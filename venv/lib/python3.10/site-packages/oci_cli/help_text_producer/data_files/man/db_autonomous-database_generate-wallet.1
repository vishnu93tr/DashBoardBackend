...
.
.TH "DB_AUTONOMOUS-DATABASE_GENERATE-WALLET" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_autonomous-database_generate-wallet \- 
.
...
.INDENT 0.0
.TP
.B \-\-generate\-type [text]
.UNINDENT
.sp
The type of wallet to generate.
.sp
\fBServerless instance usage:\fP * \fISINGLE\fP \- used to generate a wallet for a single database * \fIALL\fP \- used to generate wallet for all databases in the region
.sp
\fBDedicated Exadata infrastructure usage:\fP Value must be \fINULL\fP if attribute is used.
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
