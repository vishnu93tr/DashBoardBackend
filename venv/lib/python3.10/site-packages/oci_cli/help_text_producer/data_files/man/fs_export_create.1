...
.
.TH "FS_EXPORT_CREATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
fs_export_create \- 
.
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of this export’s export set.
.INDENT 0.0
.TP
.B \-\-file\-system\-id [text]
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of this export’s file system.
.INDENT 0.0
.TP
.B \-\-path [text]
.UNINDENT
...
.sp
\fBNote:\fP Mount targets do not have Internet\-routable IP   addresses.  Therefore they will not be reachable from the   Internet, even if an associated \fIClientOptions\fP item has   a source of \fI0.0.0.0/0\fP\&.
.sp
\fBIf set to the empty array then the export will not be   visible to any clients.\fP
.sp
The export’s \fIexportOptions\fP can be changed after creation   using the \fIUpdateExport\fP operation.
.UNINDENT
.UNINDENT
.sp
This option is a JSON list with items of type ClientOptions.  For documentation on ClientOptions please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/filestorage/20171215/datatypes/ClientOptions\fP\&.
...
.INDENT 0.0
.TP
.B \-\-is\-idmap\-groups\-for\-sys\-auth [boolean]
.UNINDENT
.sp
