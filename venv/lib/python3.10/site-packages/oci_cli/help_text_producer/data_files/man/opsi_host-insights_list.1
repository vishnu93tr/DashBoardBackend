...
.
.TH "OPSI_HOST-INSIGHTS_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
opsi_host-insights_list \- 
.
...
.nf
.ft C
oci opsi host\-insights list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
Host insight list sort options. If \fIfields\fP parameter is selected, the \fIsortBy\fP parameter must be one of the fields specified.
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
