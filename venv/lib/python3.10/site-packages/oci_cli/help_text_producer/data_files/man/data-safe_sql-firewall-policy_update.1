...
.
.TH "DATA-SAFE_SQL-FIREWALL-POLICY_UPDATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_sql-firewall-policy_update \- 
.
...
.nf
.ft C
oci data\-safe sql\-firewall\-policy update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-allowed\-client\-ips [complex type]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-allowed\-client\-os\-usernames [complex type]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-allowed\-client\-programs [complex type]
.UNINDENT
.sp
...
.nf
.ft C
ENFORCE_ALL, ENFORCE_CONTEXT, ENFORCE_SQL
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export sql_firewall_policy_id=<substitute\-value\-of\-sql_firewall_policy_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-safe/sql\-firewall\-policy/update.html#cmdoption\-sql\-firewall\-policy\-id

    oci data\-safe sql\-firewall\-policy update \-\-sql\-firewall\-policy\-id $sql_firewall_policy_id
.ft P
.fi
.UNINDENT
.UNINDENT
