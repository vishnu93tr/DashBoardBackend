...
.
.TH "NETWORK_NSG_RULES" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network_nsg_rules \- 
.
...
.SH DESCRIPTION
.sp
A security rule is one of the items in a \fI\%NetworkSecurityGroup\fP <\fBhttps://docs.cloud.oracle.com/api/#/en/iaas/latest/NetworkSecurityGroup/\fP>\&. It is a virtual firewall rule for the VNICs in the network security group. A rule can be for either inbound (
.nf
\(ga
.fi
direction\(ga= INGRESS) or outbound (
.nf
\(ga
.fi
direction\(ga= EGRESS) IP packets.
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the network security group.
...
.INDENT 0.0
.TP
.B \-\-security\-rules [complex type]
.UNINDENT
.sp
An array of security rules to add to the NSG. You can add up to 25 rules in a single \fIAddNetworkSecurityGroupSecurityRules\fP operation. Adding more than 25 rules requires multiple operations.
.sp
This option is a JSON list with items of type AddSecurityRuleDetails.  For documentation on AddSecurityRuleDetails please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/iaas/20160918/datatypes/AddSecurityRuleDetails\fP\&.
...
.ft C
    ...
    nsg_id=$(oci network nsg create \-\-compartment\-id $compartment_id \-\-vcn\-id $vcn_id \-\-query data.id \-\-raw\-output)
...
.UNINDENT
.sp
Direction of the security rule. Set to \fIEGRESS\fP for rules that allow outbound IP packets, or \fIINGRESS\fP for rules that allow inbound IP packets.
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
...
.INDENT 0.0
.TP
.B \-\-security\-rule\-ids [complex type]
.UNINDENT
.sp
The Oracle\-assigned ID of each \fI\%SecurityRule\fP <\fBhttps://docs.cloud.oracle.com/api/#/en/iaas/latest/SecurityRule/\fP> to be deleted.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
.sp
This option is a JSON list with items of type UpdateSecurityRuleDetails.  For documentation on UpdateSecurityRuleDetails please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/iaas/20160918/datatypes/UpdateSecurityRuleDetails\fP\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
