...
.
.TH "DATA-SAFE_SENSITIVE-DATA-MODEL_CHANGE-COMPARTMENT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_sensitive-data-model_change-compartment \- 
.
...
.nf
.ft C
oci data\-safe sensitive\-data\-model change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci data\-safe sensitive\-data\-model change\-compartment \-\-compartment\-id $compartment_id \-\-sensitive\-data\-model\-id $sensitive_data_model_id
.ft P
.fi
.UNINDENT
.UNINDENT
