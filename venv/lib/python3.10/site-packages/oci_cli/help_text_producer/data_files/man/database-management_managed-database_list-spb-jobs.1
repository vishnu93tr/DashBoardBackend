...
.
.TH "DATABASE-MANAGEMENT_MANAGED-DATABASE_LIST-SPB-JOBS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
database-management_managed-database_list-spb-jobs \- 
.
...
.nf
.ft C
oci database\-management managed\-database list\-spb\-jobs [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export managed_database_id=<substitute\-value\-of\-managed_database_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/database\-management/managed\-database/list\-spb\-jobs.html#cmdoption\-managed\-database\-id

    oci database\-management managed\-database list\-spb\-jobs \-\-managed\-database\-id $managed_database_id
.ft P
.fi
.UNINDENT
.UNINDENT
