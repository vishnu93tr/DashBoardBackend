...
.
.TH "IDENTITY-DOMAINS_AUTH-TOKENS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_auth-tokens \- 
.
...
.nf
.ft C
oci identity\-domains auth\-tokens list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains auth\-tokens list
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains auth\-tokens search [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains auth\-tokens search \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains auth\-tokens search \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
