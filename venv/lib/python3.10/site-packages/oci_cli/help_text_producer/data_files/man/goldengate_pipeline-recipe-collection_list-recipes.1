...
.
.TH "GOLDENGATE_PIPELINE-RECIPE-COLLECTION_LIST-RECIPES" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
goldengate_pipeline-recipe-collection_list-recipes \- 
.
...
.nf
.ft C
oci goldengate pipeline\-recipe\-collection list\-recipes [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/goldengate/pipeline\-recipe\-collection/list\-recipes.html#cmdoption\-compartment\-id

    oci goldengate pipeline\-recipe\-collection list\-recipes \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
