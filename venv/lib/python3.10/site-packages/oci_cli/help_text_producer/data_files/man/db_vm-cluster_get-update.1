...
.
.TH "DB_VM-CLUSTER_GET-UPDATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_vm-cluster_get-update \- 
.
...
.SH DESCRIPTION
.sp
Gets information about a specified maintenance update package for a VM cluster. Applies to Exadata \fI\%Cloud@Customer\fP <\fBCloud@Customer\fP> instances only.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci db vm\-cluster get\-update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export update_id=<substitute\-value\-of\-update_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/db/vm\-cluster/get\-update.html#cmdoption\-update\-id
    ...
    oci db vm\-cluster get\-update \-\-update\-id $update_id \-\-vm\-cluster\-id $vm_cluster_id
.ft P
.fi
.UNINDENT
.UNINDENT
