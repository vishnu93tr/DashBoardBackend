...
.
.TH "PSQL_WORK-REQUEST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
psql_work-request \- 
.
...
.nf
.ft C
oci psql work\-request get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export work_request_id=<substitute\-value\-of\-work_request_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/psql/work\-request/get.html#cmdoption\-work\-request\-id

    oci psql work\-request get \-\-work\-request\-id $work_request_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci psql work\-request list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
A filter to return only resources if their \fIlifecycleState\fP matches the given OperationStatus.
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
