...
.
.TH "COMPUTE_DEDICATED-VM-HOST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
compute_dedicated-vm-host \- 
.
...
.nf
.ft C
oci compute dedicated\-vm\-host change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the compartment to move the dedicated virtual machine host to.
.INDENT 0.0
.TP
...
.nf
.ft C
    export availability_domain=<substitute\-value\-of\-availability_domain> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/compute/dedicated\-vm\-host/create.html#cmdoption\-availability\-domain
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/compute/dedicated\-vm\-host/create.html#cmdoption\-compartment\-id
    export dedicated_vm_host_shape=<substitute\-value\-of\-dedicated_vm_host_shape> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/compute/dedicated\-vm\-host/create.html#cmdoption\-dedicated\-vm\-host\-shape

    dedicated_vm_host_id=$(oci compute dedicated\-vm\-host create \-\-availability\-domain $availability_domain \-\-compartment\-id $compartment_id \-\-dedicated\-vm\-host\-shape $dedicated_vm_host_shape \-\-query data.id \-\-raw\-output)

    oci compute dedicated\-vm\-host change\-compartment \-\-compartment\-id $compartment_id \-\-dedicated\-vm\-host\-id $dedicated_vm_host_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.SS Description
.sp
Creates a new dedicated virtual machine host in the specified compartment and the specified availability domain. Dedicated virtual machine hosts enable you to run your Compute virtual machine (VM) instances on dedicated servers that are a single tenant and not shared with other customers. For more information, see \fI\%Dedicated Virtual Machine Hosts\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Compute/Concepts/dedicatedvmhosts.htm\fP>\&.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
...
.INDENT 0.0
.TP
.B \-\-dedicated\-vm\-host\-shape [text]
.UNINDENT
.sp
...
.UNINDENT
.sp
The fault domain for the dedicated virtual machine host’s assigned instances. For more information, see \fI\%Fault Domains\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/regions.htm#fault\fP>\&. If you do not specify the fault domain, the system selects one for you. To change the fault domain for a dedicated virtual machine host, delete it and create a new dedicated virtual machine host in the preferred fault domain.
.sp
To get a list of fault domains, use the \fIListFaultDomains\fP operation in the \fI\%Identity and Access Management Service API\fP <\fBhttps://docs.cloud.oracle.com/iaas/api/#/en/identity/20160918/\fP>\&.
.sp
Example:
.INDENT 0.0
.INDENT 3.5
...
.ft C
    ...
    oci compute dedicated\-vm\-host create \-\-availability\-domain $availability_domain \-\-compartment\-id $compartment_id \-\-dedicated\-vm\-host\-shape $dedicated_vm_host_shape
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci compute dedicated\-vm\-host delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci compute dedicated\-vm\-host get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci compute dedicated\-vm\-host get \-\-dedicated\-vm\-host\-id $dedicated_vm_host_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci compute dedicated\-vm\-host host\-shape list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/compute/dedicated\-vm\-host/host\-shape/list.html#cmdoption\-compartment\-id

    oci compute dedicated\-vm\-host host\-shape list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci compute dedicated\-vm\-host instance\-shape list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/compute/dedicated\-vm\-host/instance\-shape/list.html#cmdoption\-compartment\-id

    oci compute dedicated\-vm\-host instance\-shape list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-remaining\-memory\-in\-gbs\-greater\-than\-or\-equal\-to [float]
.UNINDENT
.sp
The remaining memory of the dedicated VM host, in GBs.
.INDENT 0.0
.TP
.B \-\-remaining\-ocpus\-greater\-than\-or\-equal\-to [float]
.UNINDENT
.sp
...
.nf
.ft C
oci compute dedicated\-vm\-host update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci compute dedicated\-vm\-host update \-\-dedicated\-vm\-host\-id $dedicated_vm_host_id
.ft P
.fi
.UNINDENT
.UNINDENT
