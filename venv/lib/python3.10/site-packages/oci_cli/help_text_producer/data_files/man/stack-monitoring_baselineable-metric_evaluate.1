...
.
.TH "STACK-MONITORING_BASELINEABLE-METRIC_EVALUATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
stack-monitoring_baselineable-metric_evaluate \- 
.
...
.nf
.ft C
oci stack\-monitoring baselineable\-metric evaluate [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci stack\-monitoring baselineable\-metric evaluate \-\-generate\-param\-json\-input items > items.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export metric_id=<substitute\-value\-of\-metric_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/stack\-monitoring/baselineable\-metric/evaluate.html#cmdoption\-metric\-id
    ...
    oci stack\-monitoring baselineable\-metric evaluate \-\-items file://items.json \-\-metric\-id $metric_id \-\-resource\-id $resource_id
.ft P
.fi
.UNINDENT
.UNINDENT
