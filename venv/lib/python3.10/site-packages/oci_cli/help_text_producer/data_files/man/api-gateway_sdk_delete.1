...
.
.TH "API-GATEWAY_SDK_DELETE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
api-gateway_sdk_delete \- 
.
...
.nf
.ft C
oci api\-gateway sdk delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    sdk_id=$(oci api\-gateway sdk create \-\-api\-id $api_id \-\-target\-language $target_language \-\-query data.id \-\-raw\-output)

    oci api\-gateway sdk delete \-\-sdk\-id $sdk_id
.ft P
.fi
.UNINDENT
.UNINDENT
