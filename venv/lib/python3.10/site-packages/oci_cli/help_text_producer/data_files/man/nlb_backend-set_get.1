...
.
.TH "NLB_BACKEND-SET_GET" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
nlb_backend-set_get \- 
.
...
.nf
.ft C
oci nlb backend\-set get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export backend_set_name=<substitute\-value\-of\-backend_set_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/nlb/backend\-set/get.html#cmdoption\-backend\-set\-name
    ...
    oci nlb backend\-set get \-\-backend\-set\-name $backend_set_name \-\-network\-load\-balancer\-id $network_load_balancer_id
.ft P
.fi
.UNINDENT
.UNINDENT
