...
.
.TH "DB_VM-CLUSTER_DELETE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_vm-cluster_delete \- 
.
...
.SH DESCRIPTION
.sp
Deletes the specified VM cluster. Applies to Exadata \fI\%Cloud@Customer\fP <\fBCloud@Customer\fP> instances only.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci db vm\-cluster delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci db vm\-cluster delete \-\-vm\-cluster\-id $vm_cluster_id
.ft P
.fi
.UNINDENT
.UNINDENT
