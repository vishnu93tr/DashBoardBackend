...
.
.TH "LOGGING_LOG-GROUP" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
logging_log-group \- 
.
...
.SS Description
.sp
Moves a log group into a different compartment within the same tenancy.  When provided, the If\-Match is checked against the resource ETag values. For information about moving resources between compartments, see \fI\%Moving Resources Between Compartments\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Identity/Tasks/managingcompartments.htm#moveRes\fP>\&.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci logging log\-group change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci logging log\-group change\-compartment \-\-log\-group\-id $log_group_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci logging log\-group create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci logging log\-group create \-\-compartment\-id $compartment_id \-\-display\-name $display_name
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci logging log\-group delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci logging log\-group delete \-\-log\-group\-id $log_group_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci logging log\-group get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-compartmentidinsubtree [boolean]
.UNINDENT
.sp
...
.nf
.ft C
oci logging log\-group update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci logging log\-group update \-\-log\-group\-id $log_group_id
.ft P
.fi
.UNINDENT
.UNINDENT
