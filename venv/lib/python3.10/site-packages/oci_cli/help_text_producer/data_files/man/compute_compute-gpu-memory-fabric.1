...
.
.TH "COMPUTE_COMPUTE-GPU-MEMORY-FABRIC" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
compute_compute-gpu-memory-fabric \- 
.
...
.SS Description
.sp
Moves a compute GPU memory fabric into a different compartment. For information about moving resources between compartments, see \fI\%Moving Resources to a Different Compartment\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Identity/Tasks/managingcompartments.htm#moveRes\fP>\&.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci compute compute\-gpu\-memory\-fabric change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the compartment to move the compute GPU memory fabric to.
.INDENT 0.0
.TP
.B \-\-compute\-gpu\-memory\-fabric\-id [text]
.UNINDENT
.sp
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/compute/compute\-gpu\-memory\-fabric/change\-compartment.html#cmdoption\-compartment\-id
    export compute_gpu_memory_fabric_id=<substitute\-value\-of\-compute_gpu_memory_fabric_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/compute/compute\-gpu\-memory\-fabric/change\-compartment.html#cmdoption\-compute\-gpu\-memory\-fabric\-id

    oci compute compute\-gpu\-memory\-fabric change\-compartment \-\-compartment\-id $compartment_id \-\-compute\-gpu\-memory\-fabric\-id $compute_gpu_memory_fabric_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci compute compute\-gpu\-memory\-fabric get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compute_gpu_memory_fabric_id=<substitute\-value\-of\-compute_gpu_memory_fabric_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/compute/compute\-gpu\-memory\-fabric/get.html#cmdoption\-compute\-gpu\-memory\-fabric\-id

    oci compute compute\-gpu\-memory\-fabric get \-\-compute\-gpu\-memory\-fabric\-id $compute_gpu_memory_fabric_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci compute compute\-gpu\-memory\-fabric list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-compute\-gpu\-memory\-fabric\-health [text]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-compute\-gpu\-memory\-fabric\-lifecycle\-state [text]
.UNINDENT
.sp
...
.nf
.ft C
AVAILABLE, DEGRADED, OCCUPIED, PROVISIONING, UNAVAILABLE
.ft P
.fi
.UNINDENT
.UNINDENT
.INDENT 0.0
.TP
.B \-\-compute\-hpc\-island\-id [text]
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the compute HPC island.
.INDENT 0.0
.TP
.B \-\-compute\-network\-block\-id [text]
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the compute network block.
.INDENT 0.0
.TP
.B \-\-display\-name [text]
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/compute/compute\-gpu\-memory\-fabric/list.html#cmdoption\-compartment\-id
...
.nf
.ft C
oci compute compute\-gpu\-memory\-fabric update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compute_gpu_memory_fabric_id=<substitute\-value\-of\-compute_gpu_memory_fabric_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/compute/compute\-gpu\-memory\-fabric/update.html#cmdoption\-compute\-gpu\-memory\-fabric\-id

    oci compute compute\-gpu\-memory\-fabric update \-\-compute\-gpu\-memory\-fabric\-id $compute_gpu_memory_fabric_id
.ft P
.fi
.UNINDENT
.UNINDENT
