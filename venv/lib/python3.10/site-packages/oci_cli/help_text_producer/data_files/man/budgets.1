...
.
.TH "BUDGETS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
budgets \- 
.
...
.SH DESCRIPTION
.sp
Use the Budgets CLI to manage budgets and budget alerts. For more information, see \fI\%Budgets Overview\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Billing/Concepts/budgetsoverview.htm\fP>\&.
...
.nf
.ft C
oci budgets alert\-rule create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export amount=<substitute\-value\-of\-amount> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/budgets/budget/create.html#cmdoption\-amount
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/budgets/budget/create.html#cmdoption\-compartment\-id
    export reset_period=<substitute\-value\-of\-reset_period> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/budgets/budget/create.html#cmdoption\-reset\-period
    export threshold=<substitute\-value\-of\-threshold> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/budgets/alert\-rule/create.html#cmdoption\-threshold
    export threshold_type=<substitute\-value\-of\-threshold_type> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/budgets/alert\-rule/create.html#cmdoption\-threshold\-type
    export type=<substitute\-value\-of\-type> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/budgets/alert\-rule/create.html#cmdoption\-type

    budget_id=$(oci budgets budget create \-\-amount $amount \-\-compartment\-id $compartment_id \-\-reset\-period $reset_period \-\-query data.id \-\-raw\-output)

    oci budgets alert\-rule create \-\-budget\-id $budget_id \-\-threshold $threshold \-\-threshold\-type $threshold_type \-\-type $type
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci budgets alert\-rule delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    alert_rule_id=$(oci budgets alert\-rule create \-\-budget\-id $budget_id \-\-threshold $threshold \-\-threshold\-type $threshold_type \-\-type $type \-\-query data.id \-\-raw\-output)
...
.nf
.ft C
oci budgets alert\-rule get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci budgets alert\-rule list \-\-budget\-id $budget_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci budgets alert\-rule update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci budgets alert\-rule update \-\-alert\-rule\-id $alert_rule_id \-\-budget\-id $budget_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci budgets budget create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-budget\-processing\-period\-start\-offset [integer]
.UNINDENT
.sp
...
.UNINDENT
.sp
The date when the one\-time budget concludes. For example, \fI2023\-03\-23\fP\&. The date\-time format conforms to RFC 3339, and will be truncated to the starting point of the date provided after being converted to UTC time.
.INDENT 0.0
.INDENT 3.5
...
.INDENT 0.0
.TP
.B \-\-start\-date [datetime]
.UNINDENT
.sp
The date when the one\-time budget begins. For example, \fI2023\-03\-23\fP\&. The date\-time format conforms to RFC 3339, and will be truncated to the starting point of the date provided after being converted to UTC time.
.INDENT 0.0
.INDENT 3.5
The following datetime formats are supported:
.UNINDENT
...
.ft C
    ...
    oci budgets budget create \-\-amount $amount \-\-compartment\-id $compartment_id \-\-reset\-period $reset_period
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci budgets budget delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci budgets budget get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci budgets budget list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/budgets/budget/list.html#cmdoption\-compartment\-id

    oci budgets budget list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci budgets budget update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The time when the one\-time budget concludes. For example, \fI2023\-03\-23\fP\&. The date\-time format conforms to RFC 3339, and will be truncated to the starting point of the date provided after being converted to UTC time.
.INDENT 0.0
.INDENT 3.5
The following datetime formats are supported:
.UNINDENT
...
.ft C
    ...
    oci budgets budget update \-\-budget\-id $budget_id
.ft P
.fi
.UNINDENT
.UNINDENT
