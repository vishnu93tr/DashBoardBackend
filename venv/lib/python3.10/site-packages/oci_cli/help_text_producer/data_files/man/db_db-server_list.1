...
.
.TH "DB_DB-SERVER_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_db-server_list \- 
.
...
.nf
.ft C
AVAILABLE, CREATING, DELETED, DELETING, MAINTENANCE_IN_PROGRESS, UNAVAILABLE
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci db db\-server list \-\-compartment\-id $compartment_id \-\-exadata\-infrastructure\-id $exadata_infrastructure_id
.ft P
.fi
.UNINDENT
.UNINDENT
