...
.
.TH "ARTIFACTS_REPOSITORY_CREATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
artifacts_repository_create \- 
.
...
.nf
.ft C
oci artifacts repository create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci artifacts repository create \-\-compartment\-id $compartment_id \-\-is\-immutable $is_immutable \-\-repository\-type $repository_type
.ft P
.fi
.UNINDENT
.UNINDENT
