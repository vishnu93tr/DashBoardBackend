...
.
.TH "NETWORK-FIREWALL_DECRYPTION-PROFILE_DELETE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network-firewall_decryption-profile_delete \- 
.
...
.nf
.ft C
oci network\-firewall decryption\-profile delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export decryption_profile_name=<substitute\-value\-of\-decryption_profile_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/network\-firewall/decryption\-profile/delete.html#cmdoption\-decryption\-profile\-name
    ...
    oci network\-firewall decryption\-profile delete \-\-decryption\-profile\-name $decryption_profile_name \-\-network\-firewall\-policy\-id $network_firewall_policy_id
.ft P
.fi
.UNINDENT
.UNINDENT
