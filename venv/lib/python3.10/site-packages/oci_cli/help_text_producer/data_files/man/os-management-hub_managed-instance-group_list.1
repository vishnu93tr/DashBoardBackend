...
.
.TH "OS-MANAGEMENT-HUB_MANAGED-INSTANCE-GROUP_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
os-management-hub_managed-instance-group_list \- 
.
...
.SH DESCRIPTION
.sp
Lists managed instance groups that match the specified compartment or managed instance group \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP>\&. Filter the list against a variety of criteria including but not limited to name, status, architecture, and OS family.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the software source. This filter returns resources associated with this software source.
.INDENT 0.0
.TP
.B \-\-sort\-by [text]
.UNINDENT
