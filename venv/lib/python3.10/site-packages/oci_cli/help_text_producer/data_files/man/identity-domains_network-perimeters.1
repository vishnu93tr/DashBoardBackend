...
.
.TH "IDENTITY-DOMAINS_NETWORK-PERIMETERS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_network-perimeters \- 
.
...
.nf
.ft C
oci identity\-domains network\-perimeters list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains network\-perimeters search [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains network\-perimeters search \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains network\-perimeters search \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
