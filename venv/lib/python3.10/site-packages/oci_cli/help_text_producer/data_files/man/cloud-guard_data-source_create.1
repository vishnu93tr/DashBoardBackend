...
.
.TH "CLOUD-GUARD_DATA-SOURCE_CREATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
cloud-guard_data-source_create \- 
.
...
.nf
.ft C
oci cloud\-guard data\-source create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci cloud\-guard data\-source create \-\-compartment\-id $compartment_id \-\-data\-source\-feed\-provider $data_source_feed_provider \-\-display\-name $display_name
.ft P
.fi
.UNINDENT
.UNINDENT
