...
.
.TH "DATABASE-MANAGEMENT_EXTERNAL-ASM-INSTANCE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
database-management_external-asm-instance \- 
.
...
.SS Description
.sp
Gets the details for the external ASM instance specified by \fIexternalAsmInstanceId\fP\&.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci database\-management external\-asm\-instance get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-external\-asm\-instance\-id [text]
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the external ASM instance.
...
.nf
.ft C
    export external_asm_instance_id=<substitute\-value\-of\-external_asm_instance_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/database\-management/external\-asm\-instance/get.html#cmdoption\-external\-asm\-instance\-id

    oci database\-management external\-asm\-instance get \-\-external\-asm\-instance\-id $external_asm_instance_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci database\-management external\-asm\-instance list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci database\-management external\-asm\-instance list
.ft P
.fi
.UNINDENT
.UNINDENT
...
.SS Description
.sp
Updates the external ASM instance specified by \fIexternalAsmInstanceId\fP\&.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci database\-management external\-asm\-instance update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export external_asm_instance_id=<substitute\-value\-of\-external_asm_instance_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/database\-management/external\-asm\-instance/update.html#cmdoption\-external\-asm\-instance\-id

    oci database\-management external\-asm\-instance update \-\-external\-asm\-instance\-id $external_asm_instance_id
.ft P
.fi
.UNINDENT
.UNINDENT
