...
.
.TH "DATA-SAFE_REFERENTIAL-RELATION_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_referential-relation_list \- 
.
...
.nf
.ft C
oci data\-safe referential\-relation list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
key, relationType, schemaName, tableName
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci data\-safe referential\-relation list \-\-sensitive\-data\-model\-id $sensitive_data_model_id
.ft P
.fi
.UNINDENT
.UNINDENT
