...
.
.TH "DB_DATA-GUARD-ASSOCIATION_REINSTATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_data-guard-association_reinstate \- 
.
...
.SH DESCRIPTION
.sp
Reinstates the database identified by the \fIdatabaseId\fP parameter into the standby role in a Data Guard association.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci db data\-guard\-association reinstate [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export data_guard_association_id=<substitute\-value\-of\-data_guard_association_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/db/data\-guard\-association/reinstate.html#cmdoption\-data\-guard\-association\-id
    export database_admin_password=<substitute\-value\-of\-database_admin_password> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/db/data\-guard\-association/reinstate.html#cmdoption\-database\-admin\-password
    ...
    oci db data\-guard\-association reinstate \-\-data\-guard\-association\-id $data_guard_association_id \-\-database\-admin\-password $database_admin_password \-\-database\-id $database_id
.ft P
.fi
.UNINDENT
.UNINDENT
