...
.
.TH "DB_DATABASE_CHANGE-TO-EXTERNAL-HSM-KEY-LOCATION" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_database_change-to-external-hsm-key-location \- 
.
...
.nf
.ft C
oci db database change\-to\-external\-hsm\-key\-location [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export hsm_password=<substitute\-value\-of\-hsm_password> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/db/database/change\-to\-external\-hsm\-key\-location.html#cmdoption\-hsm\-password
    ...
    oci db database change\-to\-external\-hsm\-key\-location \-\-database\-id $database_id \-\-hsm\-password $hsm_password
.ft P
.fi
.UNINDENT
.UNINDENT
