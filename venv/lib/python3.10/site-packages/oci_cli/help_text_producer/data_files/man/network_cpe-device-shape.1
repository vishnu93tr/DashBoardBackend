...
.
.TH "NETWORK_CPE-DEVICE-SHAPE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network_cpe-device-shape \- 
.
...
.SH DESCRIPTION
.sp
A summary of information about a particular CPE device type. Compare with \fI\%CpeDeviceShapeDetail\fP <\fBhttps://docs.cloud.oracle.com/api/#/en/iaas/latest/CpeDeviceShapeDetail/\fP>\&.
...
.SS Description
.sp
Lists the CPE device types that the Networking service provides CPE configuration content for (example: Cisco ASA). The content helps a network engineer configure the actual CPE device represented by a \fI\%Cpe\fP <\fBhttps://docs.cloud.oracle.com/api/#/en/iaas/latest/Cpe/\fP> object.
.sp
If you want to generate CPE configuration content for one of the returned CPE device types, ensure that the \fI\%Cpe\fP <\fBhttps://docs.cloud.oracle.com/api/#/en/iaas/latest/Cpe/\fP> object’s \fIcpeDeviceShapeId\fP attribute is set to the CPE device type’s \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> (returned by this operation).
.sp
...
.nf
.ft C
oci network cpe\-device\-shape list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
