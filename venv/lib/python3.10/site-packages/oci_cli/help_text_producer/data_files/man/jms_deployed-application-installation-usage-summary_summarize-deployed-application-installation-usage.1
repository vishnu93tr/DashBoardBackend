...
.
.TH "JMS_DEPLOYED-APPLICATION-INSTALLATION-USAGE-SUMMARY_SUMMARIZE-DEPLOYED-APPLICATION-INSTALLATION-USAGE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
jms_deployed-application-installation-usage-summary_summarize-deployed-application-installation-usage \- 
.
...
.nf
.ft C
oci jms deployed\-application\-installation\-usage\-summary summarize\-deployed\-application\-installation\-usage [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-application\-name\-contains [text]
.UNINDENT
.sp
Filter the list with deployed application name contains the given value.
.INDENT 0.0
.TP
.B \-\-application\-source\-path\-contains [text]
.UNINDENT
.sp
...
.UNINDENT
.sp
The field to sort the deployed application installations. Only one sort order can be provided. If no value is specified _timeLastSeen_ is default.
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
...
.nf
.ft C
applicationName, applicationSourcePath, applicationType, approximateJavaServerInstanceCount, approximateLibraryCount, isClustered, javaServerInstanceCount, timeFirstSeen, timeLastSeen
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci jms deployed\-application\-installation\-usage\-summary summarize\-deployed\-application\-installation\-usage \-\-fleet\-id $fleet_id
.ft P
.fi
.UNINDENT
.UNINDENT
