...
.
.TH "COMPUTE_VOLUME-ATTACHMENT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
compute_volume-attachment \- 
.
...
.SH DESCRIPTION
.sp
A base object for all types of attachments between a storage volume and an instance. For specific details about iSCSI attachments, see \fI\%IScsiVolumeAttachment Reference\fP <\fBhttps://docs.cloud.oracle.com/api/#/en/iaas/latest/IScsiVolumeAttachment/\fP>\&.
.sp
For general information about volume attachments, see \fI\%Overview of Block Volume Storage\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Block/Concepts/overview.htm\fP>\&.
.sp
...
.UNINDENT
.UNINDENT
.SS \fBattach\-paravirtualized\-volume\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.sp
This is an asynchronous operation. The attachment’s \fIlifecycleState\fP will change to DETACHING temporarily until the attachment is completely removed.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci compute volume\-attachment detach [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export volume_attachment_id=<substitute\-value\-of\-volume_attachment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/compute/volume\-attachment/detach.html#cmdoption\-volume\-attachment\-id
...
.nf
.ft C
oci compute volume\-attachment get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export volume_attachment_id=<substitute\-value\-of\-volume_attachment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/compute/volume\-attachment/get.html#cmdoption\-volume\-attachment\-id

    oci compute volume\-attachment get \-\-volume\-attachment\-id $volume_attachment_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.sp
Currently, the only supported volume attachment type are \fI\%IScsiVolumeAttachment\fP <\fBhttps://docs.cloud.oracle.com/api/#/en/iaas/latest/IScsiVolumeAttachment/\fP> and \fI\%ParavirtualizedVolumeAttachment\fP <\fBhttps://docs.cloud.oracle.com/api/#/en/iaas/latest/ParavirtualizedVolumeAttachment/\fP>\&.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
...
.UNINDENT
.sp
The OCID of the instance. If –compartment\-id is not provided, then –instance\-id must be provided.
.INDENT 0.0
.TP
.B \-\-limit [integer]
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/compute/volume\-attachment/list.html#cmdoption\-compartment\-id
...
.nf
.ft C
oci compute volume\-attachment update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
LOGGING_IN, LOGGING_OUT, LOGIN_FAILED, LOGIN_SUCCEEDED, LOGOUT_FAILED, LOGOUT_SUCCEEDED, UNKNOWN
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export volume_attachment_id=<substitute\-value\-of\-volume_attachment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/compute/volume\-attachment/update.html#cmdoption\-volume\-attachment\-id

    oci compute volume\-attachment update \-\-volume\-attachment\-id $volume_attachment_id
.ft P
.fi
.UNINDENT
.UNINDENT
