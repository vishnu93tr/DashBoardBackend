...
.
.TH "DATA-INTEGRATION_COMPOSITE-STATE_GET" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-integration_composite-state_get \- 
.
...
.nf
.ft C
oci data\-integration composite\-state get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export aggregator_key=<substitute\-value\-of\-aggregator_key> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/composite\-state/get.html#cmdoption\-aggregator\-key
    export application_key=<substitute\-value\-of\-application_key> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/composite\-state/get.html#cmdoption\-application\-key
    ...
    oci data\-integration composite\-state get \-\-aggregator\-key $aggregator_key \-\-application\-key $application_key \-\-workspace\-id $workspace_id
.ft P
.fi
.UNINDENT
.UNINDENT
