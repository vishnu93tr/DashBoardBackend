...
.
.TH "DB_AUTONOMOUS-DATABASE_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_autonomous-database_list \- 
.
...
.UNINDENT
.sp
Filter on the value of the resource’s ‘isFreeTier’ property. A value of \fItrue\fP returns only Always Free resources. A value of \fIfalse\fP excludes Always Free resources from the returned results. Omitting this parameter returns both Always Free and paid resources.
.INDENT 0.0
.TP
.B \-\-is\-refreshable\-clone [boolean]
.UNINDENT
.sp
Filter on the value of the resource’s ‘isRefreshableClone’ property. A value of \fItrue\fP returns only refreshable clones. A value of \fIfalse\fP excludes refreshable clones from the returned results. Omitting this parameter returns both refreshable clones and databases that are not refreshable clones.
.INDENT 0.0
.TP
.B \-\-is\-resource\-pool\-leader [boolean]
.UNINDENT
.sp
Filter if the resource is the resource pool leader. A value of \fItrue\fP returns only resource pool leader.
.INDENT 0.0
.TP
...
.INDENT 0.0
.TP
.B \-\-lifecycle\-state\-not\-equal\-to [text]
.UNINDENT
.sp
...
.UNINDENT
.sp
The database \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the resourcepool Leader Autonomous Database.
.INDENT 0.0
.TP
.B \-\-sort\-by [text]
.UNINDENT
