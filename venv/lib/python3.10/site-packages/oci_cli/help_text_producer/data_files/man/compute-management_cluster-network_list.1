...
.
.TH "COMPUTE-MANAGEMENT_CLUSTER-NETWORK_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
compute-management_cluster-network_list \- 
.
...
.SH DESCRIPTION
.sp
Lists the \fI\%cluster networks with instance pools\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Compute/Tasks/managingclusternetworks.htm\fP> in the specified compartment.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci compute\-management cluster\-network list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/compute\-management/cluster\-network/list.html#cmdoption\-compartment\-id

    oci compute\-management cluster\-network list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
