...
.
.TH "DATABASE-MANAGEMENT_EXTERNAL-DB-SYSTEM_GET" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
database-management_external-db-system_get \- 
.
...
.SH DESCRIPTION
.sp
Gets the details for the external DB system specified by \fIexternalDbSystemId\fP\&.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci database\-management external\-db\-system get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci database\-management external\-db\-system get \-\-external\-db\-system\-id $external_db_system_id
.ft P
.fi
.UNINDENT
.UNINDENT
