...
.
.TH "DB_SCHEDULING-POLICY" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_scheduling-policy \- 
.
...
.nf
.ft C
oci db scheduling\-policy change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci db scheduling\-policy change\-compartment \-\-compartment\-id $compartment_id \-\-scheduling\-policy\-id $scheduling_policy_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci db scheduling\-policy create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-cadence\-start\-month [complex type]
.UNINDENT
.sp
...
.ft C
    ...
    oci db scheduling\-policy create \-\-cadence $cadence \-\-compartment\-id $compartment_id \-\-display\-name $display_name
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci db scheduling\-policy delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci db scheduling\-policy delete \-\-scheduling\-policy\-id $scheduling_policy_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci db scheduling\-policy get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci db scheduling\-policy get \-\-scheduling\-policy\-id $scheduling_policy_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci db scheduling\-policy update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci db scheduling\-policy update \-\-scheduling\-policy\-id $scheduling_policy_id
.ft P
.fi
.UNINDENT
.UNINDENT
