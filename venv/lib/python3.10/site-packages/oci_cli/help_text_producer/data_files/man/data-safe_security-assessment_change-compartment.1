...
.
.TH "DATA-SAFE_SECURITY-ASSESSMENT_CHANGE-COMPARTMENT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_security-assessment_change-compartment \- 
.
...
.nf
.ft C
oci data\-safe security\-assessment change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci data\-safe security\-assessment change\-compartment \-\-compartment\-id $compartment_id \-\-security\-assessment\-id $security_assessment_id
.ft P
.fi
.UNINDENT
.UNINDENT
