...
.
.TH "NETWORK-FIREWALL_SECURITY-RULE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network-firewall_security-rule \- 
.
...
.nf
.ft C
oci network\-firewall security\-rule bulk\-upload [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-bulk\-upload\-security\-rules\-details [complex type]
.UNINDENT
.sp
Request Details to bulk import the security rules for the Network Firewall Policy resource.
.INDENT 0.0
.TP
...
.nf
.ft C
    oci network\-firewall security\-rule bulk\-upload \-\-generate\-param\-json\-input bulk\-upload\-security\-rules\-details > bulk\-upload\-security\-rules\-details.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci network\-firewall security\-rule bulk\-upload \-\-bulk\-upload\-security\-rules\-details file://bulk\-upload\-security\-rules\-details.json \-\-network\-firewall\-policy\-id $network_firewall_policy_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci network\-firewall security\-rule create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.IP \(bu 2
ALLOW \- Allows the traffic.   * DROP \- Silently drops the traffic, e.g. without sending a TCP reset.   * REJECT \- Rejects the traffic, sending a TCP reset to client and/or server as applicable.   * INSPECT \- Inspects traffic for vulnerability as specified in \fIinspection\fP, which may result in rejection.
.UNINDENT
.sp
Accepted values are:
.INDENT 0.0
...
.INDENT 0.0
.IP \(bu 2
INTRUSION_DETECTION \- Intrusion Detection.   * INTRUSION_PREVENTION \- Intrusion Detection and Prevention. Traffic classified as potentially malicious will be rejected as described in \fItype\fP\&.
.UNINDENT
.sp
Accepted values are:
.INDENT 0.0
...
.nf
.ft C
oci network\-firewall security\-rule delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/network\-firewall/network\-firewall\-policy/create.html#cmdoption\-compartment\-id
    export security_rule_name=<substitute\-value\-of\-security_rule_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/network\-firewall/security\-rule/delete.html#cmdoption\-security\-rule\-name

    network_firewall_policy_id=$(oci network\-firewall network\-firewall\-policy create \-\-compartment\-id $compartment_id \-\-query data.id \-\-raw\-output)

    oci network\-firewall security\-rule delete \-\-network\-firewall\-policy\-id $network_firewall_policy_id \-\-security\-rule\-name $security_rule_name
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci network\-firewall security\-rule get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/network\-firewall/network\-firewall\-policy/create.html#cmdoption\-compartment\-id
    export security_rule_name=<substitute\-value\-of\-security_rule_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/network\-firewall/security\-rule/get.html#cmdoption\-security\-rule\-name

    network_firewall_policy_id=$(oci network\-firewall network\-firewall\-policy create \-\-compartment\-id $compartment_id \-\-query data.id \-\-raw\-output)

    oci network\-firewall security\-rule get \-\-network\-firewall\-policy\-id $network_firewall_policy_id \-\-security\-rule\-name $security_rule_name
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci network\-firewall security\-rule list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-security\-rule\-priority\-order [integer]
.UNINDENT
.sp
...
.ft C
    ...
    oci network\-firewall security\-rule list \-\-network\-firewall\-policy\-id $network_firewall_policy_id
.ft P
.fi
.UNINDENT
.UNINDENT
