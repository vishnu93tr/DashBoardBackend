...
.
.TH "DATA-SAFE_DISCOVERY-JOB_CHANGE-COMPARTMENT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_discovery-job_change-compartment \- 
.
...
.nf
.ft C
oci data\-safe discovery\-job change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci data\-safe discovery\-job change\-compartment \-\-compartment\-id $compartment_id \-\-discovery\-job\-id $discovery_job_id
.ft P
.fi
.UNINDENT
.UNINDENT
