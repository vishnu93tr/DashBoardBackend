...
.
.TH "IDENTITY-DOMAINS_API-KEYS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_api-keys \- 
.
...
.nf
.ft C
oci identity\-domains api\-keys list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains api\-keys list
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains api\-keys search [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains api\-keys search \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains api\-keys search \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
