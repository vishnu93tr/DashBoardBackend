...
.
.TH "DB_DATABASE_FAILOVER-DATA-GUARD" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_database_failover-data-guard \- 
.
...
.SH DESCRIPTION
.sp
Performs a failover to transition the standby database identified by the \fIdatabaseId\fP path parameter into the primary role after the existing primary database fails or becomes unreachable.
.sp
...
.nf
.ft C
oci db database failover\-data\-guard [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export database_admin_password=<substitute\-value\-of\-database_admin_password> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/db/database/failover\-data\-guard.html#cmdoption\-database\-admin\-password
    ...
    oci db database failover\-data\-guard \-\-database\-admin\-password $database_admin_password \-\-database\-id $database_id
.ft P
.fi
.UNINDENT
.UNINDENT
