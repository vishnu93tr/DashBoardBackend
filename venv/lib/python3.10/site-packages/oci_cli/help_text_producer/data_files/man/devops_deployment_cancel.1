...
.
.TH "DEVOPS_DEPLOYMENT_CANCEL" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
...
.nf
.ft C
oci devops deployment cancel [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export deployment_id=<substitute\-value\-of\-deployment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/devops/deployment/cancel.html#cmdoption\-deployment\-id
    export reason=<substitute\-value\-of\-reason> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/devops/deployment/cancel.html#cmdoption\-reason

    oci devops deployment cancel \-\-deployment\-id $deployment_id \-\-reason $reason
.ft P
.fi
.UNINDENT
.UNINDENT
