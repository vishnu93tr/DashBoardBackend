...
.
.TH "DATABASE-MANAGEMENT_EXTERNAL-DB-NODE_UPDATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
database-management_external-db-node_update \- 
.
...
.SH DESCRIPTION
.sp
Updates the external DB node specified by \fIexternalDbNodeId\fP\&.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci database\-management external\-db\-node update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export external_db_node_id=<substitute\-value\-of\-external_db_node_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/database\-management/external\-db\-node/update.html#cmdoption\-external\-db\-node\-id

    oci database\-management external\-db\-node update \-\-external\-db\-node\-id $external_db_node_id
.ft P
.fi
.UNINDENT
.UNINDENT
