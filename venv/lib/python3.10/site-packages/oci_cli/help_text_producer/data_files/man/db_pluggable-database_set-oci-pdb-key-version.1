...
.
.TH "DB_PLUGGABLE-DATABASE_SET-OCI-PDB-KEY-VERSION" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_pluggable-database_set-oci-pdb-key-version \- 
.
...
.SH DESCRIPTION
.sp
Sets a new version of an existing \fI\%Vault service\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/KeyManagement/Concepts/keyoverview.htm\fP> key.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci db pluggable\-database set\-oci\-pdb\-key\-version [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export kms_key_version_id=<substitute\-value\-of\-kms_key_version_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/db/pluggable\-database/set\-oci\-pdb\-key\-version.html#cmdoption\-kms\-key\-version\-id
    ...
    oci db pluggable\-database set\-oci\-pdb\-key\-version \-\-kms\-key\-version\-id $kms_key_version_id \-\-pluggable\-database\-id $pluggable_database_id
.ft P
.fi
.UNINDENT
.UNINDENT
