...
.
.TH "DEVOPS_DEPLOY-ENVIRONMENT_UPDATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
devops_deploy-environment_update \- 
.
...
.nf
.ft C
oci devops deploy\-environment update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export environment_id=<substitute\-value\-of\-environment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/devops/deploy\-environment/update.html#cmdoption\-environment\-id

    oci devops deploy\-environment update \-\-environment\-id $environment_id
.ft P
.fi
.UNINDENT
.UNINDENT
