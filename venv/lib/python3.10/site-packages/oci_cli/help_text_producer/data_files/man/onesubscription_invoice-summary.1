...
.
.TH "ONESUBSCRIPTION_INVOICE-SUMMARY" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
onesubscription_invoice-summary \- 
.
...
.nf
.ft C
oci onesubscription invoice\-summary invoice list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-ar\-customer\-transaction\-id [text]
.UNINDENT
.sp
...
.nf
.ft C
    export ar_customer_transaction_id=<substitute\-value\-of\-ar_customer_transaction_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/onesubscription/invoice\-summary/invoice/list.html#cmdoption\-ar\-customer\-transaction\-id
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/onesubscription/invoice\-summary/invoice/list.html#cmdoption\-compartment\-id

    oci onesubscription invoice\-summary invoice list \-\-ar\-customer\-transaction\-id $ar_customer_transaction_id \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
.SS invoiceline\-computed\-usage
.SS Description
.sp
...
.nf
.ft C
oci onesubscription invoice\-summary invoiceline\-computed\-usage list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The field to sort by Invoiced Computed Usages. You can provide one sort order (\fIsortOrder\fP).
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
