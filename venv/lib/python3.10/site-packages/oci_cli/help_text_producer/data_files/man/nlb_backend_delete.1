...
.
.TH "NLB_BACKEND_DELETE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
nlb_backend_delete \- 
.
...
.ft C
    ...
    export backend_name=<substitute\-value\-of\-backend_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/nlb/backend/delete.html#cmdoption\-backend\-name
    export backend_set_name=<substitute\-value\-of\-backend_set_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/nlb/backend/delete.html#cmdoption\-backend\-set\-name
    ...
    oci nlb backend delete \-\-backend\-name $backend_name \-\-backend\-set\-name $backend_set_name \-\-network\-load\-balancer\-id $network_load_balancer_id
.ft P
.fi
.UNINDENT
.UNINDENT
