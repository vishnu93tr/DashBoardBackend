...
.
.TH "LOG-ANALYTICS_INGEST-TIME-RULE_CHANGE-COMPARTMENT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
log-analytics_ingest-time-rule_change-compartment \- 
.
...
.nf
.ft C
oci log\-analytics ingest\-time\-rule change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci log\-analytics ingest\-time\-rule change\-compartment \-\-compartment\-id $compartment_id \-\-ingest\-time\-rule\-id $ingest_time_rule_id \-\-namespace\-name $namespace_name
.ft P
.fi
.UNINDENT
.UNINDENT
