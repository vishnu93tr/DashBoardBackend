...
.
.TH "DEVOPS_TRIGGER_CREATE-VBS-TRIGGER" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
devops_trigger_create-vbs-trigger \- 
.
...
.nf
.ft C
oci devops trigger create\-vbs\-trigger [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci devops trigger create\-vbs\-trigger \-\-generate\-param\-json\-input actions > actions.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci devops trigger create\-vbs\-trigger \-\-actions file://actions.json \-\-project\-id $project_id
.ft P
.fi
.UNINDENT
.UNINDENT
