...
.
.TH "OPSI_EXADATA-INSIGHTS_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
opsi_exadata-insights_list \- 
.
...
.UNINDENT
.sp
Exadata insight list sort options. If \fIfields\fP parameter is selected, the \fIsortBy\fP parameter must be one of the fields specified. Default order for timeCreated is descending. Default order for exadataName is ascending. If no value is specified timeCreated is default.
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
