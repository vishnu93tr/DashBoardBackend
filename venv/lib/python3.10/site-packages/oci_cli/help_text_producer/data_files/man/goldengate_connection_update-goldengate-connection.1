...
.
.TH "GOLDENGATE_CONNECTION_UPDATE-GOLDENGATE-CONNECTION" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
goldengate_connection_update-goldengate-connection \- 
.
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the deployment being referenced.
.INDENT 0.0
.TP
.B \-\-description [text]
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the Secret where the password is stored, which is used to connect to the Oracle GoldenGate accessed trough this connection. Note: When provided, ‘password’ field must not be provided.
.INDENT 0.0
.TP
.B \-\-port [integer]
.UNINDENT
