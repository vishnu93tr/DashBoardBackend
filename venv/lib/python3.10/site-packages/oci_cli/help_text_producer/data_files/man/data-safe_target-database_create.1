...
.
.TH "DATA-SAFE_TARGET-DATABASE_CREATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_target-database_create \- 
.
...
.nf
.ft C
oci data\-safe target\-database create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-connection\-option [complex type]
.UNINDENT
.sp
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
...
.INDENT 0.0
.TP
.B \-\-peer\-target\-database\-details [complex type]
.UNINDENT
.sp
The details of the database to be registered as a peer target database.
.sp
This option is a JSON list with items of type CreatePeerTargetDatabaseDetails.  For documentation on CreatePeerTargetDatabaseDetails please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/datasafe/20181201/datatypes/CreatePeerTargetDatabaseDetails\fP\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
.ft C
    ...
    oci data\-safe target\-database create \-\-compartment\-id $compartment_id \-\-database\-details file://database\-details.json
.ft P
.fi
.UNINDENT
.UNINDENT
