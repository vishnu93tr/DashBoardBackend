...
.
.TH "DNS_ZONE_STAGE-ZONE-DNSSEC-KEY-VERSION" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
dns_zone_stage-zone-dnssec-key-version \- 
.
...
.SH DESCRIPTION
.sp
Stages a new \fIDnssecKeyVersion\fP on the zone. Staging is a process that generates a new “successor” key version that replaces an existing “predecessor” key version. \fBNote:\fP A new key\-signing key (KSK) version is inert until you update the parent zone DS records.
.sp
For more information, see the \fI\%DNSSEC\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/DNS/Concepts/dnssec.htm\fP> documentation.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci dns zone stage\-zone\-dnssec\-key\-version [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-predecessor\-dnssec\-key\-version\-uuid [text]
.UNINDENT
.sp
The UUID of the \fIDnssecKeyVersion\fP for which a new successor should be generated.
.INDENT 0.0
.TP
.B \-\-zone\-id [text]
.UNINDENT
