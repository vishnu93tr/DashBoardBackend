...
.
.TH "CE_CLUSTER_REBOOT-CLUSTER-NODE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
ce_cluster_reboot-cluster-node \- 
.
...
.nf
.ft C
oci ce cluster reboot\-cluster\-node [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export node_id=<substitute\-value\-of\-node_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/ce/cluster/reboot\-cluster\-node.html#cmdoption\-node\-id
    ...
    oci ce cluster reboot\-cluster\-node \-\-cluster\-id $cluster_id \-\-node\-id $node_id
.ft P
.fi
.UNINDENT
.UNINDENT
