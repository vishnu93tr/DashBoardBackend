...
.
.TH "DATA-INTEGRATION_RUNTIME-PIPELINES_LIST-RUNTIME-PIPELINES" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-integration_runtime-pipelines_list-runtime-pipelines \- 
.
...
.nf
.ft C
oci data\-integration runtime\-pipelines list\-runtime\-pipelines [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export application_key=<substitute\-value\-of\-application_key> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/runtime\-pipelines/list\-runtime\-pipelines.html#cmdoption\-application\-key
    ...
    oci data\-integration runtime\-pipelines list\-runtime\-pipelines \-\-application\-key $application_key \-\-workspace\-id $workspace_id
.ft P
.fi
.UNINDENT
.UNINDENT
