...
.
.TH "COMPUTE-MANAGEMENT_INSTANCE-CONFIGURATION_LAUNCH-COMPUTE-INSTANCE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
compute-management_instance-configuration_launch-compute-instance \- 
.
...
.sp
If the instance configuration does not include all of the parameters that are required to create an instance, such as the availability domain and subnet ID, you must provide these parameters when you create an instance from the instance configuration. For more information, see the \fI\%InstanceConfiguration\fP <\fBhttps://docs.cloud.oracle.com/api/#/en/iaas/latest/InstanceConfiguration/\fP> resource.
.sp
...
.INDENT 0.0
.TP
.B \-\-secondary\-vnics [complex type]
.UNINDENT
.sp
