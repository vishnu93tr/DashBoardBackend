...
.
.TH "OS_PRIVATE-ENDPOINT_UPDATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
os_private-endpoint_update \- 
.
...
.sp
Use UpdatePrivateEndpoint to move a Private Endpoint from one compartment to another within the same tenancy. Supply the compartmentID of the compartment that you want to move the Private Endpoint to. Or use it to update the name, subnetId, endpointFqdn or privateEndpointIp or accessTargets of the Private Endpoint. For more information about moving resources between compartments, see \fI\%Moving Resources to a Different Compartment\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Identity/Tasks/managingcompartments.htm#moveRes\fP>\&.
.sp
...
.UNINDENT
.sp
The name of the private endpoint. Avoid entering confidential information. Example: \fImy\-new\-pe\-1\fP
...
.sp
This option is a JSON list with items of type AccessTargetDetails.  For documentation on AccessTargetDetails please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/objectstorage/20160918/datatypes/AccessTargetDetails\fP\&.
