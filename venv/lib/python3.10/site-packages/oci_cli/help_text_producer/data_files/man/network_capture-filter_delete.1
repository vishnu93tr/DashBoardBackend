...
.
.TH "NETWORK_CAPTURE-FILTER_DELETE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network_capture-filter_delete \- 
.
...
.SH DESCRIPTION
.sp
Deletes the specified VTAP capture filter. This is an asynchronous operation. The VTAP capture filter’s \fIlifecycleState\fP will change to TERMINATING temporarily until the VTAP capture filter is completely removed.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci network capture\-filter delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci network capture\-filter delete \-\-capture\-filter\-id $capture_filter_id
.ft P
.fi
.UNINDENT
.UNINDENT
