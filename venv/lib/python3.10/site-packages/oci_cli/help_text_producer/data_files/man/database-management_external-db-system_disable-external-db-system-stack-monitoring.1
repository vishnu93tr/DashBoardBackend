...
.
.TH "DATABASE-MANAGEMENT_EXTERNAL-DB-SYSTEM_DISABLE-EXTERNAL-DB-SYSTEM-STACK-MONITORING" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
database-management_external-db-system_disable-external-db-system-stack-monitoring \- 
.
...
.nf
.ft C
oci database\-management external\-db\-system disable\-external\-db\-system\-stack\-monitoring [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci database\-management external\-db\-system disable\-external\-db\-system\-stack\-monitoring \-\-external\-db\-system\-id $external_db_system_id
.ft P
.fi
.UNINDENT
.UNINDENT
