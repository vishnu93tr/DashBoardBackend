...
.
.TH "OS-MANAGEMENT-HUB_MANAGED-INSTANCE-GROUP_CREATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
os-management-hub_managed-instance-group_create \- 
.
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the compartment that contains the managed instance group.
.INDENT 0.0
.TP
.B \-\-display\-name [text]
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-autonomous\-settings [complex type]
.UNINDENT
.sp
...
.UNINDENT
.sp
The list of managed instance \fI\%OCIDs\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> to be added to the group.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> for the Oracle Notifications service (ONS) topic. ONS is the channel used to send notifications to the customer.
.INDENT 0.0
.TP
.B \-\-software\-source\-ids [complex type]
.UNINDENT
.sp
The list of software source \fI\%OCIDs\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> available to the managed instances in the group.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
