...
.
.TH "LOG-ANALYTICS_STORAGE_LIST-STORAGE-WORK-REQUESTS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
log-analytics_storage_list-storage-work-requests \- 
.
...
.nf
.ft C
ARCHIVE_STORAGE_DATA, CLEANUP_ARCHIVAL_STORAGE_DATA, ENCRYPT_ACTIVE_DATA, ENCRYPT_ARCHIVAL_DATA, OFFBOARD_TENANCY, PURGE_ARCHIVAL_DATA, PURGE_STORAGE_DATA, RECALL_ARCHIVED_STORAGE_DATA, RELEASE_RECALLED_STORAGE_DATA
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/log\-analytics/storage/list\-storage\-work\-requests.html#cmdoption\-compartment\-id
    export namespace_name=<substitute\-value\-of\-namespace_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/log\-analytics/storage/list\-storage\-work\-requests.html#cmdoption\-namespace\-name
