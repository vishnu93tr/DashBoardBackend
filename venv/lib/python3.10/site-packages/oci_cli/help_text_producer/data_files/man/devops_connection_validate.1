...
.
.TH "DEVOPS_CONNECTION_VALIDATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
...
.nf
.ft C
oci devops connection validate [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export connection_id=<substitute\-value\-of\-connection_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/devops/connection/validate.html#cmdoption\-connection\-id

    oci devops connection validate \-\-connection\-id $connection_id
.ft P
.fi
.UNINDENT
.UNINDENT
