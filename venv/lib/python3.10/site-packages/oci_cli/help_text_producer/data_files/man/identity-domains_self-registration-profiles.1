...
.
.TH "IDENTITY-DOMAINS_SELF-REGISTRATION-PROFILES" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_self-registration-profiles \- 
.
...
.nf
.ft C
oci identity\-domains self\-registration\-profiles list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains self\-registration\-profiles search [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains self\-registration\-profiles search \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains self\-registration\-profiles search \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
