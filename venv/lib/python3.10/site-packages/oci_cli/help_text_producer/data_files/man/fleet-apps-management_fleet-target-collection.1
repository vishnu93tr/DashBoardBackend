...
.
.TH "FLEET-APPS-MANAGEMENT_FLEET-TARGET-COLLECTION" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
fleet-apps-management_fleet-target-collection \- 
.
...
.ft C
    ...
    oci fleet\-apps\-management fleet\-target\-collection list\-fleet\-targets \-\-fleet\-id $fleet_id
.ft P
.fi
.UNINDENT
.UNINDENT
.SS \fBlist\-targets\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.ft C
    ...
    oci fleet\-apps\-management fleet\-target\-collection list\-targets \-\-fleet\-id $fleet_id
.ft P
.fi
.UNINDENT
.UNINDENT
