...
.
.TH "ANALYTICS_WORK-REQUEST-ERROR" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
analytics_work-request-error \- 
.
...
.nf
.ft C
    export work_request_id=<substitute\-value\-of\-work_request_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/analytics/work\-request\-error/list.html#cmdoption\-work\-request\-id

    oci analytics work\-request\-error list \-\-work\-request\-id $work_request_id
.ft P
.fi
.UNINDENT
.UNINDENT
