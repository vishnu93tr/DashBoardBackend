...
.
.TH "THREAT-INTELLIGENCE_INDICATOR-SUMMARIES_LIST-INDICATORS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
threat-intelligence_indicator-summaries_list-indicators \- 
.
...
.nf
.ft C
oci threat\-intelligence indicator\-summaries list\-indicators [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/threat\-intelligence/indicator\-summaries/list\-indicators.html#cmdoption\-compartment\-id

    oci threat\-intelligence indicator\-summaries list\-indicators \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
