...
.
.TH "MEDIA-SERVICES_STREAM-CDN-CONFIG_DELETE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
media-services_stream-cdn-config_delete \- 
.
...
.nf
.ft C
oci media\-services stream\-cdn\-config delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export stream_cdn_config_id=<substitute\-value\-of\-stream_cdn_config_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/media\-services/stream\-cdn\-config/delete.html#cmdoption\-stream\-cdn\-config\-id

    oci media\-services stream\-cdn\-config delete \-\-stream\-cdn\-config\-id $stream_cdn_config_id
.ft P
.fi
.UNINDENT
.UNINDENT
