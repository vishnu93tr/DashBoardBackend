...
.
.TH "DATA-SAFE_SENSITIVE-DATA-MODEL_APPLY-DISCOVERY-JOB-RESULTS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_sensitive-data-model_apply-discovery-job-results \- 
.
...
.nf
.ft C
oci data\-safe sensitive\-data\-model apply\-discovery\-job\-results [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci data\-safe sensitive\-data\-model apply\-discovery\-job\-results \-\-discovery\-job\-id $discovery_job_id \-\-sensitive\-data\-model\-id $sensitive_data_model_id
.ft P
.fi
.UNINDENT
.UNINDENT
