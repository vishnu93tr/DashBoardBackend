...
.
.TH "DISASTER-RECOVERY_DR-PROTECTION-GROUP_UPDATE-ROLE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
disaster-recovery_dr-protection-group_update-role \- 
.
...
.SH DESCRIPTION
.sp
Update the role of the DR protection group identified by \fIdrProtectionGroupId\fP\&.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci disaster\-recovery dr\-protection\-group update\-role [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export role=<substitute\-value\-of\-role> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/disaster\-recovery/dr\-protection\-group/update\-role.html#cmdoption\-role
    ...
    oci disaster\-recovery dr\-protection\-group update\-role \-\-dr\-protection\-group\-id $dr_protection_group_id \-\-role $role
.ft P
.fi
.UNINDENT
.UNINDENT
