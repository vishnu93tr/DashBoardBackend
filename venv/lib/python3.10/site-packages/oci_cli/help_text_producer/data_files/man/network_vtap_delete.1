...
.
.TH "NETWORK_VTAP_DELETE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network_vtap_delete \- 
.
...
.SH DESCRIPTION
.sp
Deletes the specified VTAP. This is an asynchronous operation. The VTAP’s \fIlifecycleState\fP will change to TERMINATING temporarily until the VTAP is completely removed.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci network vtap delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci network vtap delete \-\-vtap\-id $vtap_id
.ft P
.fi
.UNINDENT
.UNINDENT
