...
.
.TH "ROVER_STANDALONE-CLUSTER_DELETE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
rover_standalone-cluster_delete \- 
.
...
.nf
.ft C
oci rover standalone\-cluster delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export cluster_id=<substitute\-value\-of\-cluster_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/rover/standalone\-cluster/delete.html#cmdoption\-cluster\-id

    oci rover standalone\-cluster delete \-\-cluster\-id $cluster_id
.ft P
.fi
.UNINDENT
.UNINDENT
