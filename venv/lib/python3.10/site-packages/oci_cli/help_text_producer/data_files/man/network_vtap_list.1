...
.
.TH "NETWORK_VTAP_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network_vtap_list \- 
.
...
.INDENT 0.0
.IP \(bu 2
When \fIFALSE\fP, lists ALL running and stopped VTAPs. * When \fITRUE\fP, lists only running VTAPs (VTAPs where isVtapEnabled = \fITRUE\fP).
.UNINDENT
.INDENT 0.0
.TP
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the VTAP source.
.INDENT 0.0
.TP
.B \-\-target\-id [text]
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the VTAP target.
.INDENT 0.0
.TP
.B \-\-target\-ip [text]
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/network/vtap/list.html#cmdoption\-compartment\-id

    oci network vtap list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
