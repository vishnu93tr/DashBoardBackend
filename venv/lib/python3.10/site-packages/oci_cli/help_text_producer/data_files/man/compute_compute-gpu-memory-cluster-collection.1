...
.
.TH "COMPUTE_COMPUTE-GPU-MEMORY-CLUSTER-COLLECTION" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
compute_compute-gpu-memory-cluster-collection \- 
.
...
.INDENT 0.0
.IP \(bu 2
list\-compute\-gpu\-memory\-clusters
.UNINDENT
.SS \fBlist\-compute\-gpu\-memory\-clusters\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.nf
.ft C
oci compute compute\-gpu\-memory\-cluster\-collection list\-compute\-gpu\-memory\-clusters [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/compute/compute\-gpu\-memory\-cluster\-collection/list\-compute\-gpu\-memory\-clusters.html#cmdoption\-compartment\-id

    oci compute compute\-gpu\-memory\-cluster\-collection list\-compute\-gpu\-memory\-clusters \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
