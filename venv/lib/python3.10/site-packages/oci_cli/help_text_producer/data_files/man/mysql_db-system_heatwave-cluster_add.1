...
.
.TH "MYSQL_DB-SYSTEM_HEATWAVE-CLUSTER_ADD" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
mysql_db-system_heatwave-cluster_add \- 
.
...
.nf
.ft C
oci mysql db\-system heatwave\-cluster add [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-is\-lakehouse\-enabled [boolean]
.UNINDENT
.sp
...
.ft C
    ...
    export cluster_size=<substitute\-value\-of\-cluster_size> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/mysql/db\-system/heatwave\-cluster/add.html#cmdoption\-cluster\-size
    ...
    oci mysql db\-system heatwave\-cluster add \-\-cluster\-size $cluster_size \-\-db\-system\-id $db_system_id \-\-shape\-name $shape_name
.ft P
.fi
.UNINDENT
.UNINDENT
