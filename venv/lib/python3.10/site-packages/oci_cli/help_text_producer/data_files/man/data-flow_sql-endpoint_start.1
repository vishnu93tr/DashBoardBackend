...
.
.TH "DATA-FLOW_SQL-ENDPOINT_START" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-flow_sql-endpoint_start \- 
.
...
.SH DESCRIPTION
.sp
Starts the SqlEndpoint for a given \fISqlEndpointId\fP\&. When provided, If\-Match is checked against ETag values of the resource.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci data\-flow sql\-endpoint start [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci data\-flow sql\-endpoint start \-\-sql\-endpoint\-id $sql_endpoint_id
.ft P
.fi
.UNINDENT
.UNINDENT
