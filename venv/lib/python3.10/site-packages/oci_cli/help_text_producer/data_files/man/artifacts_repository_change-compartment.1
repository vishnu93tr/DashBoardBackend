...
.
.TH "ARTIFACTS_REPOSITORY_CHANGE-COMPARTMENT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
artifacts_repository_change-compartment \- 
.
...
.SH DESCRIPTION
.sp
Moves a repository into a different compartment within the same tenancy. For information about moving resources between compartments, see \fI\%Moving Resources to a Different Compartment\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Identity/Tasks/managingcompartments.htm#moveRes\fP>\&.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci artifacts repository change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the compartment into which the repository should be moved.
.INDENT 0.0
.TP
...
.ft C
    ...
    oci artifacts repository change\-compartment \-\-compartment\-id $compartment_id \-\-repository\-id $repository_id
.ft P
.fi
.UNINDENT
.UNINDENT
