...
.
.TH "DB_PLUGGABLE-DATABASE_STOP" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_pluggable-database_stop \- 
.
...
.SH DESCRIPTION
.sp
Stops a pluggable database. The \fIopenMode\fP value of the pluggable database will be \fIMOUNTED\fP upon completion.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci db pluggable\-database stop [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci db pluggable\-database stop \-\-pluggable\-database\-id $pluggable_database_id
.ft P
.fi
.UNINDENT
.UNINDENT
