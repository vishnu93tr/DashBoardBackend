...
.
.TH "IDENTITY-DOMAINS_MY-AUTH-TOKEN" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_my-auth-token \- 
.
...
.nf
.ft C
oci identity\-domains my\-auth\-token create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains my\-auth\-token create \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains my\-auth\-token create \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains my\-auth\-token delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    my_auth_token_id=$(oci identity\-domains my\-auth\-token create \-\-schemas file://schemas.json \-\-query data.id \-\-raw\-output)

    oci identity\-domains my\-auth\-token delete \-\-my\-auth\-token\-id $my_auth_token_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains my\-auth\-token get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains my\-auth\-token get \-\-my\-auth\-token\-id $my_auth_token_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains my\-auth\-token patch [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains my\-auth\-token patch \-\-generate\-param\-json\-input operations > operations.json
    oci identity\-domains my\-auth\-token patch \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains my\-auth\-token patch \-\-my\-auth\-token\-id $my_auth_token_id \-\-operations file://operations.json \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
