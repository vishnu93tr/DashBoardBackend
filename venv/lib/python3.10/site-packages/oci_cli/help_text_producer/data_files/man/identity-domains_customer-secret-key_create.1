...
.
.TH "IDENTITY-DOMAINS_CUSTOMER-SECRET-KEY_CREATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_customer-secret-key_create \- 
.
...
.nf
.ft C
oci identity\-domains customer\-secret\-key create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains customer\-secret\-key create \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains customer\-secret\-key create \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
