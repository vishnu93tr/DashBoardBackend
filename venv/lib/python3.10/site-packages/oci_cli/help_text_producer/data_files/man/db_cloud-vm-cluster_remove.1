...
.
.TH "DB_CLOUD-VM-CLUSTER_REMOVE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_cloud-vm-cluster_remove \- 
.
...
.nf
.ft C
oci db cloud\-vm\-cluster remove [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci db cloud\-vm\-cluster remove \-\-generate\-param\-json\-input db\-servers > db\-servers.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci db cloud\-vm\-cluster remove \-\-cloud\-vm\-cluster\-id $cloud_vm_cluster_id \-\-db\-servers file://db\-servers.json
.ft P
.fi
.UNINDENT
.UNINDENT
