...
.
.TH "NETWORK_VCN_DELETE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network_vcn_delete \- 
.
...
.sp
A deleted VCN’s \fIlifecycleState\fP changes to TERMINATING and then TERMINATED temporarily until the VCN is completely removed. A completely removed VCN does not appear in the results of a \fIListVcns\fP operation and can’t be used in a \fIGetVcn\fP operation.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci network vcn delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
