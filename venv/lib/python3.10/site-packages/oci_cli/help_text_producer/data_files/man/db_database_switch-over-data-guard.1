...
.
.TH "DB_DATABASE_SWITCH-OVER-DATA-GUARD" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_database_switch-over-data-guard \- 
.
...
.SH DESCRIPTION
.sp
Performs a switchover to transition primary database of this Data Guard association into a standby role. The standby database associated with the \fIdataGuardAssociationId\fP assumes the primary database role.
.sp
...
.nf
.ft C
oci db database switch\-over\-data\-guard [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export database_admin_password=<substitute\-value\-of\-database_admin_password> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/db/database/switch\-over\-data\-guard.html#cmdoption\-database\-admin\-password
    ...
    oci db database switch\-over\-data\-guard \-\-database\-admin\-password $database_admin_password \-\-database\-id $database_id
.ft P
.fi
.UNINDENT
.UNINDENT
