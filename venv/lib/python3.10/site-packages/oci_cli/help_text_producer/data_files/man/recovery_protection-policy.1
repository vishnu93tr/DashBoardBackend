...
.
.TH "RECOVERY_PROTECTION-POLICY" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
recovery_protection-policy \- 
.
...
.nf
.ft C
oci recovery protection\-policy change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the compartment into which the Protection Policy should be moved.
.INDENT 0.0
.TP
...
.ft C
    ...
    oci recovery protection\-policy change\-compartment \-\-compartment\-id $compartment_id \-\-protection\-policy\-id $protection_policy_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-must\-enforce\-cloud\-locality [boolean]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-policy\-locked\-date\-time [text]
.UNINDENT
.sp
...
.nf
.ft C
oci recovery protection\-policy delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci recovery protection\-policy delete \-\-protection\-policy\-id $protection_policy_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci recovery protection\-policy get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci recovery protection\-policy get \-\-protection\-policy\-id $protection_policy_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci recovery protection\-policy update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci recovery protection\-policy update \-\-protection\-policy\-id $protection_policy_id
.ft P
.fi
.UNINDENT
.UNINDENT
