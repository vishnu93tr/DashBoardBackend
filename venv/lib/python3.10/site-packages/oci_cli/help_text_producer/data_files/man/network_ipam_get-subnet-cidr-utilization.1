...
.
.TH "NETWORK_IPAM_GET-SUBNET-CIDR-UTILIZATION" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network_ipam_get-subnet-cidr-utilization \- 
.
...
.SH DESCRIPTION
.sp
Gets the CIDR utilization data of the specified subnet. Specify the \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP>\&.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci network ipam get\-subnet\-cidr\-utilization [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci network ipam get\-subnet\-cidr\-utilization \-\-subnet\-id $subnet_id
.ft P
.fi
.UNINDENT
.UNINDENT
