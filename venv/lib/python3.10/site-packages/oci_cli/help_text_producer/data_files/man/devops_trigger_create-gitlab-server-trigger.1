...
.
.TH "DEVOPS_TRIGGER_CREATE-GITLAB-SERVER-TRIGGER" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
devops_trigger_create-gitlab-server-trigger \- 
.
...
.nf
.ft C
oci devops trigger create\-gitlab\-server\-trigger [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci devops trigger create\-gitlab\-server\-trigger \-\-generate\-param\-json\-input actions > actions.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci devops trigger create\-gitlab\-server\-trigger \-\-actions file://actions.json \-\-project\-id $project_id
.ft P
.fi
.UNINDENT
.UNINDENT
