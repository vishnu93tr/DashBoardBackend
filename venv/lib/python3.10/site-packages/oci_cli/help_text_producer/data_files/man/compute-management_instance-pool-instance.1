...
.
.TH "COMPUTE-MANAGEMENT_INSTANCE-POOL-INSTANCE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
compute-management_instance-pool-instance \- 
.
...
.SS Description
.sp
Attaches an instance to an instance pool. For information about the prerequisites that an instance must meet before you can attach it to a pool, see \fI\%Attaching an Instance to an Instance Pool\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Compute/Tasks/updatinginstancepool.htm#attach-instance\fP>\&.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
...
.ft C
    ...
    oci compute\-management instance\-pool\-instance attach \-\-instance\-id $instance_id \-\-instance\-pool\-id $instance_pool_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-is\-auto\-terminate [boolean]
.UNINDENT
.sp
Whether to permanently terminate (delete) the instance and its attached boot volume when detaching it from the instance pool. Default is \fIfalse\fP\&.
.INDENT 0.0
.TP
.B \-\-is\-decrement\-size [boolean]
.UNINDENT
.sp
Whether to decrease the size of the instance pool when the instance is detached. If \fItrue\fP, the pool size is decreased. If \fIfalse\fP, the pool will provision a new, replacement instance using the pool’s instance configuration as a template. Default is \fItrue\fP\&.
.INDENT 0.0
.TP
.B \-\-max\-wait\-seconds [integer]
.UNINDENT
...
.ft C
    ...
    oci compute\-management instance\-pool\-instance detach \-\-instance\-id $instance_id \-\-instance\-pool\-id $instance_pool_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci compute\-management instance\-pool\-instance get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci compute\-management instance\-pool\-instance get \-\-instance\-id $instance_id \-\-instance\-pool\-id $instance_pool_id
.ft P
.fi
.UNINDENT
.UNINDENT
