...
.
.TH "DB_PLUGGABLE-DATABASE_START" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_pluggable-database_start \- 
.
...
.SH DESCRIPTION
.sp
Starts a stopped pluggable database. The \fIopenMode\fP value of the pluggable database will be \fIREAD_WRITE\fP upon completion.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci db pluggable\-database start [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci db pluggable\-database start \-\-pluggable\-database\-id $pluggable_database_id
.ft P
.fi
.UNINDENT
.UNINDENT
