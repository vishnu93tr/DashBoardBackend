...
.
.TH "DEVOPS_PROJECT_CHANGE-COMPARTMENT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
devops_project_change-compartment \- 
.
...
.nf
.ft C
oci devops project change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the compartment to which the resource must be moved.
.INDENT 0.0
.TP
.B \-\-project\-id [text]
.UNINDENT
...
.ft C
    ...
    oci devops project change\-compartment \-\-compartment\-id $compartment_id \-\-project\-id $project_id
.ft P
.fi
.UNINDENT
.UNINDENT
