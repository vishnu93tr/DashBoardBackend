...
.
.TH "DATABASE-MIGRATION_MIGRATION_DELETE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
database-migration_migration_delete \- 
.
...
.nf
.ft C
oci database\-migration migration delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export migration_id=<substitute\-value\-of\-migration_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/database\-migration/migration/delete.html#cmdoption\-migration\-id

    oci database\-migration migration delete \-\-migration\-id $migration_id
.ft P
.fi
.UNINDENT
.UNINDENT
