...
.
.TH "DATABASE-MANAGEMENT_EXTERNAL-EXADATA-INFRASTRUCTURE_CREATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
database-management_external-exadata-infrastructure_create \- 
.
...
.nf
.ft C
oci database\-management external\-exadata\-infrastructure create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci database\-management external\-exadata\-infrastructure create \-\-compartment\-id $compartment_id \-\-db\-system\-ids file://db\-system\-ids.json \-\-display\-name $display_name
.ft P
.fi
.UNINDENT
.UNINDENT
