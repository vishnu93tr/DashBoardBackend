...
.
.TH "DATA-SAFE_SQL-FIREWALL-VIOLATION-SUMMARY" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_sql-firewall-violation-summary \- 
.
...
.UNINDENT
.SS \fBlist\-sql\-firewall\-violation\-analytics\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.sp
\fBExample:\fP query=(operationTime ge ‘2021\-06\-04T01\-00\-26’) and (violationAction eq ‘BLOCKED’)
.INDENT 0.0
.TP
.B \-\-sort\-by [text]
.UNINDENT
...
.UNINDENT
.UNINDENT
.SS \fBlist\-sql\-firewall\-violations\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.nf
.ft C
oci data\-safe sql\-firewall\-violation\-summary list\-sql\-firewall\-violations [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
clientIp, clientOsUserName, clientProgram, currentDbUserName, dbUserName, operation, operationTime, sqlLevel, targetId, targetName, timeCollected, violationAction, violationCause
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-safe/sql\-firewall\-violation\-summary/list\-sql\-firewall\-violations.html#cmdoption\-compartment\-id

    oci data\-safe sql\-firewall\-violation\-summary list\-sql\-firewall\-violations \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
