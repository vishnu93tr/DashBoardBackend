...
.
.TH "LOG-ANALYTICS_INGEST-TIME-RULE_CREATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
log-analytics_ingest-time-rule_create \- 
.
...
.nf
.ft C
oci log\-analytics ingest\-time\-rule create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci log\-analytics ingest\-time\-rule create \-\-actions file://actions.json \-\-compartment\-id $compartment_id \-\-conditions file://conditions.json \-\-display\-name $display_name \-\-namespace\-name $namespace_name
.ft P
.fi
.UNINDENT
.UNINDENT
