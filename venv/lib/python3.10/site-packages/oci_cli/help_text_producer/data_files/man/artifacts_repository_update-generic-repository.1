...
.
.TH "ARTIFACTS_REPOSITORY_UPDATE-GENERIC-REPOSITORY" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
artifacts_repository_update-generic-repository \- 
.
...
.SH DESCRIPTION
.sp
Updates the properties of a repository. You can update the \fIdisplayName\fP and  \fIdescription\fP properties.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci artifacts repository update\-generic\-repository [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci artifacts repository update\-generic\-repository \-\-repository\-id $repository_id
.ft P
.fi
.UNINDENT
.UNINDENT
