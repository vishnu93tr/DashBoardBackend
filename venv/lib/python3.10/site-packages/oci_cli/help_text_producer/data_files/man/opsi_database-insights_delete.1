...
.
.TH "OPSI_DATABASE-INSIGHTS_DELETE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
opsi_database-insights_delete \- 
.
...
.nf
.ft C
oci opsi database\-insights delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export database_insight_id=<substitute\-value\-of\-database_insight_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/opsi/database\-insights/delete.html#cmdoption\-database\-insight\-id

    oci opsi database\-insights delete \-\-database\-insight\-id $database_insight_id
.ft P
.fi
.UNINDENT
.UNINDENT
