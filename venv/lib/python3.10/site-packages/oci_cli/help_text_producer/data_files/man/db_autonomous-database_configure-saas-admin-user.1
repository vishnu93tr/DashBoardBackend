...
.
.TH "DB_AUTONOMOUS-DATABASE_CONFIGURE-SAAS-ADMIN-USER" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_autonomous-database_configure-saas-admin-user \- 
.
...
.nf
.ft C
oci db autonomous\-database configure\-saas\-admin\-user [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-time\-saas\-admin\-user\-enabled [datetime]
.UNINDENT
.sp
...
.ft C
    ...
    oci db autonomous\-database configure\-saas\-admin\-user \-\-autonomous\-database\-id $autonomous_database_id
.ft P
.fi
.UNINDENT
.UNINDENT
