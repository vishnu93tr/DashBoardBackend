...
.
.TH "DATA-SAFE_MASKING-ERROR-SUMMARY_LIST-MASKING-ERRORS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_masking-error-summary_list-masking-errors \- 
.
...
.nf
.ft C
oci data\-safe masking\-error\-summary list\-masking\-errors [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export masking_report_id=<substitute\-value\-of\-masking_report_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-safe/masking\-error\-summary/list\-masking\-errors.html#cmdoption\-masking\-report\-id

    oci data\-safe masking\-error\-summary list\-masking\-errors \-\-masking\-report\-id $masking_report_id
.ft P
.fi
.UNINDENT
.UNINDENT
