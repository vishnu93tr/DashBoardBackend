...
.
.TH "DB_DATABASE_CONVERT-TO-STANDALONE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_database_convert-to-standalone \- 
.
...
.SH DESCRIPTION
.sp
Disassociate the standby database identified by the \fIdatabaseId\fP parameter from existing Data Guard group.
.sp
...
.nf
.ft C
oci db database convert\-to\-standalone [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export database_admin_password=<substitute\-value\-of\-database_admin_password> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/db/database/convert\-to\-standalone.html#cmdoption\-database\-admin\-password
    ...
    oci db database convert\-to\-standalone \-\-database\-admin\-password $database_admin_password \-\-database\-id $database_id
.ft P
.fi
.UNINDENT
.UNINDENT
