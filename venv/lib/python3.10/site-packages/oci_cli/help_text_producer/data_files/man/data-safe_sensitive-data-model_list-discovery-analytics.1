...
.
.TH "DATA-SAFE_SENSITIVE-DATA-MODEL_LIST-DISCOVERY-ANALYTICS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_sensitive-data-model_list-discovery-analytics \- 
.
...
.nf
.ft C
oci data\-safe sensitive\-data\-model list\-discovery\-analytics [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
sensitiveDataModelId, sensitiveTypeId, sensitiveTypeIdAndSensitiveDataModelId, sensitiveTypeIdAndTargetId, targetId, targetIdAndSensitiveDataModelId
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-safe/sensitive\-data\-model/list\-discovery\-analytics.html#cmdoption\-compartment\-id

    oci data\-safe sensitive\-data\-model list\-discovery\-analytics \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
