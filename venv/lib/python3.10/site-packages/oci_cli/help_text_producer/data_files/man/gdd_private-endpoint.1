...
.
.TH "GDD_PRIVATE-ENDPOINT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
gdd_private-endpoint \- 
.
...
.nf
.ft C
oci gdd private\-endpoint change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/gdd/private\-endpoint/create.html#cmdoption\-compartment\-id
    export display_name=<substitute\-value\-of\-display_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/gdd/private\-endpoint/create.html#cmdoption\-display\-name
    export subnet_id=<substitute\-value\-of\-subnet_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/gdd/private\-endpoint/create.html#cmdoption\-subnet\-id

    private_endpoint_id=$(oci gdd private\-endpoint create \-\-compartment\-id $compartment_id \-\-display\-name $display_name \-\-subnet\-id $subnet_id \-\-query data.id \-\-raw\-output)

    oci gdd private\-endpoint change\-compartment \-\-compartment\-id $compartment_id \-\-private\-endpoint\-id $private_endpoint_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci gdd private\-endpoint create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci gdd private\-endpoint create \-\-compartment\-id $compartment_id \-\-display\-name $display_name \-\-subnet\-id $subnet_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci gdd private\-endpoint delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci gdd private\-endpoint delete \-\-private\-endpoint\-id $private_endpoint_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci gdd private\-endpoint get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci gdd private\-endpoint get \-\-private\-endpoint\-id $private_endpoint_id
.ft P
.fi
.UNINDENT
.UNINDENT
.SS \fBreinstate\-proxy\-instance\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.nf
.ft C
oci gdd private\-endpoint reinstate\-proxy\-instance [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci gdd private\-endpoint reinstate\-proxy\-instance \-\-private\-endpoint\-id $private_endpoint_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci gdd private\-endpoint update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci gdd private\-endpoint update \-\-private\-endpoint\-id $private_endpoint_id
.ft P
.fi
.UNINDENT
.UNINDENT
