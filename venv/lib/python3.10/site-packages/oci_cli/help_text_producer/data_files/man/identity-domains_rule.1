...
.
.TH "IDENTITY-DOMAINS_RULE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_rule \- 
.
...
.nf
.ft C
oci identity\-domains rule create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
Rule name
.sp
\fBSCIM++ Properties:\fP  \- caseExact: true  \- idcsSearchable: true  \- multiValued: false  \- mutability: readWrite  \- required: true  \- returned: always  \- type: string  \- uniqueness: none
.INDENT 0.0
.TP
.B \-\-policy\-type [complex type]
.UNINDENT
.sp
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
...
.INDENT 0.0
.TP
.B \-\-condition\-group [complex type]
.UNINDENT
.sp
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
...
.sp
\fBSCIM++ Properties:\fP  \- idcsCompositeKey: [key, value]  \- idcsCsvAttributeNameMappings: [[columnHeaderName:Tag Key, mapsTo:tags.key], [columnHeaderName:Tag Value, mapsTo:tags.value]]  \- idcsSearchable: true  \- multiValued: true  \- mutability: readWrite  \- required: false  \- returned: request  \- type: complex  \- uniqueness: none
.sp
...
.INDENT 0.0
.TP
.B \-\-urnietfparamsscimschemasoracleidcsextensionociconsolesignonpolicyconsent\-policy [complex type]
.UNINDENT
.sp
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
...
.nf
.ft C
    oci identity\-domains condition create \-\-generate\-param\-json\-input schemas > schemas.json

    oci identity\-domains rule create \-\-generate\-param\-json\-input \-return > \-return.json
    oci identity\-domains rule create \-\-generate\-param\-json\-input policy\-type > policy\-type.json
    oci identity\-domains rule create \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export attribute_name=<substitute\-value\-of\-attribute_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/identity\-domains/condition/create.html#cmdoption\-attribute\-name
    export attribute_value=<substitute\-value\-of\-attribute_value> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/identity\-domains/condition/create.html#cmdoption\-attribute\-value
    export name=<substitute\-value\-of\-name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/identity\-domains/condition/create.html#cmdoption\-name
    export operator=<substitute\-value\-of\-operator> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/identity\-domains/condition/create.html#cmdoption\-operator

    condition_id=$(oci identity\-domains condition create \-\-attribute\-name $attribute_name \-\-attribute\-value $attribute_value \-\-name $name \-\-operator $operator \-\-schemas file://schemas.json \-\-query data.id \-\-raw\-output)

    oci identity\-domains rule create \-\-\-return file://\-return.json \-\-condition $condition \-\-name $name \-\-policy\-type file://policy\-type.json \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains rule delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    rule_id=$(oci identity\-domains rule create \-\-\-return file://\-return.json \-\-condition $condition \-\-name $name \-\-policy\-type file://policy\-type.json \-\-schemas file://schemas.json \-\-query data.id \-\-raw\-output)

    oci identity\-domains rule delete \-\-rule\-id $rule_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains rule get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains rule get \-\-rule\-id $rule_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains rule list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains rule list
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains rule patch [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains rule patch \-\-generate\-param\-json\-input operations > operations.json
    oci identity\-domains rule patch \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains rule patch \-\-operations file://operations.json \-\-rule\-id $rule_id \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains rule put [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains rule put \-\-generate\-param\-json\-input \-return > \-return.json
    oci identity\-domains rule put \-\-generate\-param\-json\-input policy\-type > policy\-type.json
    oci identity\-domains rule put \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    export attribute_name=<substitute\-value\-of\-attribute_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/identity\-domains/condition/create.html#cmdoption\-attribute\-name
    export attribute_value=<substitute\-value\-of\-attribute_value> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/identity\-domains/condition/create.html#cmdoption\-attribute\-value
    export name=<substitute\-value\-of\-name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/identity\-domains/rule/create.html#cmdoption\-name
    export operator=<substitute\-value\-of\-operator> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/identity\-domains/condition/create.html#cmdoption\-operator
    export condition=<substitute\-value\-of\-condition> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/identity\-domains/rule/create.html#cmdoption\-condition

    condition_id=$(oci identity\-domains condition create \-\-attribute\-name $attribute_name \-\-attribute\-value $attribute_value \-\-name $name \-\-operator $operator \-\-schemas file://schemas.json \-\-query data.id \-\-raw\-output)

    rule_id=$(oci identity\-domains rule create \-\-\-return file://\-return.json \-\-condition $condition \-\-name $name \-\-policy\-type file://policy\-type.json \-\-schemas file://schemas.json \-\-query data.id \-\-raw\-output)

    oci identity\-domains rule put \-\-\-return file://\-return.json \-\-condition $condition \-\-name $name \-\-policy\-type file://policy\-type.json \-\-rule\-id $rule_id \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains rule search [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains rule search \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains rule search \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
