...
.
.TH "DATA-SAFE_TARGET-DATABASE_ACTIVATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_target-database_activate \- 
.
...
.nf
.ft C
oci data\-safe target\-database activate [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci data\-safe target\-database activate \-\-generate\-param\-json\-input credentials > credentials.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci data\-safe target\-database activate \-\-credentials file://credentials.json \-\-target\-database\-id $target_database_id
.ft P
.fi
.UNINDENT
.UNINDENT
