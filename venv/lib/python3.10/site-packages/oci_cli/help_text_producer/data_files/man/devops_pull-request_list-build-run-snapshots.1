...
.
.TH "DEVOPS_PULL-REQUEST_LIST-BUILD-RUN-SNAPSHOTS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
devops_pull-request_list-build-run-snapshots \- 
.
...
.nf
.ft C
oci devops pull\-request list\-build\-run\-snapshots [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci devops pull\-request list\-build\-run\-snapshots \-\-pull\-request\-id $pull_request_id
.ft P
.fi
.UNINDENT
.UNINDENT
