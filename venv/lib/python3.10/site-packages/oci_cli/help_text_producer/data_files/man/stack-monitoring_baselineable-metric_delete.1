...
.
.TH "STACK-MONITORING_BASELINEABLE-METRIC_DELETE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
stack-monitoring_baselineable-metric_delete \- 
.
...
.nf
.ft C
oci stack\-monitoring baselineable\-metric delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export metric_id=<substitute\-value\-of\-metric_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/stack\-monitoring/baselineable\-metric/delete.html#cmdoption\-metric\-id

    oci stack\-monitoring baselineable\-metric delete \-\-metric\-id $metric_id
.ft P
.fi
.UNINDENT
.UNINDENT
