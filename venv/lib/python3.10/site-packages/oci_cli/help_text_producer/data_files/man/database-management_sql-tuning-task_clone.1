...
.
.TH "DATABASE-MANAGEMENT_SQL-TUNING-TASK_CLONE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
database-management_sql-tuning-task_clone \- 
.
...
.ft C
    ...
    oci database\-management sql\-tuning\-task clone \-\-managed\-database\-id $managed_database_id \-\-original\-task\-id $original_task_id \-\-task\-name $task_name
.ft P
.fi
.UNINDENT
.UNINDENT
