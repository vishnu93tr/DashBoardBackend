...
.
.TH "IDENTITY-DOMAINS_IDENTITY-SETTING" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_identity-setting \- 
.
...
.nf
.ft C
oci identity\-domains identity\-setting get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export identity_setting_id=<substitute\-value\-of\-identity_setting_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/identity\-domains/identity\-setting/get.html#cmdoption\-identity\-setting\-id

    oci identity\-domains identity\-setting get \-\-identity\-setting\-id $identity_setting_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains identity\-setting patch [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains identity\-setting patch \-\-generate\-param\-json\-input operations > operations.json
    oci identity\-domains identity\-setting patch \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export identity_setting_id=<substitute\-value\-of\-identity_setting_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/identity\-domains/identity\-setting/patch.html#cmdoption\-identity\-setting\-id

    oci identity\-domains identity\-setting patch \-\-identity\-setting\-id $identity_setting_id \-\-operations file://operations.json \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains identity\-setting put [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-emit\-locked\-message\-when\-user\-is\-locked [boolean]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-primary\-email\-required [boolean]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-tokens [complex type]
.UNINDENT
.sp
A list of tokens and their expiry length.
.sp
\fBSCIM++ Properties:\fP  \- caseExact: false  \- idcsCompositeKey: [type]  \- multiValued: true  \- required: false  \- type: complex  \- uniqueness: none
.sp
This option is a JSON list with items of type IdentitySettingsTokens.  For documentation on IdentitySettingsTokens please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/identitydomains/v1/datatypes/IdentitySettingsTokens\fP\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
.INDENT 0.0
.TP
.B \-\-user\-allowed\-to\-set\-recovery\-email [boolean]
.UNINDENT
.sp
...
.nf
.ft C
    oci identity\-domains identity\-setting put \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export identity_setting_id=<substitute\-value\-of\-identity_setting_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/identity\-domains/identity\-setting/put.html#cmdoption\-identity\-setting\-id

    oci identity\-domains identity\-setting put \-\-identity\-setting\-id $identity_setting_id \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
