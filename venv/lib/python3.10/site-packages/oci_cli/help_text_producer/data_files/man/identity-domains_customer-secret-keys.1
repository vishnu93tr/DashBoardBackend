...
.
.TH "IDENTITY-DOMAINS_CUSTOMER-SECRET-KEYS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_customer-secret-keys \- 
.
...
.nf
.ft C
oci identity\-domains customer\-secret\-keys list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains customer\-secret\-keys list
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains customer\-secret\-keys search [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains customer\-secret\-keys search \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains customer\-secret\-keys search \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
