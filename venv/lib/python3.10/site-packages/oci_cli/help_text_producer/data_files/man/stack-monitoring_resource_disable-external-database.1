...
.
.TH "STACK-MONITORING_RESOURCE_DISABLE-EXTERNAL-DATABASE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
stack-monitoring_resource_disable-external-database \- 
.
...
.nf
.ft C
oci stack\-monitoring resource disable\-external\-database [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci stack\-monitoring resource disable\-external\-database \-\-resource\-id $resource_id
.ft P
.fi
.UNINDENT
.UNINDENT
