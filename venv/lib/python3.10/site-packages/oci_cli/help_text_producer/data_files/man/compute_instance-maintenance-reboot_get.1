...
.
.TH "COMPUTE_INSTANCE-MAINTENANCE-REBOOT_GET" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
compute_instance-maintenance-reboot_get \- 
.
...
.SH DESCRIPTION
.sp
Gets the maximum possible date that a maintenance reboot can be extended. For more information, see \fI\%Infrastructure Maintenance\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Compute/References/infrastructure-maintenance.htm\fP>\&.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci compute instance\-maintenance\-reboot get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci compute instance\-maintenance\-reboot get \-\-instance\-id $instance_id
.ft P
.fi
.UNINDENT
.UNINDENT
