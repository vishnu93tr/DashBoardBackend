...
.
.TH "DATA-SAFE_FINDING_UPDATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_finding_update \- 
.
...
.nf
.ft C
oci data\-safe finding update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export finding_key=<substitute\-value\-of\-finding_key> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-safe/finding/update.html#cmdoption\-finding\-key

    security_assessment_id=$(oci data\-safe security\-assessment create \-\-compartment\-id $compartment_id \-\-query data.id \-\-raw\-output)

    oci data\-safe finding update \-\-finding\-key $finding_key \-\-security\-assessment\-id $security_assessment_id
.ft P
.fi
.UNINDENT
.UNINDENT
