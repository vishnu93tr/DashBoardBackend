...
.
.TH "GOLDENGATE_CONNECTION_UPDATE-AMAZON-REDSHIFT-CONNECTION" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
goldengate_connection_update-amazon-redshift-connection \- 
.
...
.nf
.ft C
oci goldengate connection update\-amazon\-redshift\-connection [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export connection_id=<substitute\-value\-of\-connection_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/goldengate/connection/update\-amazon\-redshift\-connection.html#cmdoption\-connection\-id

    oci goldengate connection update\-amazon\-redshift\-connection \-\-connection\-id $connection_id
.ft P
.fi
.UNINDENT
.UNINDENT
