...
.
.TH "MYSQL_REPLICA_UPDATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
mysql_replica_update \- 
.
...
.nf
.ft C
oci mysql replica update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The Replica \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP>\&.
...
.INDENT 0.0
.TP
.B \-\-replica\-overrides [complex type]
.UNINDENT
.sp
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
...
.ft C
    ...
    replica_id=$(oci mysql replica create \-\-db\-system\-id $db_system_id \-\-query data.id \-\-raw\-output)

    oci mysql replica update \-\-replica\-id $replica_id
.ft P
.fi
.UNINDENT
.UNINDENT
