...
.
.TH "DATABASE-MANAGEMENT_EXTERNAL-DB-SYSTEM_ENABLE-EXTERNAL-DB-SYSTEM-STACK-MONITORING" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
database-management_external-db-system_enable-external-db-system-stack-monitoring \- 
.
...
.nf
.ft C
oci database\-management external\-db\-system enable\-external\-db\-system\-stack\-monitoring [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export is_enabled=<substitute\-value\-of\-is_enabled> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/database\-management/external\-db\-system/enable\-external\-db\-system\-stack\-monitoring.html#cmdoption\-is\-enabled
    ...
    oci database\-management external\-db\-system enable\-external\-db\-system\-stack\-monitoring \-\-external\-db\-system\-id $external_db_system_id \-\-is\-enabled $is_enabled
.ft P
.fi
.UNINDENT
.UNINDENT
