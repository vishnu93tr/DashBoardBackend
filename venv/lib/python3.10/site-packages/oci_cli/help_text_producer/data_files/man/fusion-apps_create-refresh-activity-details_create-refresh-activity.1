...
.
.TH "FUSION-APPS_CREATE-REFRESH-ACTIVITY-DETAILS_CREATE-REFRESH-ACTIVITY" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
fusion-apps_create-refresh-activity-details_create-refresh-activity \- 
.
...
.INDENT 0.0
.TP
.B \-\-source\-fusion\-environment\-id [text]
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the source environment
...
.INDENT 0.0
.TP
.B \-\-is\-data\-masking\-opted [boolean]
.UNINDENT
.sp
