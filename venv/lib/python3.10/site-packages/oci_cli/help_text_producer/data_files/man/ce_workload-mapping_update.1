...
.
.TH "CE_WORKLOAD-MAPPING_UPDATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
ce_workload-mapping_update \- 
.
...
.nf
.ft C
oci ce workload\-mapping update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export cluster_id=<substitute\-value\-of\-cluster_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/ce/workload\-mapping/create.html#cmdoption\-cluster\-id
    export mapped_compartment_id=<substitute\-value\-of\-mapped_compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/ce/workload\-mapping/create.html#cmdoption\-mapped\-compartment\-id
    export namespace=<substitute\-value\-of\-namespace> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/ce/workload\-mapping/create.html#cmdoption\-namespace
    ...
    workload_mapping_id=$(oci ce workload\-mapping create \-\-cluster\-id $cluster_id \-\-mapped\-compartment\-id $mapped_compartment_id \-\-namespace $namespace \-\-query data.id \-\-raw\-output)

    oci ce workload\-mapping update \-\-cluster\-id $cluster_id \-\-workload\-mapping\-id $workload_mapping_id
.ft P
.fi
.UNINDENT
.UNINDENT
