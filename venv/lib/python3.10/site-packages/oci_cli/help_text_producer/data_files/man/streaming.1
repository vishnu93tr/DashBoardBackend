...
.
.TH "STREAMING" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
streaming \- 
.
...
.SH DESCRIPTION
.sp
Use the Streaming CLI to produce and consume messages, create streams and stream pools, and manage related items. For more information, see \fI\%Streaming\fP <\fBhttps://docs.cloud.oracle.com/Content/Streaming/Concepts/streamingoverview.htm\fP>\&.
...
.SS Description
.sp
Starts the provisioning of a new connect harness. To track the progress of the provisioning, you can periodically call \fI\%GetConnectHarness\fP <\fBhttps://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/streaming/admin/connect-harness/get.html\fP>\&. In the response, the \fIlifecycleState\fP parameter of the [ConnectHarness] object tells you its current state.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
...
.SS Description
.sp
Deletes a connect harness and its content. Connect harness contents are deleted immediately. The service retains records of the connect harness itself for 90 days after deletion. The \fIlifecycleState\fP parameter of the \fIConnectHarness\fP object changes to \fIDELETING\fP and the connect harness becomes inaccessible for read or write operations. To verify that a connect harness has been deleted, make a \fI\%GetConnectHarness\fP <\fBhttps://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/streaming/admin/connect-harness/get.html\fP> request. If the call returns the connect harness’s lifecycle state as \fIDELETED\fP, then the connect harness has been deleted. If the call returns a “404 Not Found” error, that means all records of the connect harness have been deleted.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
...
.nf
.ft C
oci streaming admin connect\-harness get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci streaming admin connect\-harness get \-\-connect\-harness\-id $connect_harness_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci streaming admin connect\-harness list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/streaming/admin/connect\-harness/list.html#cmdoption\-compartment\-id

    oci streaming admin connect\-harness list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.SS Description
.sp
Starts the provisioning of a new stream. The stream will be created in the given compartment id or stream pool id, depending on which parameter is specified. Compartment id and stream pool id cannot be specified at the same time. To track the progress of the provisioning, you can periodically call \fI\%GetStream\fP <\fBhttps://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/streaming/admin/stream/get.html\fP>\&. In the response, the \fIlifecycleState\fP parameter of the \fI\%Stream\fP <\fBhttps://docs.cloud.oracle.com/api/#/en/streaming/20180418/Stream/\fP> object tells you its current state.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
...
.SS Description
.sp
Deletes a stream and its content. Stream contents are deleted immediately. The service retains records of the stream itself for 90 days after deletion. The \fIlifecycleState\fP parameter of the \fIStream\fP object changes to \fIDELETING\fP and the stream becomes inaccessible for read or write operations. To verify that a stream has been deleted, make a \fI\%GetStream\fP <\fBhttps://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/streaming/admin/stream/get.html\fP> request. If the call returns the stream’s lifecycle state as \fIDELETED\fP, then the stream has been deleted. If the call returns a “404 Not Found” error, that means all records of the stream have been deleted.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
...
.ft C
    ...
    oci streaming admin stream get \-\-stream\-id $stream_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The OCID of the compartment. Is exclusive with the \fIstreamPoolId\fP parameter. One of them is required.
.INDENT 0.0
.TP
.B \-\-from\-json [text]
.UNINDENT
...
.UNINDENT
.sp
The OCID of the stream pool. Is exclusive with the \fIcompartmentId\fP parameter. One of them is required.
.SS Global Parameters
.sp
Use \fBoci \-\-help\fP for help on global parameters.
.sp
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the stream pool where the stream should be moved.
.INDENT 0.0
.TP
.B \-\-wait\-for\-state [text]
.UNINDENT
...
.SS Description
.sp
Starts the provisioning of a new stream pool. To track the progress of the provisioning, you can periodically call GetStreamPool. In the response, the \fIlifecycleState\fP parameter of the object tells you its current state.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
...
.INDENT 0.0
.TP
.B \-\-custom\-encryption\-key\-details [complex type]
.UNINDENT
.sp
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
...
.INDENT 0.0
.TP
.B \-\-private\-endpoint\-details [complex type]
.UNINDENT
.sp
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
...
.nf
.ft C
oci streaming admin stream\-pool get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci streaming admin stream\-pool get \-\-stream\-pool\-id $stream_pool_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci streaming admin stream\-pool list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/streaming/admin/stream\-pool/list.html#cmdoption\-compartment\-id

    oci streaming admin stream\-pool list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.SS Description
.sp
A cursor that indicates the position in the stream from which you want to begin consuming messages and which is required by the \fI\%GetMessages\fP <\fBhttps://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/streaming/stream/message/get.html\fP> operation.
.SS Available Commands
.INDENT 0.0
.IP \(bu 2
create\-cursor
...
.ft C
    export name=<substitute\-value\-of\-name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/streaming/admin/stream/create.html#cmdoption\-name
    export partitions=<substitute\-value\-of\-partitions> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/streaming/admin/stream/create.html#cmdoption\-partitions
    export group_name=<substitute\-value\-of\-group_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/streaming/stream/cursor/create\-group\-cursor.html#cmdoption\-group\-name
    export type=<substitute\-value\-of\-type> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/streaming/stream/cursor/create\-group\-cursor.html#cmdoption\-type
...
.ft C
    export name=<substitute\-value\-of\-name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/streaming/admin/stream/create.html#cmdoption\-name
    export partitions=<substitute\-value\-of\-partitions> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/streaming/admin/stream/create.html#cmdoption\-partitions
    export cursor=<substitute\-value\-of\-cursor> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/streaming/stream/group/commit.html#cmdoption\-cursor

    stream_id=$(oci streaming admin stream create \-\-name $name \-\-partitions $partitions \-\-query data.id \-\-raw\-output)

    oci streaming stream group commit \-\-cursor $cursor \-\-stream\-id $stream_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    export name=<substitute\-value\-of\-name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/streaming/admin/stream/create.html#cmdoption\-name
    export partitions=<substitute\-value\-of\-partitions> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/streaming/admin/stream/create.html#cmdoption\-partitions
    export group_name=<substitute\-value\-of\-group_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/streaming/stream/group/get.html#cmdoption\-group\-name

    stream_id=$(oci streaming admin stream create \-\-name $name \-\-partitions $partitions \-\-query data.id \-\-raw\-output)

    oci streaming stream group get \-\-group\-name $group_name \-\-stream\-id $stream_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    export name=<substitute\-value\-of\-name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/streaming/admin/stream/create.html#cmdoption\-name
    export partitions=<substitute\-value\-of\-partitions> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/streaming/admin/stream/create.html#cmdoption\-partitions
    export cursor=<substitute\-value\-of\-cursor> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/streaming/stream/group/heartbeat.html#cmdoption\-cursor

    stream_id=$(oci streaming admin stream create \-\-name $name \-\-partitions $partitions \-\-query data.id \-\-raw\-output)

    oci streaming stream group heartbeat \-\-cursor $cursor \-\-stream\-id $stream_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    export name=<substitute\-value\-of\-name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/streaming/admin/stream/create.html#cmdoption\-name
    export partitions=<substitute\-value\-of\-partitions> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/streaming/admin/stream/create.html#cmdoption\-partitions
    export group_name=<substitute\-value\-of\-group_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/streaming/stream/group/update.html#cmdoption\-group\-name

    stream_id=$(oci streaming admin stream create \-\-name $name \-\-partitions $partitions \-\-query data.id \-\-raw\-output)

    oci streaming stream group update \-\-group\-name $group_name \-\-stream\-id $stream_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.SS Description
.sp
Returns messages from the specified stream using the specified cursor as the starting point for consumption. By default, the number of messages returned is undefined, but the service returns as many as possible. To get messages, you must first obtain a cursor using the \fI\%CreateCursor\fP <\fBhttps://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/streaming/stream/cursor/create-cursor.html\fP> operation. In the response, retrieve the value of the ‘opc\-next\-cursor’ header to pass as a parameter to get the next batch of messages in the stream.
.sp
The top level –endpoint parameter must be supplied for this operation.
.SS Usage
.INDENT 0.0
