...
.
.TH "DATA-INTEGRATION_DATA-FLOW_GET" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-integration_data-flow_get \- 
.
...
.nf
.ft C
oci data\-integration data\-flow get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export data_flow_key=<substitute\-value\-of\-data_flow_key> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/data\-flow/get.html#cmdoption\-data\-flow\-key
    ...
    oci data\-integration data\-flow get \-\-data\-flow\-key $data_flow_key \-\-workspace\-id $workspace_id
.ft P
.fi
.UNINDENT
.UNINDENT
