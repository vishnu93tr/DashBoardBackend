...
.
.TH "NETWORK_NSG_DELETE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network_nsg_delete \- 
.
...
.sp
To get a list of the VNICs in a network security group, use \fI\%ListNetworkSecurityGroupVnics\fP <\fBhttps://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/network/nsg/vnics/list.html\fP>\&. Each returned \fI\%NetworkSecurityGroupVnic\fP <\fBhttps://docs.cloud.oracle.com/api/#/en/iaas/latest/NetworkSecurityGroupVnic/\fP> object contains both the \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the VNIC and the \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the VNIC’s parent resource (for example, the Compute instance that the VNIC is attached to).
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
