...
.
.TH "COMPUTE_CAPACITY-TOPOLOGY_CREATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
compute_capacity-topology_create \- 
.
...
.nf
.ft C
oci compute capacity\-topology create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the compartment that contains this compute capacity topology.
...
.ft C
    ...
    oci compute capacity\-topology create \-\-availability\-domain $availability_domain \-\-capacity\-source file://capacity\-source.json \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
