...
.
.TH "IAM_DOMAIN_ACTIVATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
iam_domain_activate \- 
.
...
.sp
After you send the request, the \fIlifecycleDetails\fP of the identity domain is set to ACTIVATING. When the operation completes, the \fIlifecycleDetails\fP is set to null and the \fIlifecycleState\fP of the identity domain is set to ACTIVE.
.sp
...
.nf
.ft C
oci iam domain activate [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci iam domain activate \-\-domain\-id $domain_id
.ft P
.fi
.UNINDENT
.UNINDENT
