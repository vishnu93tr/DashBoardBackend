...
.
.TH "DB_VM-CLUSTER_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_vm-cluster_list \- 
.
...
.SH DESCRIPTION
.sp
Lists the VM clusters in the specified compartment. Applies to Exadata \fI\%Cloud@Customer\fP <\fBCloud@Customer\fP> instances only. To list the cloud VM clusters in an Exadata Cloud Service instance, use the \fI\%ListCloudVmClusters\fP <\fBhttps://docs.cloud.oracle.com/api/#/en/database/latest/CloudVmCluster/ListCloudVmClusters\fP> operation.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci db vm\-cluster list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/db/vm\-cluster/list.html#cmdoption\-compartment\-id

    oci db vm\-cluster list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
