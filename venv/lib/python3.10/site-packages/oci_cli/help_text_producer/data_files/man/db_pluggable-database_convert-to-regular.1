...
.
.TH "DB_PLUGGABLE-DATABASE_CONVERT-TO-REGULAR" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_pluggable-database_convert-to-regular \- 
.
...
.SH DESCRIPTION
.sp
Converts a Refreshable clone to Regular pluggable database (PDB). Pluggable Database will be in \fIREAD_WRITE\fP openmode after conversion.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci db pluggable\-database convert\-to\-regular [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export pdb_id=<substitute\-value\-of\-pdb_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/db/pluggable\-database/convert\-to\-regular.html#cmdoption\-pdb\-id

    oci db pluggable\-database convert\-to\-regular \-\-pdb\-id $pdb_id
.ft P
.fi
.UNINDENT
.UNINDENT
