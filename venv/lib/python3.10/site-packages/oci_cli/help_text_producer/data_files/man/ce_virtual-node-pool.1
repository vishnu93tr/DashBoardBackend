...
.
.TH "CE_VIRTUAL-NODE-POOL" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
ce_virtual-node-pool \- 
.
...
.nf
.ft C
oci ce virtual\-node\-pool create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-placement\-configurations [complex type]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-initial\-virtual\-node\-labels [complex type]
.UNINDENT
.sp
Initial labels that will be added to the Kubernetes Virtual Node object when it registers.
.sp
This option is a JSON list with items of type InitialVirtualNodeLabel.  For documentation on InitialVirtualNodeLabel please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/containerengine/20180222/datatypes/InitialVirtualNodeLabel\fP\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
.INDENT 0.0
.TP
.B \-\-pod\-configuration [complex type]
.UNINDENT
.sp
...
.sp
This option is a JSON list with items of type Taint.  For documentation on Taint please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/containerengine/20180222/datatypes/Taint\fP\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
.INDENT 0.0
.TP
.B \-\-virtual\-node\-tags [complex type]
.UNINDENT
.sp
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
...
.nf
.ft C
    oci ce virtual\-node\-pool create \-\-generate\-param\-json\-input placement\-configurations > placement\-configurations.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci ce virtual\-node\-pool delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-is\-force\-deletion\-after\-override\-grace\-duration\-vnp [boolean]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-override\-eviction\-grace\-duration\-vnp [text]
.UNINDENT
.sp
Duration after which SKE will give up eviction of the pods on the node. PT0M will indicate you want to delete the virtual node without cordon and drain. Default PT60M, Min PT0M, Max: PT60M. Format ISO 8601 e.g PT30M
.INDENT 0.0
.TP
.B \-\-wait\-for\-state [text]
.UNINDENT
...
.nf
.ft C
oci ce virtual\-node\-pool get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci ce virtual\-node\-pool get\-virtual\-node [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci ce virtual\-node\-pool list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/ce/virtual\-node\-pool/list.html#cmdoption\-compartment\-id

    oci ce virtual\-node\-pool list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
.SS \fBlist\-virtual\-nodes\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.nf
.ft C
oci ce virtual\-node\-pool list\-virtual\-nodes [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci ce virtual\-node\-pool update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
The list of placement configurations which determines where Virtual Nodes will be provisioned across as it relates to the subnet and availability domains. The size attribute determines how many we evenly spread across these placement configurations
.sp
This option is a JSON list with items of type PlacementConfiguration.  For documentation on PlacementConfiguration please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/containerengine/20180222/datatypes/PlacementConfiguration\fP\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
