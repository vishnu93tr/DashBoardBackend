...
.
.TH "JMS_DRS-FILE-COLLECTION_LIST-DRS-FILES" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
jms_drs-file-collection_list-drs-files \- 
.
...
.nf
.ft C
oci jms drs\-file\-collection list\-drs\-files [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The field that sorts the DRS details results. Only one sort order can be provided. The default order for _drsFileKey_ is \fBdescending\fP\&. If no value is specified, then _drsFileKey_ is default.
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
...
.nf
.ft C
bucketName, checksumType, drsFileKey, drsFileName, isDefault, namespace
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci jms drs\-file\-collection list\-drs\-files \-\-fleet\-id $fleet_id
.ft P
.fi
.UNINDENT
.UNINDENT
