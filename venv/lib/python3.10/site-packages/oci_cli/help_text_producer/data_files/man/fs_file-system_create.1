...
.
.TH "FS_FILE-SYSTEM_CREATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
...
.sp
For information about Network Security Groups access control, see \fI\%Network Security Groups\fP <\fBhttps://docs.cloud.oracle.com/Content/Network/Concepts/networksecuritygroups.htm\fP>\&.
.sp
...
.sp
All Oracle Cloud Infrastructure resources, including file systems, get an Oracle\-assigned, unique ID called an Oracle Cloud Identifier (\fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP>). When you create a resource, you can find its OCID in the response. You can also retrieve a resource’s OCID by using a List API operation on that resource type or by viewing the resource in the Console.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the compartment to create the file system in.
.SH OPTIONAL PARAMETERS
.INDENT 0.0
.TP
.B \-\-are\-quota\-rules\-enabled [boolean]
.UNINDENT
.sp
Specifies the enforcement of quota rules on the file system.
.INDENT 0.0
.TP
.B \-\-clone\-attach\-status [text]
.UNINDENT
.sp
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the associated file system snapshot policy, which controls the frequency of snapshot creation and retention period of the taken snapshots.
.sp
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the KMS key used to encrypt the encryption keys associated with this file system.
.INDENT 0.0
.TP
...
.INDENT 0.0
.TP
.B \-\-source\-snapshot\-id [text]
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the snapshot used to create a cloned file system. See \fI\%Cloning a File System\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/File/Tasks/cloningFS.htm\fP>\&.
.INDENT 0.0
.TP
