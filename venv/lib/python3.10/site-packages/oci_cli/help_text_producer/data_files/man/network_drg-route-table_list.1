...
.
.TH "NETWORK_DRG-ROUTE-TABLE_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network_drg-route-table_list \- 
.
...
.sp
Use the \fIListDrgRouteRules\fP operation to retrieve the route rules in a table.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci network drg\-route\-table list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci network drg\-route\-table list \-\-drg\-id $drg_id
.ft P
.fi
.UNINDENT
.UNINDENT
