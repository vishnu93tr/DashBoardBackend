...
.
.TH "OPSI_DATABASE-INSIGHTS_UPDATE-AUTONOMOUS-DB" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
opsi_database-insights_update-autonomous-db \- 
.
...
.SH DESCRIPTION
.sp
Update tags for an Autonomous Database Insight resource in Operations Insights.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci opsi database\-insights update\-autonomous\-db [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export database_insight_id=<substitute\-value\-of\-database_insight_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/opsi/database\-insights/update\-autonomous\-db.html#cmdoption\-database\-insight\-id

    oci opsi database\-insights update\-autonomous\-db \-\-database\-insight\-id $database_insight_id
.ft P
.fi
.UNINDENT
.UNINDENT
