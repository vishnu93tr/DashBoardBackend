...
.
.TH "IDENTITY-DOMAINS_CONDITION_CREATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_condition_create \- 
.
...
.nf
.ft C
oci identity\-domains condition create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains condition create \-\-attribute\-name $attribute_name \-\-attribute\-value $attribute_value \-\-name $name \-\-operator $operator \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
