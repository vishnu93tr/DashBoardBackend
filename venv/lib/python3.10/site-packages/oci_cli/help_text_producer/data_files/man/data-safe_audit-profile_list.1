...
.
.TH "DATA-SAFE_AUDIT-PROFILE_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_audit-profile_list \- 
.
...
.sp
The ListAuditProfiles operation returns only the audit profiles in the specified \fIcompartmentId\fP\&. The list does not include any subcompartments of the compartmentId passed.
.sp
...
.sp
The parameter \fIcompartmentIdInSubtree\fP applies when you perform ListAuditProfiles on the \fIcompartmentId\fP passed and when it is set to true, the entire hierarchy of compartments can be returned. To get a full list of all compartments and subcompartments in the tenancy (root compartment), set the parameter \fIcompartmentIdInSubtree\fP to true and \fIaccessLevel\fP to ACCESSIBLE.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci data\-safe audit\-profile list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-audit\-collected\-volume\-greater\-than\-or\-equal\-to [integer]
.UNINDENT
.sp
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-safe/audit\-profile/list.html#cmdoption\-compartment\-id

    oci data\-safe audit\-profile list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
