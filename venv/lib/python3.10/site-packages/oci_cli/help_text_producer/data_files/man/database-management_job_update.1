...
.
.TH "DATABASE-MANAGEMENT_JOB_UPDATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
database-management_job_update \- 
.
...
.nf
.ft C
oci database\-management job update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export job_id=<substitute\-value\-of\-job_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/database\-management/job/update.html#cmdoption\-job\-id

    oci database\-management job update \-\-job\-id $job_id
.ft P
.fi
.UNINDENT
.UNINDENT
