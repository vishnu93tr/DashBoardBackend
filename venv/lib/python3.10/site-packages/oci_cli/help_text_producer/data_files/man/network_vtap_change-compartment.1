...
.
.TH "NETWORK_VTAP_CHANGE-COMPARTMENT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network_vtap_change-compartment \- 
.
...
.SH DESCRIPTION
.sp
Moves a VTAP to a new compartment within the same tenancy. For information about moving resources between compartments, see \fI\%Moving Resources to a Different Compartment\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Identity/Tasks/managingcompartments.htm#moveRes\fP>\&.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci network vtap change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the destination compartment for the VTAP move.
.INDENT 0.0
.TP
.B \-\-vtap\-id [text]
.UNINDENT
...
.ft C
    ...
    oci network vtap change\-compartment \-\-compartment\-id $compartment_id \-\-vtap\-id $vtap_id
.ft P
.fi
.UNINDENT
.UNINDENT
