...
.
.TH "CLOUD-GUARD_WLP-AGENT_CREATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
cloud-guard_wlp-agent_create \- 
.
...
.nf
.ft C
oci cloud\-guard wlp\-agent create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-certificate\-signed\-request [text]
.UNINDENT
.sp
...
.ft C
    ...
    oci cloud\-guard wlp\-agent create \-\-agent\-version $agent_version \-\-certificate\-signed\-request $certificate_signed_request \-\-compartment\-id $compartment_id \-\-os\-info $os_info
.ft P
.fi
.UNINDENT
.UNINDENT
