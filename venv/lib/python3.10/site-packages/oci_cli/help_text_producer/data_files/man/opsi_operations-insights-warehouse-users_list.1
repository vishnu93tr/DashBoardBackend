...
.
.TH "OPSI_OPERATIONS-INSIGHTS-WAREHOUSE-USERS_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
opsi_operations-insights-warehouse-users_list \- 
.
...
.nf
.ft C
oci opsi operations\-insights\-warehouse\-users list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export operations_insights_warehouse_id=<substitute\-value\-of\-operations_insights_warehouse_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/opsi/operations\-insights\-warehouse\-users/list.html#cmdoption\-operations\-insights\-warehouse\-id

    oci opsi operations\-insights\-warehouse\-users list \-\-operations\-insights\-warehouse\-id $operations_insights_warehouse_id
.ft P
.fi
.UNINDENT
.UNINDENT
