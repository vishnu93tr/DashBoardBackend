...
.
.TH "GENERATIVE-AI-AGENT_KNOWLEDGE-BASE_CHANGE-COMPARTMENT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
generative-ai-agent_knowledge-base_change-compartment \- 
.
...
.SH DESCRIPTION
.sp
Moves a knowledge base into a different compartment within the same tenancy. For information about moving resources between compartments, see \fI\%Moving Resources to a Different Compartment\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Identity/Tasks/managingcompartments.htm#moveRes\fP>\&.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci generative\-ai\-agent knowledge\-base change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the compartment to move the KnowledgeBase to.
.INDENT 0.0
.TP
...
.ft C
    ...
    oci generative\-ai\-agent knowledge\-base change\-compartment \-\-compartment\-id $compartment_id \-\-knowledge\-base\-id $knowledge_base_id
.ft P
.fi
.UNINDENT
.UNINDENT
