...
.
.TH "DEVOPS_PROJECT_GET-NOTIFICATION-PREFERENCE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
devops_project_get-notification-preference \- 
.
...
.nf
.ft C
oci devops project get\-notification\-preference [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export principal_id=<substitute\-value\-of\-principal_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/devops/project/get\-notification\-preference.html#cmdoption\-principal\-id
    ...
    oci devops project get\-notification\-preference \-\-principal\-id $principal_id \-\-project\-id $project_id
.ft P
.fi
.UNINDENT
.UNINDENT
