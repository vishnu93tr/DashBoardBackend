...
.
.TH "DB_BACKUP-DESTINATION_UPDATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_backup-destination_update \- 
.
...
.nf
.ft C
oci db backup\-destination update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export backup_destination_id=<substitute\-value\-of\-backup_destination_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/db/backup\-destination/update.html#cmdoption\-backup\-destination\-id

    oci db backup\-destination update \-\-backup\-destination\-id $backup_destination_id
.ft P
.fi
.UNINDENT
.UNINDENT
