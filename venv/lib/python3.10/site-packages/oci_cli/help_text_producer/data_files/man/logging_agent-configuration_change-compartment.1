...
.
.TH "LOGGING_AGENT-CONFIGURATION_CHANGE-COMPARTMENT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
logging_agent-configuration_change-compartment \- 
.
...
.nf
.ft C
oci logging agent\-configuration change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export config_id=<substitute\-value\-of\-config_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/logging/agent\-configuration/change\-compartment.html#cmdoption\-config\-id

    oci logging agent\-configuration change\-compartment \-\-config\-id $config_id
.ft P
.fi
.UNINDENT
.UNINDENT
