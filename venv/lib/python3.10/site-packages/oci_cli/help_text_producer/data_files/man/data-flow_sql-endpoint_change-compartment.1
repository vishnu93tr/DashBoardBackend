...
.
.TH "DATA-FLOW_SQL-ENDPOINT_CHANGE-COMPARTMENT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-flow_sql-endpoint_change-compartment \- 
.
...
.nf
.ft C
oci data\-flow sql\-endpoint change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci data\-flow sql\-endpoint change\-compartment \-\-compartment\-id $compartment_id \-\-sql\-endpoint\-id $sql_endpoint_id
.ft P
.fi
.UNINDENT
.UNINDENT
