...
.
.TH "STACK-MONITORING_RESOURCE-TASK_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
stack-monitoring_resource-task_list \- 
.
...
.nf
.ft C
oci stack\-monitoring resource\-task list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the compartment for which stack monitoring resource tasks should be listed.
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/stack\-monitoring/resource\-task/list.html#cmdoption\-compartment\-id

    oci stack\-monitoring resource\-task list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
