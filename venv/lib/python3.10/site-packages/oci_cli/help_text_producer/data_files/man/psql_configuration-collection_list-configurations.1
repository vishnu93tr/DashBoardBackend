...
.
.TH "PSQL_CONFIGURATION-COLLECTION_LIST-CONFIGURATIONS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
psql_configuration-collection_list-configurations \- 
.
...
.UNINDENT
.sp
A filter to return only resources if their \fIconfigType\fP matches the given \fIconfigType\fP\&.
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
...
.nf
.ft C
    oci psql configuration\-collection list\-configurations
.ft P
.fi
.UNINDENT
.UNINDENT
