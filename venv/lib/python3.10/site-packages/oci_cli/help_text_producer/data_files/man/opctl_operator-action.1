...
.
.TH "OPCTL_OPERATOR-ACTION" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
opctl_operator-action \- 
.
...
.sp
There are five groups available to the operator. x\-obmcs\-top\-level\-enum: ‘#/definitions/OperatorActionCategories’ enum: 
.nf
*
.fi
OPERATORACTIONCATEGORIES
.sp
The following infrastructure layers are controlled by the operator actions x\-obmcs\-top\-level\-enum: ‘#/definitions/InfrastructureLayers’ enum: 
.nf
*
.fi
...
.nf
.ft C
oci opctl operator\-action get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export operator_action_id=<substitute\-value\-of\-operator_action_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/opctl/operator\-action/get.html#cmdoption\-operator\-action\-id

    oci opctl operator\-action get \-\-operator\-action\-id $operator_action_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci opctl operator\-action list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/opctl/operator\-action/list.html#cmdoption\-compartment\-id

    oci opctl operator\-action list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
