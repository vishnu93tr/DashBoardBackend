...
.
.TH "DATABASE-MIGRATION_MIGRATION-OBJECTS_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
database-migration_migration-objects_list \- 
.
...
.nf
.ft C
oci database\-migration migration\-objects list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export migration_id=<substitute\-value\-of\-migration_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/database\-migration/migration\-objects/list.html#cmdoption\-migration\-id

    oci database\-migration migration\-objects list \-\-migration\-id $migration_id
.ft P
.fi
.UNINDENT
.UNINDENT
