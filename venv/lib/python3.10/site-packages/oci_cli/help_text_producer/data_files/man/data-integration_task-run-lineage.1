...
.
.TH "DATA-INTEGRATION_TASK-RUN-LINEAGE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-integration_task-run-lineage \- 
.
...
.UNINDENT
.SS \fBlist\-task\-run\-lineages\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.nf
.ft C
oci data\-integration task\-run\-lineage list\-task\-run\-lineages [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-time\-upated\-less\-than [datetime]
.UNINDENT
.sp
...
.ft C
    ...
    export application_key=<substitute\-value\-of\-application_key> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/task\-run\-lineage/list\-task\-run\-lineages.html#cmdoption\-application\-key
    ...
    oci data\-integration task\-run\-lineage list\-task\-run\-lineages \-\-application\-key $application_key \-\-workspace\-id $workspace_id
.ft P
.fi
.UNINDENT
.UNINDENT
.SS \fBlist_taskrun_lineages\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.nf
.ft C
oci data\-integration task\-run\-lineage list_taskrun_lineages [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci data\-integration task\-run\-lineage list_taskrun_lineages \-\-dis\-application\-id $dis_application_id \-\-workspace\-id $workspace_id
.ft P
.fi
.UNINDENT
.UNINDENT
