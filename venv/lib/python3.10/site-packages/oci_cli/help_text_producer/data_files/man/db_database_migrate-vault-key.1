...
.
.TH "DB_DATABASE_MIGRATE-VAULT-KEY" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_database_migrate-vault-key \- 
.
...
.SH DESCRIPTION
.sp
Changes encryption key management from customer\-managed, using the \fI\%Vault service\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/KeyManagement/Concepts/keyoverview.htm\fP>, to Oracle\-managed.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci db database migrate\-vault\-key [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export kms_key_id=<substitute\-value\-of\-kms_key_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/db/database/migrate\-vault\-key.html#cmdoption\-kms\-key\-id
    ...
    oci db database migrate\-vault\-key \-\-database\-id $database_id \-\-kms\-key\-id $kms_key_id
.ft P
.fi
.UNINDENT
.UNINDENT
