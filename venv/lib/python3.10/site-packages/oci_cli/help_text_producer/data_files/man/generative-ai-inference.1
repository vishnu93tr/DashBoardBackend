...
.
.TH "GENERATIVE-AI-INFERENCE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
...
.sp
Use the Generative AI service inference CLI to access your custom model endpoints, or to try the out\-of\-the\-box models to \fI\%chat\fP <\fBhttps://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/generative-ai-inference/chat-result/chat-cohere-chat-request.html\fP>, \fI\%generate text\fP, \fI\%summarize\fP, and \fI\%create text embeddings\fP\&.
.sp
To use a Generative AI custom model for inference, you must first create an endpoint for that model. Use the [Generative AI service management CLI] to \fI\%create a custom model\fP by fine\-tuning an out\-of\-the\-box model, or a previous version of a custom model, using your own data. Fine\-tune the custom model on a \fI\%fine\-tuning dedicated AI cluster\fP\&. Then, create a \fI\%hosting dedicated AI cluster\fP with an \fI\%endpoint\fP <\fBhttps://docs.cloud.oracle.com/api/#/en/generative-ai/latest/Endpoint/\fP> to host your custom model. For resource management in the Generative AI service, use the [Generative AI service management CLI].
.sp
To learn more about the service, see the \fI\%Generative AI documentation\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/generative-ai/home.htm\fP>\&.
...
.INDENT 0.0
.TP
.B \-\-guardrail\-configs [complex type]
.UNINDENT
.sp
...
.ft C
    ...
    oci generative\-ai\-inference apply\-guardrails\-result apply\-guardrails \-\-generate\-param\-json\-input input > input.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci generative\-ai\-inference apply\-guardrails\-result apply\-guardrails \-\-compartment\-id $compartment_id \-\-guardrail\-configs file://guardrail\-configs.json \-\-input file://input.json
.ft P
.fi
.UNINDENT
.UNINDENT
.SS \fBapply\-guardrails\-guardrails\-text\-input\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.INDENT 0.0
.TP
.B \-\-input\-content [text]
.UNINDENT
.sp
The actual input data.
.INDENT 0.0
.TP
.B \-\-input\-language\-code [text]
.UNINDENT
.sp
...
.nf
.ft C
oci generative\-ai\-inference chat\-result chat [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci generative\-ai\-inference chat\-result chat \-\-generate\-param\-json\-input chat\-request > chat\-request.json
    oci generative\-ai\-inference chat\-result chat \-\-generate\-param\-json\-input serving\-mode > serving\-mode.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/generative\-ai\-inference/chat\-result/chat.html#cmdoption\-compartment\-id

    oci generative\-ai\-inference chat\-result chat \-\-chat\-request file://chat\-request.json \-\-compartment\-id $compartment_id \-\-serving\-mode file://serving\-mode.json
.ft P
.fi
.UNINDENT
.UNINDENT
.SS \fBchat\-cohere\-chat\-request\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.UNINDENT
.UNINDENT
.SS \fBchat\-dedicated\-serving\-mode\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.nf
.ft C
oci generative\-ai\-inference chat\-result chat\-dedicated\-serving\-mode [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-serving\-mode\-endpoint\-id [text]
.UNINDENT
.sp
...
.nf
.ft C
    oci generative\-ai\-inference chat\-result chat\-dedicated\-serving\-mode \-\-generate\-param\-json\-input chat\-request > chat\-request.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/generative\-ai\-inference/chat\-result/chat\-dedicated\-serving\-mode.html#cmdoption\-compartment\-id
    export serving_mode_endpoint_id=<substitute\-value\-of\-serving_mode_endpoint_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/generative\-ai\-inference/chat\-result/chat\-dedicated\-serving\-mode.html#cmdoption\-serving\-mode\-endpoint\-id

    oci generative\-ai\-inference chat\-result chat\-dedicated\-serving\-mode \-\-chat\-request file://chat\-request.json \-\-compartment\-id $compartment_id \-\-serving\-mode\-endpoint\-id $serving_mode_endpoint_id
.ft P
.fi
.UNINDENT
.UNINDENT
.SS \fBchat\-generic\-chat\-request\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.UNINDENT
.UNINDENT
.SS \fBchat\-on\-demand\-serving\-mode\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.nf
.ft C
oci generative\-ai\-inference chat\-result chat\-on\-demand\-serving\-mode [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The unique ID of a model to use. You can use the \fI\%ListModels\fP <\fBhttps://docs.cloud.oracle.com/api/#/en/generative-ai/latest/ModelCollection/ListModels\fP> API to list the available models.
.SS Optional Parameters
.INDENT 0.0
.TP
.B \-\-from\-json [text]
...
.nf
.ft C
    oci generative\-ai\-inference chat\-result chat\-on\-demand\-serving\-mode \-\-generate\-param\-json\-input chat\-request > chat\-request.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/generative\-ai\-inference/chat\-result/chat\-on\-demand\-serving\-mode.html#cmdoption\-compartment\-id
    export serving_mode_model_id=<substitute\-value\-of\-serving_mode_model_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/generative\-ai\-inference/chat\-result/chat\-on\-demand\-serving\-mode.html#cmdoption\-serving\-mode\-model\-id

    oci generative\-ai\-inference chat\-result chat\-on\-demand\-serving\-mode \-\-chat\-request file://chat\-request.json \-\-compartment\-id $compartment_id \-\-serving\-mode\-model\-id $serving_mode_model_id
.ft P
.fi
.UNINDENT
.UNINDENT
.SS embed\-text\-result
.SS Description
.sp
...
.UNINDENT
.sp
Provide a list of strings or one base64 encoded image with \fIinput_type\fP setting to \fIIMAGE\fP\&. If text embedding, each string can be words, a phrase, or a paragraph. The maximum length of each string entry in the list is 512 tokens.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
.nf
.ft C
    oci generative\-ai\-inference embed\-text\-result embed\-text \-\-generate\-param\-json\-input inputs > inputs.json
...
.ft C
    ...
    oci generative\-ai\-inference embed\-text\-result embed\-text \-\-compartment\-id $compartment_id \-\-inputs file://inputs.json \-\-serving\-mode file://serving\-mode.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
 oci generative\-ai\-inference embed\-text\-result embed\-text \-\-compartment\-id $COMPARTMENT_ID \-\-serving\-mode "{\e"servingType\e": \e"ON_DEMAND\e", \e"modelId\e": \e"$SERVING_MODEL_ID\e"}" \-\-inputs "$INPUTS" \-\-read\-timeout 240 \-\-region "$REGION"
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-max\-chunks\-per\-document [integer]
.UNINDENT
.sp
...
.ft C
    ...
    oci generative\-ai\-inference rerank\-text\-result rerank\-text \-\-generate\-param\-json\-input input > input.json
...
.ft C
    ...
    oci generative\-ai\-inference rerank\-text\-result rerank\-text \-\-compartment\-id $compartment_id \-\-documents file://documents.json \-\-input file://input.json \-\-serving\-mode file://serving\-mode.json
.ft P
.fi
.UNINDENT
.UNINDENT
.SS \fBrerank\-text\-dedicated\-serving\-mode\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.ft C
    ...
    oci generative\-ai\-inference rerank\-text\-result rerank\-text\-dedicated\-serving\-mode \-\-generate\-param\-json\-input input > input.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci generative\-ai\-inference rerank\-text\-result rerank\-text\-dedicated\-serving\-mode \-\-compartment\-id $compartment_id \-\-documents file://documents.json \-\-input file://input.json \-\-serving\-mode\-endpoint\-id $serving_mode_endpoint_id
.ft P
.fi
.UNINDENT
.UNINDENT
.SS \fBrerank\-text\-on\-demand\-serving\-mode\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
