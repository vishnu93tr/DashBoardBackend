...
.
.TH "DNS_VIEW_GET" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
dns_view_get \- 
.
...
.sp
Note that attempting to get a view in the DELETED lifecycleState will result in a \fI404\fP response to be consistent with other operations of the API.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
...
.ft C
    ...
    oci dns view get \-\-view\-id $view_id
.ft P
.fi
.UNINDENT
.UNINDENT
