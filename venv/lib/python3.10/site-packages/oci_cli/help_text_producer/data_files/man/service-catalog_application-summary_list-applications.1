...
.
.TH "SERVICE-CATALOG_APPLICATION-SUMMARY_LIST-APPLICATIONS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
service-catalog_application-summary_list-applications \- 
.
...
.UNINDENT
.sp
Indicates whether to show only featured resources. If this is set to \fIfalse\fP or is omitted, then all resources will be returned.
.INDENT 0.0
.TP
.B \-\-limit [integer]
.UNINDENT
