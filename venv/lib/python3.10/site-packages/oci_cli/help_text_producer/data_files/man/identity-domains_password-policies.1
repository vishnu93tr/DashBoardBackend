...
.
.TH "IDENTITY-DOMAINS_PASSWORD-POLICIES" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_password-policies \- 
.
...
.nf
.ft C
oci identity\-domains password\-policies list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains password\-policies search [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains password\-policies search \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains password\-policies search \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
