...
.
.TH "ROVER_NODE_SET-SECRETS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
rover_node_set-secrets \- 
.
...
.SH DESCRIPTION
.sp
Assign super\-user\-password and unlock\-password for Rover Node
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci rover node set\-secrets [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
Assign super\-user\-password for RoverNode Identifier
.INDENT 0.0
.TP
.B \-\-unlock\-passphrase
.UNINDENT
.sp
Assign unlock\-passphrase for RoverNode Identifier
...
.ft C
    ...
    oci rover node set\-secrets \-\-node\-id $node_id
.ft P
.fi
.UNINDENT
.UNINDENT
