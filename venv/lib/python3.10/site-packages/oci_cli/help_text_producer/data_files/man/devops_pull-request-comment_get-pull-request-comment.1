...
.
.TH "DEVOPS_PULL-REQUEST-COMMENT_GET-PULL-REQUEST-COMMENT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
devops_pull-request-comment_get-pull-request-comment \- 
.
...
.nf
.ft C
oci devops pull\-request\-comment get\-pull\-request\-comment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export comment_id=<substitute\-value\-of\-comment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/devops/pull\-request\-comment/get\-pull\-request\-comment.html#cmdoption\-comment\-id
    ...
    oci devops pull\-request\-comment get\-pull\-request\-comment \-\-comment\-id $comment_id \-\-pull\-request\-id $pull_request_id
.ft P
.fi
.UNINDENT
.UNINDENT
