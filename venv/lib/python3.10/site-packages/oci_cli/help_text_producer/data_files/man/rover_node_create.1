...
.
.TH "ROVER_NODE_CREATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
rover_node_create \- 
.
...
.UNINDENT
.sp
Shape of the node on Rover device
...
.UNINDENT
.sp
Creating dynamic group and Assigning Policies for Rover node
.INDENT 0.0
.TP
.B \-\-shape [text]
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-time\-return\-window\-ends [datetime]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-time\-return\-window\-starts [datetime]
.UNINDENT
.sp
...
.ft C
    ...
    oci rover node create \-\-compartment\-id $compartment_id \-\-display\-name $display_name \-\-shape $shape
.ft P
.fi
.UNINDENT
.UNINDENT
