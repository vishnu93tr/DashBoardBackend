...
.
.TH "IDENTITY-DOMAINS_IDENTITY-PROPAGATION-TRUST_PUT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_identity-propagation-trust_put \- 
.
...
.nf
.ft C
oci identity\-domains identity\-propagation\-trust put [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-identity\-propagation\-trust\-id [text]
.UNINDENT
.sp
ID of the resource
.INDENT 0.0
...
.sp
\fBSCIM++ Properties:\fP  \- type: string  \- multiValued: false  \- required: true  \- mutability: readWrite  \- returned: always  \- caseExact: true  \- idcsSearchable: true  \- uniqueness: server
.INDENT 0.0
.TP
.B \-\-name [text]
.UNINDENT
...
.sp
\fBSCIM++ Properties:\fP  \- type: string  \- caseExact: false  \- idcsSearchable: true  \- multiValued: false  \- required: true  \- mutability: immutable  \- returned: default  \- uniqueness: none
.INDENT 0.0
.TP
...
.sp
\fBSCIM++ Properties:\fP  \- caseExact: true  \- idcsSearchable: false  \- required: true  \- mutability: readWrite  \- returned: default  \- type: string  \- multiValued: false  \- uniqueness: none
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
...
.sp
\fBSCIM++ Properties:\fP  \- type: string  \- multiValued: false  \- required: false  \- mutability: readWrite  \- returned: default  \- caseExact: true  \- idcsSearchable: true  \- uniqueness: none
.INDENT 0.0
.TP
.B \-\-active [boolean]
.UNINDENT
...
.sp
\fBSCIM++ Properties:\fP  \- type: boolean  \- multiValued: false  \- required: false  \- mutability: readWrite  \- returned: default  \- uniqueness: none  \- idcsSearchable: true
.INDENT 0.0
.TP
.B \-\-allow\-impersonation [boolean]
.UNINDENT
.sp
...
.sp
\fBSCIM++ Properties:\fP  \- type: boolean  \- multiValued: false  \- required: false  \- mutability: readWrite  \- returned: default  \- uniqueness: none  \- idcsSearchable: false
.INDENT 0.0
.TP
...
.INDENT 0.0
.TP
.B \-\-client\-claim\-values [complex type]
.UNINDENT
.sp
The value that corresponds to the client claim name used to identify to whom the token is issued.
.sp
\fBSCIM++ Properties:\fP  \- type: string  \- multiValued: true  \- required: false  \- mutability: readWrite  \- returned: default  \- uniqueness: none  \- caseExact: true  \- idcsSearchable: false
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
.sp
\fBSCIM++ Properties:\fP  \- type: string  \- multiValued: false  \- required: false  \- mutability: readWrite  \- returned: default  \- uniqueness: none  \- caseExact: false  \- idcsSearchable: false
.INDENT 0.0
.TP
.B \-\-domain\-ocid [text]
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-impersonation\-service\-users [complex type]
.UNINDENT
.sp
The Impersonating Principal.
.sp
\fBSCIM++ Properties:\fP  \- idcsCompositeKey: [rule, value]  \- idcsSearchable: false  \- multiValued: true  \- mutability: readWrite  \- required: false  \- returned: request  \- type: complex  \- uniqueness: none
.sp
This option is a JSON list with items of type IdentityPropagationTrustImpersonationServiceUsers.  For documentation on IdentityPropagationTrustImpersonationServiceUsers please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/identitydomains/v1/datatypes/IdentityPropagationTrustImpersonationServiceUsers\fP\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
.INDENT 0.0
.TP
.B \-\-subject\-claim\-name [text]
.UNINDENT
.sp
Used for locating the subject claim from the incoming token.
.sp
\fBSCIM++ Properties:\fP  \- type: string  \- multiValued: false  \- required: false  \- mutability: readWrite  \- returned: default  \- uniqueness: none  \- caseExact: true  \- idcsSearchable: false
.INDENT 0.0
.TP
.B \-\-subject\-mapping\-attribute [text]
.UNINDENT
.sp
Subject Mapping Attribute to which the value from subject claim name value would be used for identity lookup.
.sp
\fBSCIM++ Properties:\fP  \- type: string  \- multiValued: false  \- idcsSearchable: false  \- required: false  \- mutability: readWrite  \- returned: default  \- uniqueness: none
.INDENT 0.0
.TP
.B \-\-subject\-type [text]
.UNINDENT
...
.nf
.ft C
    oci identity\-domains identity\-propagation\-trust create \-\-generate\-param\-json\-input schemas > schemas.json

    oci identity\-domains identity\-propagation\-trust put \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export issuer=<substitute\-value\-of\-issuer> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/identity\-domains/identity\-propagation\-trust/create.html#cmdoption\-issuer
    export name=<substitute\-value\-of\-name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/identity\-domains/identity\-propagation\-trust/create.html#cmdoption\-name
    export type=<substitute\-value\-of\-type> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/identity\-domains/identity\-propagation\-trust/create.html#cmdoption\-type

    identity_propagation_trust_id=$(oci identity\-domains identity\-propagation\-trust create \-\-issuer $issuer \-\-name $name \-\-schemas file://schemas.json \-\-type $type \-\-query data.id \-\-raw\-output)

    oci identity\-domains identity\-propagation\-trust put \-\-identity\-propagation\-trust\-id $identity_propagation_trust_id \-\-issuer $issuer \-\-name $name \-\-schemas file://schemas.json \-\-type $type
.ft P
.fi
.UNINDENT
.UNINDENT
