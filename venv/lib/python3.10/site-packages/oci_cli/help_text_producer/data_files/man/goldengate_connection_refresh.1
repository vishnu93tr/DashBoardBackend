...
.
.TH "GOLDENGATE_CONNECTION_REFRESH" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
...
.nf
.ft C
oci goldengate connection refresh [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export connection_id=<substitute\-value\-of\-connection_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/goldengate/connection/refresh.html#cmdoption\-connection\-id

    oci goldengate connection refresh \-\-connection\-id $connection_id
.ft P
.fi
.UNINDENT
.UNINDENT
