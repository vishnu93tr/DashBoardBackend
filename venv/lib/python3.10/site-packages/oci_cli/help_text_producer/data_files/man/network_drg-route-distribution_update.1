...
.
.TH "NETWORK_DRG-ROUTE-DISTRIBUTION_UPDATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network_drg-route-distribution_update \- 
.
...
.nf
.ft C
oci network drg\-route\-distribution update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export route_distribution_id=<substitute\-value\-of\-route_distribution_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/network/drg\-route\-distribution/update.html#cmdoption\-route\-distribution\-id

    oci network drg\-route\-distribution update \-\-route\-distribution\-id $route_distribution_id
.ft P
.fi
.UNINDENT
.UNINDENT
