...
.
.TH "OPSI_WORK-REQUESTS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
opsi_work-requests \- 
.
...
.nf
.ft C
oci opsi work\-requests get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export work_request_id=<substitute\-value\-of\-work_request_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/opsi/work\-requests/get.html#cmdoption\-work\-request\-id

    oci opsi work\-requests get \-\-work\-request\-id $work_request_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci opsi work\-requests list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
