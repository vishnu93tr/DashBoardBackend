...
.
.TH "IDENTITY-DOMAINS_SMTP-CREDENTIAL" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_smtp-credential \- 
.
...
.nf
.ft C
oci identity\-domains smtp\-credential create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
User name
.sp
\fBSCIM++ Properties:\fP  \- caseExact: false  \- type: string  \- mutability: readOnly  \- required: true  \- returned: default
...
Password
.sp
\fBSCIM++ Properties:\fP  \- caseExact: true  \- type: string  \- mutability: readOnly  \- required: false  \- returned: default  \- idcsSensitive: hash_sc
.INDENT 0.0
.TP
...
.nf
.ft C
    oci identity\-domains smtp\-credential create \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export user_name=<substitute\-value\-of\-user_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/identity\-domains/smtp\-credential/create.html#cmdoption\-user\-name

    oci identity\-domains smtp\-credential create \-\-schemas file://schemas.json \-\-user\-name $user_name
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains smtp\-credential delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    smtp_credential_id=$(oci identity\-domains smtp\-credential create \-\-schemas file://schemas.json \-\-user\-name $user_name \-\-query data.id \-\-raw\-output)

    oci identity\-domains smtp\-credential delete \-\-smtp\-credential\-id $smtp_credential_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains smtp\-credential get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains smtp\-credential get \-\-smtp\-credential\-id $smtp_credential_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains smtp\-credential patch [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains smtp\-credential patch \-\-generate\-param\-json\-input operations > operations.json
    oci identity\-domains smtp\-credential patch \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains smtp\-credential patch \-\-operations file://operations.json \-\-schemas file://schemas.json \-\-smtp\-credential\-id $smtp_credential_id
.ft P
.fi
.UNINDENT
.UNINDENT
