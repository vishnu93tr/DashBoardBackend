...
.
.TH "OS-MANAGEMENT-HUB_SOFTWARE-SOURCE_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
os-management-hub_software-source_list \- 
.
...
.SH DESCRIPTION
.sp
Lists software sources that match the specified tenancy or software source \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP>\&. Filter the list against a variety of criteria including but not limited to its name, status, architecture, and OS family.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> for the software source.
.INDENT 0.0
.TP
.B \-\-software\-source\-type [text]
.UNINDENT
.sp
