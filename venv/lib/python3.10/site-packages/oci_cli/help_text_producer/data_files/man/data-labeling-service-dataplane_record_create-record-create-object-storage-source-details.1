...
.
.TH "DATA-LABELING-SERVICE-DATAPLANE_RECORD_CREATE-RECORD-CREATE-OBJECT-STORAGE-SOURCE-DETAILS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-labeling-service-dataplane_record_create-record-create-object-storage-source-details \- 
.
...
.INDENT 0.0
.TP
.B \-\-source\-details\-relative\-path [text]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-record\-metadata [complex type]
.UNINDENT
.sp
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
