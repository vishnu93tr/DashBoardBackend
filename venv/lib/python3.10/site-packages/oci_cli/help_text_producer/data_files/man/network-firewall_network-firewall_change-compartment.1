...
.
.TH "NETWORK-FIREWALL_NETWORK-FIREWALL_CHANGE-COMPARTMENT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network-firewall_network-firewall_change-compartment \- 
.
...
.nf
.ft C
oci network\-firewall network\-firewall change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the compartment into which the Network Firewalll resource should be moved.
.INDENT 0.0
.TP
.B \-\-network\-firewall\-id [text]
.UNINDENT
.sp
...
.ft C
    ...
    oci network\-firewall network\-firewall change\-compartment \-\-compartment\-id $compartment_id \-\-network\-firewall\-id $network_firewall_id
.ft P
.fi
.UNINDENT
.UNINDENT
