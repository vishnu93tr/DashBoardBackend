...
.
.TH "DATA-SAFE_REFERENTIAL-RELATION_CREATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-safe_referential-relation_create \- 
.
...
.nf
.ft C
oci data\-safe referential\-relation create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci data\-safe referential\-relation create \-\-generate\-param\-json\-input child > child.json
    oci data\-safe referential\-relation create \-\-generate\-param\-json\-input parent > parent.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export relation_type=<substitute\-value\-of\-relation_type> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-safe/referential\-relation/create.html#cmdoption\-relation\-type
    ...
    oci data\-safe referential\-relation create \-\-child file://child.json \-\-parent file://parent.json \-\-relation\-type $relation_type \-\-sensitive\-data\-model\-id $sensitive_data_model_id
.ft P
.fi
.UNINDENT
.UNINDENT
