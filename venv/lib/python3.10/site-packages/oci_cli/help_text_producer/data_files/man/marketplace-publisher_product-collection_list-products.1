...
.
.TH "MARKETPLACE-PUBLISHER_PRODUCT-COLLECTION_LIST-PRODUCTS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
marketplace-publisher_product-collection_list-products \- 
.
...
.nf
.ft C
oci marketplace\-publisher product\-collection list\-products [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/marketplace\-publisher/product\-collection/list\-products.html#cmdoption\-compartment\-id

    oci marketplace\-publisher product\-collection list\-products \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
