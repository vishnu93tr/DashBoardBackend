...
.
.TH "DATA-INTEGRATION_WORKSPACE_DELETE-IMPORT-REQUEST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-integration_workspace_delete-import-request \- 
.
...
.nf
.ft C
oci data\-integration workspace delete\-import\-request [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export import_request_key=<substitute\-value\-of\-import_request_key> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/workspace/delete\-import\-request.html#cmdoption\-import\-request\-key
    ...
    oci data\-integration workspace delete\-import\-request \-\-import\-request\-key $import_request_key \-\-workspace\-id $workspace_id
.ft P
.fi
.UNINDENT
.UNINDENT
