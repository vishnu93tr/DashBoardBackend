...
.
.TH "FUSION-APPS_FUSION-ENVIRONMENT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
fusion-apps_fusion-environment \- 
.
...
delete
.IP \(bu 2
delete\-fusion\-environment\-admin\-user
.IP \(bu 2
generate\-extract\-details
.IP \(bu 2
get
.IP \(bu 2
initiate\-extract
...
list\-admin\-users
.IP \(bu 2
reset\-fusion\-environment\-password
.IP \(bu 2
update
.UNINDENT
...
.nf
.ft C
oci fusion\-apps fusion\-environment change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci fusion\-apps fusion\-environment change\-compartment \-\-compartment\-id $compartment_id \-\-fusion\-environment\-id $fusion_environment_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-create\-fusion\-environment\-admin\-user\-details [complex type]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-additional\-language\-packs [complex type]
.UNINDENT
.sp
Language packs.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
...
.INDENT 0.0
.TP
.B \-\-maintenance\-policy [complex type]
.UNINDENT
.sp
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
...
Rules.
.sp
This option is a JSON list with items of type Rule.  For documentation on Rule please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/fusionapplications/20211201/datatypes/Rule\fP\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
.UNINDENT
.UNINDENT
.SS \fBcreate\-fusion\-environment\-admin\-user\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.nf
.ft C
oci fusion\-apps fusion\-environment delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci fusion\-apps fusion\-environment delete \-\-fusion\-environment\-id $fusion_environment_id
.ft P
.fi
.UNINDENT
.UNINDENT
.SS \fBdelete\-fusion\-environment\-admin\-user\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.nf
.ft C
oci fusion\-apps fusion\-environment delete\-fusion\-environment\-admin\-user [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export display_name=<substitute\-value\-of\-display_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/fusion\-apps/fusion\-environment\-family/create.html#cmdoption\-display\-name
    export fusion_environment_type=<substitute\-value\-of\-fusion_environment_type> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/fusion\-apps/fusion\-environment/create.html#cmdoption\-fusion\-environment\-type
    export admin_username=<substitute\-value\-of\-admin_username> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/fusion\-apps/fusion\-environment/delete\-fusion\-environment\-admin\-user.html#cmdoption\-admin\-username

    fusion_environment_family_id=$(oci fusion\-apps fusion\-environment\-family create \-\-compartment\-id $compartment_id \-\-display\-name $display_name \-\-subscription\-ids file://subscription\-ids.json \-\-query data.id \-\-raw\-output)

    fusion_environment_id=$(oci fusion\-apps fusion\-environment create \-\-compartment\-id $compartment_id \-\-create\-fusion\-environment\-admin\-user\-details file://create\-fusion\-environment\-admin\-user\-details.json \-\-display\-name $display_name \-\-fusion\-environment\-family\-id $fusion_environment_family_id \-\-fusion\-environment\-type $fusion_environment_type \-\-query data.id \-\-raw\-output)

    oci fusion\-apps fusion\-environment delete\-fusion\-environment\-admin\-user \-\-admin\-username $admin_username \-\-fusion\-environment\-id $fusion_environment_id
.ft P
.fi
.UNINDENT
.UNINDENT
.SS \fBgenerate\-extract\-details\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.nf
.ft C
oci fusion\-apps fusion\-environment generate\-extract\-details [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci fusion\-apps fusion\-environment generate\-extract\-details \-\-fusion\-environment\-id $fusion_environment_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci fusion\-apps fusion\-environment get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci fusion\-apps fusion\-environment get \-\-fusion\-environment\-id $fusion_environment_id
.ft P
.fi
.UNINDENT
.UNINDENT
.SS \fBinitiate\-extract\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.nf
.ft C
oci fusion\-apps fusion\-environment initiate\-extract [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci fusion\-apps fusion\-environment initiate\-extract \-\-fusion\-environment\-id $fusion_environment_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci fusion\-apps fusion\-environment list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/fusion\-apps/fusion\-environment/list.html#cmdoption\-compartment\-id

    oci fusion\-apps fusion\-environment list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
.SS \fBlist\-admin\-users\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.nf
.ft C
oci fusion\-apps fusion\-environment list\-admin\-users [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci fusion\-apps fusion\-environment list\-admin\-users \-\-fusion\-environment\-id $fusion_environment_id
.ft P
.fi
.UNINDENT
.UNINDENT
.SS \fBreset\-fusion\-environment\-password\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.nf
.ft C
oci fusion\-apps fusion\-environment reset\-fusion\-environment\-password [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export display_name=<substitute\-value\-of\-display_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/fusion\-apps/fusion\-environment\-family/create.html#cmdoption\-display\-name
    export fusion_environment_type=<substitute\-value\-of\-fusion_environment_type> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/fusion\-apps/fusion\-environment/create.html#cmdoption\-fusion\-environment\-type
    export admin_username=<substitute\-value\-of\-admin_username> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/fusion\-apps/fusion\-environment/reset\-fusion\-environment\-password.html#cmdoption\-admin\-username
    export password=<substitute\-value\-of\-password> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/fusion\-apps/fusion\-environment/reset\-fusion\-environment\-password.html#cmdoption\-password

    fusion_environment_family_id=$(oci fusion\-apps fusion\-environment\-family create \-\-compartment\-id $compartment_id \-\-display\-name $display_name \-\-subscription\-ids file://subscription\-ids.json \-\-query data.id \-\-raw\-output)

    fusion_environment_id=$(oci fusion\-apps fusion\-environment create \-\-compartment\-id $compartment_id \-\-create\-fusion\-environment\-admin\-user\-details file://create\-fusion\-environment\-admin\-user\-details.json \-\-display\-name $display_name \-\-fusion\-environment\-family\-id $fusion_environment_family_id \-\-fusion\-environment\-type $fusion_environment_type \-\-query data.id \-\-raw\-output)

    oci fusion\-apps fusion\-environment reset\-fusion\-environment\-password \-\-admin\-username $admin_username \-\-fusion\-environment\-id $fusion_environment_id \-\-password $password
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
Network access control rules to limit internet traffic that can access the environment. For more information, see \fI\%AllowRule Reference\fP <\fBhttps://docs.cloud.oracle.com/api/#/en/fusion-applications/latest/datatypes/AllowRule\fP>\&.
.sp
This option is a JSON list with items of type Rule.  For documentation on Rule please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/fusionapplications/20211201/datatypes/Rule\fP\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
