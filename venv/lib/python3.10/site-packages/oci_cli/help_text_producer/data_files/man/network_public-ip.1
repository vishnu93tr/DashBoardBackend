...
.
.TH "NETWORK_PUBLIC-IP" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network_public-ip \- 
.
...
.sp
For more information and comparison of the two types, see \fI\%Public IP Addresses\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Network/Tasks/managingpublicIPs.htm\fP>\&.
...
.SS Description
.sp
Moves a public IP into a different compartment within the same tenancy. For information about moving resources between compartments, see \fI\%Moving Resources to a Different Compartment\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Identity/Tasks/managingcompartments.htm#moveRes\fP>\&.
.sp
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the compartment to move the public IP to.
.INDENT 0.0
.TP
.B \-\-public\-ip\-id [text]
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the public IP.
...
.SS Description
.sp
Creates a public IP. Use the \fIlifetime\fP property to specify whether it’s an ephemeral or reserved public IP. For information about limits on how many you can create, see \fI\%Public IP Addresses\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Network/Tasks/managingpublicIPs.htm\fP>\&.
.INDENT 0.0
.IP \(bu 2
\fBFor an ephemeral public IP assigned to a private IP:\fP You must also specify a \fIprivateIpId\fP with the \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the primary private IP you want to assign the public IP to. The public IP is created in the same availability domain as the private IP. An ephemeral public IP must always be assigned to a private IP, and only to the \fIprimary\fP private IP on a VNIC, not a secondary private IP. Exception: If you create a \fI\%NatGateway\fP <\fBhttps://docs.cloud.oracle.com/api/#/en/iaas/latest/NatGateway/\fP>, Oracle automatically assigns the NAT gateway a regional ephemeral public IP that you cannot remove.
.IP \(bu 2
\fBFor a reserved public IP:\fP You may also optionally assign the public IP to a private IP by specifying \fIprivateIpId\fP\&. Or you can later assign the public IP with \fI\%UpdatePublicIp\fP <\fBhttps://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/network/public-ip/update.html\fP>\&.
.UNINDENT
.sp
...
.sp
Also, for reserved public IPs, the optional assignment part of this operation is asynchronous. Poll the public IP’s \fIlifecycleState\fP to determine if the assignment succeeded.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the compartment to contain the public IP. For ephemeral public IPs, you must set this to the private IP’s compartment \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP>\&.
.INDENT 0.0
.TP
.B \-\-lifetime [text]
.UNINDENT
.sp
Defines when the public IP is deleted and released back to the Oracle Cloud Infrastructure public IP pool. For more information, see \fI\%Public IP Addresses\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Network/Tasks/managingpublicIPs.htm\fP>\&.
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the private IP to assign the public IP to.
.sp
...
.sp
Optional for a reserved public IP. If you don’t provide it, the public IP is created but not assigned to a private IP. You can later assign the public IP with \fI\%UpdatePublicIp\fP <\fBhttps://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/network/public-ip/update.html\fP>\&.
.INDENT 0.0
.TP
.B \-\-public\-ip\-pool\-id [text]
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the public IP pool.
.INDENT 0.0
.TP
...
.SS Description
.sp
Unassigns and deletes the specified public IP (either ephemeral or reserved). You must specify the object’s \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP>\&. The public IP address is returned to the Oracle Cloud Infrastructure public IP pool.
.sp
...
.sp
For an assigned reserved public IP, the initial unassignment portion of this operation is asynchronous. Poll the public IP’s \fIlifecycleState\fP to determine if the operation succeeded.
.sp
If you want to simply unassign a reserved public IP and return it to your pool of reserved public IPs, instead use \fI\%UpdatePublicIp\fP <\fBhttps://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/network/public-ip/update.html\fP>\&.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
...
.SS Description
.sp
Updates the specified public IP. You must specify the object’s \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP>\&. Use this operation if you want to:
.INDENT 0.0
.IP \(bu 2
...
.UNINDENT
.sp
Assigning, moving, and unassigning a reserved public IP are asynchronous operations. Poll the public IP’s \fIlifecycleState\fP to determine if the operation succeeded.
.sp
\fBNote:\fP When moving a reserved public IP, the target private IP must not already have a public IP with \fIlifecycleState\fP = ASSIGNING or ASSIGNED. If it does, an error is returned. Also, the initial unassignment from the original private IP always succeeds, but the assignment to the target private IP is asynchronous and could fail silently (for example, if the target private IP is deleted or has a different public IP assigned to it in the interim). If that occurs, the public IP remains unassigned and its \fIlifecycleState\fP switches to AVAILABLE (it is not reassigned to its original private IP). You must poll the public IP’s \fIlifecycleState\fP to determine if the move succeeded.
.sp
Regarding ephemeral public IPs:
.INDENT 0.0
.IP \(bu 2
If you want to assign an ephemeral public IP to a primary private IP, use \fI\%CreatePublicIp\fP <\fBhttps://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/network/public-ip/create.html\fP>\&. * You can’t move an ephemeral public IP to a different private IP. * If you want to unassign an ephemeral public IP from its private IP, use \fI\%DeletePublicIp\fP <\fBhttps://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/network/public-ip/delete.html\fP>, which unassigns and deletes the ephemeral public IP.
.UNINDENT
.sp
\fBNote:\fP If a public IP is assigned to a secondary private IP (see \fI\%PrivateIp\fP <\fBhttps://docs.cloud.oracle.com/api/#/en/iaas/latest/PrivateIp/\fP>), and you move that secondary private IP to another VNIC, the public IP moves with it.
.sp
\fBNote:\fP There’s a limit to the number of \fI\%public IPs\fP <\fBhttps://docs.cloud.oracle.com/api/#/en/iaas/latest/PublicIp/\fP> a VNIC or instance can have. If you try to move a reserved public IP to a VNIC or instance that has already reached its public IP limit, an error is returned. For information about the public IP limits, see \fI\%Public IP Addresses\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Network/Tasks/managingpublicIPs.htm\fP>\&.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
