...
.
.TH "DATA-CATALOG_PATTERN_UPDATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-catalog_pattern_update \- 
.
...
.INDENT 0.0
.TP
.B \-\-check\-file\-path\-list [complex type]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-is\-enable\-check\-failure\-limit [boolean]
.UNINDENT
.sp
...
.UNINDENT
.sp
A map of maps that contains the properties which are specific to the pattern type. Each pattern type definition defines it’s set of required and optional properties. Example: \fI{“properties”: { “default”: { “tbd”}}}\fP
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
.ft C
    ...
    export pattern_key=<substitute\-value\-of\-pattern_key> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-catalog/pattern/update.html#cmdoption\-pattern\-key

    catalog_id=$(oci data\-catalog catalog create \-\-compartment\-id $compartment_id \-\-query data.id \-\-raw\-output)

    oci data\-catalog pattern update \-\-catalog\-id $catalog_id \-\-pattern\-key $pattern_key
.ft P
.fi
.UNINDENT
.UNINDENT
