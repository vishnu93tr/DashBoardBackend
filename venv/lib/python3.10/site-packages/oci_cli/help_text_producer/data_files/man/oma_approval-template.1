...
.
.TH "OMA_APPROVAL-TEMPLATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
oma_approval-template \- 
.
...
.nf
.ft C
oci oma approval\-template change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/oma/approval\-template/create.html#cmdoption\-compartment\-id

    approval_template_id=$(oci oma approval\-template create \-\-compartment\-id $compartment_id \-\-query data.id \-\-raw\-output)

    oci oma approval\-template change\-compartment \-\-approval\-template\-id $approval_template_id \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci oma approval\-template create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-approver\-levels [complex type]
.UNINDENT
.sp
...
.ft C
    ...
    oci oma approval\-template create \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci oma approval\-template delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci oma approval\-template delete \-\-approval\-template\-id $approval_template_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci oma approval\-template get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci oma approval\-template get \-\-approval\-template\-id $approval_template_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci oma approval\-template update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci oma approval\-template update \-\-approval\-template\-id $approval_template_id
.ft P
.fi
.UNINDENT
.UNINDENT
