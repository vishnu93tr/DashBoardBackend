...
.
.TH "NETWORK-FIREWALL_SERVICE_CREATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network-firewall_service_create \- 
.
...
.nf
.ft C
oci network\-firewall service create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export name=<substitute\-value\-of\-name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/network\-firewall/service/create.html#cmdoption\-name
    ...
    oci network\-firewall service create \-\-name $name \-\-network\-firewall\-policy\-id $network_firewall_policy_id
.ft P
.fi
.UNINDENT
.UNINDENT
