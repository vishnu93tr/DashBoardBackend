...
.
.TH "IDENTITY-DOMAINS_PASSWORD-POLICY" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_password-policy \- 
.
...
.INDENT 0.0
.TP
.B \-\-disallowed\-user\-attribute\-values [complex type]
.UNINDENT
.sp
List of User attributes whose values are not allowed in the password.
.sp
\fBAdded In:\fP 2303212224
.sp
...
.nf
.ft C
oci identity\-domains password\-policy delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    password_policy_id=$(oci identity\-domains password\-policy create \-\-name $name \-\-schemas file://schemas.json \-\-query data.id \-\-raw\-output)

    oci identity\-domains password\-policy delete \-\-password\-policy\-id $password_policy_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains password\-policy get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains password\-policy get \-\-password\-policy\-id $password_policy_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains password\-policy patch [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains password\-policy patch \-\-generate\-param\-json\-input operations > operations.json
    oci identity\-domains password\-policy patch \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains password\-policy patch \-\-operations file://operations.json \-\-password\-policy\-id $password_policy_id \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains password\-policy put \-\-name $name \-\-password\-policy\-id $password_policy_id \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
