...
.
.TH "OS-MANAGEMENT-HUB_EVENT_UPDATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
os-management-hub_event_update \- 
.
...
.nf
.ft C
oci os\-management\-hub event update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export event_id=<substitute\-value\-of\-event_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/os\-management\-hub/event/update.html#cmdoption\-event\-id

    oci os\-management\-hub event update \-\-event\-id $event_id
.ft P
.fi
.UNINDENT
.UNINDENT
