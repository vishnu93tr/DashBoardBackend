...
.
.TH "DB_FLEX-COMPONENT_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_flex-component_list \- 
.
...
.nf
.ft C
oci db flex\-component list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The field to sort by.  You can provide one sort order (\fIsortOrder\fP).  Default order for NAME is ascending. The NAME sort order is case sensitive.
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/db/flex\-component/list.html#cmdoption\-compartment\-id

    oci db flex\-component list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
