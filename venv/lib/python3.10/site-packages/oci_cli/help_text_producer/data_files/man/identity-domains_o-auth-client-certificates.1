...
.
.TH "IDENTITY-DOMAINS_O-AUTH-CLIENT-CERTIFICATES" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_o-auth-client-certificates \- 
.
...
.nf
.ft C
oci identity\-domains o\-auth\-client\-certificates list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains o\-auth\-client\-certificates list
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains o\-auth\-client\-certificates search [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains o\-auth\-client\-certificates search \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains o\-auth\-client\-certificates search \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
