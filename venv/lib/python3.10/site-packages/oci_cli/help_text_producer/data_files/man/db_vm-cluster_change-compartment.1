...
.
.TH "DB_VM-CLUSTER_CHANGE-COMPARTMENT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
db_vm-cluster_change-compartment \- 
.
...
.SH DESCRIPTION
.sp
Moves a VM cluster and its dependent resources to another compartment. Applies to Exadata \fI\%Cloud@Customer\fP <\fBCloud@Customer\fP> instances only. To move a cloud VM cluster in an Exadata Cloud Service instance to another compartment, use the \fI\%ChangeCloudVmClusterCompartment\fP <\fBhttps://docs.cloud.oracle.com/api/#/en/database/latest/CloudVmCluster/ChangeCloudVmClusterCompartment\fP> operation.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci db vm\-cluster change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the compartment to move the VM cluster to.
.INDENT 0.0
.TP
...
.ft C
    ...
    oci db vm\-cluster change\-compartment \-\-compartment\-id $compartment_id \-\-vm\-cluster\-id $vm_cluster_id
.ft P
.fi
.UNINDENT
.UNINDENT
