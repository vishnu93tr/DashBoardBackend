...
.
.TH "RESOURCE-MANAGER_STACK_GET-STACK-TF-CONFIG" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
resource-manager_stack_get-stack-tf-config \- 
.
...
.nf
.ft C
oci resource\-manager stack get\-stack\-tf\-config [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export file=<substitute\-value\-of\-file> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/resource\-manager/stack/get\-stack\-tf\-config.html#cmdoption\-file
    ...
    oci resource\-manager stack get\-stack\-tf\-config \-\-file $file \-\-stack\-id $stack_id
.ft P
.fi
.UNINDENT
.UNINDENT
