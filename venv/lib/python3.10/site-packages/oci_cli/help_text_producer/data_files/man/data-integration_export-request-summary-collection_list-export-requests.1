...
.
.TH "DATA-INTEGRATION_EXPORT-REQUEST-SUMMARY-COLLECTION_LIST-EXPORT-REQUESTS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-integration_export-request-summary-collection_list-export-requests \- 
.
...
.nf
.ft C
FAILED, IN_PROGRESS, QUEUED, SUCCESSFUL, TERMINATED, TERMINATING
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci data\-integration export\-request\-summary\-collection list\-export\-requests \-\-workspace\-id $workspace_id
.ft P
.fi
.UNINDENT
.UNINDENT
