...
.
.TH "DATA-INTEGRATION_TEMPLATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-integration_template \- 
.
...
.nf
.ft C
oci data\-integration template get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export template_id=<substitute\-value\-of\-template_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-integration/template/get.html#cmdoption\-template\-id
    ...
    oci data\-integration template get \-\-template\-id $template_id \-\-workspace\-id $workspace_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci data\-integration template list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci data\-integration template list \-\-workspace\-id $workspace_id
.ft P
.fi
.UNINDENT
.UNINDENT
