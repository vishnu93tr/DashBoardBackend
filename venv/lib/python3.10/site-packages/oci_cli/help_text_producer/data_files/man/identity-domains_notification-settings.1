...
.
.TH "IDENTITY-DOMAINS_NOTIFICATION-SETTINGS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_notification-settings \- 
.
...
.nf
.ft C
oci identity\-domains notification\-settings list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains notification\-settings list
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains notification\-settings search [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains notification\-settings search \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains notification\-settings search \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
