...
.
.TH "FUSION-APPS_SCHEDULED-ACTIVITY" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
fusion-apps_scheduled-activity \- 
.
...
.nf
.ft C
oci fusion\-apps scheduled\-activity get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export scheduled_activity_id=<substitute\-value\-of\-scheduled_activity_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/fusion\-apps/scheduled\-activity/get.html#cmdoption\-scheduled\-activity\-id
    ...
    oci fusion\-apps scheduled\-activity get \-\-fusion\-environment\-id $fusion_environment_id \-\-scheduled\-activity\-id $scheduled_activity_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci fusion\-apps scheduled\-activity list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
MONTHLY, ONEOFF, QUARTERLY, VERTEX
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
MAINTENANCE, POST_MAINTENANCE, PRE_MAINTENANCE
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci fusion\-apps scheduled\-activity list \-\-fusion\-environment\-id $fusion_environment_id
.ft P
.fi
.UNINDENT
.UNINDENT
