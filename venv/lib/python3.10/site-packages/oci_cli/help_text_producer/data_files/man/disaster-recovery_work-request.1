...
.
.TH "DISASTER-RECOVERY_WORK-REQUEST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
disaster-recovery_work-request \- 
.
...
.SS Description
.sp
Cancel the work request identified by \fIworkRequestId\fP\&.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci disaster\-recovery work\-request cancel [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export work_request_id=<substitute\-value\-of\-work_request_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/disaster\-recovery/work\-request/cancel.html#cmdoption\-work\-request\-id

    oci disaster\-recovery work\-request cancel \-\-work\-request\-id $work_request_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.SS Description
.sp
Get the status of the work request identified by \fIworkRequestId\fP\&.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci disaster\-recovery work\-request get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export work_request_id=<substitute\-value\-of\-work_request_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/disaster\-recovery/work\-request/get.html#cmdoption\-work\-request\-id

    oci disaster\-recovery work\-request get \-\-work\-request\-id $work_request_id
.ft P
.fi
.UNINDENT
.UNINDENT
