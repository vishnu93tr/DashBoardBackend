...
.
.TH "FS_FILESYSTEM-SNAPSHOT-POLICY_CREATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
fs_filesystem-snapshot-policy_create \- 
.
...
.nf
.ft C
oci fs filesystem\-snapshot\-policy create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the compartment that contains the file system snapshot policy.
...
.sp
If using the CLI, provide the schedule as a list of JSON strings, with the list wrapped in quotation marks, i.e. \fB\(ga   \-\-schedules \(aq[{"timeZone":"UTC","period":"DAILY","hourOfDay":18},{"timeZone":"UTC","period":"HOURLY"}]\(aq \(ga\fP
.sp
This option is a JSON list with items of type SnapshotSchedule.  For documentation on SnapshotSchedule please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/filestorage/20171215/datatypes/SnapshotSchedule\fP\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
