...
.
.TH "DEVOPS_BUILD-RUN_UPDATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
devops_build-run_update \- 
.
...
.nf
.ft C
oci devops build\-run update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci devops build\-run update \-\-build\-run\-id $build_run_id
.ft P
.fi
.UNINDENT
.UNINDENT
