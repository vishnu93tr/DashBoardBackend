...
.
.TH "NETWORK_CAPTURE-FILTER_UPDATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network_capture-filter_update \- 
.
...
.nf
.ft C
oci network capture\-filter update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-capture\-filter\-id [text]
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the capture filter.
...
.ft C
    ...
    oci network capture\-filter update \-\-capture\-filter\-id $capture_filter_id
.ft P
.fi
.UNINDENT
.UNINDENT
