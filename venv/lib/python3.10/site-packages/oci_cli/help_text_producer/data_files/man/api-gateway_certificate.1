...
.
.TH "API-GATEWAY_CERTIFICATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
api-gateway_certificate \- 
.
...
.SH DESCRIPTION
.sp
A certificate contains information to be installed on a gateway to secure the traffic going through it. For more information, see \fI\%API Gateway Concepts\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/APIGateway/Concepts/apigatewayconcepts.htm\fP>\&.
...
.nf
.ft C
oci api\-gateway certificate change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci api\-gateway certificate change\-compartment \-\-certificate\-id $certificate_id \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci api\-gateway certificate create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-intermediate\-certificates\-file [filename]
.UNINDENT
.sp
Location of file containing the intermediate
...
.ft C
    ...
    oci api\-gateway certificate create \-\-certificate\-file $certificate_file \-\-compartment\-id $compartment_id \-\-private\-key\-file $private_key_file
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci api\-gateway certificate delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci api\-gateway certificate delete \-\-certificate\-id $certificate_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci api\-gateway certificate get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci api\-gateway certificate get \-\-certificate\-id $certificate_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci api\-gateway certificate list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/api\-gateway/certificate/list.html#cmdoption\-compartment\-id

    oci api\-gateway certificate list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci api\-gateway certificate update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci api\-gateway certificate update \-\-certificate\-id $certificate_id
.ft P
.fi
.UNINDENT
.UNINDENT
