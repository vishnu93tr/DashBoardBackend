...
.
.TH "NETWORK_IP-SEC-CONNECTION_GET-IPSEC-CPE-DEVICE-CONFIG-CONTENT" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
...
.sp
The operation returns configuration information for all tunnels in the single specified \fI\%IPSecConnection\fP <\fBhttps://docs.cloud.oracle.com/api/#/en/iaas/latest/IPSecConnection/\fP> object. Here are other similar operations:
.INDENT 0.0
.INDENT 3.5
.INDENT 0.0
.IP \(bu 2
\fI\%GetTunnelCpeDeviceConfigContent\fP <\fBhttps://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/network/tunnel-cpe-device-config/get-tunnel-cpe-device-config-content.html\fP>   returns CPE configuration content for a specific tunnel within an IPSec connection.   * \fI\%GetCpeDeviceConfigContent\fP <\fBhttps://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/network/cpe/get-cpe-device-config-content.html\fP>   returns CPE configuration content for \fIall\fP IPSec connections that use a specific CPE.
.UNINDENT
.UNINDENT
.UNINDENT
.SH USAGE
