...
.
.TH "PSQL_BACKUP-COLLECTION_LIST-BACKUPS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
psql_backup-collection_list-backups \- 
.
...
.UNINDENT
.sp
A filter to return only resources if their \fIlifecycleState\fP matches the given \fIlifecycleState\fP\&.
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
...
.UNINDENT
.sp
The end date for getting backups. An \fI\%RFC 3339\fP <\fBhttps://tools.ietf.org/rfc/rfc3339\fP> formatted datetime string.
.INDENT 0.0
.INDENT 3.5
...
.UNINDENT
.sp
The start date for getting backups. An \fI\%RFC 3339\fP <\fBhttps://tools.ietf.org/rfc/rfc3339\fP> formatted datetime string.
.INDENT 0.0
.INDENT 3.5
The following datetime formats are supported:
.UNINDENT
