...
.
.TH "OS_REPLICATION_LIST-REPLICATION-SOURCES" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
os_replication_list-replication-sources \- 
.
...
.INDENT 0.0
.TP
.B List the replication sources of a destination bucket.
If you are replicating to a destination bucket in a different region, you must specify the –region parameter.
.UNINDENT
.SH USAGE
.INDENT 0.0
.INDENT 3.5
...
.nf
.ft C
oci os replication list\-replication\-sources [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export bucket_name=<substitute\-value\-of\-bucket_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/os/replication/list\-replication\-sources.html#cmdoption\-bucket\-name

    oci os replication list\-replication\-sources \-\-bucket\-name $bucket_name
.ft P
.fi
.UNINDENT
.UNINDENT
...
.SS Description
.sp
List the replication sources of specified destination bucket.
.SS Command
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
 oci os replication list\-replication\-sources \-bn cli\-test
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
{
 "data": [
      {
           "policy\-name": "replication\-policy\-20221228\-1851",
           "source\-bucket\-name": "bucket\-client",
           "source\-region\-name": "us\-phoenix\-1"
      }
 ]
}
.ft P
