...
.
.TH "DATA-CATALOG_DATA-ASSET_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-catalog_data-asset_list \- 
.
...
.nf
.ft C
oci data\-catalog data\-asset list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
catalogId, description, displayName, externalKey, key, lifecycleState, timeCreated, typeKey, uri
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci data\-catalog data\-asset list \-\-catalog\-id $catalog_id
.ft P
.fi
.UNINDENT
.UNINDENT
