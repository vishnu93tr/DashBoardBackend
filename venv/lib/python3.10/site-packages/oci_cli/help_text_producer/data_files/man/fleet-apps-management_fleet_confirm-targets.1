...
.
.TH "FLEET-APPS-MANAGEMENT_FLEET_CONFIRM-TARGETS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
fleet-apps-management_fleet_confirm-targets \- 
.
...
.nf
.ft C
    oci fleet\-apps\-management fleet confirm\-targets \-\-generate\-param\-json\-input targets > targets.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci fleet\-apps\-management fleet confirm\-targets \-\-fleet\-id $fleet_id \-\-targets file://targets.json
.ft P
.fi
.UNINDENT
.UNINDENT
