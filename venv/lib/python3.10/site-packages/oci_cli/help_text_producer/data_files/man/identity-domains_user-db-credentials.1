...
.
.TH "IDENTITY-DOMAINS_USER-DB-CREDENTIALS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_user-db-credentials \- 
.
...
.nf
.ft C
oci identity\-domains user\-db\-credentials list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains user\-db\-credentials list
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci identity\-domains user\-db\-credentials search [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains user\-db\-credentials search \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains user\-db\-credentials search \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
