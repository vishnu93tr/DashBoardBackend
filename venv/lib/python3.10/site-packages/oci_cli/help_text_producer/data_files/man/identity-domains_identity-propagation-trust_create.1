...
.
.TH "IDENTITY-DOMAINS_IDENTITY-PROPAGATION-TRUST_CREATE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_identity-propagation-trust_create \- 
.
...
.nf
.ft C
oci identity\-domains identity\-propagation\-trust create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci identity\-domains identity\-propagation\-trust create \-\-issuer $issuer \-\-name $name \-\-schemas file://schemas.json \-\-type $type
.ft P
.fi
.UNINDENT
.UNINDENT
