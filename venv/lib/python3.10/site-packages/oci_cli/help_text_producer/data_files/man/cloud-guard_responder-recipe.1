...
.
.TH "CLOUD-GUARD_RESPONDER-RECIPE" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
cloud-guard_responder-recipe \- 
.
...
.nf
.ft C
oci cloud\-guard responder\-recipe change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci cloud\-guard responder\-recipe change\-compartment \-\-compartment\-id $compartment_id \-\-responder\-recipe\-id $responder_recipe_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci cloud\-guard responder\-recipe create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-source\-responder\-recipe\-id [text]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-responder\-rules [complex type]
.UNINDENT
.sp
List of responder rules to override from source responder recipe
.sp
This option is a JSON list with items of type UpdateResponderRecipeResponderRule.  For documentation on UpdateResponderRecipeResponderRule please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/cloudguard/20200131/datatypes/UpdateResponderRecipeResponderRule\fP\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
.ft C
    ...
    oci cloud\-guard responder\-recipe create \-\-compartment\-id $compartment_id \-\-display\-name $display_name \-\-source\-responder\-recipe\-id $source_responder_recipe_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci cloud\-guard responder\-recipe delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci cloud\-guard responder\-recipe delete \-\-responder\-recipe\-id $responder_recipe_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci cloud\-guard responder\-recipe get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci cloud\-guard responder\-recipe get \-\-responder\-recipe\-id $responder_recipe_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.SS Description
.sp
Returns a list (ResponderRecipeCollection resource, with a page of ResponderRecipeSummary resources) of all responder recipes (RespponderRecipe resources) in a compartment, identified by compartmentId. The ListResponderRecipe operation returns only the targets in \fIcompartmentId\fP passed. The list does not include any subcompartments of the compartmentId passed.
.sp
...
.sp
The parameter \fIcompartmentIdInSubtree\fP applies when you perform ListResponderRecipe on the \fIcompartmentId\fP passed and when it is set to true, the entire hierarchy of compartments can be returned. To get a full list of all compartments and subcompartments in the tenancy (root compartment), set the parameter \fIcompartmentIdInSubtree\fP to true and \fIaccessLevel\fP to ACCESSIBLE.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
...
.INDENT 0.0
.TP
.B \-\-resource\-metadata\-only [boolean]
.UNINDENT
.sp
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/cloud\-guard/responder\-recipe/list.html#cmdoption\-compartment\-id
...
.nf
.ft C
oci cloud\-guard responder\-recipe update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci cloud\-guard responder\-recipe update \-\-display\-name $display_name \-\-responder\-recipe\-id $responder_recipe_id
.ft P
.fi
.UNINDENT
.UNINDENT
