...
.
.TH "STACK-MONITORING_RESOURCE_SEARCH-MEMBERS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
stack-monitoring_resource_search-members \- 
.
...
.SH DESCRIPTION
.sp
List the member resources for the given monitored resource identifier \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP>\&.
.SH USAGE
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci stack\-monitoring resource search\-members [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
resourceName, resourceType, sourceResourceType
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci stack\-monitoring resource search\-members \-\-resource\-id $resource_id
.ft P
.fi
.UNINDENT
.UNINDENT
