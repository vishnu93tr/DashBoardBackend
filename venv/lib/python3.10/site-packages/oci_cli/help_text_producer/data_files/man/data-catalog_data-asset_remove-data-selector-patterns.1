...
.
.TH "DATA-CATALOG_DATA-ASSET_REMOVE-DATA-SELECTOR-PATTERNS" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
data-catalog_data-asset_remove-data-selector-patterns \- 
.
...
.nf
.ft C
oci data\-catalog data\-asset remove\-data\-selector\-patterns [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci data\-catalog data\-asset remove\-data\-selector\-patterns \-\-generate\-param\-json\-input items > items.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    export data_asset_key=<substitute\-value\-of\-data_asset_key> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/data\-catalog/data\-asset/remove\-data\-selector\-patterns.html#cmdoption\-data\-asset\-key

    catalog_id=$(oci data\-catalog catalog create \-\-compartment\-id $compartment_id \-\-query data.id \-\-raw\-output)

    oci data\-catalog data\-asset remove\-data\-selector\-patterns \-\-catalog\-id $catalog_id \-\-data\-asset\-key $data_asset_key \-\-items file://items.json
.ft P
.fi
.UNINDENT
.UNINDENT
