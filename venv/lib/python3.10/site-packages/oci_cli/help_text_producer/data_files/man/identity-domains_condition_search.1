...
.
.TH "IDENTITY-DOMAINS_CONDITION_SEARCH" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
identity-domains_condition_search \- 
.
...
.nf
.ft C
oci identity\-domains condition search [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains condition search \-\-generate\-param\-json\-input schemas > schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    oci identity\-domains condition search \-\-schemas file://schemas.json
.ft P
.fi
.UNINDENT
.UNINDENT
