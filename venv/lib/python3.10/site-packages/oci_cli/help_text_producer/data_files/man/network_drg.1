...
.
.TH "NETWORK_DRG" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
network_drg \- 
.
...
.SH DESCRIPTION
.sp
A dynamic routing gateway (DRG) is a virtual router that provides a path for private network traffic between networks. You use it with other Networking Service components to create a connection to your on\-premises network using \fI\%Site\-to\-Site VPN\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Network/Tasks/managingIPsec.htm\fP> or a connection that uses \fI\%FastConnect\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Network/Concepts/fastconnect.htm\fP>\&. For more information, see \fI\%Networking Overview\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Network/Concepts/overview.htm\fP>\&.
.sp
...
.SS Description
.sp
Moves a DRG into a different compartment within the same tenancy. For information about moving resources between compartments, see \fI\%Moving Resources to a Different Compartment\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Identity/Tasks/managingcompartments.htm#moveRes\fP>\&.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci network drg change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the compartment to move the DRG to.
.INDENT 0.0
.TP
.B \-\-drg\-id [text]
.UNINDENT
...
.ft C
    ...
    oci network drg change\-compartment \-\-compartment\-id $compartment_id \-\-drg\-id $drg_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.SS Description
.sp
Creates a new dynamic routing gateway (DRG) in the specified compartment. For more information, see \fI\%Dynamic Routing Gateways (DRGs)\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Network/Tasks/managingDRGs.htm\fP>\&.
.sp
For the purposes of access control, you must provide the \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the compartment where you want the DRG to reside. Notice that the DRG doesn’t have to be in the same compartment as the VCN, the DRG attachment, or other Networking Service components. If you’re not sure which compartment to use, put the DRG in the same compartment as the VCN. For more information about compartments and access control, see \fI\%Overview of the IAM Service\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Identity/Concepts/overview.htm\fP>\&. For information about OCIDs, see \fI\%Resource Identifiers\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP>\&.
.sp
You may optionally specify a \fIdisplay name\fP for the DRG, otherwise a default is provided. It does not have to be unique, and you can change it. Avoid entering confidential information.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm\fP> of the compartment to contain the DRG.
.SS Optional Parameters
.INDENT 0.0
.TP
...
.ft C
    ...
    oci network drg create \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.SS Description
.sp
Deletes the specified DRG. The DRG must not be attached to a VCN or be connected to your on\-premise network. Also, there must not be a route table that lists the DRG as a target. This is an asynchronous operation. The DRG’s \fIlifecycleState\fP will change to TERMINATING temporarily until the DRG is completely removed.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
.nf
.ft C
oci network drg delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci network drg delete \-\-drg\-id $drg_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci network drg get \-\-drg\-id $drg_id
.ft P
.fi
.UNINDENT
.UNINDENT
.SS \fBget\-all\-drg\-attachments\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.nf
.ft C
oci network drg get\-upgrade\-status [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci network drg get\-upgrade\-status \-\-drg\-id $drg_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/network/drg/list.html#cmdoption\-compartment\-id

    oci network drg list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci network drg update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-default\-drg\-route\-tables [complex type]
.UNINDENT
.sp
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
...
.ft C
    ...
    oci network drg update \-\-drg\-id $drg_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci network drg upgrade [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci network drg upgrade \-\-drg\-id $drg_id
.ft P
.fi
.UNINDENT
.UNINDENT
