...
.
.TH "DISASTER-RECOVERY_DR-PROTECTION-GROUP_LIST" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
disaster-recovery_dr-protection-group_list \- 
.
...
.nf
.ft C
oci disaster\-recovery dr\-protection\-group list [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/disaster\-recovery/dr\-protection\-group/list.html#cmdoption\-compartment\-id

    oci disaster\-recovery dr\-protection\-group list \-\-compartment\-id $compartment_id
.ft P
.fi
.UNINDENT
.UNINDENT
