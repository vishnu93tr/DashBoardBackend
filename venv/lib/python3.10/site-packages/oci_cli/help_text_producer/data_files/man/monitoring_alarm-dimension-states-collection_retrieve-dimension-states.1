...
.
.TH "MONITORING_ALARM-DIMENSION-STATES-COLLECTION_RETRIEVE-DIMENSION-STATES" "1" "Apr 23, 2025" "3.54.5" "OCI CLI Command Reference"
.SH NAME
monitoring_alarm-dimension-states-collection_retrieve-dimension-states \- 
.
...
.sp
For more information, see \fI\%Listing Metric Stream Status in an Alarm\fP <\fBhttps://docs.cloud.oracle.com/iaas/Content/Monitoring/Tasks/list-alarm-status-metric-stream.htm\fP>\&.
.sp
...
.INDENT 0.0
.TP
.B \-\-dimension\-filters [complex type]
.UNINDENT
.sp
A filter to return only alarm state entries that match the exact set of specified dimension key\-value pairs. If you specify \fI“availabilityDomain”: “phx\-ad\-1”\fP but the alarm state entry corresponds to the set \fI“availabilityDomain”: “phx\-ad\-1”\fP and \fI“resourceId”: “ocid1.instance.region1.phx.exampleuniqueID”\fP, then no results are returned.
...
.UNINDENT
.sp
A filter to return only alarm state entries that match the status value. Example: \fIFIRING\fP
